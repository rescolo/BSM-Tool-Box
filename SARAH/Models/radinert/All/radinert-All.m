...
(*T12A: \rho_i -> Y3, Pi -> Piu, Pid, eta -> eta, Yfr -> f*)
...
LagSc =  -( + musc H.Et.conj[Sc] +  Yfr l.rd.Sc - Piu rsu.conj[H].rd - Pid rsd.H.ru + Yet rsu.conj[Et].l + YR1 ru.l.S  +  YR3 n.H.rd + YR4 n.conj[H].ru);
