...
{mEt2, {LaTeX -> "m_\\eta^2",
	LesHouches -> {HDM,1}, OutputName-> mEt2 }},

{lambda1,   {LaTeX -> "\\lambda_1",
	     LesHouches -> {HDM,2}, OutputName-> lam1 }},

{lambda2,   {LaTeX -> "\\lambda_2",
	     LesHouches -> {HDM,3}, OutputName-> lam2 }},

{lambda3,   {LaTeX -> "\\lambda_3",
	     LesHouches -> {HDM,4}, OutputName-> lam3 }},

{lambda4,   {LaTeX -> "\\lambda_4",
	     LesHouches -> {HDM,5}, OutputName-> lam4 }},

{lambda5,   {Real -> True,
	     LaTeX -> "\\lambda_5",
	     LesHouches -> {HDM,6}, OutputName-> lam5 }},


(* Fermion Sector *) 

{MTF,   {Description -> "Triplet-Mass",
         LaTeX -> "M_T", 
         LesHouches-> MTF, OutputName-> MTF }},
{Yn,   {LaTeX -> "Y_N",
	LesHouches -> YN, OutputName-> Yn }}
