...
Model`Name      = "2HDMHiggsBasis";
Model`NameLaTeX = "THDMIII Model in the Higgs Basis";
Model`Authors   = "Julian Calle and D. Restrepo: Based on Sctogogenic by N. Rojas, A. Vicente and THDM-III";
