...
DefaultInputValues ={Lambda1Input -> 0.1, Lambda2Input -> 0.13, Lambda3Input -> 1.1, Lambda4Input ->-0.5, Lambda5Input ->0.5,  M222input -> 40000, Mhinput -> 10000, Muinput -> 100, TanBeta->50};
