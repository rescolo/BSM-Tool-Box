...
WriteString[file,"! 'PreSARAH' output has been generated  at 13:20 on 25.3.2014 \n"]; 
WriteString[file,"! ---------------------------------------------------------------- \n \n"]; 
...
AddTreeResultPreSARAH[Z2l][top_,type_,file_]:=Block[{}, 
 ...
 Switch[top,  (* Check topology *) 
  1, 
	 	 WriteString[file,"  OZ2lSL=OZ2lSL+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  OZ2lSL= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteString[file,"  OZ2lSR=OZ2lSR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  OZ2lSR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteString[file,"  OZ2lVL=OZ2lVL+ coup1L\n" ];
	 	 WriteString[sphenoTeX,"  OZ2lVL= & "<> StringReplace["coup1L",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteString[file,"  OZ2lVR=OZ2lVR+ coup1R\n" ];
	 	 WriteString[sphenoTeX,"  OZ2lVR= & "<> StringReplace["coup1R",SA`SPhenoTeXSub]<>" \\\\ \n" ];
]; 
]; 
