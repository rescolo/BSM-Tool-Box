...
Print["     writing SPheno code for ",TreeS2L2d]; 
...
S, (* Scalar penguins *) 
 Switch[top,  (* Check topology *) 
  1, 
	 	 WriteStringFLB[file,"  TSOllddSLL=TSOllddSLL+ coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddSLL= & "<> StringReplace["coup1L coup2L IMP2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddSRR=TSOllddSRR+ coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddSRR= & "<> StringReplace["coup1R coup2R IMP2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddSRL=TSOllddSRL+ coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddSRL= & "<> StringReplace["coup1R coup2L IMP2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddSLR=TSOllddSLR+ coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddSLR= & "<> StringReplace["coup1L coup2R IMP2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
...
,
  2, 
	 	 ...
	 	 WriteString[sphenoTeX,"  TSOllddSLL= & "<> StringReplace["-(coup1L coup2L IMP2)/2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddSRR=TSOllddSRR+ -0.5*coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddSRR= & "<> StringReplace["-(coup1R coup2R IMP2)/2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 ...
	 	 WriteString[sphenoTeX,"  TSOllddVRR= & "<> StringReplace["(coup1R coup2L IMP2)/2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddVLL=TSOllddVLL+ 0.5*coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddVLL= & "<> StringReplace["(coup1L coup2R IMP2)/2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddVRL=TSOllddVRL+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddVRL= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddVLR=TSOllddVLR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddVLR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddTLL=TSOllddTLL+ -0.125*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddTLL= & "<> StringReplace["-(coup1L coup2L IMP2)/8",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddTLR=TSOllddTLR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddTLR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddTRL=TSOllddTRL+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddTRL= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddTRR=TSOllddTRR+ -0.125*coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddTRR= & "<> StringReplace["-(coup1R coup2R IMP2)/8",SA`SPhenoTeXSub]<>" \\\\ \n" ];
,
  3, 
	 	 WriteStringFLB[file,"  TSOllddSLL=TSOllddSLL+ -0.5*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddSLL= & "<> StringReplace["-(coup1L coup2L IMP2)/2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 ...
	 	 WriteString[sphenoTeX,"  TSOllddVRL= & "<> StringReplace["-(coup1R coup2L IMP2)/2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddVLR=TSOllddVLR+ -0.5*coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddVLR= & "<> StringReplace["-(coup1L coup2R IMP2)/2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddTLL=TSOllddTLL+ 0.125*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddTLL= & "<> StringReplace["(coup1L coup2L IMP2)/8",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TSOllddTLR=TSOllddTLR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TSOllddTLR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
