...
WriteString[ModelData, "Complex(dp) :: tForTadpoles("<>ToString[SA`NrTadpoleEquations]<>")\n"];
...
WriteString[ModelData,head<>"(dp) :: " <> SPhenoForm[AdditionalVariablesSPheno[[i]]]<>"\n"];
If[Depth[AdditionalVariablesSPheno[[i]]]>1,
WriteString[ModelData,head<>"(dp) :: " <> SPhenoForm[ToExpression[ToString[AdditionalVariablesSPheno[[i,0]]]<>"IN"]@@AdditionalVariablesSPheno[[i]]]<>"\n"];,
WriteString[ModelData,head<>"(dp) :: " <> SPhenoForm[ToExpression[ToString[AdditionalVariablesSPheno[[i]]]<>"IN"]]<>"\n"];
];
i++;];
