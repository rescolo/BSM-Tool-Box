...
GenerateSPhenoHiggsCS[ES_]:=Block[{i,j,temp},
      ...
      sphenoCS=
        OpenWrite[
          ToFileName[$sarahCurrentSPhenoDir,"HiggsCS_"<>ModelName<>".f90"]];
...
WriteSPhenoHiggsCS[ES_]:=Block[{i,j,temp, genH,genHS},
      ...
      genHS=ToString[genH];
      MakeSubroutineTitle[
        "HiggsCrossSections",{},{"mh","ratGG","ratPP","ratWW","ratZZ","ratTT",
          "CS","kont"},{},sphenoCS];
      
      WriteString[sphenoCS,"Implicit None \n"];
      WriteString[sphenoCS,"Real(dp), Intent(in) :: mh("<>genHS<>")  \n"];
      WriteString[sphenoCS,
        "Complex(dp), Intent(in) :: ratPP("<>genHS<>"), ratGG("<>genHS<>
          ")  \n"];
      WriteString[sphenoCS,
        "Real(dp), Intent(in) :: ratZZ("<>genHS<>"), ratWW("<>genHS<>"), ratTT("<>
          genHS<>")  \n"];
      WriteString[sphenoCS,
        "Real(dp), Intent(Out) :: CS(2,"<>genHS<>",5)  \n"];
      ...
      WriteString[sphenoCS, "If ((x.gt.50).AND.(x.lt.1000_dp)) Then \n"];
      WriteString[sphenoCS, 
...
;
      ...
      WriteString[sphenoCS, "If ((x.gt.50).AND.(x.lt.300_dp)) Then \n"];
      WriteString[sphenoCS, 
