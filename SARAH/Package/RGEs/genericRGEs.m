...
CalculateRGEs[TwoL_, ReadLists_,VarGens_, NoMatMul_,Simp_, Force_,IgnoreAt2L_,WriteRunning_]:=Block[{i},
...
Print[""];
Print["Finished with the calculation of the RGEs"];
Print["The results are saved in ",$sarahCurrentRGEDir];
...
betaFuncAijk[p1_,p2_,p3_]:=1/2 Aijk[p1,p2,pL] Conj[Yijk[pL,pM,pN]] Yijk[pM,pN,p3]+ Yijk[p1,p2,pL] Conj[Yijk[pL,pM,pN]] Aijk[pM,pN,p3]-2Sum[(Aijk[p1,p2,p3]-2 Mi[n1] Yijk[p1,p2,p3]) gc[n1]^2SA`Casimir[getBlankSF[p3],n1],{n1,1,AnzahlGauge}];
betaFuncAijk2L[p1_,p2_,p3_]:=-1/2 Aijk[p1,p2,pL] Conj[Yijk[pL,pM,pN]] Yijk[pN,pP,pQ] Conj[Yijk[pP,pQ,pR]] Yijk[pM,pR,p3]-Yijk[p1,p2,pL] Conj[Yijk[pL,pM,pN]] Yijk[pN,pP,pQ] Conj[Yijk[pP,pQ,pR]] Aijk[pM,pR,p3]-Yijk[p1,p2,pL] Conj[Yijk[pL,pM,pN]] Aijk[pN,pP,pQ] Conj[Yijk[pP,pQ,pR]] Yijk[pM,pR,p3]+Sum[(Aijk[p1,p2,pL] Conj[Yijk[pL,pP,pQ]] Yijk[pP,pQ,p3]+2 Yijk[p1,p2,pL] Conj[Yijk[pL,pP,pQ]] Aijk[pP,pQ,p3]-2 Mi[gnr] Yijk[p1,p2,pL] Conj[Yijk[pL,pP,pQ]] Yijk[pP,pQ,p3])gc[gnr]^2 (2 SA`Casimir[getBlankSF[pP],gnr]-SA`Casimir[getBlankSF[p3],gnr]),{gnr,1,AnzahlGauge}]+Sum[(2 Aijk[p1,p2,p3]-8 Mi[gnr] Yijk[p1,p2,p3]) gc[gnr]^4 (SA`Casimir[getBlankSF[p3],gnr] SA`Dynkin[rep,gnr]-3 SA`Casimir[gnr] SA`Casimir[getBlankSF[p3],gnr]),{gnr,1,AnzahlGauge}]+Sum[Sum[2 gc[gnr]^2 gc[gnr2]^2 (2 Aijk[p1,p2,p3]-8 Mi[gnr] Yijk[p1,p2,p3]) SA`Casimir[getBlankSF[p3],gnr] SA`Casimir[getBlankSF[p3],gnr2],{gnr2,1,AnzahlGauge}],{gnr,1,AnzahlGauge}];

betaFuncBij[p1_,p2_]:=1/2Bij[p1,pL] Conj[Yijk[pL,pM,pN]] Yijk[pM,pN,p2]+1/2  Yijk[p1,p2,pL] Conj[Yijk[pL,pM,pN]] Bij[pM,pN]+Muij[p1,pL] Conj[Yijk[pL,pM,pN]] Aijk[pM,pN,p2]-2 Sum[(Bij[p1,p2]-2 Mi[n1] Muij[p1,p2]) gc[n1]^2SA`Casimir[getBlankSF[p1],n1],{n1,1,AnzahlGauge}];
betaFuncBij2L[p1_,p2_]:=-1/2 Bij[p1,pL] Conj[Yijk[pL,pM,pN]] Yijk[pP,pQ,pN] Conj[Yijk[pP,pQ,pR]] Yijk[pM,pR,p2]-1/2 Yijk[p1,p2,pL] Conj[Yijk[pL,pM,pN]] Bij[pM,pR] Conj[Yijk[pP,pQ,pR]] Yijk[pP,pQ,pN]-1/2 Yijk[p1,p2,pL] Conj[Yijk[pL,pM,pN]] Muij[pM,pR] Conj[Yijk[pP,pQ,pR]] Aijk[pP,pQ,pN]-Muij[p1,pL] Conj[Yijk[pL,pM,pN]] Aijk[pN,pP,pQ] Conj[Yijk[pP,pQ,pR]] Yijk[pM,pR,p2]-Muij[p1,pL] Conj[Yijk[pL,pM,pN]] Yijk[pN,pP,pQ] Conj[Yijk[pP,pQ,pR]] Aijk[pM,pR,p2]+2 Sum[Sum[Yijk[p1,p2,pL] Conj[Yijk[pL,pP,pQ]] (Bij[pP,pQ]-Muij[pP,pQ] Mi[gnr]) gc[gnr]^2 SA`Casimir[getBlankSF[pP],gnr],{gn,1,AnzahlGauge}],{gnr,1,AnzahlGauge}]+Sum[(Bij[p1,pL] Conj[Yijk[pL,pP,pQ]] Yijk[pP,pQ,p2]+2 Muij[p1,pL] Conj[Yijk[pL,pP,pQ]] Aijk[pP,pQ,p2]-2 Muij[p1,pL] Conj[Yijk[pL,pP,pQ]] Yijk[pP,pQ,p2] Mi[gnr])gc[gnr]^2 (2 SA`Casimir[getBlankSF[pP],gnr]-SA`Casimir[p1,gnr]),{gnr,1,AnzahlGauge}]+Sum[(2 Bij[p1,p2]-8 Muij[p1,p2] Mi[gnr]) gc[gnr]^4 (SA`Casimir[getBlankSF[p1],gnr] SA`Dynkin[rep,gnr]-3 SA`Casimir[gnr] SA`Casimir[getBlankSF[p1],gnr]),{gnr,1,AnzahlGauge}]+Sum[Sum[(2 Bij[p1,p2]-8 Muij[p1,p2] Mi[gnr]) gc[gnr]^2 gc[gn]^2 2 SA`Casimir[getBlankSF[p1],gnr] SA`Casimir[getBlankSF[p1],gn],{gn,1,AnzahlGauge}],{gnr,1,AnzahlGauge}];
...
CalcBetaFunctions[type_,fields_,filename_,filename3I_,twoloop_,Simp_]:=Block[{i,factor,res,subNonZero,coup,SaveArray={},SaveArray3I={}},

Switch[type,
WIJKL, Print["Calculate Beta Functions for 4-point Superpotential parameters"];,
QIJKL, Print["Calculate Beta Functions for 4-point soft breaking parameters"];,
YIJK, Print["Calculate Beta Functions for trilinear Superpotential parameters"];,
MUIJ,Print["Calculate Beta Functions for bilinear Superpotential parameters"];,
LI,Print["Calculate Beta Functions for linear Superpotential parameters"];,
TIJK,Print["Calculate Beta Functions for trilinear soft breaking parameters"];,
BIJ,Print["Calculate Beta Functions for bilinear soft breaking parameters"];,
LSI,Print["Calculate Beta Functions for linear soft breaking parameters"];,
M2IJ,Print["Calculate Beta Functions for scalar soft breaking masses"];,
GAUGE,Print["Calculate Beta Functions for Gauge Couplings"];,
MI,Print["Calculate Beta Functions for Gaugino masses"];,
DGI,Print["Calculate Beta Functions for Dirac Gaugino masses"];,
...
Print["Calculate Traces for soft-scalar masses"];
TraceAbbr={{},{}};
