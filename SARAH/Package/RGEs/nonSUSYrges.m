...
GenerateCouplingVariables[NoMatMul_,Force_]:=Block[{i,j,k,subrule,per,free,added={},res,temp},
If[NoMatMul,MakeMatrixMul=False;,MakeMatrixMul=True;];
...
NeededAnaDimsForVEVs=Join[NeededAnaDimsForVEVs,{{(getBlankSF[Extract[SFields,pos[[1,1]]]]/. subComplexScalarsList)[[1]],DEFINITION[NameOfStates[[j]]][VEVs][[i,2,1]]}}];
sf=(RE[getFullSF[Extract[SFields,pos[[1,1]]]]]/. subComplexScalarsList)[[1]];
...
If[type===VEVI,
betaFunction=-betaFunction /. Delta2->Delta /. Delta[a_[{b1__}][{c1__}],a_[{b2__}][{c2__}]]->Delta[a[{b1}],a[{b2}]] /. Delta[a__]->0;
betaFunction2L=-betaFunction2L /. Delta2->Delta /. Delta[a_[{b1__}][{c1__}],a_[{b2__}][{c2__}]]->Delta[a[{b1}],a[{b2}]] /. Delta[a__]->0;,
...
searchedcoup=Select[Transpose[parameters][[1]],(FreeQ[term,#]==False)&];
...
If[resM=!=0,
If[Select[Transpose[parameters][[1]],(FreeQ[resM,#]==False)&]===searchedcoup,
sign=MINUS;
Found=True;
];
];
If[resP=!=0 && Found==False,
If[Select[Transpose[parameters][[1]],(FreeQ[resP,#]==False)&]===searchedcoup,
sign=PLUS;
Found=True;
];
];
