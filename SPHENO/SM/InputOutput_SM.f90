...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - kk Spectrum + Decays + Flavor Observables"
...
Write(io_L,104) 1, Abs(g1SM), "# g1SM "  
Write(io_L,104) 2, Abs(g2SM), "# g2SM "  
Write(io_L,104) 3, Abs(g3SM), "# g3SM "  
Write(io_L,104) 4, Abs(Null), "# Null "  
Write(io_L,104) 5, Abs(vSM), "# vSM "  
Write(io_L,104) 6, Abs(YdSM), "# YdSM "  
Write(io_L,104) 7, Abs(YeSM), "# YeSM "  
Write(io_L,104) 8, Abs(YuSM), "# YuSM "  
MassLSP = 100000._dp 
