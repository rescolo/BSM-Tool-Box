...
Program SPhenoSimplifiedDMSDFDM 
 
Use Control
Use InputOutput_SimplifiedDMSDFDM
Use LoopFunctions
Use RunSM_SimplifiedDMSDFDM
Use LowEnergy_SimplifiedDMSDFDM
Use FlavorKit_LFV_SimplifiedDMSDFDM
Use FlavorKit_QFV_SimplifiedDMSDFDM
Use FlavorKit_Observables_SimplifiedDMSDFDM
Use Mathematics
...
End Program SPhenoSimplifiedDMSDFDM 
