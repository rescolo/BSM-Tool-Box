...
Module Chi3Decays_SimplifiedDMSDFDM 
...
& gTVWp,gTVZ,gChiChiChiChi,gChiChicFdFd,gChiChicFeFe,gChiChicFuFu,gChiChicFreFre,        & 
& gChiChicFvFv,gChiFrecFdFu,gChiFrecFeFv,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gChiChiChiChi(3,3,3,3),gChiChicFdFd(3,3,3,3),gChiChicFeFe(3,3,3,3),gChiChicFuFu(3,3,3,3),& 
& gChiChicFreFre(3,3,1,1),gChiChicFvFv(3,3,3,3),gChiFrecFdFu(3,1,3,3),gChiFrecFeFv(3,1,3,3)

Real(dp),Intent(in) :: gThh,gTVWp,gTVZ

Real(dp) :: gChiChiChiChii(3,3,3),gChiChicFdFdi(3,3,3),gChiChicFeFei(3,3,3),gChiChicFuFui(3,3,3), & 
& gChiChicFreFrei(3,1,1),gChiChicFvFvi(3,3,3),gChiFrecFdFui(1,3,3),gChiFrecFeFvi(1,3,3)
...
Call CouplingsFor_Chi_decays_3B(MChi(i_run),i_run,MAh,MAh2,MChi,MChi2,MFd,            & 
...
& cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiFreVWpL,cplChiFreVWpR,deltaM)
...
Call ChiToChiChiChi(i_run,MChi,MVZ,Mhh,cplChiChihhL,cplChiChihhR,cplChiChiVZL,        & 
& cplChiChiVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,IntegralVSss,             & 
& IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,NVSss,NVSst,NVVss,          & 
& NVVst,gTVZtemp,gThhtemp,deltaM,epsI,check,gChiChiChiChii)

gChiChiChiChi(i_run,:,:,:) = gChiChiChiChii 
gT(i_run) = gT(i_run) + Sum(gChiChiChiChii) 
 
gChiChicFdFdi = 0._dp 
Call ChiToChicFdFd(i_run,MChi,MFd,MVZ,Mhh,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,        & 
& cplcFdFdVZR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,IntegralSs,            & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
& gTVZtemp,gThhtemp,deltaM,epsI,check,gChiChicFdFdi)

gChiChicFdFd(i_run,:,:,:) = gChiChicFdFdi 
gT(i_run) = gT(i_run) + Sum(gChiChicFdFdi) 
 
gChiChicFeFei = 0._dp 
Call ChiToChicFeFe(i_run,MChi,MFe,MVZ,Mhh,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,        & 
& cplcFeFeVZR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,IntegralSs,            & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
& gTVZtemp,gThhtemp,deltaM,epsI,check,gChiChicFeFei)

gChiChicFeFe(i_run,:,:,:) = gChiChicFeFei 
gT(i_run) = gT(i_run) + Sum(gChiChicFeFei) 
 
gChiChicFuFui = 0._dp 
Call ChiToChicFuFu(i_run,MChi,MFu,MVZ,Mhh,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,        & 
& cplcFuFuVZR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,IntegralSs,            & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
& gTVZtemp,gThhtemp,deltaM,epsI,check,gChiChicFuFui)

gChiChicFuFu(i_run,:,:,:) = gChiChicFuFui 
gT(i_run) = gT(i_run) + Sum(gChiChicFuFui) 
 
gChiChicFreFrei = 0._dp 
Call ChiToChicFreFre(i_run,MChi,MFre,MVZ,MVWp,cplcFreChicVWpL,cplcFreChicVWpR,        & 
& cplcFreFreVZL,cplcFreFreVZR,cplChiChiVZL,cplChiChiVZR,cplChiFreVWpL,cplChiFreVWpR,     & 
& IntegralVs,IntegralVVss,IntegralVVst,NVs,NVVss,NVVst,gTVZtemp,gTVWptemp,               & 
& deltaM,epsI,check,gChiChicFreFrei)

gChiChicFreFre(i_run,:,:,:) = gChiChicFreFrei 
gT(i_run) = gT(i_run) + Sum(gChiChicFreFrei) 
...
gChiFrecFdFui = 0._dp 
Call ChiToFrecFdFu(i_run,MFre,MFd,MFu,MVWp,MChi,cplcFdFucVWpL,cplcFdFucVWpR,          & 
& cplChiFreVWpL,cplChiFreVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWptemp,               & 
& deltaM,epsI,check,gChiFrecFdFui)

gChiFrecFdFu(i_run,:,:,:) = gChiFrecFdFui 
gT(i_run) = gT(i_run) + 2._dp*Sum(gChiFrecFdFui) 
 
gChiFrecFeFvi = 0._dp 
Call ChiToFrecFeFv(i_run,MFre,MFe,MVWp,MChi,cplcFeFvcVWpL,cplcFeFvcVWpR,              & 
& cplChiFreVWpL,cplChiFreVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWptemp,               & 
& deltaM,epsI,check,gChiFrecFeFvi)

gChiFrecFeFv(i_run,:,:,:) = gChiFrecFeFvi 
gT(i_run) = gT(i_run) + 2._dp*Sum(gChiFrecFeFvi) 
...
Do gt1=1,3
  Do gt2=1,1
    Do gt3=1,1
gPartial(i1,n_length)= gChiChicFreFre(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,1
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= 2._dp*gChiFrecFdFu(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,1
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= 2._dp*gChiFrecFeFv(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Subroutine ChiToChiChiChi(iIN,MChi,MVZ,Mhh,cplChiChihhL,cplChiChihhR,cplChiChiVZL,    & 
& cplChiChiVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,IntegralVSss,             & 
& IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,NVSss,NVSst,NVVss,          & 
...
Real(dp),Intent(in) :: MChi(3),MVZ,Mhh

Complex(dp),Intent(in) :: cplChiChihhL(3,3),cplChiChihhR(3,3),cplChiChiVZL(3,3),cplChiChiVZR(3,3)
...
coup(2) = Conjg(cplChiChihhL(iIN,gt1)) 
coup(1) = Conjg(cplChiChihhR(iIN,gt1)) 
...
coup(2) = Conjg(cplChiChihhL(iIN,gt2)) 
coup(1) = Conjg(cplChiChihhR(iIN,gt2)) 
coup(4) = Conjg(cplChiChihhL(gt1,gt3)) 
coup(3) = Conjg(cplChiChihhR(gt1,gt3))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplChiChihhL(iIN,gt1) 
coup2(2) = cplChiChihhR(iIN,gt1) 
coup2(3) = Conjg(cplChiChihhL(iIN,gt1)) 
coup2(4) = Conjg(cplChiChihhR(iIN,gt1))  
coup2(5) = cplChiChihhL(gt2,gt3) 
coup2(6) = cplChiChihhR(gt2,gt3) 
...
coup2(1) = cplChiChihhL(iIN,gt3) 
coup2(2) = cplChiChihhR(iIN,gt3) 
coup2(3) = Conjg(cplChiChihhL(iIN,gt1)) 
coup2(4) = Conjg(cplChiChihhR(iIN,gt1))  
coup2(5) = cplChiChihhL(gt1,gt2) 
coup2(6) = cplChiChihhR(gt1,gt2) 
coup2(7) = Conjg(cplChiChihhL(gt2,gt3)) 
coup2(8) = Conjg(cplChiChihhR(gt2,gt3)) 
...
coup2(1) = cplChiChihhL(iIN,gt2) 
coup2(2) = cplChiChihhR(iIN,gt2) 
coup2(3) = Conjg(cplChiChihhL(iIN,gt1)) 
coup2(4) = Conjg(cplChiChihhR(iIN,gt1))  
coup2(5) = cplChiChihhL(gt1,gt3) 
coup2(6) = cplChiChihhR(gt1,gt3) 
coup2(7) = Conjg(cplChiChihhL(gt2,gt3)) 
coup2(8) = Conjg(cplChiChihhR(gt2,gt3)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
coup2(1) = cplChiChiVZL(iIN,gt1) 
coup2(2) = cplChiChiVZR(iIN,gt1) 
coup2(3) = Conjg(cplChiChihhL(iIN,gt2)) 
coup2(4) = Conjg(cplChiChihhR(iIN,gt2))  
coup2(5) = cplChiChiVZL(gt2,gt3) 
coup2(6) = cplChiChiVZR(gt2,gt3) 
coup2(7) = Conjg(cplChiChihhL(gt1,gt3)) 
coup2(8) = Conjg(cplChiChihhR(gt1,gt3)) 
...
coup2(1) = cplChiChiVZL(iIN,gt1) 
coup2(2) = cplChiChiVZR(iIN,gt1) 
coup2(3) = Conjg(cplChiChihhL(iIN,gt3)) 
coup2(4) = Conjg(cplChiChihhR(iIN,gt3))  
coup2(5) = cplChiChiVZL(gt2,gt3) 
coup2(6) = cplChiChiVZR(gt2,gt3) 
coup2(7) = Conjg(cplChiChihhL(gt2,gt1)) 
coup2(8) = Conjg(cplChiChihhR(gt2,gt1)) 
coupT = coup2(5) 
coup2(5) = coup2(6) 
coup2(6) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
coup2(5) = cplChiChiVZL(gt2,gt3) 
coup2(6) = cplChiChiVZR(gt2,gt3) 
coup2(7) = Conjg(cplChiChihhL(gt1,gt2)) 
coup2(8) = Conjg(cplChiChihhR(gt1,gt2)) 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2*resC 
resC= 1*resC ! color factor 
...
Subroutine ChiToChicFdFd(iIN,MChi,MFd,MVZ,Mhh,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,    & 
& cplcFdFdVZR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,IntegralSs,            & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
...
Real(dp),Intent(in) :: MChi(3),MFd(3),MVZ,Mhh

Complex(dp),Intent(in) :: cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplChiChihhL(3,3),& 
...
Subroutine ChiToChicFeFe(iIN,MChi,MFe,MVZ,Mhh,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,    & 
& cplcFeFeVZR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,IntegralSs,            & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
& gTVZ,gThh,deltaM,epsI,check,g,WriteContributions)
...
Real(dp),Intent(in) :: MChi(3),MFe(3),MVZ,Mhh

Complex(dp),Intent(in) :: cplcFeFehhL(3,3),cplcFeFehhR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplChiChihhL(3,3),& 
& cplChiChihhR(3,3),cplChiChiVZL(3,3),cplChiChiVZR(3,3)
...
Subroutine ChiToChicFuFu(iIN,MChi,MFu,MVZ,Mhh,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,    & 
& cplcFuFuVZR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,IntegralSs,            & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
& gTVZ,gThh,deltaM,epsI,check,g,WriteContributions)
...
Real(dp),Intent(in) :: MChi(3),MFu(3),MVZ,Mhh
...
Subroutine ChiToChicFreFre(iIN,MChi,MFre,MVZ,MVWp,cplcFreChicVWpL,cplcFreChicVWpR,    & 
& cplcFreFreVZL,cplcFreFreVZR,cplChiChiVZL,cplChiChiVZR,cplChiFreVWpL,cplChiFreVWpR,     & 
& IntegralVs,IntegralVVss,IntegralVVst,NVs,NVVss,NVVst,gTVZ,gTVWp,deltaM,epsI,           & 
& check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MChi(3),MFre,MVZ,MVWp

Complex(dp),Intent(in) :: cplcFreChicVWpL(3),cplcFreChicVWpR(3),cplcFreFreVZL,cplcFreFreVZR,cplChiChiVZL(3,3),  & 
...
If(Abs(MChi(iIN)).gt.(Abs(MFre)+Abs(MFre)+Abs(MChi(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi cFre Fre Propagator: VZ" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
...
coup(2) = Conjg(cplChiFreVWpL(iIN)) 
coup(1) = Conjg(cplChiFreVWpR(iIN)) 
coup(4) = Conjg(cplcFreChicVWpL(gt1)) 
coup(3) = Conjg(cplcFreChicVWpR(gt1))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi cFre Fre Propagator: VWp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,1,Isum)= 0._dp
...
coup(2) = Conjg(cplcFreChicVWpL(iIN)) 
coup(1) = Conjg(cplcFreChicVWpR(iIN)) 
coup(4) = Conjg(cplChiFreVWpL(gt1)) 
coup(3) = Conjg(cplChiFreVWpR(gt1))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi cFre Fre Propagator: conj[VWp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,1,Isum)= 0._dp
...
coup2(1) = cplChiChiVZL(iIN,gt1) 
coup2(2) = cplChiChiVZR(iIN,gt1) 
coup2(4) = Conjg(cplChiFreVWpL(iIN)) 
coup2(3) = Conjg(cplChiFreVWpR(iIN))  
coup2(5) = cplcFreFreVZL 
coup2(6) = cplcFreFreVZR 
coup2(8) = Conjg(cplcFreChicVWpL(gt1)) 
coup2(7) = Conjg(cplcFreChicVWpR(gt1)) 
Call IntegrateGaugeST(Boson4, mass, coup2, deltaM, epsI,IntegralVVst,NVVst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi cFre Fre Propagator: VZ,VWp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,1,Isum)= 0._dp  
...
coup2(1) = cplChiChiVZL(iIN,gt1) 
coup2(2) = cplChiChiVZR(iIN,gt1) 
coup2(4) = Conjg(cplcFreChicVWpL(iIN)) 
coup2(3) = Conjg(cplcFreChicVWpR(iIN))  
coup2(5) = cplcFreFreVZL 
coup2(6) = cplcFreFreVZR 
coup2(8) = Conjg(cplChiFreVWpL(gt1)) 
coup2(7) = Conjg(cplChiFreVWpR(gt1)) 
Call IntegrateGaugeST(Boson4, mass, coup2, deltaM, epsI,IntegralVVst,NVVst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi cFre Fre Propagator: VZ,conj[VWp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,1,Isum)= 0._dp  
...
coup2(1) = cplChiFreVWpL(iIN) 
coup2(2) = cplChiFreVWpR(iIN) 
coup2(4) = Conjg(cplcFreChicVWpL(iIN)) 
coup2(3) = Conjg(cplcFreChicVWpR(iIN))  
coup2(5) = cplcFreChicVWpL(gt1) 
coup2(6) = cplcFreChicVWpR(gt1) 
coup2(8) = Conjg(cplChiFreVWpL(gt1)) 
coup2(7) = Conjg(cplChiFreVWpR(gt1)) 
Call IntegrateGaugeST(Boson4, mass, coup2, deltaM, epsI,IntegralVVst,NVVst, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi cFre Fre Propagator: VWp,conj[VWp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,1,Isum)= 0._dp  
...
End If
   End Do 
  g = oo512pi3 / Abs(MChi(iIN))**3*g
End Subroutine ChiToChicFreFre 
...
Real(dp),Intent(in) :: MChi(3),MVZ

Complex(dp),Intent(in) :: cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplChiChiVZL(3,3),cplChiChiVZR(3,3)
...
Subroutine ChiToFrecFdFu(iIN,MFre,MFd,MFu,MVWp,MChi,cplcFdFucVWpL,cplcFdFucVWpR,      & 
& cplChiFreVWpL,cplChiFreVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWp,deltaM,            & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFre,MFd(3),MFu(3),MVWp,MChi(3)

Complex(dp),Intent(in) :: cplcFdFucVWpL(3,3),cplcFdFucVWpR(3,3),cplChiFreVWpL(3),cplChiFreVWpR(3)
...
If(Abs(MChi(iIN)).gt.(Abs(MFu(gt3))+Abs(MFd(gt2))+Abs(MFre))) Then 
!-------------- 
!  VWp 
!-------------- 
Isum = Isum + 1 
...
Subroutine ChiToFrecFeFv(iIN,MFre,MFe,MVWp,MChi,cplcFeFvcVWpL,cplcFeFvcVWpR,          & 
& cplChiFreVWpL,cplChiFreVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWp,deltaM,            & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFre,MFe(3),MVWp,MChi(3)

Complex(dp),Intent(in) :: cplcFeFvcVWpL(3,3),cplcFeFvcVWpR(3,3),cplChiFreVWpL(3),cplChiFreVWpR(3)
...
If(Abs(MChi(iIN)).gt.(Abs(0.)+Abs(MFe(gt2))+Abs(MFre))) Then 
!-------------- 
!  VWp 
!-------------- 
Isum = Isum + 1 
...
End Module Chi3Decays_SimplifiedDMSDFDM 
