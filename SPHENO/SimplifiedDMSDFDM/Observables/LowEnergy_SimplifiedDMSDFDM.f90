...
Module LowEnergy_SimplifiedDMSDFDM 
Use Control 
...
& MFu2(3),Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2
...
& cplcgWpgWpVZ,cplcgZgWpcVWp,cplChiChiVZL(3,3),cplChiChiVZR(3,3),cplcVWpcVWpVWpVWp1,     & 
...
End Function C1C2 
End Module LowEnergy_SimplifiedDMSDFDM 
