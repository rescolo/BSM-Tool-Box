...
! ------------------------------------------------------------------------------  
! File created at 12:55 on 3.10.2016   
! ----------------------------------------------------------------------  
 
 
Program SPhenotripletLR 
 
Use Control
Use InputOutput_tripletLR
Use LoopFunctions
Use RunSM_tripletLR
Use LowEnergy_tripletLR
Use FlavorKit_LFV_tripletLR
Use FlavorKit_QFV_tripletLR
Use FlavorKit_Observables_tripletLR
Use Mathematics
Use Model_Data_tripletLR
Use Tadpoles_tripletLR 
 Use HiggsCS_tripletLR
Use TreeLevelMasses_tripletLR
Use LoopMasses_tripletLR
 
Use BranchingRatios_tripletLR
...
Call OneLoopMasses(MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFc,MFc2,MFcp,MFcp2,MFcpp,           & 
...
& ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,YL2,YQ2,M1,M23,mu32,MU22,MU12,kont)
...
& vd,vu,vR,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,BrDmunu,            & 
...
& g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,               & 
& YL2,YQ2,M1,M23,mu32,MU22,MU12,kont)
...
& LAM3input,LAMT1input,YDRinput,YL1input,YQ1input,LAMT2input,YL2input,YQ2input,          & 
& M1input,M23input,mu32input,MU22input,MU12input,vdinput,vuinput,vRinput,ae,             & 
...
& cplcdeltaRppcVWLmcVWLm,cplcdeltaRppcVWLmcVWRm,cplcdeltaRppcVWRmcVWRm,cplcFcpcFcpdeltaRppL(2,2),& 
& cplcFcpcFcpdeltaRppR(2,2),cplcFcpFccHpmL(2,3,3),cplcFcpFccHpmR(2,3,3),cplcFcpFccVWLmL(2,3),& 
& cplcFcpFccVWLmR(2,3),cplcFcpFccVWRmL(2,3),cplcFcpFccVWRmR(2,3),cplcFcpFcpAhL(2,2,3),   & 
& cplcFcpFcpAhR(2,2,3),cplcFcpFcphhL(2,2,3),cplcFcpFcphhR(2,2,3),cplcFcpFcppHpmL(2,3),   & 
& cplcFcpFcppHpmR(2,3),cplcFcpFcppVWLmL(2),cplcFcpFcppVWLmR(2),cplcFcpFcppVWRmL(2),      & 
& cplcFcpFcppVWRmR(2),cplcFcpFcpVPL(2,2),cplcFcpFcpVPR(2,2),cplcFcpFcpVZL(2,2),          & 
& cplcFcpFcpVZR(2,2),cplcFcpFcpVZRL(2,2),cplcFcpFcpVZRR(2,2),cplcFcppFcdeltaRppL(3),     & 
& cplcFcppFcdeltaRppR(3),cplcFcppFcpcHpmL(2,3),cplcFcppFcpcHpmR(2,3),cplcFcppFcpcVWLmL(2),& 
& cplcFcppFcpcVWLmR(2),cplcFcppFcpcVWRmL(2),cplcFcppFcpcVWRmR(2),cplcFcppFcppVPL,        & 
& cplcFcppFcppVPR,cplcFcppFcppVZL,cplcFcppFcppVZR,cplcFcppFcppVZRL,cplcFcppFcppVZRR,     & 
...
& cplcFuFuVZR(3,3),cplcFuFuVZRL(3,3),cplcFuFuVZRR(3,3),cplcgPgWLmcVWLm,cplcgPgWRmcVWLm,  & 
& cplcgWLmgWLmVZ,cplcgWLpgPcVWLm,cplcgWLpgWLpVZ,cplcgWLpgZcVWLm,cplcgWLpgZpcVWLm,        & 
& cplcgWRmgWLmVZ,cplcgWRmgWRmVZ,cplcgWRpgPcVWLm,cplcgWRpgWLpVZ,cplcgWRpgWRpVZ,           & 
& cplcgWRpgZcVWLm,cplcgWRpgZpcVWLm,cplcgZgWLmcVWLm,cplcgZgWRmcVWLm,cplcgZpgWLmcVWLm,     & 
& cplcgZpgWRmcVWLm,cplcHpmVPVWLm(3),cplcHpmVPVWRm(3),cplcHpmVWLmVZ(3),cplcHpmVWLmVZR(3), & 
& cplcHpmVWRmVZ(3),cplcHpmVWRmVZR(3),cplcVWLmcVWLmVWLmVWLm1,cplcVWLmcVWLmVWLmVWLm2,      & 
...
Complex(dp) :: cplcVWRmVWRmVZR,cplcVWRmVWRmVZVZ1,cplcVWRmVWRmVZVZ2,cplcVWRmVWRmVZVZ3,cpldeltaRppcdeltaRppcVWLmVWLm,& 
...
& cpldeltaRppVWLmVWLm,cpldeltaRppVWLmVWRm,cpldeltaRppVWRmVWRm,cplFcFcAhL(3,3,3),         & 
...
& cplFcFcpVWLmR(3,2),cplFcFcpVWRmL(3,2),cplFcFcpVWRmR(3,2),cplFcFcVPL(3,3),              & 
& cplFcFcVPR(3,3),cplFcFcVZL(3,3),cplFcFcVZR(3,3),cplFcFcVZRL(3,3),cplFcFcVZRR(3,3),     & 
& cplFcpFcpcdeltaRppL(2,2),cplFcpFcpcdeltaRppR(2,2),cplFeFecdeltaRppL(3,3),              & 
...
& cplhhcVWRmVWRm(3),cplhhhhcVWLmVWLm(3,3),cplhhhhhh(3,3,3),cplhhhhVZVZ(3,3),             & 
...
& LAMT1input,YDRinput,YL1input,YQ1input,LAMT2input,YL2input,YQ2input,M1input,            & 
& M23input,mu32input,MU22input,MU12input,vdinput,vuinput,vRinput,gBL,g2,gR,              & 
& g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,               & 
& YL2,YQ2,M1,M23,mu32,MU22,MU12,vd,vu,vR,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
& UC,RHO2,gBL,g2,gR,ZZ,PhiW,g3,LAMT1,LAMT2,UT,VTE,UTE,YQ1,YQ2,ZDL,ZDR,YL1,               & 
& YL2,ZEL,ZER,ZUL,ZUR,YDR,UV,phaT,cplAhAhhh,cplAhHpmcHpm,cpldeltaRpphhcdeltaRpp,         & 
& cpldeltaRppHpmHpm,cplhhhhhh,cplhhHpmcHpm,cplcdeltaRppcHpmcHpm,cplAhhhVP,               & 
& cplAhhhVZ,cplAhhhVZR,cplAhHpmcVWLm,cplAhHpmcVWRm,cplAhcHpmVWLm,cplAhcHpmVWRm,          & 
& cpldeltaRppHpmVWLm,cpldeltaRppHpmVWRm,cpldeltaRppcdeltaRppVP,cpldeltaRppcdeltaRppVZ,   & 
& cpldeltaRppcdeltaRppVZR,cplhhHpmcVWLm,cplhhHpmcVWRm,cplhhcHpmVWLm,cplhhcHpmVWRm,       & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZR