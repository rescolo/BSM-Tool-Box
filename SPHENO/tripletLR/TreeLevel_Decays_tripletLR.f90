...
Module TreeLevelDecays_tripletLR
...
& UC,ZDR,ZER,UP,UT,UTE,ZUR,ZDL,ZEL,VTE,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,              & 
& ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,YL2,YQ2,M1,M23,             & 
...
& M23,mu32,MU22,MU12,vd,vu,vR,MAh(3),MAh2(3),MdeltaRpp,MdeltaRpp2,MFc(3),MFc2(3),        & 
& MFcp(2),MFcp2(2),MFcpp,MFcpp2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),            & 
& MFv(6),MFv2(6),Mhh(3),Mhh2(3),MHpm(3),MHpm2(3),MVWLm,MVWLm2,MVWRm,MVWRm2,              & 
& MVZ,MVZ2,MVZR,MVZR2,PhiW,TW,UC(3,3),UP(3,3),ZH(3,3)

Complex(dp),Intent(in) :: YDR(3,3),YL1(3,3),YQ1(3,3),YL2(3,3),YQ2(3,3),phaT,UV(6,6),ZDR(3,3),ZER(3,3),          & 
& UT(3,3),UTE(2,2),ZUR(3,3),ZDL(3,3),ZEL(3,3),VTE(2,2),ZUL(3,3),ZW(4,4),ZZ(3,3)
...
& cplAhAhhh,cplAhhhVZ,cplAhhhVZR,cpldeltaRpphhcdeltaRpp,cplFcFchhL,cplFcFchhR,           & 
& cplcFcpFcphhL,cplcFcpFcphhR,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,           & 
...
m1out = MFc(gt1)
m2out = MFc(gt2)
coupL = cplFcFchhL(gt1,gt2,i1)
coupR = cplFcFchhR(gt1,gt2,i1)
...
m1out = MFcp(gt1)
m2out = MFcp(gt2)
coupL = cplcFcpFcphhL(gt1,gt2,i1)
coupR = cplcFcpFcphhR(gt1,gt2,i1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
Complex(dp) :: cplAhhhVZ(3,3),cpldeltaRppcdeltaRppVZ,cplFcFcVZL(3,3),cplFcFcVZR(3,3),cplcFcpFcpVZL(2,2),& 
...
& UC,ZDR,ZER,UP,UT,UTE,ZUR,ZDL,ZEL,VTE,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,              & 
& ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,YL2,YQ2,M1,M23,             & 
& mu32,MU22,MU12,vd,vu,vR,cplAhhhVZ,cpldeltaRppcdeltaRppVZ,cplFcFcVZL,cplFcFcVZR,        & 
& cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcppFcppVZL,cplcFcppFcppVZR,cplcFdFdVZL,               & 
...
m1out = MFcp(gt1)
m2out = MFcp(gt2)
coupL = cplcFcpFcpVZL(gt1,gt2)
coupR = cplcFcpFcpVZR(gt1,gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
Complex(dp) :: cplAhhhVZR(3,3),cpldeltaRppcdeltaRppVZR,cplFcFcVZRL(3,3),cplFcFcVZRR(3,3),            & 
...
& UC,ZDR,ZER,UP,UT,UTE,ZUR,ZDL,ZEL,VTE,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,              & 
& ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,YL2,YQ2,M1,M23,             & 
& mu32,MU22,MU12,vd,vu,vR,cplAhhhVZR,cpldeltaRppcdeltaRppVZR,cplFcFcVZRL,cplFcFcVZRR,    & 
...
m1out = MFcp(gt1)
m2out = MFcp(gt2)
coupL = cplcFcpFcpVZRL(gt1,gt2)
coupR = cplcFcpFcpVZRR(gt1,gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
& M1,M23,mu32,MU22,MU12,vd,vu,vR,gPartial,gT,BR)
...
& UV,TW,UC,ZDR,ZER,UP,UT,UTE,ZUR,ZDL,ZEL,VTE,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,             & 
& RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,YL2,YQ2,               & 
& M1,M23,mu32,MU22,MU12,vd,vu,vR,cpldeltaRpphhcdeltaRpp,cpldeltaRppcdeltaRppVZ,          & 
& cpldeltaRppcdeltaRppVZR,cplFcFcppcdeltaRppL,cplFcFcppcdeltaRppR,cplFcpFcpcdeltaRppL,   & 
& cplFcpFcpcdeltaRppR,cplFeFecdeltaRppL,cplFeFecdeltaRppR,cplcdeltaRppcHpmcHpm,          & 
...
m1out = MFcpp
m2out = MFc(gt2)
coupL = cplFcFcppcdeltaRppL(gt2)
coupR = cplFcFcppcdeltaRppR(gt2)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
m1out = MFcp(gt1)
m2out = MFcp(gt2)
coupL = cplFcpFcpcdeltaRppL(gt1,gt2)
coupR = cplFcpFcpcdeltaRppR(gt1,gt2)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
If (gt1.ne.gt2) gam = 2._dp*gam 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
...
Complex(dp) :: cplAhHpmcHpm(3,3,3),cplAhcHpmVWLm(3,3),cplAhcHpmVWRm(3,3),cplcFcpFccHpmL(2,3,3),      & 
...
& UC,ZDR,ZER,UP,UT,UTE,ZUR,ZDL,ZEL,VTE,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,              & 
& ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,YL2,YQ2,M1,M23,             & 
& mu32,MU22,MU12,vd,vu,vR,cplAhHpmcHpm,cplAhcHpmVWLm,cplAhcHpmVWRm,cplcFcpFccHpmL,       & 
...
m1out = MFcp(gt1)
m2out = MFc(gt2)
coupL = cplcFcpFccHpmL(gt1,gt2,i1)
coupR = cplcFcpFccHpmR(gt1,gt2,i1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = MFcpp
m2out = MFcp(gt2)
coupL = cplcFcppFcpcHpmL(gt2,i1)
coupR = cplcFcppFcpcHpmR(gt2,i1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
Complex(dp) :: cplPseudoHiggsPP(3),cplPseudoHiggsGG(3),cplAhAhhh(3,3,3),cplFcFcAhL(3,3,3),           & 
...
& UC,ZDR,ZER,UP,UT,UTE,ZUR,ZDL,ZEL,VTE,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,              & 
& ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,YL2,YQ2,M1,M23,             & 
& mu32,MU22,MU12,vd,vu,vR,cplPseudoHiggsPP,cplPseudoHiggsGG,cplAhAhhh,cplFcFcAhL,        & 
& cplFcFcAhR,cplcFcpFcpAhL,cplcFcpFcpAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,            & 
...
m1out = MFc(gt1)
m2out = MFc(gt2)
coupL = cplFcFcAhL(gt1,gt2,i1)
coupR = cplFcFcAhR(gt1,gt2,i1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
If (gt1.ne.gt2) gam = 2._dp*gam 
gPartial(i1,i_count) = 1._dp/2._dp*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
...
m1out = MFcp(gt1)
m2out = MFcp(gt2)
coupL = cplcFcpFcpAhL(gt1,gt2,i1)
coupR = cplcFcpFcpAhR(gt1,gt2,i1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
Complex(dp) :: cplAhHpmcVWLm(3,3),cplAhcVWLmVWRm(3),cplcFcpFccVWLmL(2,3),cplcFcpFccVWLmR(2,3),       & 
...
& UV,TW,UC,ZDR,ZER,UP,UT,UTE,ZUR,ZDL,ZEL,VTE,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,             & 
& RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,YL2,YQ2,               & 
& M1,M23,mu32,MU22,MU12,vd,vu,vR,cplAhHpmcVWLm,cplAhcVWLmVWRm,cplcFcpFccVWLmL,           & 
...
m1out = MFcp(gt1)
m2out = MFc(gt2)
coupL = cplcFcpFccVWLmL(gt1,gt2)
coupR = cplcFcpFccVWLmR(gt1,gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
m1out = MFcpp
m2out = MFcp(gt2)
coupL = cplcFcppFcpcVWLmL(gt2)
coupR = cplcFcppFcpcVWLmR(gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
Complex(dp) :: cplAhHpmcVWRm(3,3),cplAhcVWRmVWLm(3),cplcFcpFccVWRmL(2,3),cplcFcpFccVWRmR(2,3),       & 
...
& UV,TW,UC,ZDR,ZER,UP,UT,UTE,ZUR,ZDL,ZEL,VTE,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,             & 
& RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,LAMT1,YDR,YL1,YQ1,LAMT2,YL2,YQ2,               & 
& M1,M23,mu32,MU22,MU12,vd,vu,vR,cplAhHpmcVWRm,cplAhcVWRmVWLm,cplcFcpFccVWRmL,           & 
...
m1out = MFcp(gt1)
m2out = MFc(gt2)
coupL = cplcFcpFccVWRmL(gt1,gt2)
coupR = cplcFcpFccVWRmR(gt1,gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
m1out = MFcpp
m2out = MFcp(gt2)
coupL = cplcFcppFcpcVWRmL(gt2)
coupR = cplcFcppFcpcVWRmR(gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
End Module TreeLevelDecays_tripletLR 
