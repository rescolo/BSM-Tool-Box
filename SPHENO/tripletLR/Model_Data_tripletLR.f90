...
& LAM3IN,LAMT1IN,LAMT2IN,M1IN,M23IN,mu32IN,MU22IN,MU12IN
...
& LAM3MZ,LAMT1MZ,LAMT2MZ,M1MZ,M23MZ,mu32MZ,MU22MZ,MU12MZ
...
& LAM4GUT,LAM2GUT,LAM3GUT,LAMT1GUT,LAMT2GUT,M1GUT,M23GUT,mu32GUT,MU22GUT,MU12GUT
...
Real(dp) :: gPFu(3,336),gTFu(3),BRFu(3,336),gPFe(3,393),gTFe(3),BRFe(3,393),gPFd(3,336),          & 
...
Real(dp) :: ratiodeltaRpp(3),ratioFcp(3,2),ratioFd(3,3),ratioFe(3,3),ratioFu(3,3),ratioHpm(3,3),  & 
& ratioVWLm(3),ratioVWRm(3)

Complex(dp) :: ratioGG(3),ratioPP(3)

Real(dp) :: ratioPdeltaRpp(3),ratioPFcp(3,2),ratioPFd(3,3),ratioPFe(3,3),ratioPFu(3,3),           & 
& ratioPHpm(3,3),ratioPVWLm(3),ratioPVWRm(3)

Complex(dp) :: ratioPGG(3),ratioPPP(3)

Real(dp) :: gForTadpoles(113)
...
Complex(dp) :: M1INPUT
Complex(dp) :: M23INPUT
Complex(dp) :: lamT1INPUT
Complex(dp) :: lamT2INPUT
Real(dp) :: vdMZ 
Real(dp) :: vdSUSY 
Real(dp) :: vuMZ 
Real(dp) :: vuSUSY 
...
lamT1INPUT=(0._dp,0._dp) 
lamT2INPUT=(0._dp,0._dp) 
CG1(1,1,1) = 0._dp
 CG1(1,1,2) = 0._dp
 CG1(1,2,1) = 0._dp
...
End Module Model_Data_tripletLR