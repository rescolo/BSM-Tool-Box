...
! ------------------------------------------------------------------------------  
! File created at 12:50 on 3.10.2016   
! ----------------------------------------------------------------------  
 
 
Module Fv3Decays_tripletLR 
...
& MU12,vd,vu,vR,gTAh,gThh,gTHpm,gTVWLm,gTVWRm,gTVZ,gTVZR,gFvFvFcFc,gFvFvcFcpFcp,         & 
& gFvFvcFdFd,gFvFvcFeFe,gFvFvcFuFu,gFvFvFvFv,gFvFecFcpFc,gFvFecFcppFcp,gFvFecFuFd,       & 
& gFvFvcFcppFcpp,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gFvFvFcFc(6,6,3,3),gFvFvcFcpFcp(6,6,2,2),gFvFvcFdFd(6,6,3,3),gFvFvcFeFe(6,6,3,3),     & 
...
Real(dp) :: gFvFvFcFci(6,3,3),gFvFvcFcpFcpi(6,2,2),gFvFvcFdFdi(6,3,3),gFvFvcFeFei(6,3,3),         & 
& gFvFvcFuFui(6,3,3),gFvFvFvFvi(6,6,6),gFvFecFcpFci(3,2,3),gFvFecFcppFcpi(3,1,2),        & 
& gFvFecFuFdi(3,3,3),gFvFvcFcppFcppi(6,1,1)
...
gFvFvFcFci = 0._dp 
Call FvToFvFcFc(i_run,MFv,MFc,MVZ,MVZR,MAh,Mhh,cplFcFcAhL,cplFcFcAhR,cplFcFchhL,      & 
& cplFcFchhR,cplFcFcVZL,cplFcFcVZR,cplFcFcVZRL,cplFcFcVZRR,cplFvFvAhL,cplFvFvAhR,        & 
& cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZRL,cplFvFvVZRR,IntegralSs,        & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
& gTVZtemp,gTVZRtemp,gTAhtemp,gThhtemp,deltaM,epsI,check,gFvFvFcFci)

gFvFvFcFc(i_run,:,:,:) = gFvFvFcFci 
gT(i_run) = gT(i_run) + Sum(gFvFvFcFci) 
 
gFvFvcFcpFcpi = 0._dp 
Call FvToFvcFcpFcp(i_run,MFv,MFcp,MVZ,MVZR,MAh,Mhh,cplcFcpFcpAhL,cplcFcpFcpAhR,       & 
& cplcFcpFcphhL,cplcFcpFcphhR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR, & 
...
gFvFecFcpFci = 0._dp 
Call FvToFecFcpFc(i_run,MFe,MFcp,MFc,MVWLm,MVWRm,MHpm,MFv,cplcFcpFccHpmL,             & 
...
& NVSss,NVVss,gTVWLmtemp,gTVWRmtemp,gTHpmtemp,deltaM,epsI,check,gFvFecFcpFci)

gFvFecFcpFc(i_run,:,:,:) = gFvFecFcpFci 
gT(i_run) = gT(i_run) + 2._dp*Sum(gFvFecFcpFci) 
 
gFvFecFcppFcpi = 0._dp 
Call FvToFecFcppFcp(i_run,MFe,MFcpp,MFcp,MVWLm,MVWRm,MHpm,MFv,cplcFcppFcpcHpmL,       & 
& cplcFcppFcpcHpmR,cplcFcppFcpcVWLmL,cplcFcppFcpcVWLmR,cplcFcppFcpcVWRmL,cplcFcppFcpcVWRmR,& 
& cplFvFeHpmL,cplFvFeHpmR,cplFvFeVWLmL,cplFvFeVWLmR,cplFvFeVWRmL,cplFvFeVWRmR,           & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
& NVSss,NVVss,gTVWLmtemp,gTVWRmtemp,gTHpmtemp,deltaM,epsI,check,gFvFecFcppFcpi)
...
Subroutine FvToFvFcFc(iIN,MFv,MFc,MVZ,MVZR,MAh,Mhh,cplFcFcAhL,cplFcFcAhR,             & 
& cplFcFchhL,cplFcFchhR,cplFcFcVZL,cplFcFcVZR,cplFcFcVZRL,cplFcFcVZRR,cplFvFvAhL,        & 
...
Real(dp),Intent(in) :: MFv(6),MFc(3),MVZ,MVZR,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplFcFcAhL(3,3,3),cplFcFcAhR(3,3,3),cplFcFchhL(3,3,3),cplFcFchhR(3,3,3),              & 
& cplFcFcVZL(3,3),cplFcFcVZR(3,3),cplFcFcVZRL(3,3),cplFcFcVZRR(3,3),cplFvFvAhL(6,6,3),   & 
& cplFvFvAhR(6,6,3),cplFvFvhhL(6,6,3),cplFvFvhhR(6,6,3),cplFvFvVZL(6,6),cplFvFvVZR(6,6), & 
& cplFvFvVZRL(6,6),cplFvFvVZRR(6,6)
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv Fc Fc Propagator: Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv Fc Fc Propagator: hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv Fc Fc Propagator: VZ,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv Fc Fc Propagator: VZ,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv Fc Fc Propagator: VZR,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv Fc Fc Propagator: VZR,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv Fc Fc Propagator: Ah,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv Fc Fc Propagator: Ah,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv Fc Fc Propagator: hh,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FvToFvcFcpFcp(iIN,MFv,MFcp,MVZ,MVZR,MAh,Mhh,cplcFcpFcpAhL,cplcFcpFcpAhR,   & 
& cplcFcpFcphhL,cplcFcpFcphhR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR, & 
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZRL,         & 
& cplFvFvVZRR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,              & 
...
Real(dp),Intent(in) :: MFv(6),MFcp(2),MVZ,MVZR,MAh(3),Mhh(3)
...
If(Abs(MFv(iIN)).gt.(Abs(MFcp(gt3))+Abs(MFcp(gt2))+Abs(MFv(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv cFcp Fcp Propagator: Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv cFcp Fcp Propagator: hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv cFcp Fcp Propagator: VZ,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv cFcp Fcp Propagator: VZ,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv cFcp Fcp Propagator: VZR,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv cFcp Fcp Propagator: VZR,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv cFcp Fcp Propagator: Ah,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv cFcp Fcp Propagator: Ah,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fv cFcp Fcp Propagator: hh,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FvToFecFcpFc(iIN,MFe,MFcp,MFc,MVWLm,MVWRm,MHpm,MFv,cplcFcpFccHpmL,         & 
& cplcFcpFccHpmR,cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,        & 
& cplFvFeHpmL,cplFvFeHpmR,cplFvFeVWLmL,cplFvFeVWLmR,cplFvFeVWRmL,cplFvFeVWRmR,           & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
...
Real(dp),Intent(in) :: MFe(3),MFcp(2),MFc(3),MVWLm,MVWRm,MHpm(3),MFv(6)

Complex(dp),Intent(in) :: cplcFcpFccHpmL(2,3,3),cplcFcpFccHpmR(2,3,3),cplcFcpFccVWLmL(2,3),cplcFcpFccVWLmR(2,3),& 
& cplcFcpFccVWRmL(2,3),cplcFcpFccVWRmR(2,3),cplFvFeHpmL(6,3,3),cplFvFeHpmR(6,3,3),       & 
...
If(Abs(MFv(iIN)).gt.(Abs(MFc(gt3))+Abs(MFcp(gt2))+Abs(MFe(gt1)))) Then 
!-------------- 
!  VWLm 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fe cFcp Fc Propagator: Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fe cFcp Fc Propagator: VWLm,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fe cFcp Fc Propagator: VWRm,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fe cFcp Fc Propagator: Hpm,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FvToFecFcppFcp(iIN,MFe,MFcpp,MFcp,MVWLm,MVWRm,MHpm,MFv,cplcFcppFcpcHpmL,   & 
& cplcFcppFcpcHpmR,cplcFcppFcpcVWLmL,cplcFcppFcpcVWLmR,cplcFcppFcpcVWRmL,cplcFcppFcpcVWRmR,& 
& cplFvFeHpmL,cplFvFeHpmR,cplFvFeVWLmL,cplFvFeVWLmR,cplFvFeVWRmL,cplFvFeVWRmR,           & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
& NVSss,NVVss,gTVWLm,gTVWRm,gTHpm,deltaM,epsI,check,g,WriteContributions)
...
Real(dp),Intent(in) :: MFe(3),MFcpp,MFcp(2),MVWLm,MVWRm,MHpm(3),MFv(6)

Complex(dp),Intent(in) :: cplcFcppFcpcHpmL(2,3),cplcFcppFcpcHpmR(2,3),cplcFcppFcpcVWLmL(2),cplcFcppFcpcVWLmR(2),& 
& cplcFcppFcpcVWRmL(2),cplcFcppFcpcVWRmR(2),cplFvFeHpmL(6,3,3),cplFvFeHpmR(6,3,3),       & 
& cplFvFeVWLmL(6,3),cplFvFeVWLmR(6,3),cplFvFeVWRmL(6,3),cplFvFeVWRmR(6,3)
...
If(Abs(MFv(iIN)).gt.(Abs(MFcp(gt3))+Abs(MFcpp)+Abs(MFe(gt1)))) Then 
!-------------- 
!  VWLm 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fe cFcpp Fcp Propagator: Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fe cFcpp Fcp Propagator: VWLm,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fe cFcpp Fcp Propagator: VWRm,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fv->Fe cFcpp Fcp Propagator: Hpm,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,gt3,Isum)= 0._dp  
...
End Module Fv3Decays_tripletLR 
