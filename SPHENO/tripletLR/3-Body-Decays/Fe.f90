...
! ------------------------------------------------------------------------------  
! File created at 12:49 on 3.10.2016   
! ----------------------------------------------------------------------  
 
 
Module Fe3Decays_tripletLR 
...
& MU12,vd,vu,vR,gTAh,gTdeltaRpp,gThh,gTHpm,gTVWLm,gTVWRm,gTVZ,gTVZR,gFeFeFcFc,           & 
& gFeFecFcpFcp,gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,gFeFeFvFv,gFecFeFcppFc,gFecFeFcpFcp,     & 
& gFeFecFcppFcpp,gFeFvFcpFc,gFeFvcFcpFcpp,gFeFvcFdFu,epsI,deltaM,CheckRealStates,        & 
& gT,gPartial,BR)
...
Complex(dp) :: cplcFcpFcpAhL(2,2,3),cplcFcpFcpAhR(2,2,3),cplcFcpFcphhL(2,2,3),cplcFcpFcphhR(2,2,3),  & 
...
Real(dp),Intent(inout) :: gFeFeFcFc(3,3,3,3),gFeFecFcpFcp(3,3,2,2),gFeFecFdFd(3,3,3,3),gFeFecFeFe(3,3,3,3),     & 
& gFeFecFuFu(3,3,3,3),gFeFeFvFv(3,3,6,6),gFecFeFcppFc(3,3,1,3),gFecFeFcpFcp(3,3,2,2),    & 
& gFeFecFcppFcpp(3,3,1,1),gFeFvFcpFc(3,6,2,3),gFeFvcFcpFcpp(3,6,2,1),gFeFvcFdFu(3,6,3,3)

Real(dp),Intent(in) :: gTAh(3),gTdeltaRpp,gThh(3),gTHpm(3),gTVWLm,gTVWRm,gTVZ,gTVZR

Real(dp) :: gFeFeFcFci(3,3,3),gFeFecFcpFcpi(3,2,2),gFeFecFdFdi(3,3,3),gFeFecFeFei(3,3,3),         & 
& gFeFecFuFui(3,3,3),gFeFeFvFvi(3,6,6),gFecFeFcppFci(3,1,3),gFecFeFcpFcpi(3,2,2),        & 
& gFeFecFcppFcppi(3,1,1),gFeFvFcpFci(6,2,3),gFeFvcFcpFcppi(6,2,1),gFeFvcFdFui(6,3,3)
...
& M1,M23,mu32,MU22,MU12,vd,vu,vR,cplcFcpFcpAhL,cplcFcpFcpAhR,cplcFcpFcphhL,              & 
& cplcFcpFcphhR,cplcFcpFcppHpmL,cplcFcpFcppHpmR,cplcFcpFcppVWLmL,cplcFcpFcppVWLmR,       & 
...
gFeFeFcFci = 0._dp 
Call FeToFeFcFc(i_run,MFe,MFc,MVZ,MVZR,MAh,Mhh,cplcFeFeAhL,cplcFeFeAhR,               & 
...
gFeFecFcpFcpi = 0._dp 
Call FeToFecFcpFcp(i_run,MFe,MFcp,MVZ,MVZR,MAh,Mhh,cplcFcpFcpAhL,cplcFcpFcpAhR,       & 
...
& deltaM,epsI,check,gFeFecFcpFcpi)
...
gFecFeFcppFci = 0._dp 
Call FeTocFeFcppFc(i_run,MFe,MFcpp,MFc,MdeltaRpp,cplcFecFedeltaRppL,cplcFecFedeltaRppR,& 
& cplFcFcppcdeltaRppL,cplFcFcppcdeltaRppR,IntegralSs,IntegralSSss,NSs,NSSss,             & 
& gTdeltaRpptemp,deltaM,epsI,check,gFecFeFcppFci)

gFecFeFcppFc(i_run,:,:,:) = gFecFeFcppFci 
gT(i_run) = gT(i_run) + Sum(gFecFeFcppFci) 
 
gFecFeFcpFcpi = 0._dp 
Call FeTocFeFcpFcp(i_run,MFe,MFcp,MdeltaRpp,cplcFecFedeltaRppL,cplcFecFedeltaRppR,    & 
& cplFcpFcpcdeltaRppL,cplFcpFcpcdeltaRppR,IntegralSs,IntegralSSss,NSs,NSSss,             & 
& gTdeltaRpptemp,deltaM,epsI,check,gFecFeFcpFcpi)

gFecFeFcpFcp(i_run,:,:,:) = gFecFeFcpFcpi 
gT(i_run) = gT(i_run) + Sum(gFecFeFcpFcpi) 
...
gFeFvFcpFci = 0._dp 
Call FeToFvFcpFc(i_run,MFv,MFcp,MFc,MVWLm,MVWRm,MHpm,MFe,cplcFeFvcHpmL,               & 
& cplcFeFvcHpmR,cplcFeFvcVWLmL,cplcFeFvcVWLmR,cplcFeFvcVWRmL,cplcFeFvcVWRmR,             & 
& cplFcFcpHpmL,cplFcFcpHpmR,cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,     & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
& NVSss,NVVss,gTVWLmtemp,gTVWRmtemp,gTHpmtemp,deltaM,epsI,check,gFeFvFcpFci)

gFeFvFcpFc(i_run,:,:,:) = gFeFvFcpFci 
gT(i_run) = gT(i_run) + Sum(gFeFvFcpFci) 
 
gFeFvcFcpFcppi = 0._dp 
Call FeToFvcFcpFcpp(i_run,MFv,MFcp,MFcpp,MVWLm,MVWRm,MHpm,MFe,cplcFcpFcppHpmL,        & 
& cplcFcpFcppHpmR,cplcFcpFcppVWLmL,cplcFcpFcppVWLmR,cplcFcpFcppVWRmL,cplcFcpFcppVWRmR,   & 
& cplcFeFvcHpmL,cplcFeFvcHpmR,cplcFeFvcVWLmL,cplcFeFvcVWLmR,cplcFeFvcVWRmL,              & 
& cplcFeFvcVWRmR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,           & 
& NSs,NSSss,NVs,NVSss,NVVss,gTVWLmtemp,gTVWRmtemp,gTHpmtemp,deltaM,epsI,check,           & 
& gFeFvcFcpFcppi)
...
Do gt1=1,3
  Do gt2=1,1
    Do gt3=1,3
gPartial(i1,n_length)= gFecFeFcppFc(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,2
    Do gt3=gt2,2
gPartial(i1,n_length)= gFecFeFcpFcp(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,6
  Do gt2=1,2
    Do gt3=1,3
gPartial(i1,n_length)= gFeFvFcpFc(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Subroutine FeToFeFcFc(iIN,MFe,MFc,MVZ,MVZR,MAh,Mhh,cplcFeFeAhL,cplcFeFeAhR,           & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,             & 
& cplFcFcAhL,cplFcFcAhR,cplFcFchhL,cplFcFchhR,cplFcFcVZL,cplFcFcVZR,cplFcFcVZRL,         & 
& cplFcFcVZRR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,              & 
...
Real(dp),Intent(in) :: MFe(3),MFc(3),MVZ,MVZR,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),          & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFeVZRL(3,3),cplcFeFeVZRR(3,3),cplFcFcAhL(3,3,3),& 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fc Fc Propagator: Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fc Fc Propagator: hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fc Fc Propagator: VZ,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fc Fc Propagator: VZ,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fc Fc Propagator: VZR,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fc Fc Propagator: VZR,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fc Fc Propagator: Ah,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fc Fc Propagator: Ah,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fc Fc Propagator: hh,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FeToFecFcpFcp(iIN,MFe,MFcp,MVZ,MVZR,MAh,Mhh,cplcFcpFcpAhL,cplcFcpFcpAhR,   & 
& cplcFcpFcphhL,cplcFcpFcphhR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR, & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFeVZRL,cplcFeFeVZRR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,             & 
...
Real(dp),Intent(in) :: MFe(3),MFcp(2),MVZ,MVZR,MAh(3),Mhh(3)
...
If(Abs(MFe(iIN)).gt.(Abs(MFcp(gt3))+Abs(MFcp(gt2))+Abs(MFe(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFcp Fcp Propagator: Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFcp Fcp Propagator: hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFcp Fcp Propagator: VZ,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFcp Fcp Propagator: VZ,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFcp Fcp Propagator: VZR,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFcp Fcp Propagator: VZR,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFcp Fcp Propagator: Ah,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFcp Fcp Propagator: Ah,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFcp Fcp Propagator: hh,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FeTocFeFcppFc(iIN,MFe,MFcpp,MFc,MdeltaRpp,cplcFecFedeltaRppL,              & 
& cplcFecFedeltaRppR,cplFcFcppcdeltaRppL,cplFcFcppcdeltaRppR,IntegralSs,IntegralSSss,    & 
& NSs,NSSss,gTdeltaRpp,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MFcpp,MFc(3),MdeltaRpp

Complex(dp),Intent(in) :: cplcFecFedeltaRppL(3,3),cplcFecFedeltaRppR(3,3),cplFcFcppcdeltaRppL(3),               & 
& cplFcFcppcdeltaRppR(3)

Real(dp),Intent(inout) :: IntegralSs(500000,10)

Complex(dp),Intent(inout) :: IntegralSSss(500000,12)

Real(dp),Intent(inout) :: gTdeltaRpp
...
If(Abs(MFe(iIN)).gt.(Abs(MFc(gt3))+Abs(MFcpp)+Abs(MFe(gt1)))) Then 
!-------------- 
!  deltaRpp 
!-------------- 
Isum = Isum + 1 
...
coup(2) = Conjg(cplcFecFedeltaRppL(iIN,gt1)) 
coup(1) = Conjg(cplcFecFedeltaRppR(iIN,gt1)) 
coup(4) = Conjg(cplFcFcppcdeltaRppL(gt3)) 
coup(3) = Conjg(cplFcFcppcdeltaRppR(gt3))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->cFe Fcpp Fc Propagator: deltaRpp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
...
End If 
Contribution(gt1,1,gt3,Isum)='deltaRpp'
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MFe(iIN))**3*g
End Subroutine FeTocFeFcppFc 
 
 
Subroutine FeTocFeFcpFcp(iIN,MFe,MFcp,MdeltaRpp,cplcFecFedeltaRppL,cplcFecFedeltaRppR,& 
& cplFcpFcpcdeltaRppL,cplFcpFcpcdeltaRppR,IntegralSs,IntegralSSss,NSs,NSSss,             & 
& gTdeltaRpp,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MFcp(2),MdeltaRpp

Complex(dp),Intent(in) :: cplcFecFedeltaRppL(3,3),cplcFecFedeltaRppR(3,3),cplFcpFcpcdeltaRppL(2,2),             & 
& cplFcpFcpcdeltaRppR(2,2)
...
coup(2) = Conjg(cplcFecFedeltaRppL(iIN,gt1)) 
coup(1) = Conjg(cplcFecFedeltaRppR(iIN,gt1)) 
coup(4) = Conjg(cplFcpFcpcdeltaRppL(gt2,gt3)) 
coup(3) = Conjg(cplFcpFcpcdeltaRppR(gt2,gt3))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt3.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplcFecFedeltaRppL(iIN,gt1) 
coup2(2) = cplcFecFedeltaRppR(iIN,gt1) 
coup2(3) = Conjg(cplcFecFedeltaRppL(iIN,gt1)) 
coup2(4) = Conjg(cplcFecFedeltaRppR(iIN,gt1))  
coup2(5) = cplFcpFcpcdeltaRppL(gt3,gt2) 
coup2(6) = cplFcpFcpcdeltaRppR(gt3,gt2) 
coup2(7) = Conjg(cplFcpFcpcdeltaRppL(gt2,gt3)) 
coup2(8) = Conjg(cplFcpFcpcdeltaRppR(gt2,gt3)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->cFe Fcp Fcp Propagator: deltaRpp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
Subroutine FeToFvFcpFc(iIN,MFv,MFcp,MFc,MVWLm,MVWRm,MHpm,MFe,cplcFeFvcHpmL,           & 
& cplcFeFvcHpmR,cplcFeFvcVWLmL,cplcFeFvcVWLmR,cplcFeFvcVWRmL,cplcFeFvcVWRmR,             & 
& cplFcFcpHpmL,cplFcFcpHpmR,cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,     & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
...
Real(dp),Intent(in) :: MFv(6),MFcp(2),MFc(3),MVWLm,MVWRm,MHpm(3),MFe(3)

Complex(dp),Intent(in) :: cplcFeFvcHpmL(3,6,3),cplcFeFvcHpmR(3,6,3),cplcFeFvcVWLmL(3,6),cplcFeFvcVWLmR(3,6),    & 
& cplcFeFvcVWRmL(3,6),cplcFeFvcVWRmR(3,6),cplFcFcpHpmL(3,2,3),cplFcFcpHpmR(3,2,3),       & 
& cplFcFcpVWLmL(3,2),cplFcFcpVWLmR(3,2),cplFcFcpVWRmL(3,2),cplFcFcpVWRmR(3,2)
...
If(Abs(MFe(iIN)).gt.(Abs(MFc(gt3))+Abs(MFcp(gt2))+Abs(MFv(gt1)))) Then 
!-------------- 
!  conj[VWLm] 
!-------------- 
Isum = Isum + 1 
...
coup(4) = Conjg(cplFcFcpVWLmL(gt3,gt2)) 
coup(3) = Conjg(cplFcFcpVWLmR(gt3,gt2))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv Fcp Fc Propagator: conj[VWLm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(4) = Conjg(cplFcFcpVWRmL(gt3,gt2)) 
coup(3) = Conjg(cplFcFcpVWRmR(gt3,gt2))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv Fcp Fc Propagator: conj[VWRm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(4) = Conjg(cplFcFcpHpmL(gt3,gt2,i1)) 
coup(3) = Conjg(cplFcFcpHpmR(gt3,gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv Fcp Fc Propagator: conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(5) = cplFcFcpVWLmL(gt3,gt2) 
coup2(6) = cplFcFcpVWLmR(gt3,gt2) 
coup2(8) = Conjg(cplFcFcpVWRmL(gt3,gt2)) 
coup2(7) = Conjg(cplFcFcpVWRmR(gt3,gt2)) 
Call IntegrateGaugeSS(Boson4, mass, coup2, deltaM, epsI,IntegralVVss,NVVss, resR, check) 
If (resR.ne.resR) resR = 0._dp
resC = 2._dp*resR 
resS = resS + resC 
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv Fcp Fc Propagator: conj[VWLm],conj[VWRm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(5) = cplFcFcpVWLmL(gt3,gt2) 
coup2(6) = cplFcFcpVWLmR(gt3,gt2) 
coup2(7) = Conjg(cplFcFcpHpmL(gt3,gt2,i2)) 
coup2(8) = Conjg(cplFcFcpHpmR(gt3,gt2,i2)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv Fcp Fc Propagator: conj[VWLm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(3) = Conjg(cplcFeFvcHpmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFeFvcHpmR(iIN,gt1,i2))  
coup2(5) = cplFcFcpVWRmL(gt3,gt2) 
coup2(6) = cplFcFcpVWRmR(gt3,gt2) 
coup2(7) = Conjg(cplFcFcpHpmL(gt3,gt2,i2)) 
coup2(8) = Conjg(cplFcFcpHpmR(gt3,gt2,i2)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv Fcp Fc Propagator: conj[VWRm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(3) = Conjg(cplcFeFvcHpmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFeFvcHpmR(iIN,gt1,i2))  
coup2(5) = cplFcFcpHpmL(gt3,gt2,i1) 
coup2(6) = cplFcFcpHpmR(gt3,gt2,i1) 
coup2(7) = Conjg(cplFcFcpHpmL(gt3,gt2,i2)) 
coup2(8) = Conjg(cplFcFcpHpmR(gt3,gt2,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv Fcp Fc Propagator: conj[Hpm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MFe(iIN))**3*g
End Subroutine FeToFvFcpFc 
 
 
Subroutine FeToFvcFcpFcpp(iIN,MFv,MFcp,MFcpp,MVWLm,MVWRm,MHpm,MFe,cplcFcpFcppHpmL,    & 
& cplcFcpFcppHpmR,cplcFcpFcppVWLmL,cplcFcpFcppVWLmR,cplcFcpFcppVWRmL,cplcFcpFcppVWRmR,   & 
& cplcFeFvcHpmL,cplcFeFvcHpmR,cplcFeFvcVWLmL,cplcFeFvcVWLmR,cplcFeFvcVWRmL,              & 
& cplcFeFvcVWRmR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,           & 
& NSs,NSSss,NVs,NVSss,NVVss,gTVWLm,gTVWRm,gTHpm,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFv(6),MFcp(2),MFcpp,MVWLm,MVWRm,MHpm(3),MFe(3)

Complex(dp),Intent(in) :: cplcFcpFcppHpmL(2,3),cplcFcpFcppHpmR(2,3),cplcFcpFcppVWLmL(2),cplcFcpFcppVWLmR(2),    & 
& cplcFcpFcppVWRmL(2),cplcFcpFcppVWRmR(2),cplcFeFvcHpmL(3,6,3),cplcFeFvcHpmR(3,6,3),     & 
& cplcFeFvcVWLmL(3,6),cplcFeFvcVWLmR(3,6),cplcFeFvcVWRmL(3,6),cplcFeFvcVWRmR(3,6)
...
Isum = 25 
Allocate( gSum(6,2,1, Isum) ) 
Allocate( Contribution(6,2,1, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
If(Abs(MFe(iIN)).gt.(Abs(MFcpp)+Abs(MFcp(gt2))+Abs(MFv(gt1)))) Then 
!-------------- 
!  conj[VWLm] 
!-------------- 
Isum = Isum + 1 
...
coup(2) = Conjg(cplcFeFvcVWLmL(iIN,gt1)) 
coup(1) = Conjg(cplcFeFvcVWLmR(iIN,gt1)) 
coup(4) = Conjg(cplcFcpFcppVWLmL(gt2)) 
coup(3) = Conjg(cplcFcpFcppVWLmR(gt2))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
End If 
Contribution(gt1,gt2,1,Isum)='conj[VWLm]'
...
coup(2) = Conjg(cplcFeFvcVWRmL(iIN,gt1)) 
coup(1) = Conjg(cplcFeFvcVWRmR(iIN,gt1)) 
coup(4) = Conjg(cplcFcpFcppVWRmL(gt2)) 
coup(3) = Conjg(cplcFcpFcppVWRmR(gt2))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
gSum(gt1,gt2,1,Isum)=resD
End If 
Contribution(gt1,gt2,1,Isum)='conj[VWRm]'
...
coup(2) = Conjg(cplcFeFvcHpmL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcFeFvcHpmR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFcpFcppHpmL(gt2,i1)) 
coup(3) = Conjg(cplcFcpFcppHpmR(gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFcp Fcpp Propagator: conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,1,Isum)= 0._dp
...
gSum(gt1,gt2,1,Isum)=resD
End If 
Contribution(gt1,gt2,1,Isum)='conj[Hpm]'
      End Do 
...
coup2(4) = Conjg(cplcFeFvcVWRmL(iIN,gt1)) 
coup2(3) = Conjg(cplcFeFvcVWRmR(iIN,gt1))  
coup2(5) = cplcFcpFcppVWLmL(gt2) 
coup2(6) = cplcFcpFcppVWLmR(gt2) 
coup2(8) = Conjg(cplcFcpFcppVWRmL(gt2)) 
coup2(7) = Conjg(cplcFcpFcppVWRmR(gt2)) 
Call IntegrateGaugeSS(Boson4, mass, coup2, deltaM, epsI,IntegralVVss,NVVss, resR, check) 
If (resR.ne.resR) resR = 0._dp
resC = 2._dp*resR 
resS = resS + resC 
...
End If 
Contribution(gt1,gt2,1,Isum)='conj[VWLm],conj[VWRm]'
...
coup2(5) = cplcFcpFcppVWLmL(gt2) 
coup2(6) = cplcFcpFcppVWLmR(gt2) 
coup2(7) = Conjg(cplcFcpFcppHpmL(gt2,i2)) 
coup2(8) = Conjg(cplcFcpFcppHpmR(gt2,i2)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFcp Fcpp Propagator: conj[VWLm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,1,Isum)= 0._dp  
...
gSum(gt1,gt2,1,Isum)= resS  
End If 
Contribution(gt1,gt2,1,Isum)='conj[VWLm],conj[Hpm]'
      End Do 
...
coup2(3) = Conjg(cplcFeFvcHpmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFeFvcHpmR(iIN,gt1,i2))  
coup2(5) = cplcFcpFcppVWRmL(gt2) 
coup2(6) = cplcFcpFcppVWRmR(gt2) 
coup2(7) = Conjg(cplcFcpFcppHpmL(gt2,i2)) 
coup2(8) = Conjg(cplcFcpFcppHpmR(gt2,i2)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFcp Fcpp Propagator: conj[VWRm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,1,Isum)= 0._dp  
...
gSum(gt1,gt2,1,Isum)= resS  
End If 
Contribution(gt1,gt2,1,Isum)='conj[VWRm],conj[Hpm]'
      End Do 
...
coup2(3) = Conjg(cplcFeFvcHpmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFeFvcHpmR(iIN,gt1,i2))  
coup2(5) = cplcFcpFcppHpmL(gt2,i1) 
coup2(6) = cplcFcpFcppHpmR(gt2,i1) 
coup2(7) = Conjg(cplcFcpFcppHpmL(gt2,i2)) 
coup2(8) = Conjg(cplcFcpFcppHpmR(gt2,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFcp Fcpp Propagator: conj[Hpm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,1,Isum)= 0._dp  
...
gSum(gt1,gt2,1,Isum)= resS  
End If 
Contribution(gt1,gt2,1,Isum)='conj[Hpm],conj[Hpm]'
        End Do 
      End Do 
...
g=0._dp 
    Do gt1=1,6
      Do gt2=1,2
g(gt1,gt2,1)=Sum(gSum(gt1,gt2,1,1:25))
...
End Module Fe3Decays_tripletLR 
