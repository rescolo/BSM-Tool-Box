...
& MU12,vd,vu,vR,gTAh,gThh,gTHpm,gTVWLm,gTVWRm,gTVZ,gTVZR,gFuFuFcFc,gFuFucFcpFcp,         & 
& gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,gFuFuFvFv,gFuFdFcpFc,gFuFdcFcpFcpp,gFuFdFvFe,         & 
& gFuFucFcppFcpp,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gFuFuFcFc(3,3,3,3),gFuFucFcpFcp(3,3,2,2),gFuFucFdFd(3,3,3,3),gFuFucFeFe(3,3,3,3),     & 
& gFuFucFuFu(3,3,3,3),gFuFuFvFv(3,3,6,6),gFuFdFcpFc(3,3,2,3),gFuFdcFcpFcpp(3,3,2,1),     & 
& gFuFdFvFe(3,3,6,3),gFuFucFcppFcpp(3,3,1,1)

Real(dp),Intent(in) :: gTAh(3),gThh(3),gTHpm(3),gTVWLm,gTVWRm,gTVZ,gTVZR

Real(dp) :: gFuFuFcFci(3,3,3),gFuFucFcpFcpi(3,2,2),gFuFucFdFdi(3,3,3),gFuFucFeFei(3,3,3),         & 
& gFuFucFuFui(3,3,3),gFuFuFvFvi(3,6,6),gFuFdFcpFci(3,2,3),gFuFdcFcpFcppi(3,2,1),         & 
& gFuFdFvFei(3,6,3),gFuFucFcppFcppi(3,1,1)
...
& cplcFuFuVZRR,cplFcFcAhL,cplFcFcAhR,cplFcFchhL,cplFcFchhR,cplFcFcpHpmL,cplFcFcpHpmR,    & 
& cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,cplFcFcVZL,cplFcFcVZR,         & 
& cplFcFcVZRL,cplFcFcVZRR,cplFvFeHpmL,cplFvFeHpmR,cplFvFeVWLmL,cplFvFeVWLmR,             & 
...
gFuFuFcFci = 0._dp 
Call FuToFuFcFc(i_run,MFu,MFc,MVZ,MVZR,MAh,Mhh,cplcFuFuAhL,cplcFuFuAhR,               & 
...
gFuFucFcpFcpi = 0._dp 
Call FuToFucFcpFcp(i_run,MFu,MFcp,MVZ,MVZR,MAh,Mhh,cplcFcpFcpAhL,cplcFcpFcpAhR,       & 
...
& deltaM,epsI,check,gFuFucFcpFcpi)
...
gFuFdFcpFci = 0._dp 
Call FuToFdFcpFc(i_run,MFd,MFcp,MFc,MVWLm,MVWRm,MHpm,MFu,cplcFuFdcHpmL,               & 
...
& NVSss,NVVss,gTVWLmtemp,gTVWRmtemp,gTHpmtemp,deltaM,epsI,check,gFuFdFcpFci)

gFuFdFcpFc(i_run,:,:,:) = gFuFdFcpFci 
gT(i_run) = gT(i_run) + Sum(gFuFdFcpFci) 
 
gFuFdcFcpFcppi = 0._dp 
Call FuToFdcFcpFcpp(i_run,MFd,MFcp,MFcpp,MVWLm,MVWRm,MHpm,MFu,cplcFcpFcppHpmL,        & 
...
& cplcFuFdcVWRmR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,           & 
...
Subroutine FuToFuFcFc(iIN,MFu,MFc,MVZ,MVZR,MAh,Mhh,cplcFuFuAhL,cplcFuFuAhR,           & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,             & 
& cplFcFcAhL,cplFcFcAhR,cplFcFchhL,cplFcFchhR,cplFcFcVZL,cplFcFcVZR,cplFcFcVZRL,         & 
& cplFcFcVZRR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,              & 
...
Real(dp),Intent(in) :: MFu(3),MFc(3),MVZ,MVZR,MAh(3),Mhh(3)
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Fc Fc Propagator: Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Fc Fc Propagator: hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Fc Fc Propagator: VZ,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Fc Fc Propagator: VZ,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Fc Fc Propagator: VZR,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Fc Fc Propagator: VZR,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Fc Fc Propagator: Ah,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Fc Fc Propagator: Ah,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Fc Fc Propagator: hh,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FuToFucFcpFcp(iIN,MFu,MFcp,MVZ,MVZR,MAh,Mhh,cplcFcpFcpAhL,cplcFcpFcpAhR,   & 
& cplcFcpFcphhL,cplcFcpFcphhR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR, & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcFuFuVZRL,cplcFuFuVZRR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,             & 
...
Real(dp),Intent(in) :: MFu(3),MFcp(2),MVZ,MVZR,MAh(3),Mhh(3)
...
If(Abs(MFu(iIN)).gt.(Abs(MFcp(gt3))+Abs(MFcp(gt2))+Abs(MFu(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFcp Fcp Propagator: Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFcp Fcp Propagator: hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFcp Fcp Propagator: VZ,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFcp Fcp Propagator: VZ,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFcp Fcp Propagator: VZR,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFcp Fcp Propagator: VZR,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFcp Fcp Propagator: Ah,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFcp Fcp Propagator: Ah,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFcp Fcp Propagator: hh,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FuToFdFcpFc(iIN,MFd,MFcp,MFc,MVWLm,MVWRm,MHpm,MFu,cplcFuFdcHpmL,           & 
& cplcFuFdcHpmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplcFuFdcVWRmL,cplcFuFdcVWRmR,             & 
& cplFcFcpHpmL,cplFcFcpHpmR,cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,     & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
...
Real(dp),Intent(in) :: MFd(3),MFcp(2),MFc(3),MVWLm,MVWRm,MHpm(3),MFu(3)

Complex(dp),Intent(in) :: cplcFuFdcHpmL(3,3,3),cplcFuFdcHpmR(3,3,3),cplcFuFdcVWLmL(3,3),cplcFuFdcVWLmR(3,3),    & 
& cplcFuFdcVWRmL(3,3),cplcFuFdcVWRmR(3,3),cplFcFcpHpmL(3,2,3),cplFcFcpHpmR(3,2,3),       & 
...
If(Abs(MFu(iIN)).gt.(Abs(MFc(gt3))+Abs(MFcp(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  conj[VWLm] 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd Fcp Fc Propagator: conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd Fcp Fc Propagator: conj[VWLm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd Fcp Fc Propagator: conj[VWRm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd Fcp Fc Propagator: conj[Hpm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FuToFdcFcpFcpp(iIN,MFd,MFcp,MFcpp,MVWLm,MVWRm,MHpm,MFu,cplcFcpFcppHpmL,    & 
& cplcFcpFcppHpmR,cplcFcpFcppVWLmL,cplcFcpFcppVWLmR,cplcFcpFcppVWRmL,cplcFcpFcppVWRmR,   & 
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplcFuFdcVWRmL,              & 
& cplcFuFdcVWRmR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,           & 
...
Real(dp),Intent(in) :: MFd(3),MFcp(2),MFcpp,MVWLm,MVWRm,MHpm(3),MFu(3)

Complex(dp),Intent(in) :: cplcFcpFcppHpmL(2,3),cplcFcpFcppHpmR(2,3),cplcFcpFcppVWLmL(2),cplcFcpFcppVWLmR(2),    & 
& cplcFcpFcppVWRmL(2),cplcFcpFcppVWRmR(2),cplcFuFdcHpmL(3,3,3),cplcFuFdcHpmR(3,3,3),     & 
...
If(Abs(MFu(iIN)).gt.(Abs(MFcpp)+Abs(MFcp(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  conj[VWLm] 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFcp Fcpp Propagator: conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,1,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFcp Fcpp Propagator: conj[VWLm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,1,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFcp Fcpp Propagator: conj[VWRm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,1,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFcp Fcpp Propagator: conj[Hpm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,1,Isum)= 0._dp  
...
End Module Fu3Decays_tripletLR 
