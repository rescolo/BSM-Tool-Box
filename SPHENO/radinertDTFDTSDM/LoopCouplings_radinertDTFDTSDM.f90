...
Module LoopCouplings_radinertDTFDTSDM 
...
Subroutine CoupHiggsToPhoton(mHiggs,inG,ratChi,ratFd,ratFe,ratFu,ratHp,               & 
& ratVWp,ratXP,MChi,MFd,MFe,MFu,MHp,MVWp,MXP,gNLO,coup)

Implicit None 
Complex(dp),Intent(in) :: ratChi(2),ratFd(3),ratFe(3),ratFu(3),ratHp,ratVWp,ratXP(2)

Real(dp),Intent(in) :: MChi(2),MFd(3),MFe(3),MFu(3),MHp,MVWp,MXP(2)
...
Do i1 = 1 , 2
coup = coup + 1*(1)**2*ratXP(i1)*A_zero(mH2p/MXP(i1)**2)
HPPloopXP(i1) = HPPloopXP(i1)+1*(1)**2*ratXP(i1)*A_zero(mH2p/MXP(i1)**2)
End Do 
Do i1 = 1 , 2
coup = coup + 1*(-1)**2*ratChi(i1)*A_onehalf(mH2p/MChi(i1)**2)
HPPloopChi(i1) = HPPloopChi(i1)+1*(-1)**2*ratChi(i1)*A_onehalf(mH2p/MChi(i1)**2)
End Do 
Do i1 = 1 , 3
...
Subroutine CoupHiggsToPhotonSM(mHiggs,MChi,MFd,MFe,MFu,MHp,MVWp,MXP,gNLO,coup)
...
Subroutine CoupPseudoHiggsToPhoton(mHiggs,inG,ratChi,ratFd,ratFe,ratFu,               & 
& ratHp,ratVWp,ratXP,MChi,MFd,MFe,MFu,MHp,MVWp,MXP,gNLO,coup)
...
Do i1 =1, 2
coup = coup + cANLO_onehalf(mHiggs,MChi(i1),gNLO)*1*(-1)**2*ratChi(i1)*AP_onehalf(mH2p/MChi(i1)**2)
End Do 
Do i1 =1, 3
...
Subroutine CoupPseudoHiggsToPhotonSM(mHiggs,MChi,MFd,MFe,MFu,MHp,MVWp,MXP,            & 
& gNLO,coup)
...
End Module LoopCouplings_radinertDTFDTSDM 
