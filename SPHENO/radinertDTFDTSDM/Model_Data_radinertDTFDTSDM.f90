...
Module Model_Data_radinertDTFDTSDM 
...
Real(dp) :: g1IN,g2IN,g3IN,lam1IN,lam2IN,lam3IN,lam4IN,lam6IN,lam7IN,lam8IN,lam5IN,               & 
& etaIN(3),AIN,BIN,YfIN(3),Y3IN(3),MTFIN,MDFIN,muIN,mH2IN,mEt2IN,mu3IN

Complex(dp) :: YuIN(3,3),YdIN(3,3),YeIN(3,3)

Real(dp) :: g1MZ,g2MZ,g3MZ,lam1MZ,lam2MZ,lam3MZ,lam4MZ,lam6MZ,lam7MZ,lam8MZ,lam5MZ,               & 
& etaMZ(3),AMZ,BMZ,YfMZ(3),Y3MZ(3),MTFMZ,MDFMZ,muMZ,mH2MZ,mEt2MZ,mu3MZ

Complex(dp) :: YuMZ(3,3),YdMZ(3,3),YeMZ(3,3)

Real(dp) :: g1GUT,g2GUT,g3GUT,lam1GUT,lam2GUT,lam3GUT,lam4GUT,lam6GUT,lam7GUT,lam8GUT,            & 
& lam5GUT,etaGUT(3),AGUT,BGUT,YfGUT(3),Y3GUT(3),MTFGUT,MDFGUT,muGUT,mH2GUT,              & 
& mEt2GUT,mu3GUT

Complex(dp) :: YuGUT(3,3),YdGUT(3,3),YeGUT(3,3)
...
Real(dp) :: ratioPChi(1,2),ratioPFd(1,3),ratioPFe(1,3),ratioPFu(1,3),ratioPHp,ratioPVWp,          & 
& ratioPXP(1,2)

Complex(dp) :: ratioPGG,ratioPPP

Real(dp) :: gForTadpoles(83)
...
Logical, save :: InputValueforeta =.False. 
Logical, save :: InputValueforA =.False. 
Logical, save :: InputValueforB =.False. 
Logical, save :: InputValueforYf =.False. 
Logical, save :: InputValueforY3 =.False. 
Logical, save :: InputValueforMTF =.False. 
...
! For HiggsBounds 
Real(dp) :: BR_tHb(99)
Real(dp) :: BR_Hcs(99), BR_Hcb(99), BR_Htaunu(99), BR_tWb
...
End Module Model_Data_radinertDTFDTSDM