...
& lam8,lam5,Yu,Yd,Ye,eta,A,B,Yf,Y3,MTF,MDF,mu,mH2,mEt2,mu3,v,CKMout,sinW2_out,           & 
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(83), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG83(g1input,g2input,g3input,lam1input,lam2input,lam3input,           & 
& lam4input,lam6input,lam7input,lam8input,lam5input,Yuinput,Ydinput,Yeinput,             & 
& etainput,Ainput,Binput,Yfinput,Y3input,MTFinput,MDFinput,muinput,mH2input,             & 
& mEt2input,mu3input,vinput,g1D)

Call GToParameters83(g1D,g1,g2,g3,lam1,lam2,lam3,lam4,lam6,lam7,lam8,lam5,            & 
...
End Module RunSM_radinertDTFDTSDM 
