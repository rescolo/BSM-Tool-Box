...
Module InputOutput_radinertDTFDTSDM 
...
InputValueforYe= .True. 
   ...
   Else If (read_line(7:11).Eq."ETAIN") Then 
InputValueforeta= .True. 
    Call ReadVectorR(99,3,etaIN, "etaIN",kont)

 
   Else If (read_line(7:9).Eq."FIN") Then 
InputValueforYf= .True. 
    Call ReadVectorR(99,3,YfIN, "YfIN",kont)

 
   Else If (read_line(7:11).Eq."RHOIN") Then 
InputValueforY3= .True. 
    Call ReadVectorR(99,3,Y3IN, "Y3IN",kont)
   ...
   Else If (read_line(7:11).Eq."PI1IN") Then 
    Call Read_PI1IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMPI1IN") Then 
    Call Read_PI1IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:11).Eq."PI2IN") Then 
    Call Read_PI2IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMPI2IN") Then 
    Call Read_PI2IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:11).Eq."MTFIN") Then 
    Call Read_MTFIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMMTFIN") Then 
    Call Read_MTFIN(99,1,i_model,set_mod_par,kont) 
...
Complex(dp) :: PDGhh,PDGAh,PDGetI,PDGHp,PDGXP(2),PDGXO(2),PDGVP,PDGVZ,PDGVG,PDGVWp,PDGgP,            & 
& PDGgWp,PDGgWpC,PDGgZ,PDGgG,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3),PDGNv(3),PDGChi(2)
...
Character(len=30),Dimension(2):: NameParticleXP
Character(len=30),Dimension(2):: NameParticleXO
...
Character(len=30),Dimension(3):: NameParticleNv
Character(len=30),Dimension(2):: NameParticleChi
...
NameParticleHp="Hp"
PDGXP(1)=1003
NameParticleXP(1)="XP_1"
PDGXP(2)=1004
NameParticleXP(2)="XP_2"
PDGXO(1)=1005
NameParticleXO(1)="XO_1"
PDGXO(2)=1006
NameParticleXO(2)="XO_2"
PDGVP=22
NameParticleVP="VP"
PDGVZ=23
NameParticleVZ="VZ"
...
PDGNv(1)=310000601
NameParticleNv(1)="Nv_1"
PDGNv(2)=310000602
NameParticleNv(2)="Nv_2"
PDGNv(3)=310000603
NameParticleNv(3)="Nv_3"
PDGChi(1)=210000601
...
End Do 
Do i1=1,3
  If (MaxVal(Abs(AImag(O(i1,:)))).gt.MaxVal(Abs(Real(O(i1,:),dp)))) Then 
MNv(i1) = - MNv(i1) 
O(i1,:) = -(0._dp,1._dp)*O(i1,:) 
  End If 
End Do 
End If 
 
Write(io_L,100) "# SUSY Les Houches Accord 2 - radinert/DTFDTSDM Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 9, Real(mEt2Input,dp) ,"# mEt2Input"
Write(io_L,101) 10, Real(mu3Input,dp) ,"# mu3Input"
Write(io_L,101) 11, Real(muInput,dp) ,"# muInput"
...
Write(io_L,101) 9, Aimag(mEt2Input) ,"# mEt2Input"
End if 
If (Abs(Aimag(mu3Input)).gt.0._dp) Then 
Write(io_L,101) 10, Aimag(mu3Input) ,"# mu3Input"
End if 
If (Abs(Aimag(muInput)).gt.0._dp) Then 
Write(io_L,101) 11, Aimag(muInput) ,"# muInput"
End if 
End if 
...
Write(io_L,104) 3,Real(lam1,dp), "# lam1" 
Write(io_L,104) 4,Real(lam2,dp), "# lam2" 
Write(io_L,104) 5,Real(lam3,dp), "# lam3" 
Write(io_L,104) 6,Real(lam4,dp), "# lam4" 
Write(io_L,104) 8,Real(lam6,dp), "# lam6" 
Write(io_L,104) 9,Real(lam7,dp), "# lam7" 
Write(io_L,104) 10,Real(lam8,dp), "# lam8" 
Write(io_L,104) 7,Real(lam5,dp), "# lam5" 
Write(io_L,104) 11,Real(mu,dp), "# mu" 
Write(io_L,104) 1,Real(mEt2,dp), "# mEt2" 
Write(io_L,104) 2,Real(mu3,dp), "# mu3" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMHDM Q=",Q,"# (Renormalization Scale)" 
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block PI1 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(A,dp), "# A" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMPI1 Q=",Q,"# (Renormalization Scale)" 
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block PI2 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(B,dp), "# B" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMPI2 Q=",Q,"# (Renormalization Scale)" 
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block MTF Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(MTF,dp), "# MTF" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMMTF Q=",Q,"# (Renormalization Scale)" 
End if 
WriteNextBlock = .false. 
...
Write(io_L,106) "Block eta Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,eta(1), "# eta(1) " 
Write(io_L,104) 2,eta(2), "# eta(2) " 
Write(io_L,104) 3,eta(3), "# eta(3) " 
Write(io_L,106) "Block f Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Yf(1), "# Yf(1) " 
Write(io_L,104) 2,Yf(2), "# Yf(2) " 
Write(io_L,104) 3,Yf(3), "# Yf(3) " 
Write(io_L,106) "Block rho Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Y3(1), "# Y3(1) " 
Write(io_L,104) 2,Y3(2), "# Y3(2) " 
Write(io_L,104) 3,Y3(3), "# Y3(3) " 
...
Write(io_L,104) 3,Real(lam1GUT,dp), "# lam1" 
Write(io_L,104) 4,Real(lam2GUT,dp), "# lam2" 
Write(io_L,104) 5,Real(lam3GUT,dp), "# lam3" 
Write(io_L,104) 6,Real(lam4GUT,dp), "# lam4" 
Write(io_L,104) 8,Real(lam6GUT,dp), "# lam6" 
Write(io_L,104) 9,Real(lam7GUT,dp), "# lam7" 
Write(io_L,104) 10,Real(lam8GUT,dp), "# lam8" 
Write(io_L,104) 7,Real(lam5GUT,dp), "# lam5" 
Write(io_L,104) 11,Real(muGUT,dp), "# mu" 
Write(io_L,104) 1,Real(mEt2GUT,dp), "# mEt2" 
Write(io_L,104) 2,Real(mu3GUT,dp), "# mu3" 
Write(io_L,106) "Block PI1GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(AGUT,dp), "# A" 
Write(io_L,106) "Block PI2GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(BGUT,dp), "# B" 
Write(io_L,106) "Block MTFGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(MTFGUT,dp), "# MTF" 
...
Write(io_L,106) "Block etaGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,etaGUT(1), "# etaGUT(1) " 
Write(io_L,104) 2,etaGUT(2), "# etaGUT(2) " 
Write(io_L,104) 3,etaGUT(3), "# etaGUT(3) " 
Write(io_L,106) "Block YfGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,YfGUT(1), "# YfGUT(1) " 
Write(io_L,104) 2,YfGUT(2), "# YfGUT(2) " 
Write(io_L,104) 3,YfGUT(3), "# YfGUT(3) " 
Write(io_L,106) "Block Y3GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,Y3GUT(1), "# Y3GUT(1) " 
Write(io_L,104) 2,Y3GUT(2), "# Y3GUT(2) " 
Write(io_L,104) 3,Y3GUT(3), "# Y3GUT(3) " 
End if 
...
End if 
End if 
 Write(io_L,102) INT(Abs(PDGXP(1))),MXP(1),"# "//Trim(NameParticleXP(1))// "" 
If (MassLSP(1).gt.Abs(MXP(1))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 1003 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MXP(1))
Else 
If (MassLSP(2).gt.Abs(MXP(1))) Then 
PDGLSP(2) = 1003 
MassLSP(2) = Abs(MXP(1))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGXP(2))),MXP(2),"# "//Trim(NameParticleXP(2))// "" 
If (MassLSP(1).gt.Abs(MXP(2))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 1004 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MXP(2))
Else 
If (MassLSP(2).gt.Abs(MXP(2))) Then 
PDGLSP(2) = 1004 
MassLSP(2) = Abs(MXP(2))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGXO(1))),MXO(1),"# "//Trim(NameParticleXO(1))// "" 
If (MassLSP(1).gt.Abs(MXO(1))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 1005 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MXO(1))
Else 
If (MassLSP(2).gt.Abs(MXO(1))) Then 
PDGLSP(2) = 1005 
MassLSP(2) = Abs(MXO(1))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGXO(2))),MXO(2),"# "//Trim(NameParticleXO(2))// "" 
If (MassLSP(1).gt.Abs(MXO(2))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 1006 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MXO(2))
Else 
If (MassLSP(2).gt.Abs(MXO(2))) Then 
PDGLSP(2) = 1006 
MassLSP(2) = Abs(MXO(2))
End if 
End if 
 ...
 Write(io_L,102) INT(Abs(PDGNv(1))),MNv(1),"# "//Trim(NameParticleNv(1))// "" 
If (MassLSP(1).gt.Abs(MNv(1))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 310000601 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MNv(1))
Else 
If (MassLSP(2).gt.Abs(MNv(1))) Then 
PDGLSP(2) = 310000601 
MassLSP(2) = Abs(MNv(1))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGNv(2))),MNv(2),"# "//Trim(NameParticleNv(2))// "" 
If (MassLSP(1).gt.Abs(MNv(2))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 310000602 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MNv(2))
Else 
If (MassLSP(2).gt.Abs(MNv(2))) Then 
PDGLSP(2) = 310000602 
MassLSP(2) = Abs(MNv(2))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGNv(3))),MNv(3),"# "//Trim(NameParticleNv(3))// "" 
If (MassLSP(1).gt.Abs(MNv(3))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 310000603 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MNv(3))
Else 
If (MassLSP(2).gt.Abs(MNv(3))) Then 
PDGLSP(2) = 310000603 
MassLSP(2) = Abs(MNv(3))
End if 
End if 
...
Write(io_L,106) "Block NEUTRINOMIX Q=",Q,"# ()" 
...
If (MaxVal(Abs(AImag(Vv))).gt.0._dp) Then 
Write(io_L,106) "Block IMNEUTRINOMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block NEUTRALMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(O(1,1),dp), "# Real(O(1,1),dp)" 
Write(io_L,107)1,2,Real(O(1,2),dp), "# Real(O(1,2),dp)" 
Write(io_L,107)1,3,Real(O(1,3),dp), "# Real(O(1,3),dp)" 
Write(io_L,107)2,1,Real(O(2,1),dp), "# Real(O(2,1),dp)" 
Write(io_L,107)2,2,Real(O(2,2),dp), "# Real(O(2,2),dp)" 
Write(io_L,107)2,3,Real(O(2,3),dp), "# Real(O(2,3),dp)" 
Write(io_L,107)3,1,Real(O(3,1),dp), "# Real(O(3,1),dp)" 
Write(io_L,107)3,2,Real(O(3,2),dp), "# Real(O(3,2),dp)" 
Write(io_L,107)3,3,Real(O(3,3),dp), "# Real(O(3,3),dp)" 
If (MaxVal(Abs(AImag(O))).gt.0._dp) Then 
Write(io_L,106) "Block IMNEUTRALMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(O(1,1)), "# Aimag(O(1,1))" 
Write(io_L,107)1,2,Aimag(O(1,2)), "# Aimag(O(1,2))" 
Write(io_L,107)1,3,Aimag(O(1,3)), "# Aimag(O(1,3))" 
Write(io_L,107)2,1,Aimag(O(2,1)), "# Aimag(O(2,1))" 
Write(io_L,107)2,2,Aimag(O(2,2)), "# Aimag(O(2,2))" 
Write(io_L,107)2,3,Aimag(O(2,3)), "# Aimag(O(2,3))" 
Write(io_L,107)3,1,Aimag(O(3,1)), "# Aimag(O(3,1))" 
Write(io_L,107)3,2,Aimag(O(3,2)), "# Aimag(O(3,2))" 
Write(io_L,107)3,3,Aimag(O(3,3)), "# Aimag(O(3,3))" 
End If 

Write(io_L,106) "Block FERMIONMIXL Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(Q2(1,1),dp), "# Real(Q2(1,1),dp)" 
Write(io_L,107)1,2,Real(Q2(1,2),dp), "# Real(Q2(1,2),dp)" 
Write(io_L,107)2,1,Real(Q2(2,1),dp), "# Real(Q2(2,1),dp)" 
Write(io_L,107)2,2,Real(Q2(2,2),dp), "# Real(Q2(2,2),dp)" 
If (MaxVal(Abs(AImag(Q2))).gt.0._dp) Then 
Write(io_L,106) "Block IMFERMIONMIXL Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(Q2(1,1)), "# Aimag(Q2(1,1))" 
Write(io_L,107)1,2,Aimag(Q2(1,2)), "# Aimag(Q2(1,2))" 
Write(io_L,107)2,1,Aimag(Q2(2,1)), "# Aimag(Q2(2,1))" 
Write(io_L,107)2,2,Aimag(Q2(2,2)), "# Aimag(Q2(2,2))" 
End If 

Write(io_L,106) "Block FERMIONMIXR Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(Q3(1,1),dp), "# Real(Q3(1,1),dp)" 
Write(io_L,107)1,2,Real(Q3(1,2),dp), "# Real(Q3(1,2),dp)" 
Write(io_L,107)2,1,Real(Q3(2,1),dp), "# Real(Q3(2,1),dp)" 
Write(io_L,107)2,2,Real(Q3(2,2),dp), "# Real(Q3(2,2),dp)" 
If (MaxVal(Abs(AImag(Q3))).gt.0._dp) Then 
Write(io_L,106) "Block IMFERMIONMIXR Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(Q3(1,1)), "# Aimag(Q3(1,1))" 
Write(io_L,107)1,2,Aimag(Q3(1,2)), "# Aimag(Q3(1,2))" 
Write(io_L,107)2,1,Aimag(Q3(2,1)), "# Aimag(Q3(2,1))" 
Write(io_L,107)2,2,Aimag(Q3(2,2)), "# Aimag(Q3(2,2))" 
End If 

Write(io_L,106) "Block ZXPMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(ZXP(1,1),dp), "# Real(ZXP(1,1),dp)" 
Write(io_L,107)1,2,Real(ZXP(1,2),dp), "# Real(ZXP(1,2),dp)" 
Write(io_L,107)2,1,Real(ZXP(2,1),dp), "# Real(ZXP(2,1),dp)" 
Write(io_L,107)2,2,Real(ZXP(2,2),dp), "# Real(ZXP(2,2),dp)" 
If (MaxVal(Abs(AImag(ZXP))).gt.0._dp) Then 
Write(io_L,106) "Block IMZXPMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(ZXP(1,1)), "# Aimag(ZXP(1,1))" 
Write(io_L,107)1,2,Aimag(ZXP(1,2)), "# Aimag(ZXP(1,2))" 
Write(io_L,107)2,1,Aimag(ZXP(2,1)), "# Aimag(ZXP(2,1))" 
Write(io_L,107)2,2,Aimag(ZXP(2,2)), "# Aimag(ZXP(2,2))" 
End If 

Write(io_L,106) "Block ZXMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(ZX0(1,1),dp), "# Real(ZX0(1,1),dp)" 
Write(io_L,107)1,2,Real(ZX0(1,2),dp), "# Real(ZX0(1,2),dp)" 
Write(io_L,107)2,1,Real(ZX0(2,1),dp), "# Real(ZX0(2,1),dp)" 
Write(io_L,107)2,2,Real(ZX0(2,2),dp), "# Real(ZX0(2,2),dp)" 
If (MaxVal(Abs(AImag(ZX0))).gt.0._dp) Then 
Write(io_L,106) "Block IMZXMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(ZX0(1,1)), "# Aimag(ZX0(1,1))" 
Write(io_L,107)1,2,Aimag(ZX0(1,2)), "# Aimag(ZX0(1,2))" 
Write(io_L,107)2,1,Aimag(ZX0(2,1)), "# Aimag(ZX0(2,1))" 
Write(io_L,107)2,2,Aimag(ZX0(2,2)), "# Aimag(ZX0(2,2))" 
End If 
...
End do 
Do i2=1,2
CurrentPDG2(2) = Abs(PDGXP(i2)) 
Write(io_L,122) CurrentPDG2(1), CurrentPDG2(2), HPPloopXP(i2), " # h(",i1,")-XP(",i2,")-loop " 
End do 
Do i2=1,2
CurrentPDG2(2) = Abs(PDGChi(i2)) 
Write(io_L,122) CurrentPDG2(1), CurrentPDG2(2), HPPloopChi(i2), " # h(",i1,")-Chi(",i2,")-loop " 
End do 
Do i2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,10:201)).Gt.BRmin) Then 
...
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGChi(gt3) 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,10:201)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGChi(gt3) 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,10:201)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGChi(gt3) 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,10:201)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,2
...
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,10:201)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,2
...
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,10:201)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,2
...
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Do gt1= 1, 3
  Do gt2=1, 2
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGNv(gt1) 
CurrentPDG2(2) = -PDGXP(gt2) 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleXP(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGChi(gt1) 
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
 
If (Maxval(BRFe(1,22:225)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,2
...
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGChi(gt3) 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleChi(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGXP(gt2) 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleXP(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
 
If (Maxval(BRFe(2,22:225)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,2
...
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGChi(gt3) 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleChi(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGXP(gt2) 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleXP(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
 
If (Maxval(BRFe(3,22:225)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,2
...
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//"^* "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGChi(gt3) 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleChi(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv(gt3) 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleNv(gt2))//" "//Trim(NameParticleNv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFv(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleXP(gt2))//"^* "//")"
Write(io_L,201) BRFv(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleXP(gt2))//" "//")"
End if 
icount = icount +1 
...
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFv(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleXP(gt2))//"^* "//")"
Write(io_L,201) BRFv(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleXP(gt2))//" "//")"
End if 
icount = icount +1 
...
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFv(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleXP(gt2))//"^* "//")"
Write(io_L,201) BRFv(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleXP(gt2))//" "//")"
End if 
icount = icount +1 
...
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXP(gt2) 
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleXP(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXP(gt2) 
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleXP(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If(gTNv(1).gt.MinWidth) Then 
Write(io_L,200) INT(PDGNv(1)),gTNv(1),Trim(NameParticleNv(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 2
...
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRNv(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleNv(1))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
Write(io_L,201) BRNv(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleNv(1))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRNv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXP(gt2) 
Write(io_L,201) BRNv(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleNv(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleXP(gt2))//" "//")"
Write(io_L,201) BRNv(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleNv(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleXP(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRNv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRNv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(1))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRNv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(1))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRNv(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleNv(2))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
Write(io_L,201) BRNv(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleNv(2))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRNv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXP(gt2) 
Write(io_L,201) BRNv(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleNv(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleXP(gt2))//" "//")"
Write(io_L,201) BRNv(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleNv(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleXP(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRNv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRNv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(2))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRNv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(2))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRNv(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleNv(3))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
Write(io_L,201) BRNv(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleNv(3))//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRNv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGXP(gt2) 
Write(io_L,201) BRNv(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleNv(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleXP(gt2))//" "//")"
Write(io_L,201) BRNv(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleNv(3))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleXP(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRNv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleXO(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRNv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(3))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRNv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv(3))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleChi(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGNv(gt1) 
CurrentPDG2(2) = PDGNv(gt2) 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleNv(gt2))//" "//")"
If (((gTNv(gt1).le.WidthToBeInvisible).and.(gTNv(gt2).le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvH(1) = BRinvH(1)+BRhh(1,icount) 
End if 
End if 
...
Do gt1= 1, 2
  Do gt2= gt1, 2
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGXO(gt1) 
CurrentPDG2(2) = PDGXO(gt2) 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleXO(gt1))//" "//Trim(NameParticleXO(gt2))//" "//")"
If (((gTXO(gt1).le.WidthToBeInvisible).and.(gTXO(gt2).le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvH(1) = BRinvH(1)+BRhh(1,icount) 
End if 
End if 
...
Do gt1= 1, 2
  Do gt2=1, 2
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGXP(gt1) 
CurrentPDG2(2) = PDGXP(gt2) 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleXP(gt1))//"^* "//Trim(NameParticleXP(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If(gTXO(1).gt.MinWidth) Then 
Write(io_L,200) INT(PDGXO(1)),gTXO(1),Trim(NameParticleXO(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BRXO(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BRXO(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleXO(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
Write(io_L,201) BRXO(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleXO(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleChi(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(1) = PDGetI 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRXO(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXO(1))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
Write(io_L,201) BRXO(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXO(1))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRXO(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXO(1))//" -> "//Trim(NameParticleXO(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRXO(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleXO(1))//" -> "//Trim(NameParticleXP(gt1))//"^* "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRXO(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleXO(1))//" -> "//Trim(NameParticleXP(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
End if 
If(gTXO(2).gt.MinWidth) Then 
Write(io_L,200) INT(PDGXO(2)),gTXO(2),Trim(NameParticleXO(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BRXO(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BRXO(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleXO(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
Write(io_L,201) BRXO(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleXO(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleChi(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(1) = PDGetI 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRXO(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXO(2))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRXO(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXO(2))//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRXO(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXO(2))//" -> "//Trim(NameParticleXO(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRXO(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleXO(2))//" -> "//Trim(NameParticleXP(gt1))//"^* "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRXO(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleXO(2))//" -> "//Trim(NameParticleXP(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
...
Write(io_L,201) BRetI(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
Write(io_L,201) BRetI(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleChi(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleNv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRetI(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleXP(gt1))//"^* "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRetI(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleXP(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleXO(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
If(gTXP(1).gt.MinWidth) Then 
Write(io_L,200) INT(PDGXP(1)),gTXP(1),Trim(NameParticleXP(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BRXP(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BRXP(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRXP(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(1))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 2
If (BRXP(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRXP(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(1))//" -> "//Trim(NameParticleXP(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGNv(gt2) 
Write(io_L,201) BRXP(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleNv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRXP(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(1))//" -> "//Trim(NameParticleXO(gt1))//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRXP(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(1))//" -> "//Trim(NameParticleXP(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
If(gTXP(2).gt.MinWidth) Then 
Write(io_L,200) INT(PDGXP(2)),gTXP(2),Trim(NameParticleXP(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BRXP(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BRXP(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRXP(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(2))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 2
If (BRXP(2,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRXP(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(2))//" -> "//Trim(NameParticleXP(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGNv(gt2) 
Write(io_L,201) BRXP(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleNv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRXP(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(2))//" -> "//Trim(NameParticleXO(gt1))//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRXP(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleXP(2))//" -> "//Trim(NameParticleXP(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.radinertDTFDTSDM",status="unknown")
...
Write(123,*) "eta1= ",eta(1)
Write(123,*) "eta2= ",eta(2)
Write(123,*) "eta3= ",eta(3)
Write(123,*) "A= ",A
Write(123,*) "B= ",B
Write(123,*) "Yf1= ",Yf(1)
Write(123,*) "Yf2= ",Yf(2)
...
Write(123,*) "MXP1= ", Abs(MXP(1)) 
Write(123,*) "MXP2= ", Abs(MXP(2)) 
Write(123,*) "MXO1= ", Abs(MXO(1)) 
Write(123,*) "MXO2= ", Abs(MXO(2)) 
...
Write(123,*) "MNv1= ", Abs(MNv(1)) 
Write(123,*) "MNv2= ", Abs(MNv(2)) 
Write(123,*) "MNv3= ", Abs(MNv(3)) 
Write(123,*) "Mci1= ", Abs(MChi(1)) 
Write(123,*) "Mci2= ", Abs(MChi(2)) 
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "Wci1 = ",gTChi(1)
Write(123,*) "Wci2 = ",gTChi(2)
Write(123,*) "WNv1 = ",gTNv(1)
Write(123,*) "WNv2 = ",gTNv(2)
Write(123,*) "WNv3 = ",gTNv(3)
Write(123,*) "Wh = ",gThh
Write(123,*) "WXO1 = ",gTXO(1)
Write(123,*) "WXO2 = ",gTXO(2)
Write(123,*) "WetI = ",gTetI
Write(123,*) "WXP1 = ",gTXP(1)
Write(123,*) "WXP2 = ",gTXP(2)
Write(123,*) "" 
Write(123,*) "" 
...
End if 
If (MNv(1).Gt.0._dp) Then 
Write(123,*) "O11_r = ", Real(O(1,1),dp)
Write(123,*) "O11_i = ", AImag(O(1,1))
Write(123,*) "O12_r = ", Real(O(1,2),dp)
Write(123,*) "O12_i = ", AImag(O(1,2))
Write(123,*) "O13_r = ", Real(O(1,3),dp)
Write(123,*) "O13_i = ", AImag(O(1,3))
Else 
Write(123,*) "O11_i = ", Real(O(1,1),dp)
Write(123,*) "O11_r = ", -AImag(O(1,1))
Write(123,*) "O12_i = ", Real(O(1,2),dp)
Write(123,*) "O12_r = ", -AImag(O(1,2))
Write(123,*) "O13_i = ", Real(O(1,3),dp)
Write(123,*) "O13_r = ", -AImag(O(1,3))
End if 
If (MNv(2).Gt.0._dp) Then 
Write(123,*) "O21_r = ", Real(O(2,1),dp)
Write(123,*) "O21_i = ", AImag(O(2,1))
Write(123,*) "O22_r = ", Real(O(2,2),dp)
Write(123,*) "O22_i = ", AImag(O(2,2))
Write(123,*) "O23_r = ", Real(O(2,3),dp)
Write(123,*) "O23_i = ", AImag(O(2,3))
Else 
Write(123,*) "O21_i = ", Real(O(2,1),dp)
Write(123,*) "O21_r = ", -AImag(O(2,1))
Write(123,*) "O22_i = ", Real(O(2,2),dp)
Write(123,*) "O22_r = ", -AImag(O(2,2))
Write(123,*) "O23_i = ", Real(O(2,3),dp)
Write(123,*) "O23_r = ", -AImag(O(2,3))
End if 
If (MNv(3).Gt.0._dp) Then 
Write(123,*) "O31_r = ", Real(O(3,1),dp)
Write(123,*) "O31_i = ", AImag(O(3,1))
Write(123,*) "O32_r = ", Real(O(3,2),dp)
Write(123,*) "O32_i = ", AImag(O(3,2))
Write(123,*) "O33_r = ", Real(O(3,3),dp)
Write(123,*) "O33_i = ", AImag(O(3,3))
Else 
Write(123,*) "O31_i = ", Real(O(3,1),dp)
Write(123,*) "O31_r = ", -AImag(O(3,1))
Write(123,*) "O32_i = ", Real(O(3,2),dp)
Write(123,*) "O32_r = ", -AImag(O(3,2))
Write(123,*) "O33_i = ", Real(O(3,3),dp)
Write(123,*) "O33_r = ", -AImag(O(3,3))
End if 
If (MChi(1).Gt.0._dp) Then 
Write(123,*) "Q211_r = ", Real(Q2(1,1),dp)
Write(123,*) "Q211_i = ", AImag(Q2(1,1))
Write(123,*) "Q212_r = ", Real(Q2(1,2),dp)
Write(123,*) "Q212_i = ", AImag(Q2(1,2))
Else 
Write(123,*) "Q211_i = ", Real(Q2(1,1),dp)
Write(123,*) "Q211_r = ", -AImag(Q2(1,1))
Write(123,*) "Q212_i = ", Real(Q2(1,2),dp)
Write(123,*) "Q212_r = ", -AImag(Q2(1,2))
End if 
If (MChi(2).Gt.0._dp) Then 
Write(123,*) "Q221_r = ", Real(Q2(2,1),dp)
Write(123,*) "Q221_i = ", AImag(Q2(2,1))
Write(123,*) "Q222_r = ", Real(Q2(2,2),dp)
Write(123,*) "Q222_i = ", AImag(Q2(2,2))
Else 
Write(123,*) "Q221_i = ", Real(Q2(2,1),dp)
Write(123,*) "Q221_r = ", -AImag(Q2(2,1))
Write(123,*) "Q222_i = ", Real(Q2(2,2),dp)
Write(123,*) "Q222_r = ", -AImag(Q2(2,2))
End if 
If (MChi(1).Gt.0._dp) Then 
Write(123,*) "Q311_r = ", Real(Q3(1,1),dp)
Write(123,*) "Q311_i = ", AImag(Q3(1,1))
Write(123,*) "Q312_r = ", Real(Q3(1,2),dp)
Write(123,*) "Q312_i = ", AImag(Q3(1,2))
Else 
Write(123,*) "Q311_i = ", Real(Q3(1,1),dp)
Write(123,*) "Q311_r = ", -AImag(Q3(1,1))
Write(123,*) "Q312_i = ", Real(Q3(1,2),dp)
Write(123,*) "Q312_r = ", -AImag(Q3(1,2))
End if 
If (MChi(2).Gt.0._dp) Then 
Write(123,*) "Q321_r = ", Real(Q3(2,1),dp)
Write(123,*) "Q321_i = ", AImag(Q3(2,1))
Write(123,*) "Q322_r = ", Real(Q3(2,2),dp)
Write(123,*) "Q322_i = ", AImag(Q3(2,2))
Else 
Write(123,*) "Q321_i = ", Real(Q3(2,1),dp)
Write(123,*) "Q321_r = ", -AImag(Q3(2,1))
Write(123,*) "Q322_i = ", Real(Q3(2,2),dp)
Write(123,*) "Q322_r = ", -AImag(Q3(2,2))
End if 
If (MXP(1).Gt.0._dp) Then 
Write(123,*) "ZXP11_r = ", Real(ZXP(1,1),dp)
Write(123,*) "ZXP11_i = ", AImag(ZXP(1,1))
Write(123,*) "ZXP12_r = ", Real(ZXP(1,2),dp)
Write(123,*) "ZXP12_i = ", AImag(ZXP(1,2))
Else 
Write(123,*) "ZXP11_i = ", Real(ZXP(1,1),dp)
Write(123,*) "ZXP11_r = ", -AImag(ZXP(1,1))
Write(123,*) "ZXP12_i = ", Real(ZXP(1,2),dp)
Write(123,*) "ZXP12_r = ", -AImag(ZXP(1,2))
End if 
If (MXP(2).Gt.0._dp) Then 
Write(123,*) "ZXP21_r = ", Real(ZXP(2,1),dp)
Write(123,*) "ZXP21_i = ", AImag(ZXP(2,1))
Write(123,*) "ZXP22_r = ", Real(ZXP(2,2),dp)
Write(123,*) "ZXP22_i = ", AImag(ZXP(2,2))
Else 
Write(123,*) "ZXP21_i = ", Real(ZXP(2,1),dp)
Write(123,*) "ZXP21_r = ", -AImag(ZXP(2,1))
Write(123,*) "ZXP22_i = ", Real(ZXP(2,2),dp)
Write(123,*) "ZXP22_r = ", -AImag(ZXP(2,2))
End if 
If (MXO(1).Gt.0._dp) Then 
Write(123,*) "ZX011_r = ", Real(ZX0(1,1),dp)
Write(123,*) "ZX011_i = ", AImag(ZX0(1,1))
Write(123,*) "ZX012_r = ", Real(ZX0(1,2),dp)
Write(123,*) "ZX012_i = ", AImag(ZX0(1,2))
Else 
Write(123,*) "ZX011_i = ", Real(ZX0(1,1),dp)
Write(123,*) "ZX011_r = ", -AImag(ZX0(1,1))
Write(123,*) "ZX012_i = ", Real(ZX0(1,2),dp)
Write(123,*) "ZX012_r = ", -AImag(ZX0(1,2))
End if 
If (MXO(2).Gt.0._dp) Then 
Write(123,*) "ZX021_r = ", Real(ZX0(2,1),dp)
Write(123,*) "ZX021_i = ", AImag(ZX0(2,1))
Write(123,*) "ZX022_r = ", Real(ZX0(2,2),dp)
Write(123,*) "ZX022_i = ", AImag(ZX0(2,2))
Else 
Write(123,*) "ZX021_i = ", Real(ZX0(2,1),dp)
Write(123,*) "ZX021_r = ", -AImag(ZX0(2,1))
Write(123,*) "ZX022_i = ", Real(ZX0(2,2),dp)
Write(123,*) "ZX022_r = ", -AImag(ZX0(2,2))
End if 
...
Write(92,"(e16.8)",advance="No") BR_tHb(1) 
...
Write(92,"(e16.8)",advance="No") BR_tHb(9) 
Write(92,"(e16.8)",advance="No") BR_tHb(10) 
Write(92,"(e16.8)",advance="No") BR_tHb(11) 
Write(92,"(e16.8)",advance="No") BR_tHb(12) 
Write(92,"(e16.8)",advance="No") BR_tHb(13) 
Write(92,"(e16.8)",advance="No") BR_tHb(14) 
Write(92,"(e16.8)",advance="No") BR_tHb(15) 
Write(92,"(e16.8)",advance="No") BR_tHb(16) 
Write(92,"(e16.8)",advance="No") BR_tHb(17) 
Write(92,"(e16.8)",advance="No") BR_tHb(18) 
Write(92,"(e16.8)",advance="No") BR_tHb(19) 
Write(92,"(e16.8)",advance="No") BR_tHb(20) 
Write(92,"(e16.8)",advance="No") BR_tHb(21) 
Write(92,"(e16.8)",advance="No") BR_tHb(22) 
Write(92,"(e16.8)",advance="No") BR_tHb(23) 
Write(92,"(e16.8)",advance="No") BR_tHb(24) 
Write(92,"(e16.8)",advance="No") BR_tHb(25) 
Write(92,"(e16.8)",advance="No") BR_tHb(26) 
Write(92,"(e16.8)",advance="No") BR_tHb(27) 
Write(92,"(e16.8)",advance="No") BR_tHb(28) 
Write(92,"(e16.8)",advance="No") BR_tHb(29) 
Write(92,"(e16.8)",advance="No") BR_tHb(30) 
Write(92,"(e16.8)",advance="No") BR_tHb(31) 
Write(92,"(e16.8)",advance="No") BR_tHb(32) 
Write(92,"(e16.8)",advance="No") BR_tHb(33) 
Write(92,"(e16.8)",advance="No") BR_tHb(34) 
Write(92,"(e16.8)",advance="No") BR_tHb(35) 
Write(92,"(e16.8)",advance="No") BR_tHb(36) 
Write(92,"(e16.8)",advance="No") BR_tHb(37) 
Write(92,"(e16.8)",advance="No") BR_tHb(38) 
Write(92,"(e16.8)",advance="No") BR_tHb(39) 
Write(92,"(e16.8)",advance="No") BR_tHb(40) 
Write(92,"(e16.8)",advance="No") BR_tHb(41) 
Write(92,"(e16.8)",advance="No") BR_tHb(42) 
Write(92,"(e16.8)",advance="No") BR_tHb(43) 
Write(92,"(e16.8)",advance="No") BR_tHb(44) 
Write(92,"(e16.8)",advance="No") BR_tHb(45) 
Write(92,"(e16.8)",advance="No") BR_tHb(46) 
Write(92,"(e16.8)",advance="No") BR_tHb(47) 
Write(92,"(e16.8)",advance="No") BR_tHb(48) 
Write(92,"(e16.8)",advance="No") BR_tHb(49) 
Write(92,"(e16.8)",advance="No") BR_tHb(50) 
Write(92,"(e16.8)",advance="No") BR_tHb(51) 
Write(92,"(e16.8)",advance="No") BR_tHb(52) 
Write(92,"(e16.8)",advance="No") BR_tHb(53) 
Write(92,"(e16.8)",advance="No") BR_tHb(54) 
Write(92,"(e16.8)",advance="No") BR_tHb(55) 
Write(92,"(e16.8)",advance="No") BR_tHb(56) 
Write(92,"(e16.8)",advance="No") BR_tHb(57) 
Write(92,"(e16.8)",advance="No") BR_tHb(58) 
Write(92,"(e16.8)",advance="No") BR_tHb(59) 
Write(92,"(e16.8)",advance="No") BR_tHb(60) 
Write(92,"(e16.8)",advance="No") BR_tHb(61) 
Write(92,"(e16.8)",advance="No") BR_tHb(62) 
Write(92,"(e16.8)",advance="No") BR_tHb(63) 
Write(92,"(e16.8)",advance="No") BR_tHb(64) 
Write(92,"(e16.8)",advance="No") BR_tHb(65) 
Write(92,"(e16.8)",advance="No") BR_tHb(66) 
Write(92,"(e16.8)",advance="No") BR_tHb(67) 
Write(92,"(e16.8)",advance="No") BR_tHb(68) 
Write(92,"(e16.8)",advance="No") BR_tHb(69) 
Write(92,"(e16.8)",advance="No") BR_tHb(70) 
Write(92,"(e16.8)",advance="No") BR_tHb(71) 
Write(92,"(e16.8)",advance="No") BR_tHb(72) 
Write(92,"(e16.8)",advance="No") BR_tHb(73) 
Write(92,"(e16.8)",advance="No") BR_tHb(74) 
Write(92,"(e16.8)",advance="No") BR_tHb(75) 
Write(92,"(e16.8)",advance="No") BR_tHb(76) 
Write(92,"(e16.8)",advance="No") BR_tHb(77) 
Write(92,"(e16.8)",advance="No") BR_tHb(78) 
Write(92,"(e16.8)",advance="No") BR_tHb(79) 
Write(92,"(e16.8)",advance="No") BR_tHb(80) 
Write(92,"(e16.8)",advance="No") BR_tHb(81) 
Write(92,"(e16.8)",advance="No") BR_tHb(82) 
Write(92,"(e16.8)",advance="No") BR_tHb(83) 
Write(92,"(e16.8)",advance="No") BR_tHb(84) 
Write(92,"(e16.8)",advance="No") BR_tHb(85) 
Write(92,"(e16.8)",advance="No") BR_tHb(86) 
Write(92,"(e16.8)",advance="No") BR_tHb(87) 
Write(92,"(e16.8)",advance="No") BR_tHb(88) 
Write(92,"(e16.8)",advance="No") BR_tHb(89) 
Write(92,"(e16.8)",advance="No") BR_tHb(90) 
Write(92,"(e16.8)",advance="No") BR_tHb(91) 
Write(92,"(e16.8)",advance="No") BR_tHb(92) 
Write(92,"(e16.8)",advance="No") BR_tHb(93) 
Write(92,"(e16.8)",advance="No") BR_tHb(94) 
Write(92,"(e16.8)",advance="No") BR_tHb(95) 
Write(92,"(e16.8)",advance="No") BR_tHb(96) 
Write(92,"(e16.8)",advance="No") BR_tHb(97) 
Write(92,"(e16.8)",advance="No") BR_tHb(98) 
Write(92,"(e16.8)",advance="No") BR_tHb(99) 
Write(91,"(I1)",advance="No") 1 
Write(91,"(3e16.8)",advance="No") BR_Hcs(1) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(1) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(1) 
...
Write(91,"(3e16.8)",advance="No") BR_Hcs(9) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(9) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(9) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(10) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(10) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(10) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(11) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(11) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(11) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(12) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(12) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(12) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(13) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(13) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(13) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(14) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(14) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(14) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(15) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(15) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(15) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(16) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(16) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(16) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(17) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(17) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(17) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(18) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(18) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(18) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(19) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(19) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(19) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(20) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(20) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(20) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(21) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(21) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(21) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(22) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(22) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(22) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(23) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(23) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(23) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(24) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(24) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(24) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(25) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(25) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(25) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(26) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(26) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(26) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(27) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(27) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(27) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(28) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(28) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(28) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(29) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(29) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(29) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(30) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(30) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(30) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(31) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(31) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(31) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(32) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(32) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(32) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(33) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(33) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(33) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(34) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(34) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(34) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(35) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(35) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(35) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(36) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(36) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(36) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(37) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(37) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(37) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(38) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(38) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(38) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(39) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(39) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(39) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(40) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(40) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(40) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(41) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(41) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(41) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(42) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(42) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(42) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(43) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(43) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(43) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(44) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(44) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(44) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(45) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(45) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(45) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(46) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(46) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(46) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(47) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(47) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(47) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(48) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(48) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(48) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(49) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(49) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(49) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(50) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(50) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(50) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(51) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(51) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(51) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(52) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(52) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(52) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(53) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(53) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(53) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(54) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(54) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(54) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(55) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(55) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(55) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(56) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(56) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(56) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(57) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(57) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(57) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(58) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(58) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(58) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(59) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(59) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(59) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(60) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(60) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(60) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(61) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(61) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(61) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(62) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(62) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(62) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(63) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(63) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(63) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(64) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(64) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(64) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(65) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(65) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(65) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(66) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(66) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(66) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(67) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(67) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(67) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(68) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(68) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(68) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(69) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(69) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(69) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(70) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(70) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(70) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(71) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(71) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(71) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(72) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(72) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(72) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(73) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(73) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(73) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(74) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(74) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(74) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(75) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(75) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(75) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(76) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(76) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(76) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(77) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(77) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(77) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(78) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(78) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(78) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(79) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(79) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(79) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(80) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(80) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(80) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(81) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(81) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(81) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(82) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(82) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(82) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(83) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(83) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(83) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(84) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(84) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(84) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(85) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(85) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(85) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(86) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(86) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(86) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(87) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(87) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(87) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(88) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(88) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(88) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(89) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(89) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(89) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(90) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(90) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(90) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(91) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(91) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(91) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(92) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(92) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(92) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(93) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(93) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(93) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(94) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(94) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(94) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(95) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(95) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(95) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(96) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(96) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(96) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(97) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(97) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(97) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(98) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(98) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(98) 
Write(91,"(3e16.8)",advance="No") BR_Hcs(99) 
Write(91,"(3e16.8)",advance="No")BR_Hcb(99) 
Write(91,"(3e16.8)",advance="No")BR_Htaunu(99) 
...
Subroutine Read_PI1IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block PI1IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMPI1IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block PI1IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMPI1IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_PI1IN 
 
 
Subroutine Read_PI2IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block PI2IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMPI2IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block PI2IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMPI2IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_PI2IN 
 
 
Subroutine Read_MTFIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
MTFIN= wert 
InputValueforMTF= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MTFIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMTFIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MTFIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMTFIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_MTFIN 
...
End Module InputOutput_radinertDTFDTSDM 
