...
Program SPhenoradinertDTFDTSDM 
 
Use Control
Use InputOutput_radinertDTFDTSDM
Use LoopFunctions
Use RunSM_radinertDTFDTSDM
Use LowEnergy_radinertDTFDTSDM
Use FlavorKit_LFV_radinertDTFDTSDM
Use FlavorKit_QFV_radinertDTFDTSDM
Use FlavorKit_Observables_radinertDTFDTSDM
Use Mathematics
Use Model_Data_radinertDTFDTSDM
Use Tadpoles_radinertDTFDTSDM 
 Use HiggsCS_radinertDTFDTSDM
Use TreeLevelMasses_radinertDTFDTSDM
Use LoopMasses_radinertDTFDTSDM
 
Use BranchingRatios_radinertDTFDTSDM
...
Call OneLoopMasses(MAh,MAh2,MChi,MChi2,MetI,MetI2,MFd,MFd2,MFe,MFe2,MFu,              & 
& MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,             & 
& MXP2,O,Q2,Q3,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,Vv,ZW,ZX0,ZXP,ZZ,v,g1,g2,g3,lam1,              & 
...
& MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,O,Q2,Q3,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,              & 
& Vv,ZW,ZX0,ZXP,ZZ,v,g1,g2,g3,lam1,lam2,lam3,lam4,lam6,lam7,lam8,lam5,Yu,Yd,             & 
& Ye,eta,A,B,Yf,Y3,MTF,MDF,mu,mH2,mEt2,mu3,gPFu,gTFu,BRFu,gPFd,gTFd,BRFd,gPFe,           & 
& gTFe,BRFe,gPFv,gTFv,BRFv,gPChi,gTChi,BRChi,gPNv,gTNv,BRNv,gPhh,gThh,BRhh,              & 
& gPXO,gTXO,BRXO,gPetI,gTetI,BRetI,gPXP,gTXP,BRXP)

End If 
 
 If (CalculateLowEnergy) then 
Call CalculateLowEnergyConstraints(g1,g2,g3,lam1,lam2,lam3,lam4,lam6,lam7,            & 
& lam8,lam5,Yu,Yd,Ye,eta,A,B,Yf,Y3,MTF,MDF,mu,mH2,mEt2,mu3,v,ae,amu,atau,EDMe,           & 
...
& lam3,lam4,lam6,lam7,lam8,lam5,Yu,Yd,Ye,eta,A,B,Yf,Y3,MTF,MDF,mu,mH2,mEt2,mu3,kont)
...
& lam2input,lam3input,lam4input,lam6input,lam7input,lam8input,lam5input,Yuinput,         & 
& Ydinput,Yeinput,etainput,Ainput,Binput,Yfinput,Y3input,MTFinput,MDFinput,              & 
& muinput,mH2input,mEt2input,mu3input,vinput,ae,amu,atau,EDMe,EDMmu,EDMtau,              & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,lam1input,lam2input,lam3input,lam4input,lam6input,            & 
...
Complex(dp),Intent(inout) :: Yuinput(3,3),Ydinput(3,3),Yeinput(3,3)
...
Complex(dp) :: cplAhAhcVWpVWp,cplAhAhhh,cplAhAhVZVZ,cplAhcHpVWp,cplAhetIXO(2),cplAhhhVZ,             & 
& cplAhHpcVWp,cplAhXPcXP(2,2),cplcChicFeetIL(2,3),cplcChicFeetIR(2,3),cplcChicFeXOL(2,3,2),& 
& cplcChicFeXOR(2,3,2),cplcChiChiAhL(2,2),cplcChiChiAhR(2,2),cplcChiChihhL(2,2),         & 
& cplcChiChihhR(2,2),cplcChiChiVPL(2,2),cplcChiChiVPR(2,2),cplcChiChiVZL(2,2),           & 
& cplcChiChiVZR(2,2),cplcChiFvXPL(2,3,2),cplcChiFvXPR(2,3,2),cplcChiNvHpL(2,3),          & 
& cplcChiNvHpR(2,3),cplcChiNvVWpL(2,3),cplcChiNvVWpR(2,3),cplcFdFdAhL(3,3),              & 
...
& cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcgWCgWpVZ,cplChiFeetIL(2,3),     & 
...
& cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,cpletIcXPVWp(2),cpletIetIcVWpVWp,cpletIetIhh,          & 
& cpletIetIVZVZ,cpletIHpcXP(2),cpletIXOVZ(2),cpletIXPcHp(2),cpletIXPcVWp(2),             & 
& cplFvChicXPL(3,2,2),cplFvChicXPR(3,2,2),cplFvFeHpL(3,3),cplFvFeHpR(3,3),               & 
& cplFvFeVWpL(3,3),cplFvFeVWpR(3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplFvNvetIL(3,3),    & 
& cplFvNvetIR(3,3),cplFvNvXOL(3,3,2),cplFvNvXOR(3,3,2),cplhhcHpVWp,cplhhcVWpVWp,         & 
& cplhhhhcVWpVWp,cplhhhhhh,cplhhhhVZVZ,cplhhHpcHp,cplhhHpcVWp,cplhhVZVZ,cplhhXOXO(2,2),  & 
& cplhhXPcXP(2,2),cplHpcHpcVWpVWp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZVZ,cplHpcVWpVP,        & 
& cplHpcVWpVZ,cplHpXOcXP(2,2),cplNvChicHpL(3,2),cplNvChicHpR(3,2),cplNvChicVWpL(3,2),    & 
& cplNvChicVWpR(3,2),cplNvFeXPL(3,3,2),cplNvFeXPR(3,3,2),cplNvNvAhL(3,3),cplNvNvAhR(3,3),& 
& cplNvNvhhL(3,3),cplNvNvhhR(3,3),cplNvNvVZL(3,3),cplNvNvVZR(3,3),cplVGVGVG,             & 
& cplXOcXPVWp(2,2),cplXOXOcVWpVWp(2,2),cplXOXOVZVZ(2,2),cplXOXPcHp(2,2),cplXOXPcVWp(2,2),& 
& cplXPcXPcVWpVWp(2,2),cplXPcXPVP(2,2),cplXPcXPVZ(2,2),cplXPcXPVZVZ(2,2)
...
& lam3input,lam4input,lam6input,lam7input,lam8input,lam5input,Yuinput,Ydinput,           & 
& Yeinput,etainput,Ainput,Binput,Yfinput,Y3input,MTFinput,MDFinput,muinput,              & 
& mH2input,mEt2input,mu3input,vinput,g1,g2,g3,lam1,lam2,lam3,lam4,lam6,lam7,             & 
& lam8,lam5,Yu,Yd,Ye,eta,A,B,Yf,Y3,MTF,MDF,mu,mH2,mEt2,mu3,v,CKM_160,sinW2_160,          & 
...
MHp=MVWp
MHp2=MVWp2
Call AllCouplings(lam1,v,mu,lam5,ZX0,ZXP,lam3,lam4,lam7,g1,g2,TW,g3,A,B,              & 
& Q2,Q3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,O,eta,Y3,Yf,Vv,cplAhAhhh,cplAhetIXO,            & 
...
Call CalculateBox2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,               & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
...
& cplXPcXPVP,cplXPcXPVZ,BOddllSLL(gt1,gt2,gt3,gt4),BOddllSRR(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,PSOddllSLL(gt1,gt2,gt3,gt4),PSOddllSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,PVOddllSLL(gt1,gt2,gt3,gt4),PVOddllSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,TSOddllSLL(gt1,gt2,gt3,gt4),TSOddllSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,TVOddllSLL(gt1,gt2,gt3,gt4),TVOddllSRR(gt1,gt2,gt3,gt4)          & 
...
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhhhVZ,cplcChiChiVZL,cplcChiChiVZR,cplcChiFvXPL,   & 
& cplcChiFvXPR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,              & 
...
& cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcHpVWpVZ,             & 
& cplcVWpVWpVZ,cpletIXOVZ,cplFvChicXPL,cplFvChicXPR,cplFvFeHpL,cplFvFeHpR,               & 
& cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplFvNvetIL,cplFvNvetIR,cplFvNvXOL,      & 
& cplFvNvXOR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplNvNvVZL,cplNvNvVZR,cplXPcXPVZ,          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeSdulv(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhcHpVWp,cplAhHpcVWp,cplcChicFeetIL,               & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeVdulv(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhcHpVWp,cplAhHpcVWp,cplcChicFeetIL,               & 
& cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiFvXPL,cplcChiFvXPR,cplcFdFdAhL,      & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MChi,MChi2,MetI,MetI2,          & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,             & 
& MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,cplAhHpcVWp,     & 
& cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiChiAhL,    & 
& cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,cplcChiChiVZL,   & 
& cplcChiChiVZR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
...
& cplcFeFvcVWpR,cplcFeNvcXPL,cplcFeNvcXPR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,          & 
& cplcFuFdVWpR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,              & 
& cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplChiFeetIL,cplChiFeetIR,cplChiFeXOL,             & 
& cplChiFeXOR,cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,cpletIetIhh,             & 
& cpletIXOVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,        & 
& cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVZVZ,cplhhXOXO,         & 
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,BOddllSLLSM(gt1,gt2,gt3,gt4),BOddllSRRSM(gt1,gt2,gt3,gt4),BOddllSRLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MChi,MChi2,MetI,              & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,PSOddllSLLSM(gt1,gt2,gt3,gt4),PSOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MChi,MChi2,MetI,              & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,PVOddllSLLSM(gt1,gt2,gt3,gt4),PVOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MChi,MChi2,MetI,              & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,TSOddllSLLSM(gt1,gt2,gt3,gt4),TSOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MChi,MChi2,MetI,              & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,TVOddllSLLSM(gt1,gt2,gt3,gt4),TVOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeSdulv(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MChi,MChi2,MetI,              & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhcHpVWp,cplAhHpcVWp,cplcChicFeetIL,               & 
& cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiFvXPL,cplcChiFvXPR,cplcFdFdAhL,      & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeVdulv(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MChi,MChi2,MetI,              & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhcHpVWp,cplAhHpcVWp,cplcChicFeetIL,               & 
& cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiFvXPL,cplcChiFvXPR,cplcFdFdAhL,      & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
...
& Yeinput,etainput,Ainput,Binput,Yfinput,Y3input,MTFinput,MDFinput,muinput,              & 
& mH2input,mEt2input,mu3input,vinput,g1,g2,g3,lam1,lam2,lam3,lam4,lam6,lam7,             & 
& lam8,lam5,Yu,Yd,Ye,eta,A,B,Yf,Y3,MTF,MDF,mu,mH2,mEt2,mu3,v,CKM_MZ,sinW2_MZ,            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,               & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,BOllddSLL(gt1,gt2,gt3,gt4),BOllddSRR(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,PSOllddSLL(gt1,gt2,gt3,gt4),PSOllddSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,PVOllddSLL(gt1,gt2,gt3,gt4),PVOllddSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,TSOllddSLL(gt1,gt2,gt3,gt4),TSOllddSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,TVOllddSLL(gt1,gt2,gt3,gt4),TVOllddSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,               & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,BOlluuSLL(gt1,gt2,gt3,gt4),BOlluuSRR(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,PSOlluuSLL(gt1,gt2,gt3,gt4),PSOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,PVOlluuSLL(gt1,gt2,gt3,gt4),PVOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,TSOlluuSLL(gt1,gt2,gt3,gt4),TSOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,             & 
& MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,           & 
& cplAhHpcVWp,cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,      & 
& cplcChiChiAhL,cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,   & 
...
& cplhhXOXO,cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,         & 
& cplNvFeXPR,cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,          & 
& cplXPcXPVP,cplXPcXPVZ,TVOlluuSLL(gt1,gt2,gt3,gt4),TVOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,MetI2,           & 
& MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,             & 
& MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,cplAhHpcVWp,cplAhXPcXP,            & 
& cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiChiAhL,               & 
& cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,cplcChiChiVZL,   & 
& cplcChiChiVZR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,             & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,           & 
& cplcFeFvcVWpR,cplcFeNvcXPL,cplcFeNvcXPR,cplChiFeetIL,cplChiFeetIR,cplChiFeXOL,         & 
& cplChiFeXOR,cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,cpletIetIhh,             & 
& cpletIXOVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,        & 
& cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVZVZ,cplhhXOXO,         & 
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,BO4lSLL(gt1,gt2,gt3,gt4),BO4lSRR(gt1,gt2,gt3,gt4),BO4lSRL(gt1,gt2,gt3,gt4)  & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,               & 
& MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,            & 
& MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,cplAhHpcVWp,cplAhXPcXP,       & 
& cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiChiAhL,               & 
& cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,cplcChiChiVZL,   & 
& cplcChiChiVZR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,             & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,           & 
...
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,PSO4lSLL(gt1,gt2,gt3,gt4),PSO4lSRR(gt1,gt2,gt3,gt4),PSO4lSRL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,               & 
& MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,            & 
& MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,cplAhHpcVWp,cplAhXPcXP,       & 
& cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiChiAhL,               & 
& cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,cplcChiChiVZL,   & 
...
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,PVO4lSLL(gt1,gt2,gt3,gt4),PVO4lSRR(gt1,gt2,gt3,gt4),PVO4lSRL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,               & 
& MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,            & 
& MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,cplAhHpcVWp,cplAhXPcXP,       & 
& cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiChiAhL,               & 
& cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,cplcChiChiVZL,   & 
...
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,TSO4lSLL(gt1,gt2,gt3,gt4),TSO4lSRR(gt1,gt2,gt3,gt4),TSO4lSRL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,               & 
& MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,            & 
& MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,cplAhHpcVWp,cplAhXPcXP,       & 
& cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiChiAhL,               & 
& cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,cplcChiChiVZL,   & 
...
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,TVO4lSLL(gt1,gt2,gt3,gt4),TVO4lSRR(gt1,gt2,gt3,gt4),TVO4lSRL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4Lcross(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MChi,MChi2,MetI,            & 
& MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,            & 
& MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,cplAhHpcVWp,cplAhXPcXP,       & 
& cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiChiAhL,               & 
& cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,cplcChiChiVZL,   & 
...
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,BO4lSLLcross(gt1,gt2,gt3,gt4),BO4lSRRcross(gt1,gt2,gt3,gt4),BO4lSRLcross(gt1,gt2,gt3,gt4)& 
...
& MetI,MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,           & 
& MXO,MXO2,MXP,MXP2,cplAhAhhh,cplAhcHpVWp,cplAhetIXO,cplAhhhVZ,cplAhHpcVWp,              & 
& cplAhXPcXP,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiChiAhL,    & 
& cplcChiChiAhR,cplcChiChihhL,cplcChiChihhR,cplcChiChiVPL,cplcChiChiVPR,cplcChiChiVZL,   & 
& cplcChiChiVZR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,             & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,           & 
...
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,PSO4lSLLcross(gt1,gt2,gt3,gt4),PSO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,PVO4lSLLcross(gt1,gt2,gt3,gt4),PVO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,TSO4lSLLcross(gt1,gt2,gt3,gt4),TSO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplhhXPcXP,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNvFeXPL,cplNvFeXPR,        & 
& cplNvNvAhL,cplNvNvAhR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVP,          & 
& cplXPcXPVZ,TVO4lSLLcross(gt1,gt2,gt3,gt4),TVO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGamma2l(gt1,gt2,gt3,.False.,MAh,MAh2,MChi,MChi2,MetI,MetI2,             & 
& MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,             & 
& MXP,MXP2,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,cplcChiChiVPL,      & 
& cplcChiChiVPR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,             & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,           & 
& cplcFeFvcVWpR,cplcFeNvcXPL,cplcFeNvcXPR,cplChiFeetIL,cplChiFeetIR,cplChiFeXOL,         & 
& cplChiFeXOR,cplcHpVPVWp,cplcVWpVPVWp,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,    & 
& cplHpcHpVP,cplHpcVWpVP,cplNvFeXPL,cplNvFeXPR,cplXPcXPVP,OA2lSL(gt1,gt2),               & 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,1 
  gt3=i2 
Call CalculateH2l(gt1,gt2,gt3,.False.,MAh,MAh2,MChi,MChi2,MetI,MetI2,MFe,             & 
& MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,             & 
& MXP2,cplAhAhhh,cplAhhhVZ,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,    & 
& cplcChiChihhL,cplcChiChihhR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,           & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,             & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFeNvcXPL,cplcFeNvcXPR,cplChiFeetIL,cplChiFeetIR,       & 
& cplChiFeXOL,cplChiFeXOR,cpletIetIhh,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,     & 
& cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVZVZ,cplhhXOXO,         & 
& cplhhXPcXP,cplNvFeXPL,cplNvFeXPR,cplNvNvhhL,cplNvNvhhR,OH2lSL(gt1,gt2,gt3)             & 
& ,OH2lSR(gt1,gt2,gt3))
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateZ2l(gt1,gt2,gt3,.False.,MAh,MAh2,MChi,MChi2,MetI,MetI2,MFe,             & 
& MFe2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,             & 
& MXP2,cplAhhhVZ,cplcChicFeetIL,cplcChicFeetIR,cplcChicFeXOL,cplcChicFeXOR,              & 
& cplcChiChiVZL,cplcChiChiVZR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,           & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,             & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFeNvcXPL,cplcFeNvcXPR,cplChiFeetIL,cplChiFeetIR,       & 
& cplChiFeXOL,cplChiFeXOR,cplcHpVWpVZ,cplcVWpVWpVZ,cpletIXOVZ,cplFvFeHpL,cplFvFeHpR,     & 
& cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,        & 
& cplNvFeXPL,cplNvFeXPR,cplNvNvVZL,cplNvNvVZR,cplXPcXPVZ,OZ2lSL(gt1,gt2),OZ2lSR(gt1,gt2) & 
...
Call Gminus2(1,MAh,MAh2,MChi,MChi2,MetI,MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,             & 
& MHp,MHp2,MNv,MNv2,MXO,MXO2,MXP,MXP2,cplcFeFeAhL,cplcFeFeAhR,cplChiFeetIL,              & 
& cplChiFeetIR,cplChiFeXOL,cplChiFeXOR,cplcChiChiVPL,cplcChiChiVPR,cplcChicFeetIL,       & 
& cplcChicFeetIR,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,cplcFeFehhR,cplNvFeXPL,               & 
& cplNvFeXPR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,               & 
& cplcFeNvcXPL,cplcFeNvcXPR,cplXPcXPVP,cplcChicFeXOL,cplcChicFeXOR,ae)

Call Gminus2(2,MAh,MAh2,MChi,MChi2,MetI,MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,             & 
& MHp,MHp2,MNv,MNv2,MXO,MXO2,MXP,MXP2,cplcFeFeAhL,cplcFeFeAhR,cplChiFeetIL,              & 
& cplChiFeetIR,cplChiFeXOL,cplChiFeXOR,cplcChiChiVPL,cplcChiChiVPR,cplcChicFeetIL,       & 
& cplcChicFeetIR,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,cplcFeFehhR,cplNvFeXPL,               & 
& cplNvFeXPR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,               & 
& cplcFeNvcXPL,cplcFeNvcXPR,cplXPcXPVP,cplcChicFeXOL,cplcChicFeXOR,amu)

Call Gminus2(3,MAh,MAh2,MChi,MChi2,MetI,MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,             & 
& MHp,MHp2,MNv,MNv2,MXO,MXO2,MXP,MXP2,cplcFeFeAhL,cplcFeFeAhR,cplChiFeetIL,              & 
& cplChiFeetIR,cplChiFeXOL,cplChiFeXOR,cplcChiChiVPL,cplcChiChiVPR,cplcChicFeetIL,       & 
& cplcChicFeetIR,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,cplcFeFehhR,cplNvFeXPL,               & 
& cplNvFeXPR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,               & 
& cplcFeNvcXPL,cplcFeNvcXPR,cplXPcXPVP,cplcChicFeXOL,cplcChicFeXOR,atau)


! *****  Lepton EDM ***** 

Call LeptonEDM(1,MAh,MAh2,MChi,MChi2,MetI,MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,           & 
& MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplcFeFeAhL,cplcFeFeAhR,       & 
& cplChiFeetIL,cplChiFeetIR,cplChiFeXOL,cplChiFeXOR,cplcChiChiVPL,cplcChiChiVPR,         & 
& cplcChicFeetIL,cplcChicFeetIR,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,           & 
& cplcFeFehhL,cplcFeFehhR,cplNvFeXPL,cplNvFeXPR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,     & 
& cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplHpcHpVP,          & 
& cplcFeNvcXPL,cplcFeNvcXPR,cplcVWpVPVWp,cplXPcXPVP,cplcChicFeXOL,cplcChicFeXOR,EDMe)

Call LeptonEDM(2,MAh,MAh2,MChi,MChi2,MetI,MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,           & 
& MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplcFeFeAhL,cplcFeFeAhR,       & 
& cplChiFeetIL,cplChiFeetIR,cplChiFeXOL,cplChiFeXOR,cplcChiChiVPL,cplcChiChiVPR,         & 
& cplcChicFeetIL,cplcChicFeetIR,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,           & 
& cplcFeFehhL,cplcFeFehhR,cplNvFeXPL,cplNvFeXPR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,     & 
& cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplHpcHpVP,          & 
& cplcFeNvcXPL,cplcFeNvcXPR,cplcVWpVPVWp,cplXPcXPVP,cplcChicFeXOL,cplcChicFeXOR,EDMmu)

Call LeptonEDM(3,MAh,MAh2,MChi,MChi2,MetI,MetI2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,           & 
& MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,cplcFeFeAhL,cplcFeFeAhR,       & 
& cplChiFeetIL,cplChiFeetIR,cplChiFeXOL,cplChiFeXOR,cplcChiChiVPL,cplcChiChiVPR,         & 
& cplcChicFeetIL,cplcChicFeetIR,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,           & 
& cplcFeFehhL,cplcFeFehhR,cplNvFeXPL,cplNvFeXPR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,     & 
& cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplHpcHpVP,          & 
& cplcFeNvcXPL,cplcFeNvcXPR,cplcVWpVPVWp,cplXPcXPVP,cplcChicFeXOL,cplcChicFeXOR,EDMtau)
...
Call DeltaRho(MAh,MAh2,MChi,MChi2,MetI,MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,              & 
& MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv,MNv2,MVWp,MVWp2,MVZ,MVZ2,MXO,MXO2,MXP,MXP2,             & 
& cplAhAhcVWpVWp,cplAhAhVZVZ,cplAhhhVZ,cplAhHpcVWp,cplcChiChiVZL,cplcChiChiVZR,          & 
...
End Program SPhenoradinertDTFDTSDM 
