...
Module Fu3Decays_radinertDTFDTSDM 
...
Subroutine FuThreeBodyDecay(n_in,MAh,MAh2,MChi,MChi2,MetI,MetI2,MFd,MFd2,             & 
...
& MDF,mu,mH2,mEt2,mu3,v,gThh,gTVWp,gTVZ,gFuFdNvChi,gFuFucFdFd,gFuFdcFeFv,gFuFucChiChi,   & 
& gFuFucFeFe,gFuFucFuFu,gFuFuNvNv,gFuFuFvFv,epsI,deltaM,CheckRealStates,gT,              & 
& gPartial,BR)
...
Real(dp),Intent(inout) :: gFuFdNvChi(3,3,3,2),gFuFucFdFd(3,3,3,3),gFuFdcFeFv(3,3,3,3),gFuFucChiChi(3,3,2,2),    & 
& gFuFucFeFe(3,3,3,3),gFuFucFuFu(3,3,3,3),gFuFuNvNv(3,3,3,3),gFuFuFvFv(3,3,3,3)

Real(dp),Intent(in) :: gThh,gTVWp,gTVZ

Real(dp) :: gFuFdNvChii(3,3,2),gFuFucFdFdi(3,3,3),gFuFdcFeFvi(3,3,3),gFuFucChiChii(3,2,2),        & 
& gFuFucFeFei(3,3,3),gFuFucFuFui(3,3,3),gFuFuNvNvi(3,3,3),gFuFuFvFvi(3,3,3)
...
Call CouplingsFor_Fu_decays_3B(MFu(i_run),i_run,MAh,MAh2,MChi,MChi2,MetI,             & 
...
& cplcChiChiVZR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,           & 
...
& cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplNvChicVWpL,cplNvChicVWpR,cplNvNvhhL,              & 
& cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,deltaM)
...
gFuFdNvChii = 0._dp 
Call FuToFdNvChi(i_run,MFd,MNv,MChi,MVWp,MFu,cplcFuFdVWpL,cplcFuFdVWpR,               & 
& cplNvChicVWpL,cplNvChicVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWptemp,               & 
& deltaM,epsI,check,gFuFdNvChii)

gFuFdNvChi(i_run,:,:,:) = gFuFdNvChii 
gT(i_run) = gT(i_run) + Sum(gFuFdNvChii) 
...
gFuFucChiChii = 0._dp 
Call FuToFucChiChi(i_run,MFu,MChi,MVZ,Mhh,cplcChiChihhL,cplcChiChihhR,cplcChiChiVZL,  & 
& cplcChiChiVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,IntegralSs,              & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
& gTVZtemp,gThhtemp,deltaM,epsI,check,gFuFucChiChii)

gFuFucChiChi(i_run,:,:,:) = gFuFucChiChii 
gT(i_run) = gT(i_run) + Sum(gFuFucChiChii) 
...
gFuFuNvNvi = 0._dp 
Call FuToFuNvNv(i_run,MFu,MNv,MVZ,Mhh,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,            & 
& cplcFuFuVZR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,IntegralSs,IntegralSSss,       & 
& IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,gTVZtemp,               & 
& gThhtemp,deltaM,epsI,check,gFuFuNvNvi)

gFuFuNvNv(i_run,:,:,:) = gFuFuNvNvi 
gT(i_run) = gT(i_run) + Sum(gFuFuNvNvi) 
 
gFuFuFvFvi = 0._dp 
Call FuToFuFvFv(i_run,MFu,MFv,MVZ,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,      & 
& IntegralVs,IntegralVVss,NVs,NVVss,gTVZtemp,deltaM,epsI,check,gFuFuFvFvi)
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,2
gPartial(i1,n_length)= gFuFdNvChi(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,2
    Do gt3=1,2
gPartial(i1,n_length)= gFuFucChiChi(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=gt2,3
gPartial(i1,n_length)= gFuFuNvNv(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Subroutine FuToFdNvChi(iIN,MFd,MNv,MChi,MVWp,MFu,cplcFuFdVWpL,cplcFuFdVWpR,           & 
& cplNvChicVWpL,cplNvChicVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWp,deltaM,            & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MNv(3),MChi(2),MVWp,MFu(3)

Complex(dp),Intent(in) :: cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplNvChicVWpL(3,2),cplNvChicVWpR(3,2)
...
If(Abs(MFu(iIN)).gt.(Abs(MChi(gt3))+Abs(MNv(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  VWp 
!-------------- 
Isum = Isum + 1 
...
coup(4) = Conjg(cplNvChicVWpL(gt2,gt3)) 
coup(3) = Conjg(cplNvChicVWpR(gt2,gt3))
...
Write(*,*) "Fu->Fd Nv Chi Propagator: VWp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
...
Subroutine FuToFucChiChi(iIN,MFu,MChi,MVZ,Mhh,cplcChiChihhL,cplcChiChihhR,            & 
& cplcChiChiVZL,cplcChiChiVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,           & 
...
Real(dp),Intent(in) :: MFu(3),MChi(2),MVZ,Mhh
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cChi Chi Propagator: VZ" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cChi Chi Propagator: hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cChi Chi Propagator: VZ,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FuToFuNvNv(iIN,MFu,MNv,MVZ,Mhh,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,        & 
& cplcFuFuVZR,cplNvNvhhL,cplNvNvhhR,cplNvNvVZL,cplNvNvVZR,IntegralSs,IntegralSSss,       & 
& IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,gTVZ,gThh,              & 
& deltaM,epsI,check,g,WriteContributions)
...
Real(dp),Intent(in) :: MFu(3),MNv(3),MVZ,Mhh

Complex(dp),Intent(in) :: cplcFuFuhhL(3,3),cplcFuFuhhR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplNvNvhhL(3,3),  & 
...
If(Abs(MFu(iIN)).gt.(Abs(MNv(gt3))+Abs(MNv(gt2))+Abs(MFu(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Nv Nv Propagator: VZ" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Nv Nv Propagator: hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu Nv Nv Propagator: VZ,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MFu(iIN))**3*g
End Subroutine FuToFuNvNv 
 
 
Subroutine FuToFuFvFv(iIN,MFu,MFv,MVZ,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,             & 
...
Complex(dp),Intent(in) :: cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3)
...
End Module Fu3Decays_radinertDTFDTSDM 
