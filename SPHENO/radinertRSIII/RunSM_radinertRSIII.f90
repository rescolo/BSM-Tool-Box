...
Module RunSM_radinertRSIII 
 
Use Control 
Use LoopFunctions 
Use Mathematics 
Use StandardModel 
Use RGEs_radinertRSIII 
...
scale_save = Qin 
Call ParametersToG107(g1input,g2input,g3input,lam1input,lam2input,lam4input,          & 
& lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,mEt2input,       & 
& vinput,g1D)

Call GToParameters107(g1D,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,Yn,              & 
& MTF,mH2,mEt2,v)
...
End Module RunSM_radinertRSIII 
