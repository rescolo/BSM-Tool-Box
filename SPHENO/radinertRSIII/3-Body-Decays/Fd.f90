...
Module Fd3Decays_radinertRSIII 
...
& gFdFdcFuFu,gFdFdcFtcFtc,gFdFdFvFv,gFdFuFvFe,gFdFuFtcFt0,epsI,deltaM,CheckRealStates,   & 
& gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gFdFdcFdFd(3,3,3,3),gFdFdcFeFe(3,3,3,3),gFdFdcFuFu(3,3,3,3),gFdFdcFtcFtc(3,3,3,3),    & 
& gFdFdFvFv(3,3,3,3),gFdFuFvFe(3,3,3,3),gFdFuFtcFt0(3,3,3,3)

Real(dp),Intent(in) :: gThh,gTVWp,gTVZ

Real(dp) :: gFdFdcFdFdi(3,3,3),gFdFdcFeFei(3,3,3),gFdFdcFuFui(3,3,3),gFdFdcFtcFtci(3,3,3),        & 
& gFdFdFvFvi(3,3,3),gFdFuFvFei(3,3,3),gFdFuFtcFt0i(3,3,3)
...
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFdVWpL,          & 
& cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplFt0FtcVWpL,            & 
& cplFt0FtcVWpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,deltaM)
...
Real(dp),Intent(in) :: MFd(3),MFtc(3),MVZ
...
If(Abs(MFd(iIN)).gt.(Abs(MFtc(gt3))+Abs(MFtc(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
Real(dp),Intent(in) :: MFu(3),MFtc(3),MFt0(3),MVWp,MFd(3)
...
If(Abs(MFd(iIN)).gt.(Abs(MFt0(gt3))+Abs(MFtc(gt2))+Abs(MFu(gt1)))) Then 
!-------------- 
!  conj[VWp] 
!-------------- 
Isum = Isum + 1 
...
End Module Fd3Decays_radinertRSIII 
