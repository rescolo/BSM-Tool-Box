...
Module Fu3Decays_radinertRSIII 
...
& gFuFdcFeFv,gFuFucFeFe,gFuFucFuFu,gFuFucFtcFtc,gFuFuFvFv,epsI,deltaM,CheckRealStates,   & 
& gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gFuFdcFtcFt0(3,3,3,3),gFuFucFdFd(3,3,3,3),gFuFdcFeFv(3,3,3,3),gFuFucFeFe(3,3,3,3),    & 
& gFuFucFuFu(3,3,3,3),gFuFucFtcFtc(3,3,3,3),gFuFuFvFv(3,3,3,3)

Real(dp),Intent(in) :: gThh,gTVWp,gTVZ

Real(dp) :: gFuFdcFtcFt0i(3,3,3),gFuFucFdFdi(3,3,3),gFuFdcFeFvi(3,3,3),gFuFucFeFei(3,3,3),        & 
& gFuFucFuFui(3,3,3),gFuFucFtcFtci(3,3,3),gFuFuFvFvi(3,3,3)
...
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFtcFt0cVWpL,       & 
& cplcFtcFt0cVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,     & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,deltaM)
...
Real(dp),Intent(in) :: MFd(3),MFtc(3),MFt0(3),MVWp,MFu(3)
...
If(Abs(MFu(iIN)).gt.(Abs(MFt0(gt3))+Abs(MFtc(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  VWp 
!-------------- 
Isum = Isum + 1 
...
Real(dp),Intent(in) :: MFu(3),MFtc(3),MVZ
...
If(Abs(MFu(iIN)).gt.(Abs(MFtc(gt3))+Abs(MFtc(gt2))+Abs(MFu(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
End Module Fu3Decays_radinertRSIII 
