...
Module LowEnergy_radinertRSIII 
Use Control 
...
Subroutine Gminus2(Ifermion,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFe,            & 
& MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplcFtcFeetIL,cplcFtcFeetIR,cplcFeFtcetIL,cplcFeFtcetIR,cplFt0FeetpL,cplFt0FeetpR,     & 
& cpletpcetpVP,cplcFtcFeetRL,cplcFtcFeetRR,cplcFeFtcetRL,cplcFeFtcetRR,cplFvFeHpL,       & 
& cplFvFeHpR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFt0cetpL,             & 
& cplcFeFt0cetpR,cplcFtcFtcVPL,cplcFtcFtcVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,a_mu)

Real(dp),Intent(in)  :: MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFe(3),MFe2(3),MFt0(3),MFt02(3),            & 
& MFtc(3),MFtc2(3),MFv(3),MFv2(3),Mhh,Mhh2,MHp,MHp2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplcFtcFeetIL(3,3),cplcFtcFeetIR(3,3),              & 
& cplcFeFtcetIL(3,3),cplcFeFtcetIR(3,3),cplFt0FeetpL(3,3),cplFt0FeetpR(3,3),             & 
& cpletpcetpVP,cplcFtcFeetRL(3,3),cplcFtcFeetRR(3,3),cplcFeFtcetRL(3,3),cplcFeFtcetRR(3,3),& 
& cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),cplcFeFeVPL(3,3),    & 
& cplcFeFeVPR(3,3),cplcFeFt0cetpL(3,3),cplcFeFt0cetpR(3,3),cplcFtcFtcVPL(3,3),           & 
& cplcFtcFtcVPR(3,3),cplcFeFvcHpL(3,3),cplcFeFvcHpR(3,3),cplHpcHpVP
...
chargefactor = 1 
  Do i2= 1,3
   i3 = i2
  If ((MetI2.gt.mz2).Or.(MFtc2(i2).gt.mz2).Or.(MFtc2(i3).gt.mz2)) Then
coup1L = cplcFeFtcetIL(gt1,i2)
coup1R = cplcFeFtcetIR(gt1,i2)
coup2L = cplcFtcFeetIL(i3,gt2)
coup2R = cplcFtcFeetIR(i3,gt2)
ratio = MetI2/MFtc2(i2)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/MFtc(i2)& 
      & + 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F2(ratio)/MFtc2(i2) 
End if 
...
chargefactor = 1 
  Do i2= 1,3
   i3 = i2
  If ((MetR2.gt.mz2).Or.(MFtc2(i2).gt.mz2).Or.(MFtc2(i3).gt.mz2)) Then
coup1L = cplcFeFtcetRL(gt1,i2)
coup1R = cplcFeFtcetRR(gt1,i2)
coup2L = cplcFtcFeetRL(i3,gt2)
coup2R = cplcFtcFeetRR(i3,gt2)
ratio = MetR2/MFtc2(i2)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/MFtc(i2)& 
      & + 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F2(ratio)/MFtc2(i2) 
End if 
...
chargefactor = 1 
Do i1= 1,3
  If ((MFt02(i1).gt.mz2).Or.(Metp2.gt.mz2).Or.(Metp2.gt.mz2)) Then
coup1L = cplcFeFt0cetpL(gt1,i1)
coup1R = cplcFeFt0cetpR(gt1,i1)
coup2L = cplFt0FeetpL(i1,gt2)
coup2R = cplFt0FeetpR(i1,gt2)
ratio = Metp2/MFt02(i1)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - 2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/MFt0(i1)& 
      & - 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F1(ratio)/MFt02(i1) 
End if 
...
Subroutine LeptonEDM(Ifermion,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,              & 
& MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,              & 
& MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFtcFeetIL,cplcFtcFeetIR,cplcFeFtcetIL,cplcFeFtcetIR,  & 
& cplFt0FeetpL,cplFt0FeetpR,cpletpcetpVP,cplcFtcFeetRL,cplcFtcFeetRR,cplcFeFtcetRL,      & 
& cplcFeFtcetRR,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplcFeFehhL,               & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFt0cetpL,            & 
& cplcFeFt0cetpR,cplcFtcFtcVPL,cplcFtcFtcVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,    & 
& cplcFeFvcVWpR,cplHpcHpVP,cplcVWpVPVWp,EDM)

Implicit None
Real(dp),Intent(in)  :: MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFe(3),MFe2(3),MFt0(3),MFt02(3),            & 
& MFtc(3),MFtc2(3),MFv(3),MFv2(3),Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplcFtcFeetIL(3,3),cplcFtcFeetIR(3,3),              & 
& cplcFeFtcetIL(3,3),cplcFeFtcetIR(3,3),cplFt0FeetpL(3,3),cplFt0FeetpR(3,3),             & 
& cpletpcetpVP,cplcFtcFeetRL(3,3),cplcFtcFeetRR(3,3),cplcFeFtcetRL(3,3),cplcFeFtcetRR(3,3),& 
& cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplFvFeVWpL(3,3),cplFvFeVWpR(3,3),cplcFeFehhL(3,3),    & 
& cplcFeFehhR(3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),  & 
& cplcFeFt0cetpL(3,3),cplcFeFt0cetpR(3,3),cplcFtcFtcVPL(3,3),cplcFtcFtcVPR(3,3),         & 
...
& cplcFuFuVZL,cplcFuFuVZR,cplcgAgWpcVWp,cplcgWCgAcVWp,cplcgWCgWCVZ,cplcgWCgZcVWp,        & 
...
& cpletpetRcVWp,cpletRetRcVWpVWp,cpletRetRVZVZ,cplFvFvVZL,cplFvFvVZR,cplhhcVWpVWp,       & 
...
& cplcFtcFtcVZL(3,3),cplcFtcFtcVZR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
...
& cpletRetRcVWpVWp,cpletRetRVZVZ,cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplhhcVWpVWp,           & 
& cplhhhhcVWpVWp,cplhhhhVZVZ,cplhhHpcVWp,cplhhVZVZ,cplHpcHpcVWpVWp,cplHpcHpVZ,           & 
...
End Function C1C2 
End Module LowEnergy_radinertRSIII 
