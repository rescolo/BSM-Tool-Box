...
Module Model_Data_radinertRSIII 
...
Complex(dp) :: lam1IN,lam2IN,lam4IN,lam3IN,YuIN(3,3),YdIN(3,3),YeIN(3,3),YnIN(3,3),MTFIN(3,3),       & 
& mH2IN,mEt2IN

Real(dp) :: g1MZ,g2MZ,g3MZ,lam5MZ

Complex(dp) :: lam1MZ,lam2MZ,lam4MZ,lam3MZ,YuMZ(3,3),YdMZ(3,3),YeMZ(3,3),YnMZ(3,3),MTFMZ(3,3),       & 
& mH2MZ,mEt2MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,lam5GUT

Complex(dp) :: lam1GUT,lam2GUT,lam4GUT,lam3GUT,YuGUT(3,3),YdGUT(3,3),YeGUT(3,3),YnGUT(3,3),          & 
& MTFGUT(3,3),mH2GUT,mEt2GUT
...
Real(dp) :: gPFu(3,198),gTFu(3),BRFu(3,198),gPFe(3,261),gTFe(3),BRFe(3,261),gPFd(3,198),          & 
...
End Module Model_Data_radinertRSIII