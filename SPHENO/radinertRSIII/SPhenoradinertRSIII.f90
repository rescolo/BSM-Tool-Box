...
Program SPhenoradinertRSIII 
 
Use Control
Use InputOutput_radinertRSIII
Use LoopFunctions
Use RunSM_radinertRSIII
Use LowEnergy_radinertRSIII
Use FlavorKit_LFV_radinertRSIII
Use FlavorKit_QFV_radinertRSIII
Use FlavorKit_Observables_radinertRSIII
Use Mathematics
Use Model_Data_radinertRSIII
Use Tadpoles_radinertRSIII 
 Use HiggsCS_radinertRSIII
Use TreeLevelMasses_radinertRSIII
Use LoopMasses_radinertRSIII
 
Use BranchingRatios_radinertRSIII
...
& lam5,Yu,Yd,Ye,Yn,MTF,mH2,mEt2,kont)
...
& MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,              & 
& ZW,ZZ,v,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,Yn,MTF,mH2,mEt2,gPFu,               & 
& gTFu,BRFu,gPFe,gTFe,BRFe,gPFd,gTFd,BRFd,gPFv,gTFv,BRFv,gPVZ,gTVZ,BRVZ,gPVWp,           & 
& gTVWp,BRVWp,gPhh,gThh,BRhh,gPetR,gTetR,BRetR,gPetI,gTetI,BRetI,gPetp,gTetp,            & 
& BRetp,gPFt0,gTFt0,BRFt0,gPFtc,gTFtc,BRFtc)

End If 
 
 If (CalculateLowEnergy) then 
Call CalculateLowEnergyConstraints(g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,              & 
& Yd,Ye,Yn,MTF,mH2,mEt2,v,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,     & 
...
& lam4,lam3,lam5,Yu,Yd,Ye,Yn,MTF,mH2,mEt2,kont)
...
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,               & 
& MTFinput,mH2input,mEt2input,vinput,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,       & 
...
& Yninput(3,3),MTFinput(3,3),mH2input,mEt2input
...
Complex(dp) :: lam1,lam2,lam4,lam3,Yu(3,3),Yd(3,3),Ye(3,3),Yn(3,3),MTF(3,3),mH2,mEt2
...
& cplcFtcFeetRR(3,3),cplcFtcFt0cVWpL(3,3),cplcFtcFt0cVWpR(3,3),cplcFtcFtcVPL(3,3),       & 
& cplcFtcFtcVPR(3,3),cplcFtcFtcVZL(3,3),cplcFtcFtcVZR(3,3),cplcFtcFvcetpL(3,3),          & 
& cplcFtcFvcetpR(3,3),cplcFuFdHpL(3,3),cplcFuFdHpR(3,3),cplcFuFdVWpL(3,3),               & 
...
& cplcFuFuVZR(3,3),cplcgAgWpcVWp,cplcgWCgAcVWp,cplcgWCgWCVZ,cplcgWCgZcVWp,               & 
& cplcgWpgWpVZ,cplcgZgWpcVWp,cplcHpVPVWp,cplcHpVWpVZ,cplcVWpcVWpVWpVWp1,cplcVWpcVWpVWpVWp2,& 
...
& cpletIetIcVWpVWp,cpletIetIhh,cpletIetIVZVZ,cpletIetpcHp,cpletIetpcVWp,cpletIetRVZ,     & 
& cpletIHpcetp,cpletpcetpcVWpVWp,cpletpcetpVP,cpletpcetpVZ,cpletpcetpVZVZ,               & 
& cpletpetRcHp,cpletpetRcVWp,cpletphhcetp,cpletRcetpVWp,cpletRetRcVWpVWp,cpletRetRhh,    & 
& cpletRetRVZVZ,cpletRHpcetp,cplFt0FeetpL(3,3),cplFt0FeetpR(3,3),cplFt0FtcVWpL(3,3),     & 
& cplFt0FtcVWpR(3,3),cplFt0FvetIL(3,3),cplFt0FvetIR(3,3),cplFt0FvetRL(3,3),              & 
& cplFt0FvetRR(3,3),cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplFvFeVWpL(3,3),cplFvFeVWpR(3,3),   & 
& cplFvFtcetpL(3,3),cplFvFtcetpR(3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplhhcHpVWp,       & 
...
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,Yn,MTF,mH2,mEt2,           & 
& v,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
& Yu,ZUL,ZUR,Yn,UV,cplAhAhhh,cplAhetIetR,cpletIetIhh,cpletIetpcHp,cpletIHpcetp,          & 
...
& Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhcHpVWp,cplAhetIetR,               & 
...
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,            & 
& Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,cplcFdFdAhL,cplcFdFdAhR,               & 
...
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,            & 
& Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhcHpVWp,cplAhHpcVWp,cplcFdFdAhL,             & 
...
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhcHpVWp,cplAhetIetR,cplAhhhVZ,         & 
...
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,Yn,MTF,mH2,mEt2,           & 
& v,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
& MetR,MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,             & 
& MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhcHpVWp,cplAhetIetR,cplAhhhVZ,cplAhHpcVWp,cplcFeFeAhL,    & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZR,cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFeFtcetIL,cplcFeFtcetIR,cplcFeFtcetRL,   & 
& cplcFeFtcetRR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFtcFeetIL,     & 
& cplcFtcFeetIR,cplcFtcFeetRL,cplcFtcFeetRR,cplcFtcFtcVPL,cplcFtcFtcVPR,cplcFtcFtcVZL,   & 
& cplcFtcFtcVZR,cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,cpletIetIhh,           & 
& cpletIetRVZ,cpletpcetpVP,cpletpcetpVZ,cpletphhcetp,cpletRetRhh,cplFt0FeetpL,           & 
& cplFt0FeetpR,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,      & 
...
& Metp2,MetR,MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,            & 
& MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhcHpVWp,cplAhetIetR,cplAhhhVZ,cplAhHpcVWp,           & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFeFtcetIL,cplcFeFtcetIR,     & 
& cplcFeFtcetRL,cplcFeFtcetRR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,     & 
& cplcFtcFeetIL,cplcFtcFeetIR,cplcFtcFeetRL,cplcFtcFeetRR,cplcFtcFtcVPL,cplcFtcFtcVPR,   & 
& cplcFtcFtcVZL,cplcFtcFtcVZR,cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,         & 
& cpletIetIhh,cpletIetRVZ,cpletpcetpVP,cpletpcetpVZ,cpletphhcetp,cpletRetRhh,            & 
& cplFt0FeetpL,cplFt0FeetpR,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,               & 
...
& Metp,Metp2,MetR,MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,            & 
& MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhcHpVWp,cplAhetIetR,cplAhhhVZ,cplAhHpcVWp,      & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFeFtcetIL,cplcFeFtcetIR,     & 
& cplcFeFtcetRL,cplcFeFtcetRR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,     & 
& cplcFtcFeetIL,cplcFtcFeetIR,cplcFtcFeetRL,cplcFtcFeetRR,cplcFtcFtcVPL,cplcFtcFtcVPR,   & 
...
& MetR,MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,             & 
& MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,            & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFeFtcetIL,       & 
& cplcFeFtcetIR,cplcFeFtcetRL,cplcFeFtcetRR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,     & 
& cplcFeFvcVWpR,cplcFtcFeetIL,cplcFtcFeetIR,cplcFtcFeetRL,cplcFtcFeetRR,cplcFtcFtcVPL,   & 
& cplcFtcFtcVPR,cplcHpVPVWp,cplcVWpVPVWp,cpletpcetpVP,cplFt0FeetpL,cplFt0FeetpR,         & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplHpcHpVP,cplHpcVWpVP,OA2lSL(gt1,gt2)   & 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,1 
  gt3=i2 
Call CalculateH2l(gt1,gt2,gt3,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,            & 
& MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,            & 
& MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,          & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFt0cetpL,cplcFeFt0cetpR,         & 
& cplcFeFtcetIL,cplcFeFtcetIR,cplcFeFtcetRL,cplcFeFtcetRR,cplcFeFvcHpL,cplcFeFvcHpR,     & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFtcFeetIL,cplcFtcFeetIR,cplcFtcFeetRL,cplcFtcFeetRR,   & 
& cpletIetIhh,cpletphhcetp,cpletRetRhh,cplFt0FeetpL,cplFt0FeetpR,cplFvFeHpL,             & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateZ2l(gt1,gt2,gt3,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,            & 
& MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,            & 
& MVZ,MVZ2,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,        & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFeFtcetIL,       & 
& cplcFeFtcetIR,cplcFeFtcetRL,cplcFeFtcetRR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,     & 
& cplcFeFvcVWpR,cplcFtcFeetIL,cplcFtcFeetIR,cplcFtcFeetRL,cplcFtcFeetRR,cplcFtcFtcVZL,   & 
& cplcFtcFtcVZR,cplcHpVWpVZ,cplcVWpVWpVZ,cpletIetRVZ,cpletpcetpVZ,cplFt0FeetpL,          & 
& cplFt0FeetpR,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,      & 
...
Call Gminus2(1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFe,MFe2,MFt0,               & 
& MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,cplcFeFeAhL,cplcFeFeAhR,cplcFtcFeetIL,     & 
& cplcFtcFeetIR,cplcFeFtcetIL,cplcFeFtcetIR,cplFt0FeetpL,cplFt0FeetpR,cpletpcetpVP,      & 
& cplcFtcFeetRL,cplcFtcFeetRR,cplcFeFtcetRL,cplcFeFtcetRR,cplFvFeHpL,cplFvFeHpR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFt0cetpL,cplcFeFt0cetpR,         & 
& cplcFtcFtcVPL,cplcFtcFtcVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,ae)

Call Gminus2(2,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFe,MFe2,MFt0,               & 
& MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,cplcFeFeAhL,cplcFeFeAhR,cplcFtcFeetIL,     & 
& cplcFtcFeetIR,cplcFeFtcetIL,cplcFeFtcetIR,cplFt0FeetpL,cplFt0FeetpR,cpletpcetpVP,      & 
& cplcFtcFeetRL,cplcFtcFeetRR,cplcFeFtcetRL,cplcFeFtcetRR,cplFvFeHpL,cplFvFeHpR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFt0cetpL,cplcFeFt0cetpR,         & 
& cplcFtcFtcVPL,cplcFtcFtcVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,amu)

Call Gminus2(3,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFe,MFe2,MFt0,               & 
& MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,cplcFeFeAhL,cplcFeFeAhR,cplcFtcFeetIL,     & 
& cplcFtcFeetIR,cplcFeFtcetIL,cplcFeFtcetIR,cplFt0FeetpL,cplFt0FeetpR,cpletpcetpVP,      & 
& cplcFtcFeetRL,cplcFtcFeetRR,cplcFeFtcetRL,cplcFeFtcetRR,cplFvFeHpL,cplFvFeHpR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFt0cetpL,cplcFeFt0cetpR,         & 
& cplcFtcFtcVPL,cplcFtcFtcVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,atau)


! *****  Lepton EDM ***** 

Call LeptonEDM(1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFe,MFe2,MFt0,             & 
& MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,           & 
& cplcFeFeAhR,cplcFtcFeetIL,cplcFtcFeetIR,cplcFeFtcetIL,cplcFeFtcetIR,cplFt0FeetpL,      & 
& cplFt0FeetpR,cpletpcetpVP,cplcFtcFeetRL,cplcFtcFeetRR,cplcFeFtcetRL,cplcFeFtcetRR,     & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,     & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFtcFtcVPL,       & 
& cplcFtcFtcVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplHpcHpVP,        & 
& cplcVWpVPVWp,EDMe)

Call LeptonEDM(2,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFe,MFe2,MFt0,             & 
& MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,           & 
& cplcFeFeAhR,cplcFtcFeetIL,cplcFtcFeetIR,cplcFeFtcetIL,cplcFeFtcetIR,cplFt0FeetpL,      & 
& cplFt0FeetpR,cpletpcetpVP,cplcFtcFeetRL,cplcFtcFeetRR,cplcFeFtcetRL,cplcFeFtcetRR,     & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,     & 
...
Call LeptonEDM(3,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFe,MFe2,MFt0,             & 
& MFt02,MFtc,MFtc2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,           & 
& cplcFeFeAhR,cplcFtcFeetIL,cplcFtcFeetIR,cplcFeFtcetIL,cplcFeFtcetIR,cplFt0FeetpL,      & 
& cplFt0FeetpR,cpletpcetpVP,cplcFtcFeetRL,cplcFtcFeetRR,cplcFeFtcetRL,cplcFeFtcetRR,     & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,     & 
...
& MFt0,MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,              & 
& MVZ2,cplAhAhcVWpVWp,cplAhAhVZVZ,cplAhhhVZ,cplAhHpcVWp,cplcFdFdVZL,cplcFdFdVZR,         & 
& cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcVWpL,cplcFeFvcVWpR,       & 
& cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVZL,               & 
& cplcFuFuVZR,cplcgAgWpcVWp,cplcgWCgAcVWp,cplcgWCgWCVZ,cplcgWCgZcVWp,cplcgWpgWpVZ,       & 
...
End Program SPhenoradinertRSIII 
