...
Subroutine GToParameters106(g,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,             & 
& Yn,MTF,mH2,mEt2)
...
Complex(dp),Intent(out) :: lam1,lam2,lam4,lam3,Yu(3,3),Yd(3,3),Ye(3,3),Yn(3,3),MTF(3,3),mH2,mEt2
...
SumI = (i2-1) + (i1-1)*3
SumI = SumI*2 
Yn(i1,i2) = Cmplx( g(SumI+67), g(SumI+68), dp) 
End Do 
 End Do 
...
SumI = (i2-1) + (i1-1)*3
SumI = SumI*2 
MTF(i1,i2) = Cmplx( g(SumI+85), g(SumI+86), dp) 
End Do 
 End Do 
...
Subroutine ParametersToG106(g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,               & 
& Yn,MTF,mH2,mEt2,g)
...
SumI = (i2-1) + (i1-1)*3
SumI = SumI*2 
g(SumI+67) = Real(Yn(i1,i2), dp) 
g(SumI+68) = Aimag(Yn(i1,i2)) 
End Do 
End Do 
...
SumI = (i2-1) + (i1-1)*3
SumI = SumI*2 
g(SumI+85) = Real(MTF(i1,i2), dp) 
g(SumI+86) = Aimag(MTF(i1,i2)) 
End Do 
End Do 
...
& ,Yn(3,3),betaYn1(3,3),betaYn2(3,3),DYn(3,3),adjYn(3,3),MTF(3,3),betaMTF1(3,3)          & 
& ,betaMTF2(3,3),DMTF(3,3),adjMTF(3,3),mH2,betamH21,betamH22,DmH2,mEt2,betamEt21,        & 
& betamEt22,DmEt2
Iname = Iname +1 
...
Call GToParameters106(gy,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,Yn,               & 
& MTF,mH2,mEt2)
...
Call ParametersToG106(Dg1,Dg2,Dg3,Dlam1,Dlam2,Dlam4,Dlam3,Dlam5,DYu,DYd,              & 
& DYe,DYn,DMTF,DmH2,DmEt2,f)

Iname = Iname - 1 
 
End Subroutine rge106  

Subroutine GToParameters107(g,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,             & 
& Yn,MTF,mH2,mEt2,v)
...
Subroutine ParametersToG107(g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,               & 
& Yn,MTF,mH2,mEt2,v,g)
...
Call GToParameters107(gy,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,Yn,               & 
& MTF,mH2,mEt2,v)
...
Call ParametersToG107(Dg1,Dg2,Dg3,Dlam1,Dlam2,Dlam4,Dlam3,Dlam5,DYu,DYd,              & 
& DYe,DYn,DMTF,DmH2,DmEt2,Dv,f)

Iname = Iname - 1 
 
End Subroutine rge107  

End Module RGEs_radinertRSIII 
