...
Module LoopMasses_radinertRSIII 
...
Use StandardModel 
Use Tadpoles_radinertRSIII 
 Use TreeLevelMasses_radinertRSIII 
 
Real(dp), Private :: MFv_1L(3), MFv2_1L(3)  
Complex(dp), Private :: UV_1L(3,3)  
Real(dp), Private :: MFt0_1L(3), MFt02_1L(3)  
Real(dp), Private :: MFtc_1L(3), MFtc2_1L(3)  
...
& MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,v,g1,g2,g3,lam1,               & 
& lam2,lam4,lam3,lam5,Yu,Yd,Ye,Yn,MTF,mH2,mEt2,kont)

Implicit None 
Real(dp),Intent(inout) :: g1,g2,g3,lam5

Complex(dp),Intent(inout) :: lam1,lam2,lam4,lam3,Yu(3,3),Yd(3,3),Ye(3,3),Yn(3,3),MTF(3,3),mH2,mEt2
...
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFt0cetpL(3,3),cplcFeFt0cetpR(3,3),             & 
...
& cplcFtcFvcetpL(3,3),cplcFtcFvcetpR(3,3),cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),             & 
& cplcFuFuhhL(3,3),cplcFuFuhhR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcgAgWpcVWp,     & 
...
& cplcUFeFt0cetpL(3,3),cplcUFeFt0cetpR(3,3),cplcUFeFtcetIL(3,3),cplcUFeFtcetIR(3,3),     & 
& cplcUFeFtcetRL(3,3),cplcUFeFtcetRR(3,3),cplcUFeFvcHpL(3,3),cplcUFeFvcHpR(3,3),         & 
& cplcUFeFvcVWpL(3,3),cplcUFeFvcVWpR(3,3),cplcUFtcFeetIL(3,3),cplcUFtcFeetIR(3,3),       & 
& cplcUFtcFeetRL(3,3),cplcUFtcFeetRR(3,3),cplcUFtcFt0cVWpL(3,3),cplcUFtcFt0cVWpR(3,3),   & 
& cplcUFtcFtcVPL(3,3),cplcUFtcFtcVPR(3,3),cplcUFtcFtcVZL(3,3),cplcUFtcFtcVZR(3,3),       & 
& cplcUFtcFvcetpL(3,3),cplcUFtcFvcetpR(3,3),cplcUFuFdHpL(3,3),cplcUFuFdHpR(3,3),         & 
...
& cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,cpletIcetpVWp,cpletIetIcVWpVWp,cpletIetIetIetI,        & 
& cpletIetIetpcetp,cpletIetIetRetR,cpletIetIhh,cpletIetIhhhh,cpletIetIHpcHp,             & 
& cpletIetIVZVZ,cpletIetpcHp,cpletIetpcVWp,cpletIetRVZ,cpletIHpcetp,cpletpcetpcVWpVWp,   & 
& cpletpcetpVP,cpletpcetpVPVP,cpletpcetpVZ,cpletpcetpVZVZ,cpletpetpcetpcetp,             & 
& cpletpetRcHp,cpletpetRcVWp,cpletpetRetRcetp,cpletphhcetp,cpletphhhhcetp,               & 
& cpletpHpcetpcHp,cpletRcetpVWp,cpletRetRcVWpVWp,cpletRetRetRetR,cpletRetRhh,            & 
& cpletRetRhhhh,cpletRetRHpcHp,cpletRetRVZVZ,cpletRHpcetp,cplFt0FvetIL(3,3)

Complex(dp) :: cplFt0FvetIR(3,3),cplFt0FvetRL(3,3),cplFt0FvetRR(3,3),cplFt0UFvetIL(3,3),              & 
& cplFt0UFvetIR(3,3),cplFt0UFvetRL(3,3),cplFt0UFvetRR(3,3),cplFvFvVZL(3,3),              & 
...
& cplHpHpcHpcHp,cplUFt0FeetpL(3,3),cplUFt0FeetpR(3,3),cplUFt0FtcVWpL(3,3),               & 
& cplUFt0FtcVWpR(3,3),cplUFt0FvetIL(3,3),cplUFt0FvetIR(3,3),cplUFt0FvetRL(3,3),          & 
& cplUFt0FvetRR(3,3),cplUFvFeHpL(3,3),cplUFvFeHpR(3,3),cplUFvFeVWpL(3,3),cplUFvFeVWpR(3,3),& 
& cplUFvFtcetpL(3,3),cplUFvFtcetpR(3,3),cplUFvFvVZL(3,3),cplUFvFvVZR(3,3)
...
& MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,v,g1,g2,g3,lam1,lam2,lam4,lam3,           & 
& lam5,Yu,Yd,Ye,Yn,MTF,mH2,mEt2,GenerationMixing,kont)
...
& cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,             & 
& cplcgWpgWpVZ,cplcgWCgWCVZ,cplHpcVWpVZ,cplcVWpVWpVZ,cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,    & 
& cplcVWpVWpVZVZ3,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFdFucVWpL,cplcFdFucVWpR,           & 
...
& MFd2,MFe,MFe2,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MHp,MHp2,MVWp,MVWp2,               & 
...
Call CouplingsForLoopMasses(Yn,Ye,ZER,g2,ZEL,g1,UV,TW,Yd,ZDL,ZDR,g3,Yu,               & 
& ZUL,ZUR,lam4,lam5,v,lam1,lam3,lam2,cplFt0UFvetIL,cplFt0UFvetIR,cplUFvFtcetpL,          & 
& cplUFvFtcetpR,cplFt0UFvetRL,cplFt0UFvetRR,cplUFvFeHpL,cplUFvFeHpR,cplUFvFeVWpL,        & 
& cplUFvFeVWpR,cplUFvFvVZL,cplUFvFvVZR,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,           & 
...
& cplcUFuFuVZR,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFtcetIL,cplcUFeFtcetIR,cplcUFeFtcetRL,   & 
& cplcUFeFtcetRR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,       & 
& cplcUFeFeVZR,cplcUFeFt0cetpL,cplcUFeFt0cetpR,cplcUFeFvcHpL,cplcUFeFvcHpR,              & 
& cplcUFeFvcVWpL,cplcUFeFvcVWpR,cplUFt0FvetIL,cplUFt0FvetIR,cplUFt0FeetpL,               & 
& cplUFt0FeetpR,cplUFt0FvetRL,cplUFt0FvetRR,cplUFt0FtcVWpL,cplUFt0FtcVWpR,               & 
& cplcUFtcFeetIL,cplcUFtcFeetIR,cplcUFtcFeetRL,cplcUFtcFeetRR,cplcUFtcFt0cVWpL,          & 
& cplcUFtcFt0cVWpR,cplcUFtcFtcVPL,cplcUFtcFtcVPR,cplcUFtcFtcVZL,cplcUFtcFtcVZR,          & 
& cplcUFtcFvcetpL,cplcUFtcFvcetpR,cplAhcHpVWp,cpletIetpcHp,cpletpetRcHp,cplcFdFucHpL,    & 
...
& cpletphhcetp,cpletpcetpVP,cpletpcetpVZ,cpletRHpcetp,cpletRcetpVWp,cplcFeFt0cetpL,      & 
& cplcFeFt0cetpR,cplcFtcFvcetpL,cplcFtcFvcetpR,cplAhAhetpcetp,cpletIetIetpcetp,          & 
...
& cplhhhhhhhh,cplhhhhcVWpVWp,cplhhhhVZVZ,cpletIetpcVWp,cpletIetRVZ,cplcFtcFeetIL,        & 
& cplcFtcFeetIR,cplFt0FvetIL,cplFt0FvetIR,cpletIetIetIetI,cpletIetIetRetR,               & 
& cpletIetIcVWpVWp,cpletIetIVZVZ,cpletpetRcVWp,cplcFtcFeetRL,cplcFtcFeetRR,              & 
& cplFt0FvetRL,cplFt0FvetRR,cpletRetRetRetR,cpletRetRcVWpVWp,cpletRetRVZVZ,              & 
...
& cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFvcVWpL,             & 
...
mH2Tree  = mH2
Call SolveTadpoleEquations(g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,Yn,             & 
& MTF,mH2,mEt2,v,Tad1Loop)

mH21L = mH2
Call OneLoopFv(MFt0,MFt02,MetI,MetI2,MFtc,MFtc2,Metp,Metp2,MetR,MetR2,MHp,            & 
& MHp2,MFe,MFe2,MVWp,MVWp2,MVZ,MVZ2,MFv,MFv2,cplFt0UFvetIL,cplFt0UFvetIR,cplUFvFtcetpL,  & 
& cplUFvFtcetpR,cplFt0UFvetRL,cplFt0UFvetRR,cplUFvFeHpL,cplUFvFeHpR,cplUFvFeVWpL,        & 
& cplUFvFeVWpR,cplUFvFvVZL,cplUFvFvVZR,0.1_dp*delta_mass,MFv_1L,MFv2_1L,UV_1L,kont)

Call OneLoopFt0(MTF,MFv,MFv2,MetI,MetI2,MFe,MFe2,Metp,Metp2,MetR,MetR2,               & 
& MVWp,MVWp2,MFtc,MFtc2,cplUFt0FvetIL,cplUFt0FvetIR,cplUFt0FeetpL,cplUFt0FeetpR,         & 
& cplUFt0FvetRL,cplUFt0FvetRR,cplUFt0FtcVWpL,cplUFt0FtcVWpR,0.1_dp*delta_mass,           & 
& MFt0_1L,MFt02_1L,kont)

Call OneLoopFtc(MTF,MFe,MFe2,MetI,MetI2,MetR,MetR2,MVWp,MVWp2,MFt0,MFt02,             & 
& MFtc,MFtc2,MVZ,MVZ2,Metp,Metp2,MFv,MFv2,cplcUFtcFeetIL,cplcUFtcFeetIR,cplcUFtcFeetRL,  & 
& cplcUFtcFeetRR,cplcUFtcFt0cVWpL,cplcUFtcFt0cVWpR,cplcUFtcFtcVPL,cplcUFtcFtcVPR,        & 
& cplcUFtcFtcVZL,cplcUFtcFtcVZR,cplcUFtcFvcetpL,cplcUFtcFvcetpR,0.1_dp*delta_mass,       & 
& MFtc_1L,MFtc2_1L,kont)
...
& Metp2,MVZ,MVZ2,MetR,MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,MAh,MAh2,            & 
& cpletIHpcetp,cpletIcetpVWp,cpletphhcetp,cpletpcetpVP,cpletpcetpVZ,cpletRHpcetp,        & 
& cpletRcetpVWp,cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFtcFvcetpL,cplcFtcFvcetpR,             & 
& cplAhAhetpcetp,cpletIetIetpcetp,cpletpetpcetpcetp,cpletpetRetRcetp,cpletphhhhcetp,     & 
...
& MetI2,MHp,MHp2,Metp,Metp2,MVWp,MVWp2,MVZ,MVZ2,MFtc,MFtc2,MFe,MFe2,MFv,MFv2,            & 
& MFt0,MFt02,cplAhetIetR,cpletIetIhh,cpletIetpcHp,cpletIetpcVWp,cpletIetRVZ,             & 
& cplcFtcFeetIL,cplcFtcFeetIR,cplFt0FvetIL,cplFt0FvetIR,cplAhAhetIetI,cpletIetIetIetI,   & 
& cpletIetIetpcetp,cpletIetIetRetR,cpletIetIhhhh,cpletIetIHpcHp,cpletIetIcVWpVWp,        & 
& cpletIetIVZVZ,0.1_dp*delta_mass,MetI_1L,MetI2_1L,kont)

Call OneLoopetR(mEt2,lam4,lam3,lam5,v,MetI,MetI2,MAh,MAh2,MVZ,MVZ2,MHp,               & 
& MHp2,Metp,Metp2,MVWp,MVWp2,Mhh,Mhh2,MetR,MetR2,MFtc,MFtc2,MFe,MFe2,MFv,MFv2,           & 
& MFt0,MFt02,cplAhetIetR,cpletIetRVZ,cpletpetRcHp,cpletpetRcVWp,cpletRetRhh,             & 
& cplcFtcFeetRL,cplcFtcFeetRR,cplFt0FvetRL,cplFt0FvetRR,cplAhAhetRetR,cpletIetIetRetR,   & 
& cpletpetRetRcetp,cpletRetRetRetR,cpletRetRhhhh,cpletRetRHpcHp,cpletRetRcVWpVWp,        & 
& cpletRetRVZVZ,0.1_dp*delta_mass,MetR_1L,MetR2_1L,kont)
...
& MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,               & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,kont)
...
Subroutine OneLoopFv(MFt0,MFt02,MetI,MetI2,MFtc,MFtc2,Metp,Metp2,MetR,MetR2,          & 
& MHp,MHp2,MFe,MFe2,MVWp,MVWp2,MVZ,MVZ2,MFv,MFv2,cplFt0UFvetIL,cplFt0UFvetIR,            & 
& cplUFvFtcetpL,cplUFvFtcetpR,cplFt0UFvetRL,cplFt0UFvetRR,cplUFvFeHpL,cplUFvFeHpR,       & 
& cplUFvFeVWpL,cplUFvFeVWpR,cplUFvFvVZL,cplUFvFvVZR,delta,MFv_1L,MFv2_1L,Vv_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: MFt0(3),MFt02(3),MetI,MetI2,MFtc(3),MFtc2(3),Metp,Metp2,MetR,MetR2,MHp,               & 
& MHp2,MFe(3),MFe2(3),MVWp,MVWp2,MVZ,MVZ2,MFv(3),MFv2(3)

Complex(dp), Intent(in) :: cplFt0UFvetIL(3,3),cplFt0UFvetIR(3,3),cplUFvFtcetpL(3,3),cplUFvFtcetpR(3,3),          & 
& cplFt0UFvetRL(3,3),cplFt0UFvetRR(3,3),cplUFvFeHpL(3,3),cplUFvFeHpR(3,3),               & 
& cplUFvFeVWpL(3,3),cplUFvFeVWpR(3,3),cplUFvFvVZL(3,3),cplUFvFvVZR(3,3)
...
sigS=0._dp 
p2 = MFv2(il)
Call Sigma1LoopFv(p2,MFt0,MFt02,MetI,MetI2,MFtc,MFtc2,Metp,Metp2,MetR,MetR2,          & 
& MHp,MHp2,MFe,MFe2,MVWp,MVWp2,MVZ,MVZ2,MFv,MFv2,cplFt0UFvetIL,cplFt0UFvetIR,            & 
& cplUFvFtcetpL,cplUFvFtcetpR,cplFt0UFvetRL,cplFt0UFvetRR,cplUFvFeHpL,cplUFvFeHpR,       & 
& cplUFvFeVWpL,cplUFvFeVWpR,cplUFvFvVZL,cplUFvFvVZR,sigL,sigR,sigS)
...
Subroutine Sigma1LoopFv(p2,MFt0,MFt02,MetI,MetI2,MFtc,MFtc2,Metp,Metp2,               & 
& MetR,MetR2,MHp,MHp2,MFe,MFe2,MVWp,MVWp2,MVZ,MVZ2,MFv,MFv2,cplFt0UFvetIL,               & 
& cplFt0UFvetIR,cplUFvFtcetpL,cplUFvFtcetpR,cplFt0UFvetRL,cplFt0UFvetRR,cplUFvFeHpL,     & 
& cplUFvFeHpR,cplUFvFeVWpL,cplUFvFeVWpR,cplUFvFvVZL,cplUFvFvVZR,sigL,sigR,sigS)
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -1._dp*B1(p2,MFt02(i1),MetI2) 
B0m2 = 2._dp*MFt0(i1)*B0(p2,MFt02(i1),MetI2) 
coupL1 = cplFt0UFvetIL(i1,gO1)
coupR1 = cplFt0UFvetIR(i1,gO1)
coupL2 =  Conjg(cplFt0UFvetIL(i1,gO2))
coupR2 =  Conjg(cplFt0UFvetIR(i1,gO2))
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -1._dp*B1(p2,MFtc2(i1),Metp2) 
B0m2 = 2._dp*MFtc(i1)*B0(p2,MFtc2(i1),Metp2) 
coupL1 = cplUFvFtcetpL(gO1,i1)
coupR1 = cplUFvFtcetpR(gO1,i1)
coupL2 =  Conjg(cplUFvFtcetpL(gO2,i1))
coupR2 =  Conjg(cplUFvFtcetpR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -1._dp*B1(p2,MFt02(i1),MetR2) 
B0m2 = 2._dp*MFt0(i1)*B0(p2,MFt02(i1),MetR2) 
coupL1 = cplFt0UFvetRL(i1,gO1)
coupR1 = cplFt0UFvetRR(i1,gO1)
coupL2 =  Conjg(cplFt0UFvetRL(i1,gO2))
coupR2 =  Conjg(cplFt0UFvetRR(i1,gO2))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Subroutine OneLoopFe(Ye,v,MFe,MFe2,MAh,MAh2,MFtc,MFtc2,MetI,MetI2,MetR,               & 
& MetR2,Mhh,Mhh2,MVZ,MVZ2,Metp,Metp2,MFt0,MFt02,MHp,MHp2,MFv,MFv2,MVWp,MVWp2,            & 
& cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFtcetIL,cplcUFeFtcetIR,cplcUFeFtcetRL,cplcUFeFtcetRR, & 
& cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,         & 
& cplcUFeFt0cetpL,cplcUFeFt0cetpR,cplcUFeFvcHpL,cplcUFeFvcHpR,cplcUFeFvcVWpL,            & 
& cplcUFeFvcVWpR,delta,MFe_1L,MFe2_1L,ZEL_1L,ZER_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: MFe(3),MFe2(3),MAh,MAh2,MFtc(3),MFtc2(3),MetI,MetI2,MetR,MetR2,Mhh,Mhh2,              & 
& MVZ,MVZ2,Metp,Metp2,MFt0(3),MFt02(3),MHp,MHp2,MFv(3),MFv2(3),MVWp,MVWp2

Real(dp), Intent(in) :: v

Complex(dp), Intent(in) :: Ye(3,3)

Complex(dp), Intent(in) :: cplcUFeFeAhL(3,3),cplcUFeFeAhR(3,3),cplcUFeFtcetIL(3,3),cplcUFeFtcetIR(3,3),          & 
& cplcUFeFtcetRL(3,3),cplcUFeFtcetRR(3,3),cplcUFeFehhL(3,3),cplcUFeFehhR(3,3),           & 
& cplcUFeFeVPL(3,3),cplcUFeFeVPR(3,3),cplcUFeFeVZL(3,3),cplcUFeFeVZR(3,3),               & 
& cplcUFeFt0cetpL(3,3),cplcUFeFt0cetpR(3,3),cplcUFeFvcHpL(3,3),cplcUFeFvcHpR(3,3),       & 
...
sigS=0._dp 
p2 = MFe2(il) 
Call Sigma1LoopFe(p2,MFe,MFe2,MAh,MAh2,MFtc,MFtc2,MetI,MetI2,MetR,MetR2,              & 
& Mhh,Mhh2,MVZ,MVZ2,Metp,Metp2,MFt0,MFt02,MHp,MHp2,MFv,MFv2,MVWp,MVWp2,cplcUFeFeAhL,     & 
& cplcUFeFeAhR,cplcUFeFtcetIL,cplcUFeFtcetIR,cplcUFeFtcetRL,cplcUFeFtcetRR,              & 
& cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,         & 
& cplcUFeFt0cetpL,cplcUFeFt0cetpR,cplcUFeFvcHpL,cplcUFeFvcHpR,cplcUFeFvcVWpL,            & 
...
Subroutine Sigma1LoopFe(p2,MFe,MFe2,MAh,MAh2,MFtc,MFtc2,MetI,MetI2,MetR,              & 
& MetR2,Mhh,Mhh2,MVZ,MVZ2,Metp,Metp2,MFt0,MFt02,MHp,MHp2,MFv,MFv2,MVWp,MVWp2,            & 
& cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFtcetIL,cplcUFeFtcetIR,cplcUFeFtcetRL,cplcUFeFtcetRR, & 
& cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,         & 
& cplcUFeFt0cetpL,cplcUFeFt0cetpR,cplcUFeFvcHpL,cplcUFeFvcHpR,cplcUFeFvcVWpL,            & 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -0.5_dp*Real(B1(p2,MFtc2(i1),MetI2),dp) 
B0m2 = MFtc(i1)*Real(B0(p2,MFtc2(i1),MetI2),dp) 
coupL1 = cplcUFeFtcetIL(gO1,i1)
coupR1 = cplcUFeFtcetIR(gO1,i1)
coupL2 =  Conjg(cplcUFeFtcetIL(gO2,i1))
coupR2 =  Conjg(cplcUFeFtcetIR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -0.5_dp*Real(B1(p2,MFtc2(i1),MetR2),dp) 
B0m2 = MFtc(i1)*Real(B0(p2,MFtc2(i1),MetR2),dp) 
coupL1 = cplcUFeFtcetRL(gO1,i1)
coupR1 = cplcUFeFtcetRR(gO1,i1)
coupL2 =  Conjg(cplcUFeFtcetRL(gO2,i1))
coupR2 =  Conjg(cplcUFeFtcetRR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -0.5_dp*Real(B1(p2,MFt02(i2),Metp2),dp) 
B0m2 = MFt0(i2)*Real(B0(p2,MFt02(i2),Metp2),dp) 
coupL1 = cplcUFeFt0cetpL(gO1,i2)
coupR1 = cplcUFeFt0cetpR(gO1,i2)
coupL2 =  Conjg(cplcUFeFt0cetpL(gO2,i2))
coupR2 =  Conjg(cplcUFeFt0cetpR(gO2,i2))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Subroutine OneLoopFt0(MTF,MFv,MFv2,MetI,MetI2,MFe,MFe2,Metp,Metp2,MetR,               & 
& MetR2,MVWp,MVWp2,MFtc,MFtc2,cplUFt0FvetIL,cplUFt0FvetIR,cplUFt0FeetpL,cplUFt0FeetpR,   & 
& cplUFt0FvetRL,cplUFt0FvetRR,cplUFt0FtcVWpL,cplUFt0FtcVWpR,delta,MFt0_1L,               & 
& MFt02_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: MFv(3),MFv2(3),MetI,MetI2,MFe(3),MFe2(3),Metp,Metp2,MetR,MetR2,MVWp,MVWp2,            & 
& MFtc(3),MFtc2(3)

Complex(dp), Intent(in) :: MTF(3,3)

Complex(dp), Intent(in) :: cplUFt0FvetIL(3,3),cplUFt0FvetIR(3,3),cplUFt0FeetpL(3,3),cplUFt0FeetpR(3,3),          & 
& cplUFt0FvetRL(3,3),cplUFt0FvetRR(3,3),cplUFt0FtcVWpL(3,3),cplUFt0FtcVWpR(3,3)
...
Real(dp), Intent(in) :: delta 
Real(dp) :: mi2(3), test_m2(3),p2 
Real(dp), Intent(out) :: MFt0_1L(3),MFt02_1L(3) 
Complex(dp) ::  None1_1L(3,3) 
Real(dp) :: MFt0_t(3),MFt02_t(3) 
Complex(dp) ::  None1_t(3,3) 
Complex(dp) ::  phaseM, E3(3), sigL(3,3), sigR(3,3), sigS(3,3) 
Real(dp) :: None1a(3,3), test(2), eig(3) 

Iname = Iname + 1 
NameOfUnit(Iname) = 'OneLoopMFt0'
 
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+MTF(1,1)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+MTF(1,2)/2._dp
mat1a(1,2) = mat1a(1,2)+MTF(2,1)/2._dp
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+MTF(1,3)/2._dp
mat1a(1,3) = mat1a(1,3)+MTF(3,1)/2._dp
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+MTF(1,2)/2._dp
mat1a(2,1) = mat1a(2,1)+MTF(2,1)/2._dp
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+MTF(2,2)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+MTF(2,3)/2._dp
mat1a(2,3) = mat1a(2,3)+MTF(3,2)/2._dp
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+MTF(1,3)/2._dp
mat1a(3,1) = mat1a(3,1)+MTF(3,1)/2._dp
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+MTF(2,3)/2._dp
mat1a(3,2) = mat1a(3,2)+MTF(3,2)/2._dp
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+MTF(3,3)
...
sigS=0._dp 
p2 = MFt02(il)
Call Sigma1LoopFt0(p2,MFv,MFv2,MetI,MetI2,MFe,MFe2,Metp,Metp2,MetR,MetR2,             & 
& MVWp,MVWp2,MFtc,MFtc2,cplUFt0FvetIL,cplUFt0FvetIR,cplUFt0FeetpL,cplUFt0FeetpR,         & 
& cplUFt0FvetRL,cplUFt0FvetRR,cplUFt0FtcVWpL,cplUFt0FtcVWpR,sigL,sigR,sigS)
...
If (ForceRealMatrices) mat1 = Real(mat1,dp) 
If (Maxval(Abs(Aimag(mat1))).Eq.0._dp) Then 
Call EigenSystem(Real(mat1,dp),Eig,None1a,ierr,test) 
 
   Do i1=1,3
   If (Eig(i1).Lt.0._dp) Then 
    MFt0_t(i1) = - Eig(i1) 
    None1_1L(i1,:) = (0._dp,1._dp)*None1a(i1,:) 
   Else 
    MFt0_t(i1) = Eig(i1) 
    None1_1L(i1,:) = None1a(i1,:)
    End If 
   End Do 
 
Do i1=1,2
  Do i2=i1+1,3
    If (Abs(MFt0_t(i1)).Gt.Abs(MFt0_t(i2))) Then 
      Eig(1) = MFt0_t(i1) 
      MFt0_t(i1) = MFt0_t(i2) 
      MFt0_t(i2) = Eig(1) 
      E3 = None1_1L(i1,:) 
      None1_1L(i1,:) = None1_1L(i2,:) 
      None1_1L(i2,:) = E3
    End If 
   End Do 
End Do 
 
MFt0_1L(iL) = MFt0_t(iL) 
MFt02_1L(iL) = MFt0_t(iL)**2 
Else 
 
mat2 = Matmul( Transpose(Conjg( mat1) ), mat1 ) 
Call Eigensystem(mat2, Eig, None1_1L, ierr, test) 
mat2 = Matmul( Conjg(None1_1L), Matmul( mat1, Transpose( Conjg(None1_1L)))) 
Do i1=1,3
If (Abs(mat2(i1,i1)).gt.0._dp) Then 
  phaseM = Sqrt( mat2(i1,i1) / Abs(mat2(i1,i1))) 
  None1_1L(i1,:)= phaseM * None1_1L(i1,:) 
End if 
  If (Eig(i1).Le.0._dp) Then 
    If (ErrorLevel.Ge.0) Then 
      Write(10,*) 'Warning from Subroutine '//NameOfUnit(Iname) 
...
If (p2.Ne.0._dp) Then 
  test(1) = Abs(MFt02_1L(il)-p2)/p2
Else 
  test(2) = Abs(MFt02_1L(il))
End If 
If (Abs(MFt02_1L(il)).lt.1.0E-30_dp) Exit p2_loop 
If (test(1).lt.0.1_dp*delta) Exit p2_loop 
If(i_count.gt.30) then 
  Write(ErrCan,*) "Possible numerical problem in "//NameOfUnit(Iname) 
  Exit p2_loop 
...
Iname = Iname -1 
End Subroutine OneLoopFt0
 
 
Subroutine Sigma1LoopFt0(p2,MFv,MFv2,MetI,MetI2,MFe,MFe2,Metp,Metp2,MetR,             & 
& MetR2,MVWp,MVWp2,MFtc,MFtc2,cplUFt0FvetIL,cplUFt0FvetIR,cplUFt0FeetpL,cplUFt0FeetpR,   & 
& cplUFt0FvetRL,cplUFt0FvetRR,cplUFt0FtcVWpL,cplUFt0FtcVWpR,sigL,sigR,sigS)
...
coupL1 = cplUFt0FvetIL(gO1,i1)
coupR1 = cplUFt0FvetIR(gO1,i1)
coupL2 =  Conjg(cplUFt0FvetIL(gO2,i1))
coupR2 =  Conjg(cplUFt0FvetIR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
coupL1 = cplUFt0FeetpL(gO1,i1)
coupR1 = cplUFt0FeetpR(gO1,i1)
coupL2 =  Conjg(cplUFt0FeetpL(gO2,i1))
coupR2 =  Conjg(cplUFt0FeetpR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
coupL1 = cplUFt0FvetRL(gO1,i1)
coupR1 = cplUFt0FvetRR(gO1,i1)
coupL2 =  Conjg(cplUFt0FvetRL(gO2,i1))
coupR2 =  Conjg(cplUFt0FvetRR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -2._dp*(B1(p2,MFtc2(i2),MVWp2) + 0.5_dp*rMS) 
B0m2 = -8._dp*MFtc(i2)*(B0(p2,MFtc2(i2),MVWp2) - 0.5_dp*rMS) 
coupL1 = cplUFt0FtcVWpL(gO1,i2)
coupR1 = cplUFt0FtcVWpR(gO1,i2)
coupL2 =  Conjg(cplUFt0FtcVWpL(gO2,i2))
coupR2 =  Conjg(cplUFt0FtcVWpR(gO2,i2))
SumS(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupL1*coupL2*B1m2 
sumL(gO1,gO2) = coupR1*coupR2*B1m2 
   End Do 
...
End Subroutine Sigma1LoopFt0 
 
Subroutine OneLoopFtc(MTF,MFe,MFe2,MetI,MetI2,MetR,MetR2,MVWp,MVWp2,MFt0,             & 
& MFt02,MFtc,MFtc2,MVZ,MVZ2,Metp,Metp2,MFv,MFv2,cplcUFtcFeetIL,cplcUFtcFeetIR,           & 
& cplcUFtcFeetRL,cplcUFtcFeetRR,cplcUFtcFt0cVWpL,cplcUFtcFt0cVWpR,cplcUFtcFtcVPL,        & 
& cplcUFtcFtcVPR,cplcUFtcFtcVZL,cplcUFtcFtcVZR,cplcUFtcFvcetpL,cplcUFtcFvcetpR,          & 
& delta,MFtc_1L,MFtc2_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: MFe(3),MFe2(3),MetI,MetI2,MetR,MetR2,MVWp,MVWp2,MFt0(3),MFt02(3),MFtc(3),             & 
& MFtc2(3),MVZ,MVZ2,Metp,Metp2,MFv(3),MFv2(3)

Complex(dp), Intent(in) :: MTF(3,3)

Complex(dp), Intent(in) :: cplcUFtcFeetIL(3,3),cplcUFtcFeetIR(3,3),cplcUFtcFeetRL(3,3),cplcUFtcFeetRR(3,3),      & 
& cplcUFtcFt0cVWpL(3,3),cplcUFtcFt0cVWpR(3,3),cplcUFtcFtcVPL(3,3),cplcUFtcFtcVPR(3,3),   & 
& cplcUFtcFtcVZL(3,3),cplcUFtcFtcVZR(3,3),cplcUFtcFvcetpL(3,3),cplcUFtcFvcetpR(3,3)
...
Real(dp), Intent(in) :: delta 
Real(dp) :: mi2(3), test_m2(3), p2 
Real(dp), Intent(out) :: MFtc_1L(3),MFtc2_1L(3) 
 Complex(dp) :: None1_1L(3,3), None2_1L(3,3) 
 
 Real(dp) :: MFtc_t(3),MFtc2_t(3) 
 Complex(dp) :: None1_t(3,3), None2_t(3,3), sigL(3,3), sigR(3,3), sigS(3,3) 
 
 Complex(dp) :: mat(3,3)=0._dp, mat2(3,3)=0._dp, phaseM 

Complex(dp) :: None12(3,3), None22(3,3) 
 
 Real(dp) :: None11(3,3), None21(3,3), test(2) 
 
 Iname = Iname + 1 
NameOfUnit(Iname) = 'OneLoopMFtc'
...
sigS=0._dp 
p2 = MFtc2(il) 
Call Sigma1LoopFtc(p2,MFe,MFe2,MetI,MetI2,MetR,MetR2,MVWp,MVWp2,MFt0,MFt02,           & 
& MFtc,MFtc2,MVZ,MVZ2,Metp,Metp2,MFv,MFv2,cplcUFtcFeetIL,cplcUFtcFeetIR,cplcUFtcFeetRL,  & 
& cplcUFtcFeetRR,cplcUFtcFt0cVWpL,cplcUFtcFt0cVWpR,cplcUFtcFtcVPL,cplcUFtcFtcVPR,        & 
& cplcUFtcFtcVZL,cplcUFtcFtcVZR,cplcUFtcFvcetpL,cplcUFtcFvcetpR,sigL,sigR,sigS)
...
If (ForceRealMatrices) mat2 = Real(mat2,dp) 
If (Maxval(Abs(Aimag(mat2))).Eq.0._dp) Then 
Call EigenSystem(Real(mat2,dp),MFtc2_t,None21,ierr,test) 
None22 = None21 
Else 
Call EigenSystem(mat2,MFtc2_t,None22,ierr,test) 
 End If 
...
MFtc2_1L(il) = MFtc2_t(il) 
MFtc_1L(il) = Sqrt(MFtc2_1L(il)) 
 
If (p2.Ne.0._dp) Then 
  test(1) = Abs(MFtc2_1L(il)-p2)/p2
Else 
  test(2) = Abs(MFtc2_1L(il))
End If 
If (Abs(MFtc2_1L(il)).lt.1.0E-30_dp) Exit p2_loop 
If (test(1).lt.0.1_dp*delta) Exit p2_loop 
If(i_count.gt.30) then 
  Write(ErrCan,*) "Possible numerical problem in "//NameOfUnit(Iname) 
  Exit p2_loop 
...
If (ForceRealMatrices) mat2 = Real(mat2,dp) 
If (Maxval(Abs(Aimag(mat2))).Eq.0._dp) Then 
Call EigenSystem(Real(mat2,dp),MFtc2_t,None11,ierr,test) 
 
 
None12 = None11 
Else 
Call EigenSystem(mat2,MFtc2_t,None12,ierr,test) 
...
mat2 = Matmul(Matmul( Conjg(None12),mat1),Transpose( Conjg(None22))) 
Do i1=1,3
If (Abs(mat2(i1,i1)).gt.0._dp) Then 
phaseM = mat2(i1,i1) / Abs(mat2(i1,i1)) 
None22(i1,:) = phaseM *None22(i1,:) 
 End if 
End Do 
...
Iname = Iname -1 
End Subroutine OneLoopFtc
 
 
Subroutine Sigma1LoopFtc(p2,MFe,MFe2,MetI,MetI2,MetR,MetR2,MVWp,MVWp2,MFt0,           & 
& MFt02,MFtc,MFtc2,MVZ,MVZ2,Metp,Metp2,MFv,MFv2,cplcUFtcFeetIL,cplcUFtcFeetIR,           & 
& cplcUFtcFeetRL,cplcUFtcFeetRR,cplcUFtcFt0cVWpL,cplcUFtcFt0cVWpR,cplcUFtcFtcVPL,        & 
& cplcUFtcFtcVPR,cplcUFtcFtcVZL,cplcUFtcFtcVZR,cplcUFtcFvcetpL,cplcUFtcFvcetpR,          & 
& sigL,sigR,sigS)
...
coupL1 = cplcUFtcFeetIL(gO1,i1)
coupR1 = cplcUFtcFeetIR(gO1,i1)
coupL2 =  Conjg(cplcUFtcFeetIL(gO2,i1))
coupR2 =  Conjg(cplcUFtcFeetIR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -0.5_dp*Real(B1(p2,MFe2(i1),MetR2),dp) 
B0m2 = MFe(i1)*Real(B0(p2,MFe2(i1),MetR2),dp) 
coupL1 = cplcUFtcFeetRL(gO1,i1)
coupR1 = cplcUFtcFeetRR(gO1,i1)
coupL2 =  Conjg(cplcUFtcFeetRL(gO2,i1))
coupR2 =  Conjg(cplcUFtcFeetRR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = - Real(B1(p2,MFt02(i2),MVWp2)+ 0.5_dp*rMS,dp) 
B0m2 = -4._dp*MFt0(i2)*Real(B0(p2,MFt02(i2),MVWp2)-0.5_dp*rMS,dp) 
coupL1 = cplcUFtcFt0cVWpL(gO1,i2)
coupR1 = cplcUFtcFt0cVWpR(gO1,i2)
coupL2 =  Conjg(cplcUFtcFt0cVWpL(gO2,i2))
coupR2 =  Conjg(cplcUFtcFt0cVWpR(gO2,i2))
SumS(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupL1*coupL2*B1m2 
sumL(gO1,gO2) = coupR1*coupR2*B1m2 
   End Do 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = - Real(B1(p2,MFtc2(i2),0._dp)+ 0.5_dp*rMS,dp) 
B0m2 = -4._dp*MFtc(i2)*Real(B0(p2,MFtc2(i2),0._dp)-0.5_dp*rMS,dp) 
coupL1 = cplcUFtcFtcVPL(gO1,i2)
coupR1 = cplcUFtcFtcVPR(gO1,i2)
coupL2 =  Conjg(cplcUFtcFtcVPL(gO2,i2))
coupR2 =  Conjg(cplcUFtcFtcVPR(gO2,i2))
SumS(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupL1*coupL2*B1m2 
sumL(gO1,gO2) = coupR1*coupR2*B1m2 
   End Do 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = - Real(B1(p2,MFtc2(i2),MVZ2)+ 0.5_dp*rMS,dp) 
B0m2 = -4._dp*MFtc(i2)*Real(B0(p2,MFtc2(i2),MVZ2)-0.5_dp*rMS,dp) 
coupL1 = cplcUFtcFtcVZL(gO1,i2)
coupR1 = cplcUFtcFtcVZR(gO1,i2)
coupL2 =  Conjg(cplcUFtcFtcVZL(gO2,i2))
coupR2 =  Conjg(cplcUFtcFtcVZR(gO2,i2))
SumS(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupL1*coupL2*B1m2 
sumL(gO1,gO2) = coupR1*coupR2*B1m2 
   End Do 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -0.5_dp*Real(B1(p2,MFv2(i2),Metp2),dp) 
B0m2 = MFv(i2)*Real(B0(p2,MFv2(i2),Metp2),dp) 
coupL1 = cplcUFtcFvcetpL(gO1,i2)
coupR1 = cplcUFtcFvcetpR(gO1,i2)
coupL2 =  Conjg(cplcUFtcFvcetpL(gO2,i2))
coupR2 =  Conjg(cplcUFtcFvcetpR(gO2,i2))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
& Metp,Metp2,MVZ,MVZ2,MetR,MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,MAh,            & 
& MAh2,cpletIHpcetp,cpletIcetpVWp,cpletphhcetp,cpletpcetpVP,cpletpcetpVZ,cpletRHpcetp,   & 
& cpletRcetpVWp,cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFtcFvcetpL,cplcFtcFvcetpR,             & 
& cplAhAhetpcetp,cpletIetIetpcetp,cpletpetpcetpcetp,cpletpetRetRcetp,cpletphhhhcetp,     & 
& cpletpHpcetpcHp,cpletpcetpVPVP,cpletpcetpcVWpVWp,cpletpcetpVZVZ,delta,mass,            & 
& mass2,kont)

Real(dp), Intent(in) :: MHp,MHp2,MetI,MetI2,MVWp,MVWp2,Mhh,Mhh2,Metp,Metp2,MVZ,MVZ2,MetR,MetR2,               & 
& MFe(3),MFe2(3),MFt0(3),MFt02(3),MFtc(3),MFtc2(3),MFv(3),MFv2(3),MAh,MAh2
...
& cpletRcetpVWp,cplcFeFt0cetpL(3,3),cplcFeFt0cetpR(3,3),cplcFtcFvcetpL(3,3),             & 
& cplcFtcFvcetpR(3,3),cplAhAhetpcetp,cpletIetIetpcetp,cpletpetpcetpcetp,cpletpetRetRcetp,& 
...
& MVZ2,MetR,MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,MAh,MAh2,cpletIHpcetp,         & 
& cpletIcetpVWp,cpletphhcetp,cpletpcetpVP,cpletpcetpVZ,cpletRHpcetp,cpletRcetpVWp,       & 
& cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFtcFvcetpL,cplcFtcFvcetpR,cplAhAhetpcetp,            & 
& cpletIetIetpcetp,cpletpetpcetpcetp,cpletpetRetRcetp,cpletphhhhcetp,cpletpHpcetpcHp,    & 
& cpletpcetpVPVP,cpletpcetpcVWpVWp,cpletpcetpVZVZ,kont,PiSf)
...
& MVZ,MVZ2,MetR,MetR2,MFe,MFe2,MFt0,MFt02,MFtc,MFtc2,MFv,MFv2,MAh,MAh2,cpletIHpcetp,     & 
& cpletIcetpVWp,cpletphhcetp,cpletpcetpVP,cpletpcetpVZ,cpletRHpcetp,cpletRcetpVWp,       & 
& cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFtcFvcetpL,cplcFtcFvcetpR,cplAhAhetpcetp,            & 
& cpletIetIetpcetp,cpletpetpcetpcetp,cpletpetRetRcetp,cpletphhhhcetp,cpletpHpcetpcHp,    & 
& cpletpcetpVPVP,cpletpcetpcVWpVWp,cpletpcetpVZVZ,kont,res)
...
sumI = 0._dp 
    ...
    Do i1 = 1, 3
       Do i2 = 1, 3
 G0m2 = Gloop(p2,MFe2(i1),MFt02(i2)) 
B0m2 = -2._dp*MFe(i1)*MFt0(i2)*B0(p2,MFe2(i1),MFt02(i2)) 
coupL1 = cplcFeFt0cetpL(i1,i2)
coupR1 = cplcFeFt0cetpR(i1,i2)
coupL2 =  Conjg(cplcFeFt0cetpL(i1,i2))
coupR2 =  Conjg(cplcFeFt0cetpR(i1,i2))
    SumI = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
res = res +1._dp* SumI  
      End Do 
...
sumI = 0._dp 
    ...
    Do i1 = 1, 3
       Do i2 = 1, 3
 G0m2 = Gloop(p2,MFtc2(i1),MFv2(i2)) 
B0m2 = -2._dp*MFtc(i1)*MFv(i2)*B0(p2,MFtc2(i1),MFv2(i2)) 
coupL1 = cplcFtcFvcetpL(i1,i2)
coupR1 = cplcFtcFvcetpR(i1,i2)
coupL2 =  Conjg(cplcFtcFvcetpL(i1,i2))
coupR2 =  Conjg(cplcFtcFvcetpR(i1,i2))
    SumI = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
res = res +1._dp* SumI  
      End Do 
...
& MetI,MetI2,MHp,MHp2,Metp,Metp2,MVWp,MVWp2,MVZ,MVZ2,MFtc,MFtc2,MFe,MFe2,MFv,            & 
& MFv2,MFt0,MFt02,cplAhetIetR,cpletIetIhh,cpletIetpcHp,cpletIetpcVWp,cpletIetRVZ,        & 
& cplcFtcFeetIL,cplcFtcFeetIR,cplFt0FvetIL,cplFt0FvetIR,cplAhAhetIetI,cpletIetIetIetI,   & 
& cpletIetIetpcetp,cpletIetIetRetR,cpletIetIhhhh,cpletIetIHpcHp,cpletIetIcVWpVWp,        & 
& cpletIetIVZVZ,delta,mass,mass2,kont)

Real(dp), Intent(in) :: MetR,MetR2,MAh,MAh2,Mhh,Mhh2,MetI,MetI2,MHp,MHp2,Metp,Metp2,MVWp,MVWp2,               & 
& MVZ,MVZ2,MFtc(3),MFtc2(3),MFe(3),MFe2(3),MFv(3),MFv2(3),MFt0(3),MFt02(3)

Real(dp), Intent(in) :: lam5,v

Complex(dp), Intent(in) :: mEt2,lam4,lam3

Complex(dp), Intent(in) :: cplAhetIetR,cpletIetIhh,cpletIetpcHp,cpletIetpcVWp,cpletIetRVZ,cplcFtcFeetIL(3,3),    & 
& cplcFtcFeetIR(3,3),cplFt0FvetIL(3,3),cplFt0FvetIR(3,3),cplAhAhetIetI,cpletIetIetIetI,  & 
& cpletIetIetpcetp,cpletIetIetRetR,cpletIetIhhhh,cpletIetIHpcHp,cpletIetIcVWpVWp,        & 
& cpletIetIVZVZ
...
& Metp2,MVWp,MVWp2,MVZ,MVZ2,MFtc,MFtc2,MFe,MFe2,MFv,MFv2,MFt0,MFt02,cplAhetIetR,         & 
& cpletIetIhh,cpletIetpcHp,cpletIetpcVWp,cpletIetRVZ,cplcFtcFeetIL,cplcFtcFeetIR,        & 
& cplFt0FvetIL,cplFt0FvetIR,cplAhAhetIetI,cpletIetIetIetI,cpletIetIetpcetp,              & 
...
& Metp,Metp2,MVWp,MVWp2,MVZ,MVZ2,MFtc,MFtc2,MFe,MFe2,MFv,MFv2,MFt0,MFt02,cplAhetIetR,    & 
& cpletIetIhh,cpletIetpcHp,cpletIetpcVWp,cpletIetRVZ,cplcFtcFeetIL,cplcFtcFeetIR,        & 
& cplFt0FvetIL,cplFt0FvetIR,cplAhAhetIetI,cpletIetIetIetI,cpletIetIetpcetp,              & 
& cpletIetIetRetR,cpletIetIhhhh,cpletIetIHpcHp,cpletIetIcVWpVWp,cpletIetIVZVZ,kont,res)
...
sumI = 0._dp 
    ...
    Do i1 = 1, 3
       Do i2 = 1, 3
 G0m2 = Gloop(p2,MFtc2(i1),MFe2(i2)) 
B0m2 = -2._dp*MFtc(i1)*MFe(i2)*B0(p2,MFtc2(i1),MFe2(i2)) 
coupL1 = cplcFtcFeetIL(i1,i2)
coupR1 = cplcFtcFeetIR(i1,i2)
coupL2 =  Conjg(cplcFtcFeetIL(i1,i2))
coupR2 =  Conjg(cplcFtcFeetIR(i1,i2))
    SumI = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
res = res +2._dp* SumI  
      End Do 
...
sumI = 0._dp 
    ...
    Do i1 = 1, 3
       Do i2 = 1, 3
 G0m2 = Gloop(p2,MFv2(i1),MFt02(i2)) 
B0m2 = -2._dp*MFv(i1)*MFt0(i2)*B0(p2,MFv2(i1),MFt02(i2)) 
coupL1 = cplFt0FvetIL(i2,i1)
coupR1 = cplFt0FvetIR(i2,i1)
coupL2 =  Conjg(cplFt0FvetIL(i2,i1))
coupR2 =  Conjg(cplFt0FvetIR(i2,i1))
    SumI = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
res = res +1._dp* SumI  
      End Do 
...
& MHp,MHp2,Metp,Metp2,MVWp,MVWp2,Mhh,Mhh2,MetR,MetR2,MFtc,MFtc2,MFe,MFe2,MFv,            & 
& MFv2,MFt0,MFt02,cplAhetIetR,cpletIetRVZ,cpletpetRcHp,cpletpetRcVWp,cpletRetRhh,        & 
& cplcFtcFeetRL,cplcFtcFeetRR,cplFt0FvetRL,cplFt0FvetRR,cplAhAhetRetR,cpletIetIetRetR,   & 
& cpletpetRetRcetp,cpletRetRetRetR,cpletRetRhhhh,cpletRetRHpcHp,cpletRetRcVWpVWp,        & 
& cpletRetRVZVZ,delta,mass,mass2,kont)

Real(dp), Intent(in) :: MetI,MetI2,MAh,MAh2,MVZ,MVZ2,MHp,MHp2,Metp,Metp2,MVWp,MVWp2,Mhh,Mhh2,MetR,            & 
& MetR2,MFtc(3),MFtc2(3),MFe(3),MFe2(3),MFv(3),MFv2(3),MFt0(3),MFt02(3)

Real(dp), Intent(in) :: lam5,v

Complex(dp), Intent(in) :: mEt2,lam4,lam3

Complex(dp), Intent(in) :: cplAhetIetR,cpletIetRVZ,cpletpetRcHp,cpletpetRcVWp,cpletRetRhh,cplcFtcFeetRL(3,3),    & 
& cplcFtcFeetRR(3,3),cplFt0FvetRL(3,3),cplFt0FvetRR(3,3),cplAhAhetRetR,cpletIetIetRetR,  & 
& cpletpetRetRcetp,cpletRetRetRetR,cpletRetRhhhh,cpletRetRHpcHp,cpletRetRcVWpVWp,        & 
& cpletRetRVZVZ
...
& MVWp2,Mhh,Mhh2,MetR,MetR2,MFtc,MFtc2,MFe,MFe2,MFv,MFv2,MFt0,MFt02,cplAhetIetR,         & 
& cpletIetRVZ,cpletpetRcHp,cpletpetRcVWp,cpletRetRhh,cplcFtcFeetRL,cplcFtcFeetRR,        & 
& cplFt0FvetRL,cplFt0FvetRR,cplAhAhetRetR,cpletIetIetRetR,cpletpetRetRcetp,              & 
...
& MVWp,MVWp2,Mhh,Mhh2,MetR,MetR2,MFtc,MFtc2,MFe,MFe2,MFv,MFv2,MFt0,MFt02,cplAhetIetR,    & 
& cpletIetRVZ,cpletpetRcHp,cpletpetRcVWp,cpletRetRhh,cplcFtcFeetRL,cplcFtcFeetRR,        & 
& cplFt0FvetRL,cplFt0FvetRR,cplAhAhetRetR,cpletIetIetRetR,cpletpetRetRcetp,              & 
& cpletRetRetRetR,cpletRetRhhhh,cpletRetRHpcHp,cpletRetRcVWpVWp,cpletRetRVZVZ,kont,res)
...
sumI = 0._dp 
 ...
 G0m2 = Gloop(p2,MFtc2(i1),MFe2(i2)) 
B0m2 = -2._dp*MFtc(i1)*MFe(i2)*B0(p2,MFtc2(i1),MFe2(i2)) 
coupL1 = cplcFtcFeetRL(i1,i2)
coupR1 = cplcFtcFeetRR(i1,i2)
coupL2 =  Conjg(cplcFtcFeetRL(i1,i2))
coupR2 =  Conjg(cplcFtcFeetRR(i1,i2))
    SumI = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
res = res +2._dp* SumI  
      End Do 
...
sumI = 0._dp 
 ...
 G0m2 = Gloop(p2,MFv2(i1),MFt02(i2)) 
B0m2 = -2._dp*MFv(i1)*MFt0(i2)*B0(p2,MFv2(i1),MFt02(i2)) 
coupL1 = cplFt0FvetRL(i2,i1)
coupR1 = cplFt0FvetRR(i2,i1)
coupL2 =  Conjg(cplFt0FvetRL(i2,i1))
coupR2 =  Conjg(cplFt0FvetRR(i2,i1))
    SumI = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
res = res +1._dp* SumI  
      End Do 
...
& Metp,Metp2,MFd,MFd2,MFe,MFe2,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MHp,MHp2,           & 
& MVWp,MVWp2,cplAhhhVZ,cpletIetRVZ,cpletpcetpVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,     & 
& cplcFeFeVZR,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,            & 
& cplFvFvVZR,cplcgWpgWpVZ,cplcgWCgWCVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcVWpVWpVZ,    & 
& cplAhAhVZVZ,cpletIetIVZVZ,cpletpcetpVZVZ,cpletRetRVZVZ,cplhhhhVZVZ,cplHpcHpVZVZ,       & 
...
& MFe2(3),MFtc(3),MFtc2(3),MFu(3),MFu2(3),MFv(3),MFv2(3),MVZ,MVZ2,MHp,MHp2,              & 
& MVWp,MVWp2
...
& MFd,MFd2,MFe,MFe2,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MHp,MHp2,MVWp,MVWp2,           & 
& cplAhhhVZ,cpletIetRVZ,cpletpcetpVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,    & 
& cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,             & 
& cplcgWpgWpVZ,cplcgWCgWCVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcVWpVWpVZ,               & 
& cplAhAhVZVZ,cpletIetIVZVZ,cpletpcetpVZVZ,cpletRetRVZVZ,cplhhhhVZVZ,cplHpcHpVZVZ,       & 
...
sumI = 0._dp 
    ...
    Do i1 = 1, 3
       Do i2 = 1, 3
 H0m2 = Hloop(p2,MFtc2(i1),MFtc2(i2)) 
B0m2 = 4._dp*MFtc(i1)*MFtc(i2)*B0(p2,MFtc2(i1),MFtc2(i2)) 
coupL1 = cplcFtcFtcVZL(i1,i2)
coupR1 = cplcFtcFtcVZR(i1,i2)
    SumI = (Abs(coupL1)**2+Abs(coupR1)**2)*H0m2 & 
                & + (Real(Conjg(coupL1)*coupR1,dp))*B0m2 
res = res +1._dp* SumI  
      End Do 
...
& MetR2,MFtc,MFtc2,MFt0,MFt02,MFd,MFd2,MFu,MFu2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,              & 
& MVWp,MVWp2,MVZ,MVZ2,cplAhHpcVWp,cpletIetpcVWp,cpletpetRcVWp,cplcFtcFt0cVWpL,           & 
& cplcFtcFt0cVWpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFvcVWpL,cplcFeFvcVWpR,               & 
...
Real(dp), Intent(in) :: MHp,MHp2,MAh,MAh2,Metp,Metp2,MetI,MetI2,MetR,MetR2,MFtc(3),MFtc2(3),MFt0(3),          & 
& MFt02(3),MFd(3),MFd2(3),MFu(3),MFu2(3),MFe(3),MFe2(3),MFv(3),MFv2(3),Mhh,              & 
& Mhh2,MVWp,MVWp2,MVZ,MVZ2

Real(dp), Intent(in) :: g2,v

Complex(dp), Intent(in) :: cplAhHpcVWp,cpletIetpcVWp,cpletpetRcVWp,cplcFtcFt0cVWpL(3,3),cplcFtcFt0cVWpR(3,3),    & 
...
p2 = MVWp2
PiSf = ZeroC 
Call Pi1LoopVWp(p2,MHp,MHp2,MAh,MAh2,Metp,Metp2,MetI,MetI2,MetR,MetR2,MFtc,           & 
& MFtc2,MFt0,MFt02,MFd,MFd2,MFu,MFu2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MVWp,MVWp2,              & 
& MVZ,MVZ2,cplAhHpcVWp,cpletIetpcVWp,cpletpetRcVWp,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,      & 
& cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcgWCgAcVWp,cplcgAgWpcVWp,   & 
& cplcgZgWpcVWp,cplcgWCgZcVWp,cplhhHpcVWp,cplhhcVWpVWp,cplHpcVWpVP,cplHpcVWpVZ,          & 
& cplcVWpVPVWp,cplcVWpVWpVZ,cplAhAhcVWpVWp,cpletIetIcVWpVWp,cpletpcetpcVWpVWp,           & 
...
& MFtc,MFtc2,MFt0,MFt02,MFd,MFd2,MFu,MFu2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MVWp,               & 
& MVWp2,MVZ,MVZ2,cplAhHpcVWp,cpletIetpcVWp,cpletpetRcVWp,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,& 
& cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcgWCgAcVWp,cplcgAgWpcVWp,   & 
& cplcgZgWpcVWp,cplcgWCgZcVWp,cplhhHpcVWp,cplhhcVWpVWp,cplHpcVWpVP,cplHpcVWpVZ,          & 
& cplcVWpVPVWp,cplcVWpVWpVZ,cplAhAhcVWpVWp,cpletIetIcVWpVWp,cpletpcetpcVWpVWp,           & 
& cpletRetRcVWpVWp,cplhhhhcVWpVWp,cplHpcHpcVWpVWp,cplcVWpVPVPVWp3,cplcVWpVPVPVWp1,       & 
...
sumI = 0._dp 
    ...
    Do i1 = 1, 3
       Do i2 = 1, 3
 H0m2 = Hloop(p2,MFtc2(i1),MFt02(i2)) 
B0m2 = 4._dp*MFtc(i1)*MFt0(i2)*B0(p2,MFtc2(i1),MFt02(i2)) 
coupL1 = cplcFtcFt0cVWpL(i1,i2)
coupR1 = cplcFtcFt0cVWpR(i1,i2)
    SumI = (Abs(coupL1)**2+Abs(coupR1)**2)*H0m2 & 
                & + (Real(Conjg(coupL1)*coupR1,dp))*B0m2 
res = res +1._dp* SumI  
      End Do 
...
End Module LoopMasses_radinertRSIII 
