...
Module InputOutput_radinertRSIII 
...
InputValueforYe= .True. 
   ...
   Else If (read_line(7:10).Eq."YNIN") Then 
InputValueforYn= .True. 
    Call ReadMatrixC(99,3,3,YnIN,0, "YnIN",kont)

 
   Else If (read_line(7:12).Eq."IMYNIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMYn") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,YnIN,1, "YnIN",kont)

 
   Else If (read_line(7:11).Eq."MTFIN") Then 
InputValueforMTF= .True. 
    Call ReadMatrixC(99,3,3,MTFIN,0, "MTFIN",kont)

 
   Else If (read_line(7:13).Eq."IMMTFIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMMTF") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,MTFIN,1, "MTFIN",kont)
...
Complex(dp) :: PDGhh,PDGAh,PDGHp,PDGetR,PDGetI,PDGetp,PDGVP,PDGVZ,PDGVG,PDGVWp,PDGgP,PDGgWp,         & 
& PDGgWpC,PDGgZ,PDGgG,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3),PDGFt0(3),PDGFtc(3)
...
Character(len=30),Dimension(3):: NameParticleFt0
Character(len=30),Dimension(3):: NameParticleFtc
...
PDGFt0(1)=6000057
NameParticleFt0(1)="Ft0_1"
PDGFt0(2)=6000058
NameParticleFt0(2)="Ft0_2"
PDGFt0(3)=6000059
NameParticleFt0(3)="Ft0_3"
PDGFtc(1)=6000061
NameParticleFtc(1)="Ftc_1"
PDGFtc(2)=6000062
NameParticleFtc(2)="Ftc_2"
PDGFtc(3)=6000063
NameParticleFtc(3)="Ftc_3"
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - radinert/RSIII Spectrum + Decays + Flavor Observables"
...
Write(io_L,106) "Block YN Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(Yn(1,1),dp), "# Real(Yn(1,1),dp)" 
Write(io_L,107)1,2,Real(Yn(1,2),dp), "# Real(Yn(1,2),dp)" 
Write(io_L,107)1,3,Real(Yn(1,3),dp), "# Real(Yn(1,3),dp)" 
Write(io_L,107)2,1,Real(Yn(2,1),dp), "# Real(Yn(2,1),dp)" 
Write(io_L,107)2,2,Real(Yn(2,2),dp), "# Real(Yn(2,2),dp)" 
Write(io_L,107)2,3,Real(Yn(2,3),dp), "# Real(Yn(2,3),dp)" 
Write(io_L,107)3,1,Real(Yn(3,1),dp), "# Real(Yn(3,1),dp)" 
Write(io_L,107)3,2,Real(Yn(3,2),dp), "# Real(Yn(3,2),dp)" 
Write(io_L,107)3,3,Real(Yn(3,3),dp), "# Real(Yn(3,3),dp)" 
If (MaxVal(Abs(AImag(Yn))).gt.0._dp) Then 
Write(io_L,106) "Block IMYN Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(Yn(1,1)), "# Aimag(Yn(1,1))" 
Write(io_L,107)1,2,Aimag(Yn(1,2)), "# Aimag(Yn(1,2))" 
Write(io_L,107)1,3,Aimag(Yn(1,3)), "# Aimag(Yn(1,3))" 
Write(io_L,107)2,1,Aimag(Yn(2,1)), "# Aimag(Yn(2,1))" 
Write(io_L,107)2,2,Aimag(Yn(2,2)), "# Aimag(Yn(2,2))" 
Write(io_L,107)2,3,Aimag(Yn(2,3)), "# Aimag(Yn(2,3))" 
Write(io_L,107)3,1,Aimag(Yn(3,1)), "# Aimag(Yn(3,1))" 
Write(io_L,107)3,2,Aimag(Yn(3,2)), "# Aimag(Yn(3,2))" 
Write(io_L,107)3,3,Aimag(Yn(3,3)), "# Aimag(Yn(3,3))" 
End If 

Write(io_L,106) "Block MTF Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(MTF(1,1),dp), "# Real(MTF(1,1),dp)" 
Write(io_L,107)1,2,Real(MTF(1,2),dp), "# Real(MTF(1,2),dp)" 
Write(io_L,107)1,3,Real(MTF(1,3),dp), "# Real(MTF(1,3),dp)" 
Write(io_L,107)2,1,Real(MTF(2,1),dp), "# Real(MTF(2,1),dp)" 
Write(io_L,107)2,2,Real(MTF(2,2),dp), "# Real(MTF(2,2),dp)" 
Write(io_L,107)2,3,Real(MTF(2,3),dp), "# Real(MTF(2,3),dp)" 
Write(io_L,107)3,1,Real(MTF(3,1),dp), "# Real(MTF(3,1),dp)" 
Write(io_L,107)3,2,Real(MTF(3,2),dp), "# Real(MTF(3,2),dp)" 
Write(io_L,107)3,3,Real(MTF(3,3),dp), "# Real(MTF(3,3),dp)" 
If (MaxVal(Abs(AImag(MTF))).gt.0._dp) Then 
Write(io_L,106) "Block IMMTF Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(MTF(1,1)), "# Aimag(MTF(1,1))" 
Write(io_L,107)1,2,Aimag(MTF(1,2)), "# Aimag(MTF(1,2))" 
Write(io_L,107)1,3,Aimag(MTF(1,3)), "# Aimag(MTF(1,3))" 
Write(io_L,107)2,1,Aimag(MTF(2,1)), "# Aimag(MTF(2,1))" 
Write(io_L,107)2,2,Aimag(MTF(2,2)), "# Aimag(MTF(2,2))" 
Write(io_L,107)2,3,Aimag(MTF(2,3)), "# Aimag(MTF(2,3))" 
Write(io_L,107)3,1,Aimag(MTF(3,1)), "# Aimag(MTF(3,1))" 
Write(io_L,107)3,2,Aimag(MTF(3,2)), "# Aimag(MTF(3,2))" 
Write(io_L,107)3,3,Aimag(MTF(3,3)), "# Aimag(MTF(3,3))" 
End If 
...
Write(io_L,106) "Block YnGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(YnGUT(1,1),dp), "# Real(YnGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(YnGUT(1,2),dp), "# Real(YnGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(YnGUT(1,3),dp), "# Real(YnGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(YnGUT(2,1),dp), "# Real(YnGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(YnGUT(2,2),dp), "# Real(YnGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(YnGUT(2,3),dp), "# Real(YnGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(YnGUT(3,1),dp), "# Real(YnGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(YnGUT(3,2),dp), "# Real(YnGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(YnGUT(3,3),dp), "# Real(YnGUT(3,3),dp)" 
If (MaxVal(Abs(AImag(YnGUT))).gt.0._dp) Then 
Write(io_L,106) "Block IMYnGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(YnGUT(1,1)), "# Aimag(YnGUT(1,1))" 
Write(io_L,107)1,2,Aimag(YnGUT(1,2)), "# Aimag(YnGUT(1,2))" 
Write(io_L,107)1,3,Aimag(YnGUT(1,3)), "# Aimag(YnGUT(1,3))" 
Write(io_L,107)2,1,Aimag(YnGUT(2,1)), "# Aimag(YnGUT(2,1))" 
Write(io_L,107)2,2,Aimag(YnGUT(2,2)), "# Aimag(YnGUT(2,2))" 
Write(io_L,107)2,3,Aimag(YnGUT(2,3)), "# Aimag(YnGUT(2,3))" 
Write(io_L,107)3,1,Aimag(YnGUT(3,1)), "# Aimag(YnGUT(3,1))" 
Write(io_L,107)3,2,Aimag(YnGUT(3,2)), "# Aimag(YnGUT(3,2))" 
Write(io_L,107)3,3,Aimag(YnGUT(3,3)), "# Aimag(YnGUT(3,3))" 
End If 

Write(io_L,106) "Block MTFGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(MTFGUT(1,1),dp), "# Real(MTFGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(MTFGUT(1,2),dp), "# Real(MTFGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(MTFGUT(1,3),dp), "# Real(MTFGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(MTFGUT(2,1),dp), "# Real(MTFGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(MTFGUT(2,2),dp), "# Real(MTFGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(MTFGUT(2,3),dp), "# Real(MTFGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(MTFGUT(3,1),dp), "# Real(MTFGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(MTFGUT(3,2),dp), "# Real(MTFGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(MTFGUT(3,3),dp), "# Real(MTFGUT(3,3),dp)" 
If (MaxVal(Abs(AImag(MTFGUT))).gt.0._dp) Then 
Write(io_L,106) "Block IMMTFGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(MTFGUT(1,1)), "# Aimag(MTFGUT(1,1))" 
Write(io_L,107)1,2,Aimag(MTFGUT(1,2)), "# Aimag(MTFGUT(1,2))" 
Write(io_L,107)1,3,Aimag(MTFGUT(1,3)), "# Aimag(MTFGUT(1,3))" 
Write(io_L,107)2,1,Aimag(MTFGUT(2,1)), "# Aimag(MTFGUT(2,1))" 
Write(io_L,107)2,2,Aimag(MTFGUT(2,2)), "# Aimag(MTFGUT(2,2))" 
Write(io_L,107)2,3,Aimag(MTFGUT(2,3)), "# Aimag(MTFGUT(2,3))" 
Write(io_L,107)3,1,Aimag(MTFGUT(3,1)), "# Aimag(MTFGUT(3,1))" 
Write(io_L,107)3,2,Aimag(MTFGUT(3,2)), "# Aimag(MTFGUT(3,2))" 
Write(io_L,107)3,3,Aimag(MTFGUT(3,3)), "# Aimag(MTFGUT(3,3))" 
End If 
...
End if 
 ...
 Write(io_L,102) INT(Abs(PDGFt0(1))),MFt0(1),"# "//Trim(NameParticleFt0(1))// "" 
If (MassLSP(1).gt.Abs(MFt0(1))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6000057 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFt0(1))
Else 
If (MassLSP(2).gt.Abs(MFt0(1))) Then 
PDGLSP(2) = 6000057 
MassLSP(2) = Abs(MFt0(1))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGFt0(2))),MFt0(2),"# "//Trim(NameParticleFt0(2))// "" 
If (MassLSP(1).gt.Abs(MFt0(2))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6000058 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFt0(2))
Else 
If (MassLSP(2).gt.Abs(MFt0(2))) Then 
PDGLSP(2) = 6000058 
MassLSP(2) = Abs(MFt0(2))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGFt0(3))),MFt0(3),"# "//Trim(NameParticleFt0(3))// "" 
If (MassLSP(1).gt.Abs(MFt0(3))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6000059 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFt0(3))
Else 
If (MassLSP(2).gt.Abs(MFt0(3))) Then 
PDGLSP(2) = 6000059 
MassLSP(2) = Abs(MFt0(3))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGFtc(1))),MFtc(1),"# "//Trim(NameParticleFtc(1))// "" 
If (MassLSP(1).gt.Abs(MFtc(1))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6000061 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFtc(1))
Else 
If (MassLSP(2).gt.Abs(MFtc(1))) Then 
PDGLSP(2) = 6000061 
MassLSP(2) = Abs(MFtc(1))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGFtc(2))),MFtc(2),"# "//Trim(NameParticleFtc(2))// "" 
If (MassLSP(1).gt.Abs(MFtc(2))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6000062 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFtc(2))
Else 
If (MassLSP(2).gt.Abs(MFtc(2))) Then 
PDGLSP(2) = 6000062 
MassLSP(2) = Abs(MFtc(2))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGFtc(3))),MFtc(3),"# "//Trim(NameParticleFtc(3))// "" 
If (MassLSP(1).gt.Abs(MFtc(3))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6000063 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFtc(3))
Else 
If (MassLSP(2).gt.Abs(MFtc(3))) Then 
PDGLSP(2) = 6000063 
MassLSP(2) = Abs(MFtc(3))
End if 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,10:198)).Gt.BRmin) Then 
...
CurrentPDG3(2) = -PDGFtc(gt2) 
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(1) = PDGFu(gt1) 
CurrentPDG3(2) = -PDGFtc(gt2) 
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,10:198)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,10:198)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(1) = PDGFtc(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Do gt1= 1, 3
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFt0(gt1) 
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,19:261)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFtc(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=gt1,3
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFtc(gt1) 
CurrentPDG3(2) = -PDGFe(gt2) 
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=gt1,3
    Do gt3=1,3
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFt0(gt1) 
CurrentPDG3(2) = PDGFt0(gt2) 
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFt0(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,19:261)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFtc(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFt0(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,19:261)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFtc(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFt0(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,10:198)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,10:198)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,10:198)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleetp)//" "//")"
Write(io_L,201) BRFv(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleetp)//" "//")"
Write(io_L,201) BRFv(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleetp)//" "//")"
Write(io_L,201) BRFv(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
If (BRVZ(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFtc(gt1) 
CurrentPDG2(2) = PDGFtc(gt2) 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFtc(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If (BRVWp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFtc(gt1) 
CurrentPDG2(2) = PDGFt0(gt2) 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFt0(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRetR(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleetR)//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
Write(io_L,201) BRetR(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleetR)//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGFt0(gt2) 
Write(io_L,201) BRetR(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetR)//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFt0(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRetI(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
Write(io_L,201) BRetI(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGFt0(gt2) 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFt0(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFt0(gt2) 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFt0(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If(gTFt0(1).gt.MinWidth) Then 
Write(io_L,200) INT(PDGFt0(1)),gTFt0(1),Trim(NameParticleFt0(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BRFt0(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFt0(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRFt0(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetp)//" "//")"
Write(io_L,201) BRFt0(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFt0(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRFt0(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRFt0(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFt0(1,13:147)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(2) = PDGFv(gt2) 
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFt0(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
Write(io_L,202) BRFt0(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(2) = PDGFv(gt2) 
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFt0(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFt0(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFt0(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRFt0(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
Write(io_L,202) BRFt0(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFt0(1))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
...
End if 
If(gTFt0(2).gt.MinWidth) Then 
Write(io_L,200) INT(PDGFt0(2)),gTFt0(2),Trim(NameParticleFt0(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BRFt0(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFt0(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRFt0(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetp)//" "//")"
Write(io_L,201) BRFt0(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFt0(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRFt0(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRFt0(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFt0(2,13:147)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(2) = PDGFv(gt2) 
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFt0(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
Write(io_L,202) BRFt0(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(2) = PDGFv(gt2) 
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFt0(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFt0(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFt0(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRFt0(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
Write(io_L,202) BRFt0(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFt0(2))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
...
End if 
If(gTFt0(3).gt.MinWidth) Then 
Write(io_L,200) INT(PDGFt0(3)),gTFt0(3),Trim(NameParticleFt0(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BRFt0(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFt0(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRFt0(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetp)//" "//")"
Write(io_L,201) BRFt0(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFt0(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRFt0(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRFt0(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFt0(3,13:147)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(2) = PDGFv(gt2) 
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFt0(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
Write(io_L,202) BRFt0(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(2) = PDGFv(gt2) 
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFt0(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFt0(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFt0(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRFt0(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
Write(io_L,202) BRFt0(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFt0(3))//" -> "//Trim(NameParticleFtc(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
...
If(gTFtc(1).gt.MinWidth) Then 
Write(io_L,200) INT(PDGFtc(1)),gTFtc(1),Trim(NameParticleFtc(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BRFtc(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFtc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFtc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRFtc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRFtc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFtc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFtc(1,16:258)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(2) = -PDGFtc(gt2) 
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFtc(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(1))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
If(gTFtc(2).gt.MinWidth) Then 
Write(io_L,200) INT(PDGFtc(2)),gTFtc(2),Trim(NameParticleFtc(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BRFtc(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFtc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFtc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRFtc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRFtc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFtc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFtc(2,16:258)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(2) = -PDGFtc(gt2) 
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRFtc(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFtc(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFtc(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRFtc(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFtc(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRFtc(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRFtc(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(2))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
If(gTFtc(3).gt.MinWidth) Then 
Write(io_L,200) INT(PDGFtc(3)),gTFtc(3),Trim(NameParticleFtc(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BRFtc(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFtc(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFtc(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRFtc(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRFtc(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFtc(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFtc(3,16:258)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(2) = -PDGFtc(gt2) 
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRFtc(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFt0(gt3) 
Write(io_L,202) BRFtc(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFt0(gt1))//" "//Trim(NameParticleFtc(gt2))//" "//Trim(NameParticleFt0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRFtc(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFtc(gt3) 
Write(io_L,202) BRFtc(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFtc(gt2))//"^* "//Trim(NameParticleFtc(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRFtc(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRFtc(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc(3))//" -> "//Trim(NameParticleFtc(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.radinertRSIII",status="unknown")
...
Write(123,*) "lam5= ",lam5
Write(123,*) "Yn11_r= ",Real(Yn(1,1),dp)
Write(123,*) "Yn12_r= ",Real(Yn(1,2),dp)
Write(123,*) "Yn13_r= ",Real(Yn(1,3),dp)
Write(123,*) "Yn21_r= ",Real(Yn(2,1),dp)
Write(123,*) "Yn22_r= ",Real(Yn(2,2),dp)
Write(123,*) "Yn23_r= ",Real(Yn(2,3),dp)
Write(123,*) "Yn31_r= ",Real(Yn(3,1),dp)
Write(123,*) "Yn32_r= ",Real(Yn(3,2),dp)
Write(123,*) "Yn33_r= ",Real(Yn(3,3),dp)
Write(123,*) "Yn11_i= ",AImag(Yn(1,1))
Write(123,*) "Yn12_i= ",AImag(Yn(1,2))
Write(123,*) "Yn13_i= ",AImag(Yn(1,3))
Write(123,*) "Yn21_i= ",AImag(Yn(2,1))
Write(123,*) "Yn22_i= ",AImag(Yn(2,2))
Write(123,*) "Yn23_i= ",AImag(Yn(2,3))
Write(123,*) "Yn31_i= ",AImag(Yn(3,1))
Write(123,*) "Yn32_i= ",AImag(Yn(3,2))
Write(123,*) "Yn33_i= ",AImag(Yn(3,3))
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "MFt01= ", Abs(MFt0(1)) 
Write(123,*) "MFt02= ", Abs(MFt0(2)) 
Write(123,*) "MFt03= ", Abs(MFt0(3)) 
Write(123,*) "MFtc1= ", Abs(MFtc(1)) 
Write(123,*) "MFtc2= ", Abs(MFtc(2)) 
Write(123,*) "MFtc3= ", Abs(MFtc(3)) 
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "WFt01 = ",gTFt0(1)
Write(123,*) "WFt02 = ",gTFt0(2)
Write(123,*) "WFt03 = ",gTFt0(3)
Write(123,*) "WFtc1 = ",gTFtc(1)
Write(123,*) "WFtc2 = ",gTFtc(2)
Write(123,*) "WFtc3 = ",gTFtc(3)
Write(123,*) "" 
Write(123,*) "" 
...
End Module InputOutput_radinertRSIII 
