...
Module CouplingsForDecays_radinertRSIII
...
& MFeinput,MFe2input,MFt0input,MFt02input,MFtcinput,MFtc2input,MFuinput,MFu2input,       & 
& MFvinput,MFv2input,Mhhinput,Mhh2input,MHpinput,MHp2input,MVWpinput,MVWp2input,         & 
& MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,               & 
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
...
& MetR2input,MFdinput(3),MFd2input(3),MFeinput(3),MFe2input(3),MFt0input(3),             & 
& MFt02input(3),MFtcinput(3),MFtc2input(3),MFuinput(3),MFu2input(3),MFvinput(3),         & 
& MFv2input(3),Mhhinput,Mhh2input,MHpinput,MHp2input,MVWpinput,MVWp2input,               & 
...
& lam5,Yu,Yd,Ye,Yn,MTF,mH2,mEt2,.True.,kont)
...
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cplcFeFtcetIL,cplcFeFtcetIR,cplcFeFtcetRL,cplcFeFtcetRR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFt0cetpL,cplcFeFt0cetpR,         & 
...
Complex(dp),Intent(out) :: cplcFeFtcetIL(3,3),cplcFeFtcetIR(3,3),cplcFeFtcetRL(3,3),cplcFeFtcetRR(3,3),          & 
...
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cplFt0FvetIL,cplFt0FvetIR,cplFvFtcetpL,cplFvFtcetpR,cplFt0FvetRL,     & 
& cplFt0FvetRR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,deltaM)
...
Complex(dp),Intent(out) :: cplFt0FvetIL(3,3),cplFt0FvetIR(3,3),cplFvFtcetpL(3,3),cplFvFtcetpR(3,3),              & 
...
& cplFvFvVZR,cplhhVZVZ,cplcVWpVWpVZ,deltaM)
...
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cpletIetpcVWp,cpletpetRcVWp,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,          & 
...
Complex(dp),Intent(out) :: cpletIetpcVWp,cpletpetRcVWp,cplcFtcFt0cVWpL(3,3),cplcFtcFt0cVWpR(3,3),cplcFdFucVWpL(3,3),& 
...
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cpletIetRVZ,cpletpetRcVWp,cpletRetRhh,cplcFtcFeetRL,cplcFtcFeetRR,    & 
& cplFt0FvetRL,cplFt0FvetRR,deltaM)
...
Complex(dp),Intent(out) :: cpletIetRVZ,cpletpetRcVWp,cpletRetRhh,cplcFtcFeetRL(3,3),cplcFtcFeetRR(3,3),          & 
...
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cpletIetIhh,cpletIetpcVWp,cpletIetRVZ,cplcFtcFeetIL,cplcFtcFeetIR,    & 
& cplFt0FvetIL,cplFt0FvetIR,deltaM)
...
Complex(dp),Intent(out) :: cpletIetIhh,cpletIetpcVWp,cpletIetRVZ,cplcFtcFeetIL(3,3),cplcFtcFeetIR(3,3),          & 
...
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cpletIcetpVWp,cpletphhcetp,cpletpcetpVZ,cpletRcetpVWp,cplcFeFt0cetpL, & 
& cplcFeFt0cetpR,cplcFtcFvcetpL,cplcFtcFvcetpR,deltaM)
...
Complex(dp),Intent(out) :: cpletIcetpVWp,cpletphhcetp,cpletpcetpVZ,cpletRcetpVWp,cplcFeFt0cetpL(3,3),            & 
...
Subroutine CouplingsFor_Ft0_decays_2B(m_in,i1,MAhinput,MAh2input,MetIinput,           & 
& MetI2input,Metpinput,Metp2input,MetRinput,MetR2input,MFdinput,MFd2input,               & 
& MFeinput,MFe2input,MFt0input,MFt02input,MFtcinput,MFtc2input,MFuinput,MFu2input,       & 
& MFvinput,MFv2input,Mhhinput,Mhh2input,MHpinput,MHp2input,MVWpinput,MVWp2input,         & 
& MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,               & 
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cplFt0FvetIL,cplFt0FvetIR,cplFt0FeetpL,cplFt0FeetpR,cplFt0FvetRL,     & 
& cplFt0FvetRR,cplFt0FtcVWpL,cplFt0FtcVWpR,deltaM)
...
Complex(dp),Intent(out) :: cplFt0FvetIL(3,3),cplFt0FvetIR(3,3),cplFt0FeetpL(3,3),cplFt0FeetpR(3,3),              & 
...
Real(dp) :: gSM(11), sinW2, dt, tz, Qin 
Iname = Iname + 1 
NameOfUnit(Iname) = 'Couplings_Ft0_2B'
...
End subroutine CouplingsFor_Ft0_decays_2B
 
Subroutine CouplingsFor_Ftc_decays_2B(m_in,i1,MAhinput,MAh2input,MetIinput,           & 
& MetI2input,Metpinput,Metp2input,MetRinput,MetR2input,MFdinput,MFd2input,               & 
& MFeinput,MFe2input,MFt0input,MFt02input,MFtcinput,MFtc2input,MFuinput,MFu2input,       & 
& MFvinput,MFv2input,Mhhinput,Mhh2input,MHpinput,MHp2input,MVWpinput,MVWp2input,         & 
& MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,               & 
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cplcFtcFeetIL,cplcFtcFeetIR,cplcFtcFeetRL,cplcFtcFeetRR,              & 
& cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFtcFvcetpL,            & 
...
Complex(dp),Intent(out) :: cplcFtcFeetIL(3,3),cplcFtcFeetIR(3,3),cplcFtcFeetRL(3,3),cplcFtcFeetRR(3,3),          & 
...
Real(dp) :: gSM(11), sinW2, dt, tz, Qin 
Iname = Iname + 1 
NameOfUnit(Iname) = 'Couplings_Ftc_2B'
...
End subroutine CouplingsFor_Ftc_decays_2B
...
& cplcFeFvcVWpR,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR,             & 
...
& cplcFeFvcVWpL(3,3),cplcFeFvcVWpR(3,3),cplcFtcFt0cVWpL(3,3),cplcFtcFt0cVWpR(3,3),       & 
& cplcFtcFtcVZL(3,3),cplcFtcFtcVZR(3,3),cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),             & 
...
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFt0cetpL,cplcFeFt0cetpR,cplcFeFtcetIL,       & 
& cplcFeFtcetIR,cplcFeFtcetRL,cplcFeFtcetRR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFtcFeetIL,   & 
& cplcFtcFeetIR,cplcFtcFeetRL,cplcFtcFeetRR,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFdVWpL,    & 
& cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplFt0FeetpL,             & 
& cplFt0FeetpR,cplFt0FtcVWpL,cplFt0FtcVWpR,cplFt0FvetIL,cplFt0FvetIR,cplFt0FvetRL,       & 
& cplFt0FvetRR,cplFvFeVWpL,cplFvFeVWpR,cplFvFtcetpL,cplFvFtcetpR,cplFvFvVZL,             & 
& cplFvFvVZR,deltaM)
...
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,        & 
& cplcFdFucVWpR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFtcFtcVZL,           & 
& cplcFtcFtcVZR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,           & 
& cplcFuFuVZR,cplFt0FtcVWpL,cplFt0FtcVWpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,            & 
& cplFvFvVZR,deltaM)
...
& cplcFdFucVWpR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),& 
& cplcFtcFtcVZL(3,3),cplcFtcFtcVZR(3,3),cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),             & 
& cplcFuFuhhL(3,3),cplcFuFuhhR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplFt0FtcVWpL(3,3),& 
& cplFt0FtcVWpR(3,3),cplFvFeVWpL(3,3),cplFvFeVWpR(3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3)
...
Subroutine CouplingsFor_Ft0_decays_3B(m_in,i1,MAhinput,MAh2input,MetIinput,           & 
& MetI2input,Metpinput,Metp2input,MetRinput,MetR2input,MFdinput,MFd2input,               & 
& MFeinput,MFe2input,MFt0input,MFt02input,MFtcinput,MFtc2input,MFuinput,MFu2input,       & 
& MFvinput,MFv2input,Mhhinput,Mhh2input,MHpinput,MHp2input,MVWpinput,MVWp2input,         & 
& MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,               & 
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFt0cetpL,cplcFeFt0cetpR,            & 
& cplcFtcFeetIL,cplcFtcFeetIR,cplcFtcFeetRL,cplcFtcFeetRR,cplcFtcFt0cVWpL,               & 
& cplcFtcFt0cVWpR,cplcFtcFvcetpL,cplcFtcFvcetpR,cplFt0FeetpL,cplFt0FeetpR,               & 
& cplFt0FtcVWpL,cplFt0FtcVWpR,cplFt0FvetIL,cplFt0FvetIR,cplFt0FvetRL,cplFt0FvetRR,       & 
& cplFvFeVWpL,cplFvFeVWpR,deltaM)
...
Complex(dp),Intent(out) :: cplcFdFucVWpL(3,3),cplcFdFucVWpR(3,3),cplcFeFt0cetpL(3,3),cplcFeFt0cetpR(3,3),        & 
...
Real(dp) :: gSM(11), sinW2, dt, tz, Qin 
Iname = Iname + 1 
NameOfUnit(Iname) = 'Couplings_Ft0_3B'
...
End subroutine CouplingsFor_Ft0_decays_3B
 
Subroutine CouplingsFor_Ftc_decays_3B(m_in,i1,MAhinput,MAh2input,MetIinput,           & 
& MetI2input,Metpinput,Metp2input,MetRinput,MetR2input,MFdinput,MFd2input,               & 
& MFeinput,MFe2input,MFt0input,MFt02input,MFtcinput,MFtc2input,MFuinput,MFu2input,       & 
& MFvinput,MFv2input,Mhhinput,Mhh2input,MHpinput,MHp2input,MVWpinput,MVWp2input,         & 
& MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,               & 
& ZULinput,UVinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,lam2input,          & 
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,Yninput,MTFinput,mH2input,       & 
& mEt2input,vinput,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFtcetIL,        & 
& cplcFeFtcetIR,cplcFeFtcetRL,cplcFeFtcetRR,cplcFtcFeetIL,cplcFtcFeetIR,cplcFtcFeetRL,   & 
& cplcFtcFeetRR,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR,             & 
& cplcFtcFvcetpL,cplcFtcFvcetpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVZL,cplcFuFuVZR,       & 
& cplFt0FeetpL,cplFt0FeetpR,cplFt0FtcVWpL,cplFt0FtcVWpR,cplFt0FvetIL,cplFt0FvetIR,       & 
& cplFt0FvetRL,cplFt0FvetRR,cplFvFeVWpL,cplFvFeVWpR,cplFvFtcetpL,cplFvFtcetpR,           & 
& cplFvFvVZL,cplFvFvVZR,deltaM)
...
Complex(dp),Intent(out) :: cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFtcetIL(3,3),& 
...
Real(dp) :: gSM(11), sinW2, dt, tz, Qin 
Iname = Iname + 1 
NameOfUnit(Iname) = 'Couplings_Ftc_3B'
...
End subroutine CouplingsFor_Ftc_decays_3B
...
End Module CouplingsForDecays_radinertRSIII
