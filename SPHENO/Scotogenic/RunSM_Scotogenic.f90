...
! ------------------------------------------------------------------------------  
! File created at 21:33 on 7.12.2016   
! ----------------------------------------------------------------------  
 
 
Module RunSM_Scotogenic 
...
& lam3input,lam5input,Yninput,Yuinput,Ydinput,Yeinput,Mninput,mH2input,mEt2input,        & 
& vinput,g1D)

Call GToParameters107(g1D,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yn,Yu,Yd,Ye,              & 
& Mn,mH2,mEt2,v)
