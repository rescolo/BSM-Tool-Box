...
InputValueforMn= .True. 
    Call ReadMatrixC(99,3,3,MnIN,0, "MnIN",kont)

 
   Else If (read_line(7:12).Eq."IMMNIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMMn") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,MnIN,1, "MnIN",kont)
...
& PDGgWpC,PDGgZ,PDGgG,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3),PDGChi(3)
...
Character(len=30),Dimension(3):: NameParticleChi
...
Do i1=1,3
  If (MaxVal(Abs(AImag(ZX(i1,:)))).gt.MaxVal(Abs(Real(ZX(i1,:),dp)))) Then 
MChi(i1) = - MChi(i1) 
ZX(i1,:) = -(0._dp,1._dp)*ZX(i1,:) 
  End If 
End Do 
Do i1=1,3
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - Scotogenic Spectrum + Decays + Flavor Observables"
...
If ((MaxVal(Abs(AImag(Yn))).gt.0._dp).OR.(OutputForMG)) Then 
...
Write(io_L,107)1,1,Real(Mn(1,1),dp), "# Real(Mn(1,1),dp)" 
Write(io_L,107)1,2,Real(Mn(1,2),dp), "# Real(Mn(1,2),dp)" 
Write(io_L,107)1,3,Real(Mn(1,3),dp), "# Real(Mn(1,3),dp)" 
Write(io_L,107)2,1,Real(Mn(2,1),dp), "# Real(Mn(2,1),dp)" 
Write(io_L,107)2,2,Real(Mn(2,2),dp), "# Real(Mn(2,2),dp)" 
Write(io_L,107)2,3,Real(Mn(2,3),dp), "# Real(Mn(2,3),dp)" 
Write(io_L,107)3,1,Real(Mn(3,1),dp), "# Real(Mn(3,1),dp)" 
Write(io_L,107)3,2,Real(Mn(3,2),dp), "# Real(Mn(3,2),dp)" 
Write(io_L,107)3,3,Real(Mn(3,3),dp), "# Real(Mn(3,3),dp)" 
If ((MaxVal(Abs(AImag(Mn))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMMN Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(Mn(1,1)), "# Aimag(Mn(1,1))" 
Write(io_L,107)1,2,Aimag(Mn(1,2)), "# Aimag(Mn(1,2))" 
Write(io_L,107)1,3,Aimag(Mn(1,3)), "# Aimag(Mn(1,3))" 
Write(io_L,107)2,1,Aimag(Mn(2,1)), "# Aimag(Mn(2,1))" 
Write(io_L,107)2,2,Aimag(Mn(2,2)), "# Aimag(Mn(2,2))" 
Write(io_L,107)2,3,Aimag(Mn(2,3)), "# Aimag(Mn(2,3))" 
Write(io_L,107)3,1,Aimag(Mn(3,1)), "# Aimag(Mn(3,1))" 
Write(io_L,107)3,2,Aimag(Mn(3,2)), "# Aimag(Mn(3,2))" 
Write(io_L,107)3,3,Aimag(Mn(3,3)), "# Aimag(Mn(3,3))" 
End If 
...
If ((MaxVal(Abs(AImag(YnGUT))).gt.0._dp).OR.(OutputForMG)) Then 
...
Write(io_L,107)1,1,Real(MnGUT(1,1),dp), "# Real(MnGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(MnGUT(1,2),dp), "# Real(MnGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(MnGUT(1,3),dp), "# Real(MnGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(MnGUT(2,1),dp), "# Real(MnGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(MnGUT(2,2),dp), "# Real(MnGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(MnGUT(2,3),dp), "# Real(MnGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(MnGUT(3,1),dp), "# Real(MnGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(MnGUT(3,2),dp), "# Real(MnGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(MnGUT(3,3),dp), "# Real(MnGUT(3,3),dp)" 
If ((MaxVal(Abs(AImag(MnGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMMnGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(MnGUT(1,1)), "# Aimag(MnGUT(1,1))" 
Write(io_L,107)1,2,Aimag(MnGUT(1,2)), "# Aimag(MnGUT(1,2))" 
Write(io_L,107)1,3,Aimag(MnGUT(1,3)), "# Aimag(MnGUT(1,3))" 
Write(io_L,107)2,1,Aimag(MnGUT(2,1)), "# Aimag(MnGUT(2,1))" 
Write(io_L,107)2,2,Aimag(MnGUT(2,2)), "# Aimag(MnGUT(2,2))" 
Write(io_L,107)2,3,Aimag(MnGUT(2,3)), "# Aimag(MnGUT(2,3))" 
Write(io_L,107)3,1,Aimag(MnGUT(3,1)), "# Aimag(MnGUT(3,1))" 
Write(io_L,107)3,2,Aimag(MnGUT(3,2)), "# Aimag(MnGUT(3,2))" 
Write(io_L,107)3,3,Aimag(MnGUT(3,3)), "# Aimag(MnGUT(3,3))" 
End If 
...
Write(io_L,107)1,1,Real(ZX(1,1),dp), "# Real(ZX(1,1),dp)" 
Write(io_L,107)1,2,Real(ZX(1,2),dp), "# Real(ZX(1,2),dp)" 
Write(io_L,107)1,3,Real(ZX(1,3),dp), "# Real(ZX(1,3),dp)" 
Write(io_L,107)2,1,Real(ZX(2,1),dp), "# Real(ZX(2,1),dp)" 
Write(io_L,107)2,2,Real(ZX(2,2),dp), "# Real(ZX(2,2),dp)" 
Write(io_L,107)2,3,Real(ZX(2,3),dp), "# Real(ZX(2,3),dp)" 
...
Write(io_L,107)1,3,Aimag(ZX(1,3)), "# Aimag(ZX(1,3))" 
Write(io_L,107)2,1,Aimag(ZX(2,1)), "# Aimag(ZX(2,1))" 
Write(io_L,107)2,2,Aimag(ZX(2,2)), "# Aimag(ZX(2,2))" 
Write(io_L,107)2,3,Aimag(ZX(2,3)), "# Aimag(ZX(2,3))" 
Write(io_L,107)3,1,Aimag(ZX(3,1)), "# Aimag(ZX(3,1))" 
Write(io_L,107)3,2,Aimag(ZX(3,2)), "# Aimag(ZX(3,2))" 
Write(io_L,107)3,3,Aimag(ZX(3,3)), "# Aimag(ZX(3,3))" 
End If 
...
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,13:174)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,13:174)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,13:174)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRetR(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetR)//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRChi(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetp)//" "//")"
Write(io_L,201) BRChi(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRChi(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetp)//" "//")"
Write(io_L,201) BRChi(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
Write(io_L,201) BRChi(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRChi(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetp)//" "//")"
Write(io_L,201) BRChi(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRChi(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.Scotogenic",status="unknown")
...
Write(123,*) "ZX11_r = ", Real(ZX(1,1),dp)
Write(123,*) "ZX11_i = ", AImag(ZX(1,1))
Write(123,*) "ZX12_r = ", Real(ZX(1,2),dp)
Write(123,*) "ZX12_i = ", AImag(ZX(1,2))
Write(123,*) "ZX13_r = ", Real(ZX(1,3),dp)
Write(123,*) "ZX13_i = ", AImag(ZX(1,3))
Else 
Write(123,*) "ZX11_i = ", Real(ZX(1,1),dp)
Write(123,*) "ZX11_r = ", -AImag(ZX(1,1))
Write(123,*) "ZX12_i = ", Real(ZX(1,2),dp)
Write(123,*) "ZX12_r = ", -AImag(ZX(1,2))
Write(123,*) "ZX13_i = ", Real(ZX(1,3),dp)
Write(123,*) "ZX13_r = ", -AImag(ZX(1,3))
End if 
If (MChi(2).Gt.0._dp) Then 
Write(123,*) "ZX21_r = ", Real(ZX(2,1),dp)
Write(123,*) "ZX21_i = ", AImag(ZX(2,1))
Write(123,*) "ZX22_r = ", Real(ZX(2,2),dp)
Write(123,*) "ZX22_i = ", AImag(ZX(2,2))
Write(123,*) "ZX23_r = ", Real(ZX(2,3),dp)
Write(123,*) "ZX23_i = ", AImag(ZX(2,3))
Else 
Write(123,*) "ZX21_i = ", Real(ZX(2,1),dp)
Write(123,*) "ZX21_r = ", -AImag(ZX(2,1))
Write(123,*) "ZX22_i = ", Real(ZX(2,2),dp)
Write(123,*) "ZX22_r = ", -AImag(ZX(2,2))
Write(123,*) "ZX23_i = ", Real(ZX(2,3),dp)
Write(123,*) "ZX23_r = ", -AImag(ZX(2,3))
End if 
If (MChi(3).Gt.0._dp) Then 
Write(123,*) "ZX31_r = ", Real(ZX(3,1),dp)
Write(123,*) "ZX31_i = ", AImag(ZX(3,1))
Write(123,*) "ZX32_r = ", Real(ZX(3,2),dp)
Write(123,*) "ZX32_i = ", AImag(ZX(3,2))
Write(123,*) "ZX33_r = ", Real(ZX(3,3),dp)
Write(123,*) "ZX33_i = ", AImag(ZX(3,3))
Else 
Write(123,*) "ZX31_i = ", Real(ZX(3,1),dp)
Write(123,*) "ZX31_r = ", -AImag(ZX(3,1))
Write(123,*) "ZX32_i = ", Real(ZX(3,2),dp)
Write(123,*) "ZX32_r = ", -AImag(ZX(3,2))
Write(123,*) "ZX33_i = ", Real(ZX(3,3),dp)
Write(123,*) "ZX33_r = ", -AImag(ZX(3,3))
End if 
...
End Module InputOutput_Scotogenic 
