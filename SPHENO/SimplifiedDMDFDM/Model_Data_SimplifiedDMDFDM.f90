...
Module Model_Data_SimplifiedDMDFDM 
...
Real(dp) :: g1,g2,g3,MDF

Complex(dp) :: lam1,Yu(3,3),Yd(3,3),Ye(3,3),mH2

Real(dp) :: g1IN,g2IN,g3IN,MDFIN

Complex(dp) :: lam1IN,YuIN(3,3),YdIN(3,3),YeIN(3,3),mH2IN

Real(dp) :: g1MZ,g2MZ,g3MZ,MDFMZ

Complex(dp) :: lam1MZ,YuMZ(3,3),YdMZ(3,3),YeMZ(3,3),mH2MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,MDFGUT
...
& gTFd(3),BRFd(3,153),gPFv(3,6),gTFv(3),BRFv(3,6),gPVZ(1,40),gTVZ,BRVZ(1,40),            & 
