...
Program SPhenoSimplifiedDMDFDM 
 
Use Control
Use InputOutput_SimplifiedDMDFDM
Use LoopFunctions
Use RunSM_SimplifiedDMDFDM
Use LowEnergy_SimplifiedDMDFDM
Use FlavorKit_LFV_SimplifiedDMDFDM
Use FlavorKit_QFV_SimplifiedDMDFDM
Use FlavorKit_Observables_SimplifiedDMDFDM
Use Mathematics
Use Model_Data_SimplifiedDMDFDM
Use Tadpoles_SimplifiedDMDFDM 
 Use HiggsCS_SimplifiedDMDFDM
Use TreeLevelMasses_SimplifiedDMDFDM
Use LoopMasses_SimplifiedDMDFDM
 
Use BranchingRatios_SimplifiedDMDFDM
...
Call CalculateLowEnergyConstraints(g1,g2,g3,lam1,Yu,Yd,Ye,MDF,mH2,v,ae,               & 
...
& Yuinput,Ydinput,Yeinput,MDFinput,mH2input,vinput,ae,amu,atau,EDMe,EDMmu,               & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,MDFinput,vinput
...
& Ydinput,Yeinput,MDFinput,mH2input,vinput,g1,g2,g3,lam1,Yu,Yd,Ye,MDF,mH2,               & 
...
MHp=MVWp
MHp2=MVWp2
Call AllCouplings(lam1,v,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,cplAhAhhh,      & 
...
& Yeinput,MDFinput,mH2input,vinput,g1,g2,g3,lam1,Yu,Yd,Ye,MDF,mH2,v,CKM_MZ,              & 
...
End Program SPhenoSimplifiedDMDFDM 
