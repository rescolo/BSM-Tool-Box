...
Real(dp) :: scale_save, Qin, tz, dt, g1D(63), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG63(g1input,g2input,g3input,lam1input,Yuinput,Ydinput,               & 
& Yeinput,MDFinput,mH2input,vinput,g1D)

Call GToParameters63(g1D,g1,g2,g3,lam1,Yu,Yd,Ye,MDF,mH2,v)
...
End Module RunSM_SimplifiedDMDFDM 
