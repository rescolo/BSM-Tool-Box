...
Module TreeLevelMasses_2HDMHiggsBasis 
...
Subroutine TreeMasses(MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,MFd2,MFe,MFe2,               & 
...
& epsD,epsE,Yd,Ye,mH2,mEt2,M12,GenerationMixing,kont)
...
Real(dp),Intent(out) :: MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),          & 
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMasses2HDM/HiggsBasis'
...
MHp2 = (2*(2._dp*(mH2) + lam1*v**2 + lam6*v*vv + lam3*vv**2) + 2*v*vv*Conjg(lam6)     & 
&  + g2**2*v**2*RXiWp)/4._dp 
...
! ------------------------------- 
Metp2 = (2*(2._dp*(mEt2) + lam3*v**2 + lam7*v*vv + lam2*vv**2) + 2*v*vv*Conjg(lam7)   & 
&  + g2**2*vv**2*RXiWp)/4._dp 
...
MFd2 = MFd**2 
Call CalculateMFu(Yu,epsU,v,vv,ZUL,ZUR,MFu,kont)
...
& v,vv,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,Yu,epsU,epsD,epsE,Yd,Ye,              & 
& mH2,mEt2,M12,kont)
...
Subroutine TreeMassesEffPot(MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,MFd2,MFe,              & 
& MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,            & 
& ZUL,ZH,ZW,ZZ,alphaH,v,vv,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,Yu,               & 
& epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,GenerationMixing,kont)
...
MFd2 = MFd**2 
Call CalculateMFuEffPot(Yu,epsU,v,vv,ZUL,ZUR,MFu,kont)
...
Subroutine CalculateMFu(Yu,epsU,v,vv,ZUL,ZUR,MFu,kont)
...
ZUR = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(v*epsU(1,1))/sqrt(2._dp)
mat(1,1) = mat(1,1)+(vv*Yu(1,1))/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(v*epsU(2,1))/sqrt(2._dp)
mat(1,2) = mat(1,2)+(vv*Yu(2,1))/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+(v*epsU(3,1))/sqrt(2._dp)
mat(1,3) = mat(1,3)+(vv*Yu(3,1))/sqrt(2._dp)
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(v*epsU(1,2))/sqrt(2._dp)
mat(2,1) = mat(2,1)+(vv*Yu(1,2))/sqrt(2._dp)
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(v*epsU(2,2))/sqrt(2._dp)
mat(2,2) = mat(2,2)+(vv*Yu(2,2))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(v*epsU(3,2))/sqrt(2._dp)
mat(2,3) = mat(2,3)+(vv*Yu(3,2))/sqrt(2._dp)
mat(3,1) = 0._dp 
mat(3,1) = mat(3,1)+(v*epsU(1,3))/sqrt(2._dp)
mat(3,1) = mat(3,1)+(vv*Yu(1,3))/sqrt(2._dp)
mat(3,2) = 0._dp 
mat(3,2) = mat(3,2)+(v*epsU(2,3))/sqrt(2._dp)
mat(3,2) = mat(3,2)+(vv*Yu(2,3))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(v*epsU(3,3))/sqrt(2._dp)
mat(3,3) = mat(3,3)+(vv*Yu(3,3))/sqrt(2._dp)
...
Subroutine CalculateMFuEffPot(Yu,epsU,v,vv,ZUL,ZUR,MFu,kont)
...
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,vv,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,               & 
& lam5,lam6,Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,GenerationMixing,kont)
...
Subroutine SortGoldstones(MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,MFd2,MFe,MFe2,           & 
& MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,             & 
& ZH,ZW,ZZ,alphaH,kont)
...
End Module TreeLevelMasses_2HDMHiggsBasis 
