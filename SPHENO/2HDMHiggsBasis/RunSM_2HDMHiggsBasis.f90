...
& M12,v,vv,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(132), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG132(g1input,g2input,g3input,lam1input,lam2input,lam4input,          & 
& lam3input,lam7input,lam5input,lam6input,Yuinput,epsUinput,epsDinput,epsEinput,         & 
& Ydinput,Yeinput,mH2input,mEt2input,M12input,vinput,vvinput,g1D)

Call GToParameters132(g1D,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,Yu,             & 
...
vev2=mZ2*CosW2SinW2/(pi*Alpha_mZ) -2*vv**2 
vevSM = sqrt(vev2) 
...
End Module RunSM_2HDMHiggsBasis 
