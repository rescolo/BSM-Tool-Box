...
Module Fe3Decays_2HDMHiggsBasis 
...
Subroutine FeThreeBodyDecay(n_in,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,MFd2,             & 
...
& epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gTetI,gTetp,gThh,gTVWp,gTVZ,gFeFecFdFd,              & 
...
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,           & 
...
& cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFvVZL,cplcFvFvVZR,deltaM)
...
gFeFecFdFdi = 0._dp 
Call FeToFecFdFd(i_run,MFe,MFd,MVZ,MetI,Mhh,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,    & 
...
gFeFecFeFei = 0._dp 
Call FeToFecFeFe(i_run,MFe,MVZ,MetI,Mhh,cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,        & 
...
gFeFecFuFui = 0._dp 
Call FeToFecFuFu(i_run,MFe,MFu,MVZ,MetI,Mhh,cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,    & 
...
gFeFecFvFvi = 0._dp 
Call FeToFecFvFv(i_run,MFe,MVZ,MVWp,Metp,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,       & 
& cplcFeFvcetpR,cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,      & 
& cplcFvFeetpR,cplcFvFvVZL,cplcFvFvVZR,IntegralSs,IntegralSSss,IntegralVs,               & 
& IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NVs,NVSss,               & 
& NVSst,NVVss,NVVst,gTVZtemp,gTVWptemp,gTetptemp,deltaM,epsI,check,gFeFecFvFvi)

gFeFecFvFv(i_run,:,:,:) = gFeFecFvFvi 
gT(i_run) = gT(i_run) + Sum(gFeFecFvFvi) 
 
gFeFvcFuFdi = 0._dp 
Call FeToFvcFuFd(i_run,MFu,MFd,MVWp,Metp,MFe,cplcFeFvcetpL,cplcFeFvcetpR,             & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFdetpL,cplcFuFdetpR,       & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
& NVSss,NVVss,gTVWptemp,gTetptemp,deltaM,epsI,check,gFeFvcFuFdi)
...
Subroutine FeToFecFdFd(iIN,MFe,MFd,MVZ,MetI,Mhh,cplcFdFdetIL,cplcFdFdetIR,            & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeetIL,cplcFeFeetIR,             & 
...
Real(dp),Intent(in) :: MFe(3),MFd(3),MVZ,MetI,Mhh(2)
...
coup(2) = Conjg(cplcFeFeetIL(iIN,gt1)) 
coup(1) = Conjg(cplcFeFeetIR(iIN,gt1)) 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFd Fd Propagator: etI" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplcFeFeetIL(iIN,gt1)) 
coup2(4) = Conjg(cplcFeFeetIR(iIN,gt1))  
...
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFd Fd Propagator: VZ,etI" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFeFeetIL(iIN,gt1) 
coup2(2) = cplcFeFeetIR(iIN,gt1) 
coup2(3) = Conjg(cplcFeFehhL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFeFehhR(iIN,gt1,i2))  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFd Fd Propagator: etI,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FeToFecFeFe(iIN,MFe,MVZ,MetI,Mhh,cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,    & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,IntegralSs,IntegralSSss,IntegralSSst,              & 
& IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,              & 
...
Real(dp),Intent(in) :: MFe(3),MVZ,MetI,Mhh(2)
...
coup(2) = Conjg(cplcFeFeetIL(iIN,gt3)) 
coup(1) = Conjg(cplcFeFeetIR(iIN,gt3)) 
coup(4) = Conjg(cplcFeFeetIL(gt2,gt1)) 
coup(3) = Conjg(cplcFeFeetIR(gt2,gt1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt3) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplcFeFeetIL(iIN,gt3) 
coup2(2) = cplcFeFeetIR(iIN,gt3) 
coup2(3) = Conjg(cplcFeFeetIL(iIN,gt1)) 
coup2(4) = Conjg(cplcFeFeetIR(iIN,gt1))  
coup2(5) = cplcFeFeetIL(gt2,gt1) 
coup2(6) = cplcFeFeetIR(gt2,gt1) 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFe Fe Propagator: etI" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFeFeVZL(iIN,gt3) 
coup2(2) = cplcFeFeVZR(iIN,gt3) 
coup2(3) = Conjg(cplcFeFeetIL(iIN,gt3)) 
coup2(4) = Conjg(cplcFeFeetIR(iIN,gt3))  
coup2(5) = cplcFeFeVZL(gt2,gt1) 
coup2(6) = cplcFeFeVZR(gt2,gt1) 
coup2(7) = Conjg(cplcFeFeetIL(gt2,gt1)) 
coup2(8) = Conjg(cplcFeFeetIR(gt2,gt1)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFe Fe Propagator: VZ,etI" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFe Fe Propagator: etI,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FeToFecFuFu(iIN,MFe,MFu,MVZ,MetI,Mhh,cplcFeFeetIL,cplcFeFeetIR,            & 
...
Real(dp),Intent(in) :: MFe(3),MFu(3),MVZ,MetI,Mhh(2)
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFu Fu Propagator: etI" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFu Fu Propagator: VZ,etI" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFu Fu Propagator: etI,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FeToFecFvFv(iIN,MFe,MVZ,MVWp,Metp,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,   & 
& cplcFeFvcetpR,cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,      & 
& cplcFvFeetpR,cplcFvFvVZL,cplcFvFvVZR,IntegralSs,IntegralSSss,IntegralVs,               & 
& IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NVs,NVSss,               & 
& NVSst,NVVss,NVVst,gTVZ,gTVWp,gTetp,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MVZ,MVWp,Metp

Complex(dp),Intent(in) :: cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvcetpL(3,3),cplcFeFvcetpR(3,3),              & 
& cplcFeFvVWpL(3,3),cplcFeFvVWpR(3,3),cplcFvFecVWpL(3,3),cplcFvFecVWpR(3,3),             & 
...
Real(dp),Intent(inout) :: gTVZ,gTVWp,gTetp
...
coup(2) = Conjg(cplcFeFvVWpL(iIN,gt3)) 
coup(1) = Conjg(cplcFeFvVWpR(iIN,gt3)) 
coup(4) = Conjg(cplcFvFecVWpL(gt2,gt1)) 
coup(3) = Conjg(cplcFvFecVWpR(gt2,gt1))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFv Fv Propagator: VWp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplcFeFvcetpL(iIN,gt3)) 
coup(1) = Conjg(cplcFeFvcetpR(iIN,gt3)) 
coup(4) = Conjg(cplcFvFeetpL(gt2,gt1)) 
coup(3) = Conjg(cplcFvFeetpR(gt2,gt1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFv Fv Propagator: conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFeFeVZL(iIN,gt1) 
coup2(2) = cplcFeFeVZR(iIN,gt1) 
coup2(4) = Conjg(cplcFeFvVWpL(iIN,gt3)) 
coup2(3) = Conjg(cplcFeFvVWpR(iIN,gt3))  
coup2(5) = cplcFvFvVZL(gt2,gt3) 
coup2(6) = cplcFvFvVZR(gt2,gt3) 
coup2(8) = Conjg(cplcFvFecVWpL(gt2,gt1)) 
coup2(7) = Conjg(cplcFvFecVWpR(gt2,gt1)) 
Call IntegrateGaugeST(Boson4, mass, coup2, deltaM, epsI,IntegralVVst,NVVst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFv Fv Propagator: VZ,VWp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFeFeVZL(iIN,gt1) 
coup2(2) = cplcFeFeVZR(iIN,gt1) 
coup2(3) = Conjg(cplcFeFvcetpL(iIN,gt3)) 
coup2(4) = Conjg(cplcFeFvcetpR(iIN,gt3))  
coup2(5) = cplcFvFvVZL(gt2,gt3) 
coup2(6) = cplcFvFvVZR(gt2,gt3) 
coup2(7) = Conjg(cplcFvFeetpL(gt2,gt1)) 
coup2(8) = Conjg(cplcFvFeetpR(gt2,gt1)) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFv Fv Propagator: VZ,conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFeFvVWpL(iIN,gt3) 
coup2(2) = cplcFeFvVWpR(iIN,gt3) 
coup2(3) = Conjg(cplcFeFvcetpL(iIN,gt3)) 
coup2(4) = Conjg(cplcFeFvcetpR(iIN,gt3))  
coup2(5) = cplcFvFecVWpL(gt2,gt1) 
coup2(6) = cplcFvFecVWpR(gt2,gt1) 
coup2(7) = Conjg(cplcFvFeetpL(gt2,gt1)) 
coup2(8) = Conjg(cplcFvFeetpR(gt2,gt1)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe cFv Fv Propagator: VWp,conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='VWp,conj[etp]'
...
Subroutine FeToFvcFuFd(iIN,MFu,MFd,MVWp,Metp,MFe,cplcFeFvcetpL,cplcFeFvcetpR,         & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFdetpL,cplcFuFdetpR,       & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
...
Real(dp),Intent(in) :: MFu(3),MFd(3),MVWp,Metp,MFe(3)
...
coup(2) = Conjg(cplcFeFvVWpL(iIN,gt1)) 
coup(1) = Conjg(cplcFeFvVWpR(iIN,gt1)) 
coup(4) = Conjg(cplcFuFdcVWpL(gt2,gt3)) 
coup(3) = Conjg(cplcFuFdcVWpR(gt2,gt3))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFu Fd Propagator: VWp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplcFeFvcetpL(iIN,gt1)) 
coup(1) = Conjg(cplcFeFvcetpR(iIN,gt1)) 
coup(4) = Conjg(cplcFuFdetpL(gt2,gt3)) 
coup(3) = Conjg(cplcFuFdetpR(gt2,gt3))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFu Fd Propagator: conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFeFvVWpL(iIN,gt1) 
coup2(2) = cplcFeFvVWpR(iIN,gt1) 
coup2(3) = Conjg(cplcFeFvcetpL(iIN,gt1)) 
coup2(4) = Conjg(cplcFeFvcetpR(iIN,gt1))  
coup2(5) = cplcFuFdcVWpL(gt2,gt3) 
coup2(6) = cplcFuFdcVWpR(gt2,gt3) 
coup2(7) = Conjg(cplcFuFdetpL(gt2,gt3)) 
coup2(8) = Conjg(cplcFuFdetpR(gt2,gt3)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFu Fd Propagator: VWp,conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End Module Fe3Decays_2HDMHiggsBasis 
