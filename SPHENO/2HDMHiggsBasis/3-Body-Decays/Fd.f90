...
Module Fd3Decays_2HDMHiggsBasis 
...
Subroutine FdThreeBodyDecay(n_in,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,MFd2,             & 
...
& epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gTetI,gTetp,gThh,gTVWp,gTVZ,gFdFdcFdFd,              & 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFdetpL,cplcFuFdetpR,         & 
...
gFdFdcFuFui = 0._dp 
Call FdToFdcFuFu(i_run,MFd,MFu,MVZ,MVWp,Metp,MetI,Mhh,cplcFdFdetIL,cplcFdFdetIR,      & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,           & 
...
& gTVWptemp,gTetptemp,gTetItemp,gThhtemp,deltaM,epsI,check,gFdFdcFuFui)
...
gFdFucFvFei = 0._dp 
Call FdToFucFvFe(i_run,MFu,MFe,MVWp,Metp,MFd,cplcFdFucetpL,cplcFdFucetpR,             & 
& cplcFdFuVWpL,cplcFdFuVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
& NVSss,NVVss,gTVWptemp,gTetptemp,deltaM,epsI,check,gFdFucFvFei)
...
Subroutine FdToFdcFuFu(iIN,MFd,MFu,MVZ,MVWp,Metp,MetI,Mhh,cplcFdFdetIL,               & 
...
Real(dp),Intent(in) :: MFd(3),MFu(3),MVZ,MVWp,Metp,MetI,Mhh(2)
...
coup(2) = Conjg(cplcFdFucetpL(iIN,gt3)) 
coup(1) = Conjg(cplcFdFucetpR(iIN,gt3)) 
coup(4) = Conjg(cplcFuFdetpL(gt2,gt1)) 
coup(3) = Conjg(cplcFuFdetpR(gt2,gt1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFdFdVZL(iIN,gt1) 
coup2(2) = cplcFdFdVZR(iIN,gt1) 
coup2(3) = Conjg(cplcFdFucetpL(iIN,gt3)) 
coup2(4) = Conjg(cplcFdFucetpR(iIN,gt3))  
coup2(5) = cplcFuFuVZL(gt2,gt3) 
coup2(6) = cplcFuFuVZR(gt2,gt3) 
coup2(7) = Conjg(cplcFuFdetpL(gt2,gt1)) 
coup2(8) = Conjg(cplcFuFdetpR(gt2,gt1)) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: VZ,conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: VWp,conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFdFucetpL(iIN,gt3) 
coup2(2) = cplcFdFucetpR(iIN,gt3) 
coup2(3) = Conjg(cplcFdFdetIL(iIN,gt1)) 
coup2(4) = Conjg(cplcFdFdetIR(iIN,gt1))  
coup2(5) = cplcFuFdetpL(gt2,gt1) 
coup2(6) = cplcFuFdetpR(gt2,gt1) 
coup2(7) = Conjg(cplcFuFuetIL(gt2,gt3)) 
coup2(8) = Conjg(cplcFuFuetIR(gt2,gt3)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[etp],etI" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[etp],hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[etp],hh'
      End Do 
...
Subroutine FdToFucFvFe(iIN,MFu,MFe,MVWp,Metp,MFd,cplcFdFucetpL,cplcFdFucetpR,         & 
& cplcFdFuVWpL,cplcFdFuVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
...
Real(dp),Intent(in) :: MFu(3),MFe(3),MVWp,Metp,MFd(3)

Complex(dp),Intent(in) :: cplcFdFucetpL(3,3),cplcFdFucetpR(3,3),cplcFdFuVWpL(3,3),cplcFdFuVWpR(3,3),            & 
& cplcFvFecVWpL(3,3),cplcFvFecVWpR(3,3),cplcFvFeetpL(3,3),cplcFvFeetpR(3,3)
...
coup(4) = Conjg(cplcFvFecVWpL(gt2,gt3)) 
coup(3) = Conjg(cplcFvFecVWpR(gt2,gt3))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu cFv Fe Propagator: VWp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplcFdFucetpL(iIN,gt1)) 
coup(1) = Conjg(cplcFdFucetpR(iIN,gt1)) 
coup(4) = Conjg(cplcFvFeetpL(gt2,gt3)) 
coup(3) = Conjg(cplcFvFeetpR(gt2,gt3))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu cFv Fe Propagator: conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplcFdFucetpL(iIN,gt1)) 
coup2(4) = Conjg(cplcFdFucetpR(iIN,gt1))  
coup2(5) = cplcFvFecVWpL(gt2,gt3) 
coup2(6) = cplcFvFecVWpR(gt2,gt3) 
coup2(7) = Conjg(cplcFvFeetpL(gt2,gt3)) 
coup2(8) = Conjg(cplcFvFeetpR(gt2,gt3)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu cFv Fe Propagator: VWp,conj[etp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End Module Fd3Decays_2HDMHiggsBasis 
