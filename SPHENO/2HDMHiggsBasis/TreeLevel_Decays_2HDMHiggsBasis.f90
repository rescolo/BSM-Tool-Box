...
Module TreeLevelDecays_2HDMHiggsBasis
...
Subroutine FuTwoBodyDecay(i_in,deltaM,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gPartial,gT,BR)

Implicit None 
 
Real(dp),Intent(in) :: g1,g2,g3,lam5,v,vv,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd(3),MFd2(3),MFe(3),              & 
& MFe2(3),MFu(3),MFu2(3),Mhh(2),Mhh2(2),MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZH(2,2),         & 
& ZZ(2,2),alphaH

Complex(dp),Intent(in) :: lam1,lam2,lam4,lam3,lam7,lam6,Yu(3,3),epsU(3,3),epsD(3,3),epsE(3,3),Yd(3,3),          & 
& Ye(3,3),mH2,mEt2,M12,ZDR(3,3),ZER(3,3),ZUR(3,3),ZDL(3,3),ZEL(3,3),ZUL(3,3),ZW(2,2)

Complex(dp) :: cplcFuFuetIL(3,3),cplcFuFuetIR(3,3),cplcFuFdetpL(3,3),cplcFuFdetpR(3,3),              & 
...
Call CouplingsFor_Fu_decays_2B(m_in,i1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,cplcFuFuetIL,cplcFuFuetIR,cplcFuFdetpL,      & 
& cplcFuFdetpR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,          & 
& cplcFuFuVZR,deltaM)
...
m1out = MFd(gt1)
m2out = Metp
coupL = cplcFuFdetpL(i1,gt1)
coupR = cplcFuFdetpR(i1,gt1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
Subroutine FeTwoBodyDecay(i_in,deltaM,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gPartial,gT,BR)
...
m_in = MFe(i1) 
If (m_in.Eq.0._dp) Cycle 
Call CouplingsFor_Fe_decays_2B(m_in,i1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,       & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvVWpL,cplcFeFvVWpR,cplcFeFvcetpL,           & 
& cplcFeFvcetpR,deltaM)
...
m1out = 0.
m2out = Metp
coupL = cplcFeFvcetpL(i1,gt1)
coupR = cplcFeFvcetpR(i1,gt1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
Subroutine FdTwoBodyDecay(i_in,deltaM,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gPartial,gT,BR)
...
m_in = MFd(i1) 
If (m_in.Eq.0._dp) Cycle 
Call CouplingsFor_Fd_decays_2B(m_in,i1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,       & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFdFucetpL,           & 
& cplcFdFucetpR,deltaM)
...
m1out = MFu(gt1)
m2out = Metp
coupL = cplcFdFucetpL(i1,gt1)
coupR = cplcFdFucetpR(i1,gt1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
Subroutine FvTwoBodyDecay(i_in,deltaM,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gPartial,gT,BR)
...
Complex(dp) :: cplcFvFeetpL(3,3),cplcFvFeetpR(3,3),cplcFvFecVWpL(3,3),cplcFvFecVWpR(3,3),            & 
...
m_in = 0. 
If (m_in.Eq.0._dp) Cycle 
Call CouplingsFor_Fv_decays_2B(m_in,i1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,cplcFvFeetpL,cplcFvFeetpR,cplcFvFecVWpL,     & 
& cplcFvFecVWpR,cplcFvFvVZL,cplcFvFvVZR,deltaM)
...
m1out = MFe(gt1)
m2out = Metp
coupL = cplcFvFeetpL(i1,gt1)
coupR = cplcFvFeetpR(i1,gt1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = MFe(gt1)
m2out = MVWp
coupL = cplcFvFecVWpL(i1,gt1)
coupR = cplcFvFecVWpR(i1,gt1)
Call FermionToFermionVectorBoson(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
Subroutine VZTwoBodyDecay(i_in,deltaM,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gPartial,gT,BR)
...
Complex(dp) :: cpletIhhVZ(2),cpletpVWpVZ,cpletpcetpVZ,cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),             & 
...
i1=1 
m_in = MVZ 
Call CouplingsFor_VZ_decays_2B(m_in,i1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,cpletIhhVZ,cpletpVWpVZ,cpletpcetpVZ,         & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcFvFvVZL,cplcFvFvVZR,cplhhVZVZ,cplcVWpVWpVZ,deltaM)
...
Subroutine VWpTwoBodyDecay(i_in,deltaM,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gPartial,gT,BR)
...
Complex(dp) :: cpletIcetpcVWp,cplcFuFdcVWpL(3,3),cplcFuFdcVWpR(3,3),cplcFvFecVWpL(3,3),              & 
...
& ZER,ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,            & 
& lam6,Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,cpletIcetpcVWp,cplcFuFdcVWpL,           & 
& cplcFuFdcVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplhhcVWpVWp,cplhhcetpcVWp,cplcVWpVWpVZ,     & 
& cplcetpcVWpVZ,deltaM)
...
m1out = 0.
m2out = MFe(gt2)
coupL = cplcFvFecVWpL(gt1,gt2)
coupR = cplcFvFecVWpR(gt1,gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
Subroutine hhTwoBodyDecay(i_in,deltaM,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gPartial,gT,BR)
...
m_in = Mhh(i1) 
If (m_in.Eq.0._dp) Cycle 
Call CouplingsFor_hh_decays_2B(m_in,i1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,        & 
& cplHiggsWWvirt,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cpletphhVWp,cpletphhcetp,             & 
...
Subroutine etpTwoBodyDecay(i_in,deltaM,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gPartial,gT,BR)
...
Complex(dp) :: cpletIetpcetp,cpletIcetpcVWp,cpletphhcetp(2),cpletpcetpVZ,cplcFdFucetpL(3,3),         & 
...
& MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,               & 
& ZER,ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,            & 
& lam6,Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,cpletIetpcetp,cpletIcetpcVWp,           & 
& cpletphhcetp,cpletpcetpVZ,cplcFdFucetpL,cplcFdFucetpR,cplcFeFvcetpL,cplcFeFvcetpR,     & 
& cplhhcetpcVWp,cplcetpcVWpVZ,deltaM)
...
m1out = MFd(gt1)
m2out = MFu(gt2)
coupL = cplcFdFucetpL(gt1,gt2)
coupR = cplcFdFucetpR(gt1,gt2)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(1,i_count) = 3*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
m1out = MFe(gt1)
m2out = 0.
coupL = cplcFeFvcetpL(gt1,gt2)
coupR = cplcFeFvcetpR(gt1,gt2)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
Subroutine etITwoBodyDecay(i_in,deltaM,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,           & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,gPartial,gT,BR)
...
Complex(dp) :: cpletIetIetI,cpletIetIhh(2),cpletIetpVWp,cpletIetpcetp,cplcFdFdetIL(3,3),             & 
...
& MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,               & 
& ZER,ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,            & 
& lam6,Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,cpletIetIetI,cpletIetIhh,               & 
& cpletIetpVWp,cpletIetpcetp,cplcFdFdetIL,cplcFdFdetIR,cplcFeFeetIL,cplcFeFeetIR,        & 
& cplcFuFuetIL,cplcFuFuetIR,cpletIhhhh,cpletIhhVZ,deltaM)
...
End Module TreeLevelDecays_2HDMHiggsBasis 
