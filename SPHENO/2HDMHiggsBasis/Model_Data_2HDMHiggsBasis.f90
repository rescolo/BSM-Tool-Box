...
Module Model_Data_2HDMHiggsBasis 
...
Complex(dp) :: lam1IN,lam2IN,lam4IN,lam3IN,lam7IN,lam6IN,YuIN(3,3),epsUIN(3,3),epsDIN(3,3),          & 
& epsEIN(3,3),YdIN(3,3),YeIN(3,3),mH2IN,mEt2IN,M12IN

Real(dp) :: g1MZ,g2MZ,g3MZ,lam5MZ

Complex(dp) :: lam1MZ,lam2MZ,lam4MZ,lam3MZ,lam7MZ,lam6MZ,YuMZ(3,3),epsUMZ(3,3),epsDMZ(3,3),          & 
& epsEMZ(3,3),YdMZ(3,3),YeMZ(3,3),mH2MZ,mEt2MZ,M12MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,lam5GUT

Complex(dp) :: lam1GUT,lam2GUT,lam4GUT,lam3GUT,lam7GUT,lam6GUT,YuGUT(3,3),epsUGUT(3,3),              & 
& epsDGUT(3,3),epsEGUT(3,3),YdGUT(3,3),YeGUT(3,3),mH2GUT,mEt2GUT,M12GUT
...
Real(dp) :: gPFu(3,153),gTFu(3),BRFu(3,153),gPFe(3,153),gTFe(3),BRFe(3,153),gPFd(3,153),          & 
...
Real(dp) :: ratioetp(2),ratioFd(2,3),ratioFe(2,3),ratioFu(2,3),ratioHp(2),ratioVWp(2)
...
Logical, save :: InputValueforvv =.False. 
...
Real(dp) :: BRHHH(2,2), BRHAA(2,1) 
 Real(dp) :: BRAHH(1,2), BRAAA(1,1) 
 Real(dp) :: BRinvH(2), BRinvA(1) 
...
End Module Model_Data_2HDMHiggsBasis