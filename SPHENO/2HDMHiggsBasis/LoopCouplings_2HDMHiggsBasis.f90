...
Module LoopCouplings_2HDMHiggsBasis 
...
& ratVWp,Metp,MHp,MFd,MFe,MFu,MVWp,gNLO,coup)

Implicit None 
Complex(dp),Intent(in) :: ratetp,ratFd(3),ratFe(3),ratFu(3),ratHp,ratVWp

Real(dp),Intent(in) :: Metp,MHp,MFd(3),MFe(3),MFu(3),MVWp
...
HPPloopetp(inG) = HPPloopetp(inG)+1*(1)**2*ratetp*A_zero(mH2p/Metp**2)
...
Subroutine CoupHiggsToPhotonSM(mHiggs,Metp,MHp,MFd,MFe,MFu,MVWp,gNLO,coup)
...
& ratHp,ratVWp,Metp,MHp,MFd,MFe,MFu,MVWp,gNLO,coup)
...
Subroutine CoupPseudoHiggsToPhotonSM(mHiggs,Metp,MHp,MFd,MFe,MFu,MVWp,gNLO,coup)
...
End Module LoopCouplings_2HDMHiggsBasis 
