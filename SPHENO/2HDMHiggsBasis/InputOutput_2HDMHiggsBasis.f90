...
Module InputOutput_2HDMHiggsBasis 
...
InputValueforYe= .True. 
   ...
   Else If (read_line(7:10).Eq."VVIN") Then 
    Call Read_VVIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."IMVVIN") Then 
    Call Read_VVIN(99,1,i_model,set_mod_par,kont) 
...
Complex(dp) :: PDGhh(2),PDGAh,PDGHp,PDGetI,PDGetp,PDGVP,PDGVZ,PDGVWp,PDGVG,PDGgP,PDGgWp,             & 
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - 2HDM/HiggsBasis Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 8, Real(mEt2Input,dp) ,"# mEt2Input"
...
Write(io_L,101) 8, Aimag(mEt2Input) ,"# mEt2Input"
End if 
End if 
...
Write(io_L,104) 8,Real(lam7,dp), "# lam7" 
...
Write(io_L,104) 9,Real(M12,dp), "# M12" 
...
Write(io_L,104) 8,Aimag(lam7), "# lam7" 
Write(io_L,104) 7,Aimag(lam6), "# lam6" 
Write(io_L,104) 1,Aimag(mEt2), "# mEt2" 
Write(io_L,104) 9,Aimag(M12), "# M12" 
End if 
WriteNextBlock = .false. 
...
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block VV Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(vv,dp), "# vv" 
Write(io_L,104) 1,Real(vv,dp), "# vv" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMVV Q=",Q,"# (Renormalization Scale)" 
End if 
WriteNextBlock = .false. 
...
WriteNextBlock = .false. 
Write(io_L,106) "Block TREEHDM Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 9,Real(M12Tree,dp), "# M12" 
If (Abs(Aimag(M12Tree)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block TREEIMHDM Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 9,Aimag(M12Tree), "# M12" 
End if 
WriteNextBlock = .false. 
...
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block LOOPHDM Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 9,Real(M121L,dp), "# M12" 
If (Abs(Aimag(M121L)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block LOOPIMHDM Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 9,Aimag(M121L), "# M12" 
End if 
WriteNextBlock = .false. 
...
Write(io_L,122) CurrentPDG2(1), CurrentPDG2(2), HPPloopetp(i1), " # h(",i1,")-etp(",i2,")-loop " 
End do 
Do i2=1,1
...
Write(io_L,201) BRFu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFu(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRFu(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFu(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRFu(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,19:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,19:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,19:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,201) BRFd(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFd(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
...
Write(io_L,201) BRFd(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFd(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
...
Write(io_L,201) BRFd(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGetp 
Write(io_L,201) BRFd(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleetp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
...
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRVZ(1,icount).Gt.BrMin) Then 
...
Write(io_L,201) BRVZ(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleetp)//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRVZ(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGFd(gt2) 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleFv(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
  End Do 
  Do gt2=1, 2
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleetI)//" "//")"
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRhh(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetp 
...
Write(io_L,201) BRhh(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleetp)//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRhh(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleetI)//" "//")"
If (((gTetI.le.WidthToBeInvisible).and.(gTetI.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRhh(2,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRhh(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetp 
...
Write(io_L,201) BRhh(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleetp)//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRhh(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleetp)//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
If (BRetp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetI 
...
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRetp(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGFu(gt2) 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFu(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (BRetp(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
End if 
...
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 2
If (BRetI(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRetI(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
CurrentPDG2(2) = PDGFd(gt2) 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFu(gt2) 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFu(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.2HDMHiggsBasis",status="unknown")
...
Subroutine Read_VVIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block VVIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMVVIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block VVIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMVVIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_VVIN 
...
End Module InputOutput_2HDMHiggsBasis 
