...
Program SPheno2HDMHiggsBasis 
 
Use Control
Use InputOutput_2HDMHiggsBasis
Use LoopFunctions
Use RunSM_2HDMHiggsBasis
Use LowEnergy_2HDMHiggsBasis
Use FlavorKit_LFV_2HDMHiggsBasis
Use FlavorKit_QFV_2HDMHiggsBasis
Use FlavorKit_Observables_2HDMHiggsBasis
Use Mathematics
Use Model_Data_2HDMHiggsBasis
Use Tadpoles_2HDMHiggsBasis 
 Use HiggsCS_2HDMHiggsBasis
Use TreeLevelMasses_2HDMHiggsBasis
Use LoopMasses_2HDMHiggsBasis
 
Use BranchingRatios_2HDMHiggsBasis
...
Call OneLoopMasses(MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,MFd2,MFe,MFe2,MFu,              & 
& MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZH,              & 
& ZW,ZZ,alphaH,v,vv,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,Yu,epsU,epsD,            & 
& epsE,Yd,Ye,mH2,mEt2,M12,kont)
...
& Metp,Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,           & 
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,alphaH,v,vv,g1,g2,g3,lam1,lam2,lam4,               & 
& lam3,lam7,lam5,lam6,Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,gPFu,gTFu,BRFu,               & 
& gPFe,gTFe,BRFe,gPFd,gTFd,BRFd,gPFv,gTFv,BRFv,gPVZ,gTVZ,BRVZ,gPVWp,gTVWp,               & 
& BRVWp,gPhh,gThh,BRhh,gPetp,gTetp,BRetp,gPetI,gTetI,BRetI)
...
& lam6,Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,ae,amu,atau,EDMe,EDMmu,EDMtau,          & 
...
& lam2,lam4,lam3,lam7,lam5,lam6,Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,kont)
...
& lam2input,lam4input,lam3input,lam7input,lam5input,lam6input,Yuinput,epsUinput,         & 
& epsDinput,epsEinput,Ydinput,Yeinput,mH2input,mEt2input,M12input,vinput,vvinput,        & 
...
Complex(dp),Intent(inout) :: lam1input,lam2input,lam4input,lam3input,lam7input,lam6input,Yuinput(3,3),             & 
...
Complex(dp) :: cplAhAhAh,cplAhAhcVWpVWp,cplAhAhetI,cplAhAhhh(2),cplAhAhVZVZ,cplAhcHpcVWp,            & 
& cplAhetIetI,cplAhetIhh(2),cplAhetpcetp,cplAhetpcHp,cplAhhhhh(2,2),cplAhhhVZ(2),        & 
& cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,cplcFdFdAhL(3,3),        & 
...
& cplcFdFucHpL(3,3),cplcFdFucHpR(3,3),cplcFdFuVWpL(3,3),cplcFdFuVWpR(3,3),               & 
...
& cplcFuFdetpL(3,3),cplcFuFdetpR(3,3),cplcFuFdHpL(3,3),cplcFuFdHpR(3,3),cplcFuFuAhL(3,3),& 
& cplcFuFuAhR(3,3),cplcFuFuetIL(3,3),cplcFuFuetIR(3,3),cplcFuFuhhL(3,3,2),               & 
...
& cplcFvFeetpL(3,3),cplcFvFeetpR(3,3),cplcFvFeHpL(3,3),cplcFvFeHpR(3,3),cplcFvFvVZL(3,3),& 
& cplcFvFvVZR(3,3),cplcgAgWpcVWp,cplcgWCgAcVWp,cplcgWCgWCVZ,cplcgWCgZcVWp,               & 
& cplcgWpgWpVZ,cplcgZgWpcVWp,cplcHpcVWpVP,cplcHpcVWpVZ,cplcVWpcVWpVWpVWp1,               & 
...
& cpletIcetpcVWp,cpletIetIcVWpVWp,cpletIetIetI,cpletIetIhh(2),cpletIetIVZVZ,             & 
& cpletIetpcetp,cpletIetpcHp,cpletIetpVWp,cpletIhhhh(2,2),cpletIhhVZ(2),cpletIHpcetp,    & 
& cpletIHpcHp,cpletpcetpcVWpVWp,cpletpcetpVP,cpletpcetpVZ,cpletpcetpVZVZ,cpletphhcetp(2),& 
& cpletphhcHp(2),cpletphhVWp(2),cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp(2),cplhhcHpcVWp(2),& 
& cplhhcVWpVWp(2),cplhhhhcVWpVWp(2,2),cplhhhhhh(2,2,2),cplhhhhVZVZ(2,2),cplhhHpcetp(2),  & 
& cplhhHpcHp(2),cplhhHpVWp(2),cplhhVZVZ(2),cplHpcHpcVWpVWp,cplHpcHpVP,cplHpcHpVZ,        & 
& cplHpcHpVZVZ,cplHpVPVWp,cplHpVWpVZ,cplVGVGVG
...
& epsEinput,Ydinput,Yeinput,mH2input,mEt2input,M12input,vinput,vvinput,g1,               & 
& g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,             & 
& M12,v,vv,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHp=MVWp
MHp2=MVWp2
Call AllCouplings(lam6,vv,v,lam1,lam4,lam3,lam5,ZH,lam7,lam2,g1,g2,TW,g3,             & 
& Yd,ZDL,ZDR,Ye,ZEL,ZER,epsU,ZUL,ZUR,epsD,epsE,Yu,cplAhAhAh,cplAhAhetI,cplAhAhhh,        & 
& cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,cplAhhhhh,cplAhHpcetp,cplAhHpcHp,      & 
& cpletIetIetI,cpletIetIhh,cpletIetpcetp,cpletIetpcHp,cpletIhhhh,cpletIHpcetp,           & 
& cpletIHpcHp,cpletphhcetp,cpletphhcHp,cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplAhhhVZ,       & 
& cplAhHpVWp,cplAhcHpcVWp,cpletIetpVWp,cpletIhhVZ,cpletIcetpcVWp,cpletphhVWp,            & 
& cpletpcetpVP,cpletpcetpVZ,cplhhHpVWp,cplhhcetpcVWp,cplhhcHpcVWp,cplHpcHpVP,            & 
& cplHpcHpVZ,cpletpVPVWp,cpletpVWpVZ,cplhhcVWpVWp,cplhhVZVZ,cplHpVPVWp,cplHpVWpVZ,       & 
& cplcetpcVWpVP,cplcHpcVWpVP,cplcetpcVWpVZ,cplcHpcVWpVZ,cplVGVGVG,cplcVWpVPVWp,          & 
...
& cplcFuFdcVWpR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecVWpL,           & 
& cplcFvFecVWpR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWpL,            & 
& cplcFdFuVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFvVZL,            & 
& cplcFvFvVZR)
...
Call CalculateBox2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,           & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeAhL,cplcFeFeAhR,           & 
& cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,         & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFdetpL,cplcFuFdetpR,       & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuetIL,cplcFuFuetIR,             & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcHpcVWpVP,cplcHpcVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,cpletIcetpcVWp,cpletIetIetI,       & 
& cpletIetIhh,cpletIetpcetp,cpletIetpcHp,cpletIetpVWp,cpletIhhhh,cpletIhhVZ,             & 
& cpletIHpcetp,cpletIHpcHp,cpletpcetpVP,cpletpcetpVZ,cpletphhcetp,cpletphhcHp,           & 
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,BOddllSLL(gt1,gt2,gt3,gt4),BOddllSRR(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,PSOddllSLL(gt1,gt2,gt3,gt4),PSOddllSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,PVOddllSLL(gt1,gt2,gt3,gt4),PVOddllSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TSOddllSLL(gt1,gt2,gt3,gt4),TSOddllSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TVOddllSLL(gt1,gt2,gt3,gt4),TVOddllSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,              & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
& cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvVWpL,cplcFeFvVWpR,cplcFuFdcVWpL,       & 
& cplcFuFdcVWpR,cplcFuFdetpL,cplcFuFdetpR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFuVZL,           & 
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,BOddvvVRR(gt1,gt2,gt3,gt4)    & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,            & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
...
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,PSOddvvVRR(gt1,gt2,gt3,gt4)   & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,            & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
...
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,PVOddvvVRR(gt1,gt2,gt3,gt4)   & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,            & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
...
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,TSOddvvVRR(gt1,gt2,gt3,gt4)   & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,            & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
...
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,TVOddvvVRR(gt1,gt2,gt3,gt4)   & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,           & 
& MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,          & 
& cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,cplAhhhhh,      & 
& cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,       & 
& cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFdetpL,cplcFuFdetpR,cplcFuFdHpL,cplcFuFdHpR,         & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,BO4dSLL(gt1,gt2,gt3,gt4),BO4dSRR(gt1,gt2,gt3,gt4),               & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,               & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TSO4dSLL(gt1,gt2,gt3,gt4),TSO4dSRR(gt1,gt2,gt3,gt4)              & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,               & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TVO4dSLL(gt1,gt2,gt3,gt4),TVO4dSRR(gt1,gt2,gt3,gt4)              & 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,1 
  gt3=i2 
Call CalculateA2q(gt1,gt2,gt3,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,             & 
& MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,              & 
& cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,cplAhhhhh,      & 
& cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,      & 
& cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,              & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFdetpL,       & 
& cplcFuFdetpR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFuAhL,cplcFuFuAhR,OAh2qSL(gt1,gt2,gt3)      & 
& ,OAh2qSR(gt1,gt2,gt3))
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeSdulv(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhcHpcVWp,   & 
& cplAhetpcetp,cplAhetpcHp,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,              & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,             & 
& cplcFdFucetpR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeAhL,         & 
& cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,             & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,          & 
& cplcFeFvcHpR,cplcFeFvVWpL,cplcFeFvVWpR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFdetpL,       & 
& cplcFuFdetpR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuetIL,             & 
& cplcFuFuetIR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,              & 
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVP,cplcHpcVWpVZ,cplcVWpVWpVZ,            & 
& cpletIcetpcVWp,cpletIetpcetp,cpletIetpcHp,cpletIetpVWp,cpletIHpcetp,cpletIHpcHp,       & 
& cpletpcetpVP,cpletpcetpVZ,cpletphhcetp,cpletphhcHp,cpletphhVWp,cpletpVPVWp,            & 
& cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,cplhhHpcetp,cplhhHpcHp,            & 
& cplhhHpVWp,cplHpcHpVP,cplHpcHpVZ,cplHpVPVWp,cplHpVWpVZ,TSOdulvSLL(gt1,gt2,gt3,gt4)     & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeVdulv(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhcHpcVWp,   & 
& cplAhetpcetp,cplAhetpcHp,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,              & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,             & 
...
& cpletpcetpVP,cpletpcetpVZ,cpletphhcetp,cpletphhcHp,cpletphhVWp,cpletpVPVWp,            & 
& cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,cplhhHpcetp,cplhhHpcHp,            & 
& cplhhHpVWp,cplHpcHpVP,cplHpcHpVZ,cplHpVPVWp,cplHpVWpVZ,TVOdulvSLL(gt1,gt2,gt3,gt4)     & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGamma2Q(gt1,gt2,gt3,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,             & 
& MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcetpcVWpVP,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,             & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,             & 
& cplcFdFucetpR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFuFdcVWpL,       & 
& cplcFuFdcVWpR,cplcFuFdetpL,cplcFuFdetpR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFuVPL,           & 
& cplcFuFuVPR,cplcHpcVWpVP,cplcVWpVPVWp,cpletpcetpVP,cpletpVPVWp,cplHpcHpVP,             & 
& cplHpVPVWp,OA2qSL(gt1,gt2),OA2qSR(gt1,gt2),OA2qVL(gt1,gt2),OA2qVR(gt1,gt2))
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGluon2Q(gt1,gt2,gt3,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,             & 
& MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcFdFdAhL,cplcFdFdAhR,       & 
& cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,             & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,           & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFuFdcVWpL,cplcFuFdcVWpR,       & 
& cplcFuFdetpL,cplcFuFdetpR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFuVGL,cplcFuFuVGR,             & 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,2 
  gt3=i2 
Call CalculateH2q(gt1,gt2,gt3,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,             & 
& MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhetIhh,              & 
& cplAhhhhh,cplAhhhVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFuVWpL,        & 
& cplcFdFuVWpR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFdetpL,cplcFuFdetpR,cplcFuFdHpL,        & 
& cplcFuFdHpR,cplcFuFuhhL,cplcFuFuhhR,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cpletphhcetp,    & 
& cpletphhcHp,cpletphhVWp,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,cplhhhhhh,             & 
& cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,OH2qSL(gt1,gt2,gt3),OH2qSR(gt1,gt2,gt3))
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,Metp2,          & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,            & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,           & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,BOddllSLLSM(gt1,gt2,gt3,gt4),BOddllSRRSM(gt1,gt2,gt3,gt4)        & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,              & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,PSOddllSLLSM(gt1,gt2,gt3,gt4),PSOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,              & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,PVOddllSLLSM(gt1,gt2,gt3,gt4),PVOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,              & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TSOddllSLLSM(gt1,gt2,gt3,gt4),TSOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,              & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TVOddllSLLSM(gt1,gt2,gt3,gt4),TVOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
...
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,BOddvvVRRSM(gt1,gt2,gt3,gt4)  & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
...
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,PSOddvvVRRSM(gt1,gt2,gt3,gt4) & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
...
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,PVOddvvVRRSM(gt1,gt2,gt3,gt4) & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
...
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,TSOddvvVRRSM(gt1,gt2,gt3,gt4) & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,      & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,          & 
...
& cplcFuFuVZR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,         & 
& cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,cplcVWpVWpVZ,cpletIhhVZ,              & 
& cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,TVOddvvVRRSM(gt1,gt2,gt3,gt4) & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4d(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,Metp2,            & 
& MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,          & 
& cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,cplAhhhhh,      & 
& cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,BO4dSLLSM(gt1,gt2,gt3,gt4),BO4dSRRSM(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4d(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,Metp2,          & 
& MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,          & 
& cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,cplAhhhhh,      & 
& cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TSO4dSLLSM(gt1,gt2,gt3,gt4),TSO4dSRRSM(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4d(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,Metp2,          & 
& MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,          & 
& cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,cplAhhhhh,      & 
& cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TVO4dSLLSM(gt1,gt2,gt3,gt4),TVO4dSRRSM(gt1,gt2,gt3,gt4)          & 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,1 
  gt3=i2 
Call CalculateA2q(gt1,gt2,gt3,.true.,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,              & 
& MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,              & 
& cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,cplAhhhhh,      & 
& cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,      & 
& cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,              & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,          & 
& cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFdetpL,       & 
& cplcFuFdetpR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFuAhL,cplcFuFuAhR,OAh2qSLSM(gt1,gt2,gt3)    & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeSdulv(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,              & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhcHpcVWp,   & 
& cplAhetpcetp,cplAhetpcHp,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,              & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,             & 
...
& cpletpcetpVP,cpletpcetpVZ,cpletphhcetp,cpletphhcHp,cpletphhVWp,cpletpVPVWp,            & 
& cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,cplhhHpcetp,cplhhHpcHp,            & 
& cplhhHpVWp,cplHpcHpVP,cplHpcHpVZ,cplHpVPVWp,cplHpVWpVZ,TSOdulvSLLSM(gt1,gt2,gt3,gt4)   & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeVdulv(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MetI,MetI2,Metp,              & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhcHpcVWp,   & 
& cplAhetpcetp,cplAhetpcHp,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,              & 
& cplcetpcVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,             & 
...
& cpletpcetpVP,cpletpcetpVZ,cpletphhcetp,cpletphhcHp,cpletphhVWp,cpletpVPVWp,            & 
& cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,cplhhHpcetp,cplhhHpcHp,            & 
& cplhhHpVWp,cplHpcHpVP,cplHpcHpVZ,cplHpVPVWp,cplHpVWpVZ,TVOdulvSLLSM(gt1,gt2,gt3,gt4)   & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGamma2Q(gt1,gt2,gt3,.true.,MAh,MAh2,MetI,MetI2,Metp,Metp2,              & 
& MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcetpcVWpVP,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,             & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,             & 
& cplcFdFucetpR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFuFdcVWpL,       & 
& cplcFuFdcVWpR,cplcFuFdetpL,cplcFuFdetpR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFuVPL,           & 
& cplcFuFuVPR,cplcHpcVWpVP,cplcVWpVPVWp,cpletpcetpVP,cpletpVPVWp,cplHpcHpVP,             & 
& cplHpVPVWp,OA2qSLSM(gt1,gt2),OA2qSRSM(gt1,gt2),OA2qVLSM(gt1,gt2),OA2qVRSM(gt1,gt2))
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGluon2Q(gt1,gt2,gt3,.true.,MAh,MAh2,MetI,MetI2,Metp,Metp2,              & 
& MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcFdFdAhL,cplcFdFdAhR,       & 
& cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,             & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,           & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFdFuVWpL,cplcFdFuVWpR,cplcFuFdcVWpL,cplcFuFdcVWpR,       & 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,2 
  gt3=i2 
Call CalculateH2q(gt1,gt2,gt3,.true.,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,              & 
& MFd2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhetIhh,              & 
& cplAhhhhh,cplAhhhVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZR,cplcFdFucetpL,cplcFdFucetpR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFuVWpL,        & 
...
& cplcFuFdHpR,cplcFuFuhhL,cplcFuFuhhR,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cpletphhcetp,    & 
& cpletphhcHp,cpletphhVWp,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,cplhhhhhh,             & 
& cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,OH2qSLSM(gt1,gt2,gt3),OH2qSRSM(gt1,gt2,gt3))
...
& epsEinput,Ydinput,Yeinput,mH2input,mEt2input,M12input,vinput,vvinput,g1,               & 
& g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,             & 
& M12,v,vv,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,BOllddSLL(gt1,gt2,gt3,gt4),BOllddSRR(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,PSOllddSLL(gt1,gt2,gt3,gt4),PSOllddSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,PVOllddSLL(gt1,gt2,gt3,gt4),PVOllddSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TSOllddSLL(gt1,gt2,gt3,gt4),TSOllddSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TVOllddSLL(gt1,gt2,gt3,gt4),TVOllddSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,BOlluuSLL(gt1,gt2,gt3,gt4),BOlluuSRR(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,PSOlluuSLL(gt1,gt2,gt3,gt4),PSOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,PVOlluuSLL(gt1,gt2,gt3,gt4),PVOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TSOlluuSLL(gt1,gt2,gt3,gt4),TSOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,             & 
& Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,      & 
& cplAhAhetI,cplAhAhhh,cplAhcHpcVWp,cplAhetIetI,cplAhetIhh,cplAhetpcetp,cplAhetpcHp,     & 
& cplAhhhhh,cplAhhhVZ,cplAhHpcetp,cplAhHpcHp,cplAhHpVWp,cplcetpcVWpVP,cplcetpcVWpVZ,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdetIL,cplcFdFdetIR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cpletphhVWp,cpletpVPVWp,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,           & 
& cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,           & 
& cplHpVPVWp,cplHpVWpVZ,TVOlluuSLL(gt1,gt2,gt3,gt4),TVOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,           & 
& MFe,MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,cplAhAhhh,         & 
& cplAhetIetI,cplAhetIhh,cplAhhhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,cplcFeFeetIL,       & 
& cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvVWpL,        & 
& cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,        & 
& cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,cplhhVZVZ,        & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,             & 
& cplAhAhhh,cplAhetIetI,cplAhetIhh,cplAhhhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,          & 
& cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,         & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& cplcFvFeHpL,cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,      & 
& cplhhVZVZ,PSO4lSLL(gt1,gt2,gt3,gt4),PSO4lSRR(gt1,gt2,gt3,gt4),PSO4lSRL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,             & 
& cplAhAhhh,cplAhetIetI,cplAhetIhh,cplAhhhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,          & 
& cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,         & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& cplcFvFeHpL,cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,      & 
& cplhhVZVZ,PVO4lSLL(gt1,gt2,gt3,gt4),PVO4lSRR(gt1,gt2,gt3,gt4),PVO4lSRL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,             & 
& cplAhAhhh,cplAhetIetI,cplAhetIhh,cplAhhhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,          & 
& cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,         & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& cplcFvFeHpL,cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,      & 
& cplhhVZVZ,TSO4lSLL(gt1,gt2,gt3,gt4),TSO4lSRR(gt1,gt2,gt3,gt4),TSO4lSRL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,               & 
& Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,             & 
& cplAhAhhh,cplAhetIetI,cplAhetIhh,cplAhhhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,          & 
& cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,         & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& cplcFvFeHpL,cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,      & 
& cplhhVZVZ,TVO4lSLL(gt1,gt2,gt3,gt4),TVO4lSRR(gt1,gt2,gt3,gt4),TVO4lSRL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4Lcross(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MetI,MetI2,Metp,            & 
& Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,             & 
& cplAhAhhh,cplAhetIetI,cplAhetIhh,cplAhhhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,          & 
& cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,         & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& cplcFvFeHpL,cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,      & 
& cplhhVZVZ,BO4lSLLcross(gt1,gt2,gt3,gt4),BO4lSRRcross(gt1,gt2,gt3,gt4),BO4lSRLcross(gt1,gt2,gt3,gt4)& 
...
& Metp,Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhAh,cplAhAhetI,        & 
& cplAhAhhh,cplAhetIetI,cplAhetIhh,cplAhhhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,          & 
& cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,         & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& cplcFvFeHpL,cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,      & 
& cplhhVZVZ,PSO4lSLLcross(gt1,gt2,gt3,gt4),PSO4lSRRcross(gt1,gt2,gt3,gt4),               & 
...
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& cplcFvFeHpL,cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,      & 
& cplhhVZVZ,PVO4lSLLcross(gt1,gt2,gt3,gt4),PVO4lSRRcross(gt1,gt2,gt3,gt4),               & 
...
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& cplcFvFeHpL,cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,      & 
& cplhhVZVZ,TSO4lSLLcross(gt1,gt2,gt3,gt4),TSO4lSRRcross(gt1,gt2,gt3,gt4),               & 
...
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,       & 
& cplcFvFeHpL,cplcFvFeHpR,cpletIetIetI,cpletIetIhh,cpletIhhhh,cpletIhhVZ,cplhhhhhh,      & 
& cplhhVZVZ,TVO4lSLLcross(gt1,gt2,gt3,gt4),TVO4lSRRcross(gt1,gt2,gt3,gt4),               & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGamma2l(gt1,gt2,gt3,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,             & 
& MFe,MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcetpcVWpVP,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,             & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,          & 
& cplcFeFvcHpR,cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,       & 
& cplcFvFeetpR,cplcFvFeHpL,cplcFvFeHpR,cplcHpcVWpVP,cplcVWpVPVWp,cpletpcetpVP,           & 
& cpletpVPVWp,cplHpcHpVP,cplHpVPVWp,OA2lSL(gt1,gt2),OA2lSR(gt1,gt2),OA1L(gt1,gt2)        & 
& ,OA1R(gt1,gt2))
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,2 
  gt3=i2 
Call CalculateH2l(gt1,gt2,gt3,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFe,             & 
& MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhetIhh,cplAhhhhh,             & 
& cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,               & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,             & 
& cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,       & 
& cplcFvFecVWpR,cplcFvFeetpL,cplcFvFeetpR,cplcFvFeHpL,cplcFvFeHpR,cpletIetIhh,           & 
& cpletIhhhh,cpletIhhVZ,cpletphhcetp,cpletphhcHp,cpletphhVWp,cplhhcetpcVWp,              & 
& cplhhcHpcVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcetp,cplhhHpcHp,cplhhHpVWp,cplhhVZVZ,       & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateZ2l(gt1,gt2,gt3,.False.,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFe,             & 
& MFe2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,cplcetpcVWpVZ,cplcFeFeAhL,        & 
& cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,             & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,          & 
& cplcFeFvcHpR,cplcFeFvVWpL,cplcFeFvVWpR,cplcFvFecVWpL,cplcFvFecVWpR,cplcFvFeetpL,       & 
& cplcFvFeetpR,cplcFvFeHpL,cplcFvFeHpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpcVWpVZ,             & 
& cplcVWpVWpVZ,cpletIhhVZ,cpletpcetpVZ,cpletpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpVWpVZ,      & 
...
Call Gminus2(1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,             & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFvFeetpL,cplcFvFeetpR,           & 
& cpletpcetpVP,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,              & 
& cplcFeFeVPR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,ae)

Call Gminus2(2,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,             & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFvFeetpL,cplcFvFeetpR,           & 
& cpletpcetpVP,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,              & 
& cplcFeFeVPR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,amu)

Call Gminus2(3,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,             & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFvFeetpL,cplcFvFeetpR,           & 
& cpletpcetpVP,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,              & 
& cplcFeFeVPR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,atau)


! *****  Lepton EDM ***** 

Call LeptonEDM(1,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,           & 
& MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFvFeetpL,    & 
& cplcFvFeetpR,cpletpcetpVP,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecVWpL,cplcFvFecVWpR,           & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,       & 
& cplHpcHpVP,cplcVWpVPVWp,EDMe)

Call LeptonEDM(2,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,           & 
& MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFvFeetpL,    & 
& cplcFvFeetpR,cpletpcetpVP,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecVWpL,cplcFvFecVWpR,           & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,       & 
...
Call LeptonEDM(3,MAh,MAh2,MetI,MetI2,Metp,Metp2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,           & 
& MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFeetIL,cplcFeFeetIR,cplcFvFeetpL,    & 
& cplcFvFeetpR,cpletpcetpVP,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecVWpL,cplcFvFecVWpR,           & 
& cplcFeFvVWpL,cplcFeFvVWpR,cplcFeFvcetpL,cplcFeFvcetpR,cplcFeFvcHpL,cplcFeFvcHpR,       & 
...
vev2=Sqrt(mZ2*(1._dp-sinW2)*SinW2/(pi*alpha)) +(vv**2*(g2*Cos(TW) + g1*Sin(TW))**2)/4._dp 
v=vev2 
Call SolveTadpoleEquations(g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,               & 
& Yu,epsU,epsD,epsE,Yd,Ye,mH2,mEt2,M12,v,vv,(/ ZeroC, ZeroC /))
...
Call DeltaRho(MAh,MAh2,MetI,MetI2,Metp,Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,              & 
& Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhcVWpVWp,cplAhAhVZVZ,cplAhcHpcVWp,         & 
& cplAhhhVZ,cplcetpcVWpVP,cplcetpcVWpVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,             & 
& cplcFeFeVZR,cplcFuFdcVWpL,cplcFuFdcVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecVWpL,         & 
& cplcFvFecVWpR,cplcFvFvVZL,cplcFvFvVZR,cplcgAgWpcVWp,cplcgWCgAcVWp,cplcgWCgWCVZ,        & 
& cplcgWCgZcVWp,cplcgWpgWpVZ,cplcgZgWpcVWp,cplcHpcVWpVP,cplcHpcVWpVZ,cplcVWpcVWpVWpVWp1, & 
& cplcVWpcVWpVWpVWp2,cplcVWpcVWpVWpVWp3,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,cplcVWpVPVPVWp3, & 
& cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,             & 
& cpletIcetpcVWp,cpletIetIcVWpVWp,cpletIetIVZVZ,cpletIhhVZ,cpletpcetpcVWpVWp,            & 
& cpletpcetpVZ,cpletpcetpVZVZ,cpletpVWpVZ,cplhhcetpcVWp,cplhhcHpcVWp,cplhhcVWpVWp,       & 
& cplhhhhcVWpVWp,cplhhhhVZVZ,cplhhVZVZ,cplHpcHpcVWpVWp,cplHpcHpVZ,cplHpcHpVZVZ,          & 
& cplHpVWpVZ,dRho)
...
End Program SPheno2HDMHiggsBasis 
