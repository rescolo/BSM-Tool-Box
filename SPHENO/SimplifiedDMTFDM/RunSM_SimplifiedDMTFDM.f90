...
& Ydinput,Yeinput,MTFinput,Muinput,vinput,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,CKMout,         & 
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(64), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG64(g1input,g2input,g3input,Laminput,Yuinput,Ydinput,Yeinput,        & 
& MTFinput,Muinput,vinput,g1D)

Call GToParameters64(g1D,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v)
...
End Module RunSM_SimplifiedDMTFDM 
