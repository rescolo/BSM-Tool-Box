...
Module Model_Data_SimplifiedDMTFDM 
...
Complex(dp) :: LamIN,YuIN(3,3),YdIN(3,3),YeIN(3,3),MTFIN,MuIN

Real(dp) :: g1MZ,g2MZ,g3MZ

Complex(dp) :: LamMZ,YuMZ(3,3),YdMZ(3,3),YeMZ(3,3),MTFMZ,MuMZ

Real(dp) :: g1GUT,g2GUT,g3GUT

Complex(dp) :: LamGUT,YuGUT(3,3),YdGUT(3,3),YeGUT(3,3),MTFGUT,MuGUT
...
Real(dp) :: gPFu(3,150),gTFu(3),BRFu(3,150),gPFe(3,150),gTFe(3),BRFe(3,150),gPFd(3,150),          & 
...
MTFINPUT=(0._dp,0._dp) 
End Subroutine Set_All_Parameters_0 
 


End Module Model_Data_SimplifiedDMTFDM