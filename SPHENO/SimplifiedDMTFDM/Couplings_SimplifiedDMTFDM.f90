...
Module Couplings_SimplifiedDMTFDM
...
& Yu,ZUL,ZUR,UV,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,     & 
...
& cplcFeFeVZL,cplcFeFeVZR,cplFt0FtcVWpL,cplFt0FtcVWpR,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,   & 
& cplcFtcFtcVPL,cplcFtcFtcVPR,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVGL,cplcFuFuVGR,       & 
...
& cplcFeFeVZR(3,3),cplFt0FtcVWpL,cplFt0FtcVWpR,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,          & 
& cplcFtcFtcVPL,cplcFtcFtcVPR,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVGL(3,3),              & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFvFeHpT(gt1,gt2,Ye,UV,ZER,cplcFvFeHpL(gt1,gt2),cplcFvFeHpR(gt1,gt2))
...
cplFt0FtcVWpL = 0._dp 
cplFt0FtcVWpR = 0._dp 
Call CouplingFt0FtcVWpT(g2,cplFt0FtcVWpL,cplFt0FtcVWpR)



cplcFtcFt0cVWpL = 0._dp 
cplcFtcFt0cVWpR = 0._dp 
Call CouplingcFtcFt0cVWpT(g2,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR)



cplcFtcFtcVPL = 0._dp 
cplcFtcFtcVPR = 0._dp 
Call CouplingcFtcFtcVPT(g2,TW,cplcFtcFtcVPL,cplcFtcFtcVPR)



cplcFtcFtcVZL = 0._dp 
cplcFtcFtcVZR = 0._dp 
Call CouplingcFtcFtcVZT(g2,TW,cplcFtcFtcVZL,cplcFtcFtcVZR)
...
& ZUR,UV,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplAhhhVZ,cplAhHpcVWp,cplAhcHpVWp,               & 
& cplhhHpcVWp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplhhcVWpVWp,cplhhVZVZ,cplHpcVWpVP,      & 
...
& cplcFvFeVWpL,cplcFvFeVWpR,cplcFeFeVZL,cplcFeFeVZR,cplFt0FtcVWpL,cplFt0FtcVWpR,         & 
...
& cplcFvFeVWpL(3,3),cplcFvFeVWpR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplFt0FtcVWpL,   & 
& cplFt0FtcVWpR,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFtcFtcVPL,cplcFtcFtcVPR,             & 
& cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),        & 
& cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFdFucVWpL(3,3),cplcFdFucVWpR(3,3),& 
...
Subroutine CouplingcFvFeHpT(gt1,gt2,Ye,UV,ZER,resL,resR)
...
Subroutine CouplingcFvFeVWpT(gt1,gt2,g2,UV,ZEL,resL,resR)
...
Subroutine CouplingFt0FtcVWpT(g2,resL,resR)
...
Subroutine CouplingcFtcFt0cVWpT(g2,resL,resR)
...
Subroutine CouplingcFtcFtcVPT(g2,TW,resL,resR)
...
Subroutine CouplingcFtcFtcVZT(g2,TW,resL,resR)
...
& UV,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplVGVGVG,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,       & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFvFeHp2L(gt1,gt2,Ye,UV,ZER,cplcFvFeHpL(gt1,gt2),cplcFvFeHpR(gt1,gt2))
...
Subroutine CouplingcFvFeHp2L(gt1,gt2,Ye,UV,ZER,resL,resR)
...
Subroutine CouplingsForLoopMasses(Ye,ZER,g2,ZEL,g1,UV,TW,Yd,ZDL,ZDR,g3,               & 
& Yu,ZUL,ZUR,v,Lam,cplcUFvFeHpL,cplcUFvFeHpR,cplcUFvFeVWpL,cplcUFvFeVWpR,cplcUFvFvVZL,   & 
...
Implicit None 
Real(dp), Intent(in) :: g2,g1,TW,g3,v

Complex(dp), Intent(in) :: Ye(3,3),ZER(3,3),ZEL(3,3),UV(3,3),Yd(3,3),ZDL(3,3),ZDR(3,3),Yu(3,3),ZUL(3,3),         & 
& ZUR(3,3),Lam

Complex(dp), Intent(out) :: cplcUFvFeHpL(3,3),cplcUFvFeHpR(3,3),cplcUFvFeVWpL(3,3),cplcUFvFeVWpR(3,3),            & 
& cplcUFvFvVZL(3,3),cplcUFvFvVZR(3,3),cplcUFdFdAhL(3,3),cplcUFdFdAhR(3,3),               & 
...
& cplcUFuFuAhL(3,3),cplcUFuFuAhR(3,3),cplcUFuFdHpL(3,3),cplcUFuFdHpR(3,3),               & 
...
& cplcUFeFvcVWpL(3,3),cplcUFeFvcVWpR(3,3),cplFt0FtcVWpL,cplFt0FtcVWpR,cplcFtcFt0cVWpL,   & 
...
& cplHpHpcHpcHp,cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,cplAhAhhh,cplcFdFdAhL(3,3),    & 
& cplcFdFdAhR(3,3),cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),  & 
...
& cplhhhhVZVZ,cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),       & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcUFvFvVZL(gt1,gt2,g1,g2,UV,TW,cplcUFvFvVZL(gt1,gt2),cplcUFvFvVZR(gt1,gt2))
...
cplFt0FtcVWpL = 0._dp 
cplFt0FtcVWpR = 0._dp 
Call CouplingFt0FtcVWpL(g2,cplFt0FtcVWpL,cplFt0FtcVWpR)



cplcFtcFt0cVWpL = 0._dp 
cplcFtcFt0cVWpR = 0._dp 
Call CouplingcFtcFt0cVWpL(g2,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR)



cplcFtcFtcVPL = 0._dp 
cplcFtcFtcVPR = 0._dp 
Call CouplingcFtcFtcVPL(g2,TW,cplcFtcFtcVPL,cplcFtcFtcVPR)



cplcFtcFtcVZL = 0._dp 
cplcFtcFtcVZR = 0._dp 
Call CouplingcFtcFtcVZL(g2,TW,cplcFtcFtcVZL,cplcFtcFtcVZR)
...
Subroutine CouplingcUFvFvVZL(gt1,gt2,g1,g2,UV,TW,resL,resR)
...
Subroutine CouplingFt0FtcVWpL(g2,resL,resR)
...
End Subroutine CouplingFt0FtcVWpL  
 
 
Subroutine CouplingcFtcFt0cVWpL(g2,resL,resR)
...
Subroutine CouplingcFtcFtcVPL(g2,TW,resL,resR)
...
End Subroutine CouplingcFtcFtcVPL  
 
 
Subroutine CouplingcFtcFtcVZL(g2,TW,resL,resR)
...
Subroutine CouplingsForVectorBosons(g2,TW,g1,v,ZDL,ZUL,UV,ZEL,cplFt0FtcVWpL,          & 
& cplFt0FtcVWpR,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR,             & 
...
Implicit None 
Real(dp), Intent(in) :: g2,TW,g1,v

Complex(dp), Intent(in) :: ZDL(3,3),ZUL(3,3),UV(3,3),ZEL(3,3)

Complex(dp), Intent(out) :: cplFt0FtcVWpL,cplFt0FtcVWpR,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFtcFtcVZL,            & 
& cplcFtcFtcVZR,cplAhcHpVWp,cplhhcHpVWp,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,              & 
& cplHpcHpcVWpVWp,cplHpcHpVZVZ,cplAhhhVZ,cplAhHpcVWp,cplAhAhcVWpVWp,cplAhAhVZVZ,         & 
& cplhhHpcVWp,cplhhcVWpVWp,cplhhVZVZ,cplhhhhcVWpVWp,cplhhhhVZVZ,cplcFdFdVZL(3,3),        & 
& cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),  & 
& cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcgWpgWpVZ,cplcgWCgWCVZ,cplHpcVWpVZ,               & 
...
& ZEL,ZER,UV,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,           & 
& cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFucHpL,        & 
& cplcUFdFucHpR,cplcUFdFucVWpL,cplcUFdFucVWpR,cplcUFuFuAhL,cplcUFuFuAhR,cplcUFuFdHpL,    & 
& cplcUFuFdHpR,cplcUFuFdVWpL,cplcUFuFdVWpR,cplcUFuFuhhL,cplcUFuFuhhR,cplcUFuFuVGL,       & 
& cplcUFuFuVGR,cplcUFuFuVPL,cplcUFuFuVPR,cplcUFuFuVZL,cplcUFuFuVZR,cplcUFeFeAhL,         & 
...
Complex(dp), Intent(in) :: Yd(3,3),ZDL(3,3),ZDR(3,3),Yu(3,3),ZUL(3,3),ZUR(3,3),Ye(3,3),ZEL(3,3),ZER(3,3),UV(3,3)
...
End Module Couplings_SimplifiedDMTFDM 
