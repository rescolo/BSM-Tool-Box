...
Module TreeLevelDecays_SimplifiedDMTFDM
...
Subroutine FuTwoBodyDecay(i_in,deltaM,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,MFt02,          & 
& MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,             & 
& ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,gPartial,gT,BR)

Implicit None 
 
Real(dp),Intent(in) :: g1,g2,g3,v,MAh,MAh2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFt0,MFt02,MFtc,MFtc2,              & 
& MFu(3),MFu2(3),MFv(3),MFv2(3),Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZZ(2,2)

Complex(dp),Intent(in) :: Lam,Yu(3,3),Yd(3,3),Ye(3,3),MTF,Mu,ZDR(3,3),ZER(3,3),ZUR(3,3),ZDL(3,3),               & 
& ZEL(3,3),ZUL(3,3),UV(3,3),ZW(2,2)
...
Call CouplingsFor_Fu_decays_2B(m_in,i1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,               & 
& MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,              & 
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,cplcFuFdVWpL,       & 
...
Subroutine FeTwoBodyDecay(i_in,deltaM,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,MFt02,          & 
& MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,             & 
& ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,gPartial,gT,BR)
...
m_in = MFe(i1) 
If (m_in.Eq.0._dp) Cycle 
Call CouplingsFor_Fe_decays_2B(m_in,i1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,               & 
& MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,              & 
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,cplcFeFehhL,        & 
...
Subroutine FdTwoBodyDecay(i_in,deltaM,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,MFt02,          & 
& MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,             & 
& ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,gPartial,gT,BR)
...
m_in = MFd(i1) 
If (m_in.Eq.0._dp) Cycle 
Call CouplingsFor_Fd_decays_2B(m_in,i1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,               & 
& MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,              & 
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,cplcFdFdhhL,        & 
...
Subroutine hhTwoBodyDecay(i_in,deltaM,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,MFt02,          & 
& MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,             & 
& ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,gPartial,gT,BR)
...
i1=1 
m_in = Mhh 
Call CouplingsFor_hh_decays_2B(m_in,i1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,               & 
& MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,              & 
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,cplHiggsPP,         & 
& cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,          & 
& cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplhhhhhh,cplhhcVWpVWp,cplhhVZVZ,deltaM)
...
Subroutine Ft0TwoBodyDecay(i_in,deltaM,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,               & 
& MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,              & 
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,gPartial,gT,BR)
...
Complex(dp) :: cplFt0FtcVWpL,cplFt0FtcVWpR
...
i1=1 
m_in = MFt0 
Call CouplingsFor_Ft0_decays_2B(m_in,i1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,              & 
& MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,              & 
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,cplFt0FtcVWpL,      & 
& cplFt0FtcVWpR,deltaM)
...
Subroutine FtcTwoBodyDecay(i_in,deltaM,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,               & 
& MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,              & 
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,gPartial,gT,BR)
...
Complex(dp) :: cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR
...
i1=1 
m_in = MFtc 
Call CouplingsFor_Ftc_decays_2B(m_in,i1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,              & 
& MFt02,MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,              & 
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,cplcFtcFt0cVWpL,    & 
& cplcFtcFt0cVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR,deltaM)
...
m1out = MFt0
m2out = MVWp
coupL = cplcFtcFt0cVWpL
coupR = cplcFtcFt0cVWpR
Call FermionToFermionVectorBoson(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
End Module TreeLevelDecays_SimplifiedDMTFDM 
