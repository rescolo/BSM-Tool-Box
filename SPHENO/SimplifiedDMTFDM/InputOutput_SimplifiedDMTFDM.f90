...
Module InputOutput_SimplifiedDMTFDM 
...
InputValueforYe= .True. 
   ...
   Else If (read_line(7:18).Eq."MIXEDBLOCKIN") Then 
    Call Read_MixedBlockIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:20).Eq."IMMIXEDBLOCKIN") Then 
    Call Read_MixedBlockIN(99,1,i_model,set_mod_par,kont) 
...
If (i_c.Eq.0) MTFINPUT= Cmplx(wert,Aimag(MTFINPUT),dp) 
If (i_c.Eq.1) MTFINPUT= Cmplx(Real(MTFINPUT,dp),wert,dp) 
Else
...
& PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3),PDGFt0,PDGFtc
...
Character(len=30) :: NameParticleFt0
Character(len=30) :: NameParticleFtc
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - SimplifiedDM/TFDM Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 2, Real(MTFINPUT,dp) ,"# MTFINPUT"
WriteNextBlock = .False. 
If (Abs(Aimag(LambdaIN)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(MTFINPUT)).gt.0._dp) WriteNextBlock = .True. 
...
End if 
If (Abs(Aimag(MTFINPUT)).gt.0._dp) Then 
Write(io_L,101) 2, Aimag(MTFINPUT) ,"# MTFINPUT"
End if 
End if 
...
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block MixedBlock Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(MTF,dp), "# MTF" 
If (Abs(Aimag(MTF)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMMixedBlock Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Aimag(MTF), "# MTF" 
End if 
WriteNextBlock = .false. 
...
Write(io_L,106) "Block MixedBlockGUT Q=",M_GUT,"# (GUT scale)" 
...
Write(io_L,100) "#   PDG code      mass          particle" 
 ...
 Write(io_L,102) 6000059,MFt0,"# Ft0" 
If (MassLSP(1).gt.Abs(MFt0)) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6000059 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFt0)
Else 
If (MassLSP(2).gt.Abs(MFt0)) Then 
PDGLSP(2) = 6000059 
MassLSP(2) = Abs(MFt0)
End if 
End if 
 Write(io_L,102) 6000061,MFtc,"# Ftc" 
If (MassLSP(1).gt.Abs(MFtc)) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6000061 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFtc)
Else 
If (MassLSP(2).gt.Abs(MFtc)) Then 
PDGLSP(2) = 6000061 
MassLSP(2) = Abs(MFtc)
End if 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,10:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
If (BRFu(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFd(gt1) 
CurrentPDG3(2) = -PDGFtc 
CurrentPDG3(3) = PDGFt0 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFt0)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(1) = PDGFu(gt1) 
CurrentPDG3(2) = -PDGFtc 
CurrentPDG3(3) = PDGFtc 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFtc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,10:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
If (BRFu(2,icount).Gt.BrMin) Then 
...
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFt0)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFtc 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFtc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,10:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
If (BRFu(3,icount).Gt.BrMin) Then 
...
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFt0)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFtc 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFtc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,10:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFtc 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFtc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFt0 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFtc)//" "//Trim(NameParticleFt0)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,10:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFtc 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFtc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFt0 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFtc)//" "//Trim(NameParticleFt0)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,10:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFtc 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFtc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFt0 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFtc)//" "//Trim(NameParticleFt0)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,10:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFtc 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFtc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFt0 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc)//" "//Trim(NameParticleFt0)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,10:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFtc 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFtc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFt0 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc)//" "//Trim(NameParticleFt0)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,10:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFtc 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFtc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFt0 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFtc)//" "//Trim(NameParticleFt0)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
If(gTFt0.gt.MinWidth) Then 
Write(io_L,200) INT(PDGFt0),gTFt0,Trim(NameParticleFt0) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BRFt0(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFtc 
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRFt0(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFt0)//" -> "//Trim(NameParticleFtc)//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRFt0(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFt0)//" -> "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
If (Maxval(BRFt0(1,2:19)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
  Do gt2=1,3
    Do gt3=1,3
If (BRFt0(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFtc 
CurrentPDG3(2) = -PDGFd(gt2) 
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRFt0(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFt0)//" -> "//Trim(NameParticleFtc)//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
Write(io_L,202) BRFt0(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFt0)//" -> "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRFt0(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFt0)//" -> "//Trim(NameParticleFtc)//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFv(gt3))//" "//")"
Write(io_L,202) BRFt0(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFt0)//" -> "//Trim(NameParticleFtc)//"^* "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
...
If(gTFtc.gt.MinWidth) Then 
Write(io_L,200) INT(PDGFtc),gTFtc,Trim(NameParticleFtc) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BRFtc(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFt0 
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRFtc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc)//" -> "//Trim(NameParticleFt0)//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
If (BRFtc(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFtc 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRFtc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFtc)//" -> "//Trim(NameParticleFtc)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRFtc(1,3:20)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
  Do gt2=1,3
    Do gt3=1,3
If (BRFtc(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFt0 
CurrentPDG3(2) = -PDGFu(gt2) 
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc)//" -> "//Trim(NameParticleFt0)//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRFtc(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFtc)//" -> "//Trim(NameParticleFt0)//" "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
End Do 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.SimplifiedDMTFDM",status="unknown")
...
Write(123,*) "MFt0= ", Abs(MFt0) 
Write(123,*) "MFtc= ", Abs(MFtc) 
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "Wh = ",gThh
Write(123,*) "WFt0 = ",gTFt0
Write(123,*) "WFtc = ",gTFtc
Write(123,*) "" 
Write(123,*) "" 
...
Subroutine Read_MixedBlockIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) MTFIN= Cmplx(wert,Aimag(MTFIN),dp) 
If (i_c.Eq.1) MTFIN= Cmplx(Real(MTFIN,dp),wert,dp) 
InputValueforMTF= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MixedBlockIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMixedBlockIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MixedBlockIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMixedBlockIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_MixedBlockIN 
...
End Module InputOutput_SimplifiedDMTFDM 
