...
Module Fd3Decays_SimplifiedDMTFDM 
...
Subroutine FdThreeBodyDecay(n_in,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,MFt02,               & 
...
& gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,gFdFdcFtcFtc,gFdFdcFvFv,gFdFucFvFe,gFdFuFtcFt0,       & 
...
Real(dp),Intent(inout) :: gFdFdcFdFd(3,3,3,3),gFdFdcFeFe(3,3,3,3),gFdFdcFuFu(3,3,3,3),gFdFdcFtcFtc(3,3,1,1),    & 
& gFdFdcFvFv(3,3,3,3),gFdFucFvFe(3,3,3,3),gFdFuFtcFt0(3,3,1,1)

Real(dp),Intent(in) :: gThh,gTVWp,gTVZ

Real(dp) :: gFdFdcFdFdi(3,3,3),gFdFdcFeFei(3,3,3),gFdFdcFuFui(3,3,3),gFdFdcFtcFtci(3,1,1),        & 
& gFdFdcFvFvi(3,3,3),gFdFucFvFei(3,3,3),gFdFuFtcFt0i(3,1,1)
...
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFtcFtcVZL,cplcFtcFtcVZR,           & 
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,             & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,cplFt0FtcVWpL,cplFt0FtcVWpR,deltaM)
...
gFdFdcFtcFtci = 0._dp 
Call FdToFdcFtcFtc(i_run,MFd,MFtc,MVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFtcFtcVZL,          & 
& cplcFtcFtcVZR,IntegralVs,IntegralVVss,NVs,NVVss,gTVZtemp,deltaM,epsI,check,            & 
& gFdFdcFtcFtci)

gFdFdcFtcFtc(i_run,:,:,:) = gFdFdcFtcFtci 
gT(i_run) = gT(i_run) + Sum(gFdFdcFtcFtci) 
...
gFdFuFtcFt0i = 0._dp 
Call FdToFuFtcFt0(i_run,MFu,MFtc,MFt0,MVWp,MFd,cplcFdFucVWpL,cplcFdFucVWpR,           & 
& cplFt0FtcVWpL,cplFt0FtcVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWptemp,               & 
& deltaM,epsI,check,gFdFuFtcFt0i)

gFdFuFtcFt0(i_run,:,:,:) = gFdFuFtcFt0i 
gT(i_run) = gT(i_run) + Sum(gFdFuFtcFt0i) 
...
Do gt1=1,3
  Do gt2=1,1
    Do gt3=1,1
gPartial(i1,n_length)= gFdFdcFtcFtc(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,1
    Do gt3=1,1
gPartial(i1,n_length)= gFdFuFtcFt0(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Subroutine FdToFdcFtcFtc(iIN,MFd,MFtc,MVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFtcFtcVZL,      & 
& cplcFtcFtcVZR,IntegralVs,IntegralVVss,NVs,NVVss,gTVZ,deltaM,epsI,check,g,              & 
& WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MFtc,MVZ

Complex(dp),Intent(in) :: cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFtcFtcVZL,cplcFtcFtcVZR
...
If(Abs(MFd(iIN)).gt.(Abs(MFtc)+Abs(MFtc)+Abs(MFd(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFtc Ftc Propagator: VZ" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
...
Subroutine FdToFuFtcFt0(iIN,MFu,MFtc,MFt0,MVWp,MFd,cplcFdFucVWpL,cplcFdFucVWpR,       & 
& cplFt0FtcVWpL,cplFt0FtcVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWp,deltaM,            & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFtc,MFt0,MVWp,MFd(3)
...
If(Abs(MFd(iIN)).gt.(Abs(MFt0)+Abs(MFtc)+Abs(MFu(gt1)))) Then 
!-------------- 
!  conj[VWp] 
!-------------- 
Isum = Isum + 1 
...
coup(2) = Conjg(cplcFdFucVWpL(iIN,gt1)) 
coup(1) = Conjg(cplcFdFucVWpR(iIN,gt1)) 
coup(4) = Conjg(cplFt0FtcVWpL) 
coup(3) = Conjg(cplFt0FtcVWpR)
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu Ftc Ft0 Propagator: conj[VWp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,1,Isum)= 0._dp
...
End If
   End Do 
  g = oo512pi3 / Abs(MFd(iIN))**3*g
End Subroutine FdToFuFtcFt0 
 
 
End Module Fd3Decays_SimplifiedDMTFDM 
