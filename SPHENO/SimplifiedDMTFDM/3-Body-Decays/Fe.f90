...
Module Fe3Decays_SimplifiedDMTFDM 
...
Subroutine FeThreeBodyDecay(n_in,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,MFt02,               & 
...
& gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,gFeFecFtcFtc,gFeFecFvFv,gFeFvcFuFd,gFeFvFtcFt0,       & 
...
Real(dp),Intent(inout) :: gFeFecFdFd(3,3,3,3),gFeFecFeFe(3,3,3,3),gFeFecFuFu(3,3,3,3),gFeFecFtcFtc(3,3,1,1),    & 
& gFeFecFvFv(3,3,3,3),gFeFvcFuFd(3,3,3,3),gFeFvFtcFt0(3,3,1,1)

Real(dp),Intent(in) :: gThh,gTVWp,gTVZ

Real(dp) :: gFeFecFdFdi(3,3,3),gFeFecFeFei(3,3,3),gFeFecFuFui(3,3,3),gFeFecFtcFtci(3,1,1),        & 
& gFeFecFvFvi(3,3,3),gFeFvcFuFdi(3,3,3),gFeFvFtcFt0i(3,1,1)
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR,       & 
...
gFeFecFtcFtci = 0._dp 
Call FeToFecFtcFtc(i_run,MFe,MFtc,MVZ,cplcFeFeVZL,cplcFeFeVZR,cplcFtcFtcVZL,          & 
...
gFeFvFtcFt0i = 0._dp 
Call FeToFvFtcFt0(i_run,MFv,MFtc,MFt0,MVWp,MFe,cplcFeFvcVWpL,cplcFeFvcVWpR,           & 
& cplFt0FtcVWpL,cplFt0FtcVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWptemp,               & 
& deltaM,epsI,check,gFeFvFtcFt0i)
...
Subroutine FeToFecFtcFtc(iIN,MFe,MFtc,MVZ,cplcFeFeVZL,cplcFeFeVZR,cplcFtcFtcVZL,      & 
& cplcFtcFtcVZR,IntegralVs,IntegralVVss,NVs,NVVss,gTVZ,deltaM,epsI,check,g,              & 
& WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MFtc,MVZ

Complex(dp),Intent(in) :: cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFtcFtcVZL,cplcFtcFtcVZR
...
If(Abs(MFe(iIN)).gt.(Abs(MFtc)+Abs(MFtc)+Abs(MFe(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
Subroutine FeToFvFtcFt0(iIN,MFv,MFtc,MFt0,MVWp,MFe,cplcFeFvcVWpL,cplcFeFvcVWpR,       & 
& cplFt0FtcVWpL,cplFt0FtcVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWp,deltaM,            & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFv(3),MFtc,MFt0,MVWp,MFe(3)
...
If(Abs(MFe(iIN)).gt.(Abs(MFt0)+Abs(MFtc)+Abs(MFv(gt1)))) Then 
!-------------- 
!  conj[VWp] 
!-------------- 
Isum = Isum + 1 
...
End Module Fe3Decays_SimplifiedDMTFDM 
