...
Module Fu3Decays_SimplifiedDMTFDM 
...
Subroutine FuThreeBodyDecay(n_in,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFt0,MFt02,               & 
& MFtc,MFtc2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,             & 
& ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,gThh,gTVWp,gTVZ,           & 
& gFuFdcFtcFt0,gFuFucFdFd,gFuFdcFeFv,gFuFucFeFe,gFuFucFuFu,gFuFucFtcFtc,gFuFucFvFv,      & 
...
Real(dp),Intent(inout) :: gFuFdcFtcFt0(3,3,1,1),gFuFucFdFd(3,3,3,3),gFuFdcFeFv(3,3,3,3),gFuFucFeFe(3,3,3,3),    & 
& gFuFucFuFu(3,3,3,3),gFuFucFtcFtc(3,3,1,1),gFuFucFvFv(3,3,3,3)

Real(dp),Intent(in) :: gThh,gTVWp,gTVZ

Real(dp) :: gFuFdcFtcFt0i(3,1,1),gFuFucFdFdi(3,3,3),gFuFdcFeFvi(3,3,3),gFuFucFeFei(3,3,3),        & 
& gFuFucFuFui(3,3,3),gFuFucFtcFtci(3,1,1),gFuFucFvFvi(3,3,3)
...
& MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZZ,g1,g2,g3,Lam,Yu,Yd,Ye,MTF,Mu,v,               & 
...
& cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFdVWpL,              & 
...
gFuFdcFtcFt0i = 0._dp 
Call FuToFdcFtcFt0(i_run,MFd,MFtc,MFt0,MVWp,MFu,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,      & 
& cplcFuFdVWpL,cplcFuFdVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWptemp,deltaM,          & 
& epsI,check,gFuFdcFtcFt0i)

gFuFdcFtcFt0(i_run,:,:,:) = gFuFdcFtcFt0i 
gT(i_run) = gT(i_run) + Sum(gFuFdcFtcFt0i) 
...
gFuFucFtcFtci = 0._dp 
Call FuToFucFtcFtc(i_run,MFu,MFtc,MVZ,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVZL,        & 
& cplcFuFuVZR,IntegralVs,IntegralVVss,NVs,NVVss,gTVZtemp,deltaM,epsI,check,              & 
& gFuFucFtcFtci)

gFuFucFtcFtc(i_run,:,:,:) = gFuFucFtcFtci 
gT(i_run) = gT(i_run) + Sum(gFuFucFtcFtci) 
...
Do gt1=1,3
  Do gt2=1,1
    Do gt3=1,1
gPartial(i1,n_length)= gFuFdcFtcFt0(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,1
    Do gt3=1,1
gPartial(i1,n_length)= gFuFucFtcFtc(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Subroutine FuToFdcFtcFt0(iIN,MFd,MFtc,MFt0,MVWp,MFu,cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,  & 
& cplcFuFdVWpL,cplcFuFdVWpR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWp,deltaM,              & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MFtc,MFt0,MVWp,MFu(3)

Complex(dp),Intent(in) :: cplcFtcFt0cVWpL,cplcFtcFt0cVWpR,cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3)
...
If(Abs(MFu(iIN)).gt.(Abs(MFt0)+Abs(MFtc)+Abs(MFd(gt1)))) Then 
!-------------- 
!  VWp 
!-------------- 
Isum = Isum + 1 
...
coup(4) = Conjg(cplcFtcFt0cVWpL) 
coup(3) = Conjg(cplcFtcFt0cVWpR)
...
Write(*,*) "Fu->Fd cFtc Ft0 Propagator: VWp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
...
Subroutine FuToFucFtcFtc(iIN,MFu,MFtc,MVZ,cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVZL,    & 
& cplcFuFuVZR,IntegralVs,IntegralVVss,NVs,NVVss,gTVZ,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFtc,MVZ

Complex(dp),Intent(in) :: cplcFtcFtcVZL,cplcFtcFtcVZR,cplcFuFuVZL(3,3),cplcFuFuVZR(3,3)
...
If(Abs(MFu(iIN)).gt.(Abs(MFtc)+Abs(MFtc)+Abs(MFu(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
coup(2) = Conjg(cplcFuFuVZL(iIN,gt1)) 
coup(1) = Conjg(cplcFuFuVZR(iIN,gt1)) 
coup(4) = Conjg(cplcFtcFtcVZL) 
coup(3) = Conjg(cplcFtcFtcVZR)
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFtc Ftc Propagator: VZ" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,1,1,Isum)= 0._dp
...
End Module Fu3Decays_SimplifiedDMTFDM 
