...
! ------------------------------------------------------------------------------  
! File created at 17:48 on 16.6.2016   
! ----------------------------------------------------------------------  
 
 
Module InputOutput_LRDM 
...
InputValueforYQ2= .True. 
   ...
   Else If (read_line(7:16).Eq."IMPHASETIN") Then 
    Call Read_PHASETIN(99,1,i_model,set_mod_par,kont) 
...
& PDGFu(3),PDGFe(3),PDGFv(6),PDGFcpp,PDGFcp,PDGFc
...
Character(len=30) :: NameParticleFcp
Character(len=30) :: NameParticleFc
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - LR/DM Spectrum + Decays + Flavor Observables"
...
End if 
End if 
 Write(io_L,102) 17,MFcp,"# Fcp" 
If (MassLSP(1).gt.Abs(MFcp)) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 17 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFcp)
Else 
If (MassLSP(2).gt.Abs(MFcp)) Then 
PDGLSP(2) = 17 
MassLSP(2) = Abs(MFcp)
End if 
End if 
 Write(io_L,102) 9000012,MFc,"# Fc" 
If (MassLSP(1).gt.Abs(MFc)) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 9000012 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFc)
Else 
If (MassLSP(2).gt.Abs(MFc)) Then 
PDGLSP(2) = 9000012 
MassLSP(2) = Abs(MFc)
End if 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,28:285)).Gt.BRmin) Then 
...
CurrentPDG3(1) = PDGFd(gt1) 
CurrentPDG3(2) = -PDGFc 
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
If (BRFu(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFd(gt1) 
CurrentPDG3(2) = -PDGFcp 
CurrentPDG3(3) = PDGFcpp 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcpp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,28:285)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcpp 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcpp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,28:285)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcpp 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcpp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,40:303)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG3(3) = PDGFcpp 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcpp)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,40:303)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG3(3) = PDGFcpp 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcpp)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,40:303)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG3(3) = PDGFcpp 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcpp)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,28:285)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,28:285)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,28:285)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(1,46:474)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
Write(io_L,202) BRFv(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
Write(io_L,202) BRFv(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcpp)//" "//Trim(NameParticleFcp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(2,46:474)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
Write(io_L,202) BRFv(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
Write(io_L,202) BRFv(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcpp)//" "//Trim(NameParticleFcp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(3,46:474)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
Write(io_L,202) BRFv(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
Write(io_L,202) BRFv(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcpp)//" "//Trim(NameParticleFcp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(4,46:474)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(4,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(4))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
Write(io_L,202) BRFv(4,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(4))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(4,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(4))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
Write(io_L,202) BRFv(4,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(4))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcpp)//" "//Trim(NameParticleFcp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(4))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(4))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(5,46:474)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(5,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(5))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
Write(io_L,202) BRFv(5,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(5))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(5,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(5))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
Write(io_L,202) BRFv(5,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(5))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcpp)//" "//Trim(NameParticleFcp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(6,46:474)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(6,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(6))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
Write(io_L,202) BRFv(6,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(6))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(6,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleFv(6))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
Write(io_L,202) BRFv(6,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleFv(6))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFcpp)//" "//Trim(NameParticleFcp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG3(3) = PDGFcp 
Write(io_L,202) BRFv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFv(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,6
...
CurrentPDG2(2) = PDGFc 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
If (BRVZ(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFcp 
CurrentPDG2(2) = PDGFcp 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
If (BRVZ(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGFc 
Write(io_L,201) BRVZR(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZR)//" -> "//Trim(NameParticleFc)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
If (BRVZR(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFcp 
CurrentPDG2(2) = PDGFcp 
Write(io_L,201) BRVZR(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZR)//" -> "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
If (BRVZR(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFcpp 
...
CurrentPDG2(2) = -PDGFc 
Write(io_L,201) BRVWLm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWLm)//"^* -> "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//"^* "//")"
End if 
icount = icount +1 
If (BRVWLm(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFcpp 
CurrentPDG2(2) = -PDGFcp 
Write(io_L,201) BRVWLm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWLm)//"^* -> "//Trim(NameParticleFcpp)//" "//Trim(NameParticleFcp)//"^* "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
CurrentPDG2(2) = PDGFc 
Write(io_L,201) BRVWRm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWRm)//" -> "//Trim(NameParticleFcp)//"^* "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
If (BRVWRm(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFcpp 
CurrentPDG2(2) = PDGFcp 
Write(io_L,201) BRVWRm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWRm)//" -> "//Trim(NameParticleFcpp)//"^* "//Trim(NameParticleFcp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.LRDM",status="unknown")
...
Write(123,*) "Mcp= ", Abs(MFcp) 
Write(123,*) "Mc0= ", Abs(MFc) 
Write(123,*) "" 
Write(123,*) "" 
