...
Module Model_Data_radinertT13A 
...
Real(dp) :: g1,g2,g3,YR3,YR1(3,3),YR4,MS2(3,3)

Complex(dp) :: Lam,LSH(3,3),Yu(3,3),Yd(3,3),Ye(3,3),Mn,MDF,mu2

Real(dp) :: g1IN,g2IN,g3IN,YR3IN,YR1IN(3,3),YR4IN,MS2IN(3,3)

Complex(dp) :: LamIN,LSHIN(3,3),YuIN(3,3),YdIN(3,3),YeIN(3,3),MnIN,MDFIN,mu2IN

Real(dp) :: g1MZ,g2MZ,g3MZ,YR3MZ,YR1MZ(3,3),YR4MZ,MS2MZ(3,3)

Complex(dp) :: LamMZ,LSHMZ(3,3),YuMZ(3,3),YdMZ(3,3),YeMZ(3,3),MnMZ,MDFMZ,mu2MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,YR3GUT,YR1GUT(3,3),YR4GUT,MS2GUT(3,3)

Complex(dp) :: LamGUT,LSHGUT(3,3),YuGUT(3,3),YdGUT(3,3),YeGUT(3,3),MnGUT,MDFGUT,mu2GUT
...
Real(dp) :: gPFu(3,183),gTFu(3),BRFu(3,183),gPhh(1,46),gThh,BRhh(1,46),gPSs(3,189),               & 
...
Logical :: Include_in_loopNv0 = .true. 
...
Logical, save :: InputValueforYR3 =.False. 
Logical, save :: InputValueforYR1 =.False. 
Logical, save :: InputValueforYR4 =.False. 
...
Complex(dp) :: LS(3, 3, 3, 3)
Complex(dp) :: LamSIN(3, 3, 3, 3)
...
End Module Model_Data_radinertT13A