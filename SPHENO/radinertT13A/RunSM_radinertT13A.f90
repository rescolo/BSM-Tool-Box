...
Module RunSM_radinertT13A 
 
Use Control 
Use LoopFunctions 
Use Mathematics 
Use StandardModel 
Use RGEs_radinertT13A 
Use Model_Data_radinertT13A 

Logical,Private,Save::OnlyDiagonal 
Contains 
 
 Subroutine RunSM_and_SUSY_RGEs(Qout,g1input,g2input,g3input,Laminput,LSHinput,        & 
& Yuinput,Ydinput,Yeinput,YR3input,YR1input,YR4input,Mninput,MDFinput,mu2input,          & 
& MS2input,vinput,g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,Mn,MDF,mu2,MS2,v,CKMout,         & 
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(104), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG104(g1input,g2input,g3input,Laminput,LSHinput,Yuinput,              & 
& Ydinput,Yeinput,YR3input,YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,         & 
& vinput,g1D)

Call GToParameters104(g1D,g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,Mn,MDF,               & 
& mu2,MS2,v)
