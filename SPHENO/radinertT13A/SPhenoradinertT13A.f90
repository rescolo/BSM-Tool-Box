...
Program SPhenoradinertT13A 
 
Use Control
Use InputOutput_radinertT13A
Use LoopFunctions
Use RunSM_radinertT13A
Use LowEnergy_radinertT13A
Use FlavorKit_LFV_radinertT13A
Use FlavorKit_QFV_radinertT13A
Use FlavorKit_Observables_radinertT13A
Use Mathematics
Use Model_Data_radinertT13A
Use Tadpoles_radinertT13A 
 Use HiggsCS_radinertT13A
Use LoopMasses_radinertT13A
 
Use BranchingRatios_radinertT13A
...
Call CalculateLowEnergyConstraints(g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,             & 
& Mn,MDF,mu2,MS2,v,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,            & 
...
& LSHinput,Yuinput,Ydinput,Yeinput,YR3input,YR1input,YR4input,Mninput,MDFinput,          & 
& mu2input,MS2input,vinput,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,    & 
& BrDmunu,ratioDmunu,BrDsmunu,ratioDsmunu,BrDstaunu,ratioDstaunu,BrBmunu,ratioBmunu,     & 
& BrBtaunu,ratioBtaunu,BrKmunu,ratioKmunu,RK,RKSM,muEgamma,tauEgamma,tauMuGamma,         & 
& CRmuEAl,CRmuETi,CRmuESr,CRmuESb,CRmuEAu,CRmuEPb,BRmuTo3e,BRtauTo3e,BRtauTo3mu,         & 
& BRtauToemumu,BRtauTomuee,BRtauToemumu2,BRtauTomuee2,BrZtoMuE,BrZtoTauE,BrZtoTauMu,     & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,YR3input,YR1input(3,3),YR4input,MS2input(3,3),vinput

Complex(dp),Intent(inout) :: Laminput,LSHinput(3,3),Yuinput(3,3),Ydinput(3,3),Yeinput(3,3),Mninput,MDFinput,mu2input
...
Complex(dp) :: ZDR(3,3),ZER(3,3),ZUR(3,3),ZDL(3,3),ZEL(3,3),VSs(3,3),ZUL(3,3),Vv(3,3),               & 
& ZvN(3,3),ZW(2,2)

Real(dp) :: g1,g2,g3,YR3,YR1(3,3),YR4,MS2(3,3),v

Complex(dp) :: Lam,LSH(3,3),Yu(3,3),Yd(3,3),Ye(3,3),Mn,MDF,mu2
...
& cplhhHpcVWp,cplhhSsSs(3,3),cplhhVZVZ,cplHpcHpcVWpVWp,cplHpcHpVP,cplHpcHpVZ,            & 
& cplHpcHpVZVZ,cplHpcVWpVP,cplHpcVWpVZ,cplNv0FreHpL(3),cplNv0FreHpR(3),cplNv0FreVWpL(3), & 
& cplNv0FreVWpR(3),cplNv0Nv0AhL(3,3),cplNv0Nv0AhR(3,3),cplNv0Nv0hhL(3,3),cplNv0Nv0hhR(3,3),& 
& cplNv0Nv0VZL(3,3),cplNv0Nv0VZR(3,3),cplVGVGVG
...
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call RunSM_and_SUSY_RGEs(160._dp,g1input,g2input,g3input,Laminput,LSHinput,           & 
& Yuinput,Ydinput,Yeinput,YR3input,YR1input,YR4input,Mninput,MDFinput,mu2input,          & 
& MS2input,vinput,g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,Mn,MDF,mu2,MS2,v,CKM_160,        & 
...
MHp=MVWp
MHp2=MVWp2
Call AllCouplings(Lam,v,LSH,VSs,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,             & 
& ZUR,YR3,YR4,ZvN,Vv,YR1,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhSsSs,cplAhhhVZ,             & 
...
& cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcHpVPVWp,               & 
& cplcHpVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,               & 
...
& cplAhhhVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,     & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFeVZL,cplcFeFeVZR,         & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFuFdHpL,cplcFuFdHpR,         & 
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcHpVWpVZ,cplcVWpVWpVZ,            & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,       & 
& cplFvNv0SsR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplNv0Nv0VZL,cplNv0Nv0VZR,BOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplhhHpcVWp,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,TSOdulvSLL(gt1,gt2,gt3,gt4)  & 
...
& cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,    & 
& cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,cplFvNv0SsR,cplhhcHpVWp,cplhhcVWpVWp,cplhhHpcHp,     & 
& cplhhHpcVWp,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,TVOdulvSLL(gt1,gt2,gt3,gt4)  & 
...
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcHpVWpVZ,cplcVWpVWpVZ,            & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,       & 
& cplFvNv0SsR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplNv0Nv0VZL,cplNv0Nv0VZR,BOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcHpVWpVZ,cplcVWpVWpVZ,            & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,       & 
& cplFvNv0SsR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplNv0Nv0VZL,cplNv0Nv0VZR,PSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcHpVWpVZ,cplcVWpVWpVZ,            & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,       & 
& cplFvNv0SsR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplNv0Nv0VZL,cplNv0Nv0VZR,PVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcHpVWpVZ,cplcVWpVWpVZ,            & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,       & 
& cplFvNv0SsR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplNv0Nv0VZL,cplNv0Nv0VZR,TSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcHpVWpVZ,cplcVWpVWpVZ,            & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,       & 
& cplFvNv0SsR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplNv0Nv0VZL,cplNv0Nv0VZR,TVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,    & 
& cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,cplFvNv0SsR,cplhhcHpVWp,cplhhcVWpVWp,cplhhHpcHp,     & 
& cplhhHpcVWp,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,TSOdulvSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,    & 
& cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,cplFvNv0SsR,cplhhcHpVWp,cplhhcVWpVWp,cplhhHpcHp,     & 
& cplhhHpcVWp,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,TVOdulvSLLSM(gt1,gt2,gt3,gt4)& 
...
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,Laminput,LSHinput,Yuinput,        & 
& Ydinput,Yeinput,YR3input,YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,         & 
& vinput,g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,Mn,MDF,mu2,MS2,v,CKM_MZ,sinW2_MZ,         & 
...
& MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhcHpVWp,         & 
...
& cplcFreFreVPR,cplcFreFreVZL,cplcFreFreVZR,cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVPVWp,        & 
& cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,      & 
& cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhSsSs,cplhhVZVZ,         & 
& cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,BO4lSLL(gt1,gt2,gt3,gt4),BO4lSRR(gt1,gt2,gt3,gt4)& 
...
& cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,      & 
& cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhSsSs,cplhhVZVZ,         & 
& cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,PSO4lSLL(gt1,gt2,gt3,gt4),               & 
...
& cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,      & 
& cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhSsSs,cplhhVZVZ,         & 
& cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,PVO4lSLL(gt1,gt2,gt3,gt4),               & 
...
& cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,      & 
& cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhSsSs,cplhhVZVZ,         & 
& cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,TSO4lSLL(gt1,gt2,gt3,gt4),               & 
...
& cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,      & 
& cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhSsSs,cplhhVZVZ,         & 
& cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,TVO4lSLL(gt1,gt2,gt3,gt4),               & 
...
& MFre2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,               & 
...
& cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,cplcFreFreVZR,cplcHpVPVWp,cplcHpVWpVZ,       & 
& cplcVWpVPVWp,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,               & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,       & 
& cplhhSsSs,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,BO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplcVWpVPVWp,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,               & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,       & 
& cplhhSsSs,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,PSO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplcVWpVPVWp,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,               & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,       & 
& cplhhSsSs,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,PVO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplcVWpVPVWp,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,               & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,       & 
& cplhhSsSs,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,TSO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplcVWpVPVWp,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,               & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,       & 
& cplhhSsSs,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,TVO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,       & 
...
& cplcFreFeSsL,cplcFreFeSsR,cplcFreFreVPL,cplcFreFreVPR,cplcHpVPVWp,cplcVWpVPVWp,        & 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,1 
  gt3=i2 
Call CalculateH2l(gt1,gt2,gt3,.False.,MAh,MAh2,MFe,MFe2,MFre,MFre2,MFv,               & 
& MFv2,Mhh,Mhh2,MHp,MHp2,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,               & 
...
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFreFeSsL,cplcFreFeSsR,cplFvFeHpL,cplFvFeHpR,           & 
& cplFvFeVWpL,cplFvFeVWpR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,     & 
& cplhhSsSs,cplhhVZVZ,OH2lSL(gt1,gt2,gt3),OH2lSR(gt1,gt2,gt3))
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateZ2l(gt1,gt2,gt3,.False.,MAh,MAh2,MFe,MFe2,MFre,MFre2,MFv,               & 
& MFv2,Mhh,Mhh2,MHp,MHp2,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,cplcFeFeAhL,             & 
...
& cplcFeFvcVWpR,cplcFreFeSsL,cplcFreFeSsR,cplcFreFreVZL,cplcFreFreVZR,cplcHpVWpVZ,       & 
& cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,      & 
...
Call Gminus2(1,MAh,MAh2,MFe,MFe2,MFre,MFre2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,               & 
& MSs,MSs2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,cplcFeFehhR,        & 
...
Call Gminus2(2,MAh,MAh2,MFe,MFe2,MFre,MFre2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,               & 
& MSs,MSs2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFreFeSsL,cplcFreFeSsR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFreSsL,cplcFeFreSsR,           & 
& cplcFreFreVPL,cplcFreFreVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,amu)

Call Gminus2(3,MAh,MAh2,MFe,MFe2,MFre,MFre2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,               & 
& MSs,MSs2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFreFeSsL,cplcFreFeSsR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFreSsL,cplcFeFreSsR,           & 
...
Call LeptonEDM(1,MAh,MAh2,MFe,MFe2,MFre,MFre2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,             & 
& MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHpL,cplFvFeHpR,            & 
& cplFvFeVWpL,cplFvFeVWpR,cplcFeFehhL,cplcFeFehhR,cplcFreFeSsL,cplcFreFeSsR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFreSsL,cplcFeFreSsR,             & 
& cplcFreFreVPL,cplcFreFreVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,     & 
& cplHpcHpVP,cplcVWpVPVWp,EDMe)

Call LeptonEDM(2,MAh,MAh2,MFe,MFe2,MFre,MFre2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,             & 
& MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHpL,cplFvFeHpR,            & 
& cplFvFeVWpL,cplFvFeVWpR,cplcFeFehhL,cplcFeFehhR,cplcFreFeSsL,cplcFreFeSsR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFreSsL,cplcFeFreSsR,             & 
& cplcFreFreVPL,cplcFreFreVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,     & 
...
Call LeptonEDM(3,MAh,MAh2,MFe,MFe2,MFre,MFre2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,             & 
& MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHpL,cplFvFeHpR,            & 
& cplFvFeVWpL,cplFvFeVWpR,cplcFeFehhL,cplcFeFehhR,cplcFreFeSsL,cplcFreFeSsR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFreSsL,cplcFeFreSsR,             & 
& cplcFreFreVPL,cplcFreFreVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,     & 
...
End Program SPhenoradinertT13A 
