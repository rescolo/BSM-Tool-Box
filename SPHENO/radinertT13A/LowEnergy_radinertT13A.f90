...
& MHp,MHp2,MSs,MSs2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,           & 
& cplcFeFehhR,cplcFreFeSsL,cplcFreFeSsR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFreSsL,            & 
& cplcFeFreSsR,cplcFreFreVPL,cplcFreFreVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,a_mu)

Real(dp),Intent(in)  :: MAh,MAh2,MFe(3),MFe2(3),MFre,MFre2,MFv(3),MFv2(3),Mhh,Mhh2,MHp,MHp2,MSs(3),MSs2(3)

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplcFeFehhL(3,3),   & 
& cplcFeFehhR(3,3),cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),& 
& cplcFeFreSsL(3,3),cplcFeFreSsR(3,3),cplcFreFreVPL,cplcFreFreVPR,cplcFeFvcHpL(3,3),     & 
...
Do i1= 1,3
  If ((MSs2(i1).gt.mz2).Or.(MFre2.gt.mz2).Or.(MFre2.gt.mz2)) Then
coup1L = cplcFeFreSsL(gt1,i1)
coup1R = cplcFeFreSsR(gt1,i1)
coup2L = cplcFreFeSsL(gt2,i1)
coup2R = cplcFreFeSsR(gt2,i1)
ratio = MSs2(i1)/MFre2
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
& Mhh2,MHp,MHp2,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHpL,         & 
& cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplcFeFehhL,cplcFeFehhR,cplcFreFeSsL,               & 
...
Implicit None
Real(dp),Intent(in)  :: MAh,MAh2,MFe(3),MFe2(3),MFre,MFre2,MFv(3),MFv2(3),Mhh,Mhh2,MHp,MHp2,MSs(3),           & 
& MSs2(3),MVWp,MVWp2,MVZ,MVZ2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplFvFeVWpL(3,3),   & 
& cplFvFeVWpR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),& 
& cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFreSsL(3,3), & 
& cplcFeFreSsR(3,3),cplcFreFreVPL,cplcFreFreVPR,cplcFeFvcHpL(3,3),cplcFeFvcHpR(3,3),     & 
...
& MFv2,Mhh,Mhh2,MHp,MHp2,MNv0,MNv02,MVWp,MVWp2,MVZ,MVZ2,cplAhAhcVWpVWp,cplAhAhVZVZ,      & 
...
& cplNv0Nv0VZL,cplNv0Nv0VZR,rho)

Implicit None
Real(dp),Intent(in)  :: MAh,MAh2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFre,MFre2,MFu(3),MFu2(3),MFv(3),              & 
& MFv2(3),Mhh,Mhh2,MHp,MHp2,MNv0(3),MNv02(3),MVWp,MVWp2,MVZ,MVZ2
...
& cplcFreNv0cVWpR(3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcgAgWpcVWp,cplcgWCgAcVWp,      & 
& cplcgWCgWCVZ,cplcgWCgZcVWp,cplcgWpgWpVZ,cplcgZgWpcVWp,cplcVWpcVWpVWpVWp1,              & 
& cplcVWpcVWpVWpVWp2,cplcVWpcVWpVWpVWp3,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,cplcVWpVPVPVWp3, & 
& cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,             & 
& cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplhhcVWpVWp,cplhhhhcVWpVWp,cplhhhhVZVZ,               & 
& cplhhHpcVWp,cplhhVZVZ,cplHpcHpcVWpVWp,cplHpcHpVZ,cplHpcHpVZVZ,cplHpcVWpVP,             & 
& cplHpcVWpVZ,cplNv0Nv0VZL(3,3),cplNv0Nv0VZR(3,3)
...
& MFu2,MFv,MFv2,MVZ,MVZ2,MHp,MHp2,MVWp,MVWp2,MNv0,MNv02,cplAhhhVZ,cplcFdFdVZL,           & 
...
End Function C1C2 
End Module LowEnergy_radinertT13A 
