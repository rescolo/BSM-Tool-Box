...
Module Nv03Decays_radinertT13A 
...
& YR1,YR4,Mn,MDF,mu2,MS2,v,gThh,gTSs,gTVWp,gTVZ,gNv0FrecFdFu,gNv0FrecFeFv,               & 
& gNv0Nv0cFreFre,gNv0Nv0FvFv,gNv0Nv0cFdFd,gNv0Nv0cFeFe,gNv0Nv0cFuFu,gNv0Nv0Nv0Nv0,       & 
...
Real(dp),Intent(inout) :: gNv0FrecFdFu(3,1,3,3),gNv0FrecFeFv(3,1,3,3),gNv0Nv0cFreFre(3,3,1,1),gNv0Nv0FvFv(3,3,3,3),& 
& gNv0Nv0cFdFd(3,3,3,3),gNv0Nv0cFeFe(3,3,3,3),gNv0Nv0cFuFu(3,3,3,3),gNv0Nv0Nv0Nv0(3,3,3,3)

Real(dp),Intent(in) :: gThh,gTSs(3),gTVWp,gTVZ

Real(dp) :: gNv0FrecFdFui(1,3,3),gNv0FrecFeFvi(1,3,3),gNv0Nv0cFreFrei(3,1,1),gNv0Nv0FvFvi(3,3,3), & 
& gNv0Nv0cFdFdi(3,3,3),gNv0Nv0cFeFei(3,3,3),gNv0Nv0cFuFui(3,3,3),gNv0Nv0Nv0Nv0i(3,3,3)

Real(dp) :: gThhtemp,gTSstemp(3),gTVWptemp,gTVZtemp
...
& MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,VSs,ZUL,Vv,ZvN,ZW,ZZ,g1,g2,g3,              & 
& Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,Mn,MDF,mu2,MS2,v,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,     & 
& cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,           & 
& cplcFeFeVZR,cplcFeFreSsL,cplcFeFreSsR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFreFreVZL,       & 
& cplcFreFreVZR,cplcFreNv0cVWpL,cplcFreNv0cVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,     & 
& cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,cplFvNv0SsR,cplNv0FreVWpL,               & 
...
gNv0FrecFeFvi = 0._dp 
Call Nv0ToFrecFeFv(i_run,MFre,MFe,MFv,MVWp,MSs,MNv0,cplcFeFreSsL,cplcFeFreSsR,        & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplFvNv0SsL,cplFvNv0SsR,cplNv0FreVWpL,cplNv0FreVWpR,       & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NVs,            & 
& NVSst,NVVss,gTVWptemp,gTSstemp,deltaM,epsI,check,gNv0FrecFeFvi)
...
gNv0Nv0FvFvi = 0._dp 
Call Nv0ToNv0FvFv(i_run,MNv0,MFv,MVZ,MSs,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,           & 
& cplFvNv0SsR,cplNv0Nv0VZL,cplNv0Nv0VZR,IntegralSs,IntegralSSss,IntegralSSst,            & 
& IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NSSst,NVs,NVSst,NVVss,gTVZtemp,         & 
& gTSstemp,deltaM,epsI,check,gNv0Nv0FvFvi)
...
Subroutine Nv0ToFrecFeFv(iIN,MFre,MFe,MFv,MVWp,MSs,MNv0,cplcFeFreSsL,cplcFeFreSsR,    & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplFvNv0SsL,cplFvNv0SsR,cplNv0FreVWpL,cplNv0FreVWpR,       & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NVs,            & 
...
Real(dp),Intent(in) :: MFre,MFe(3),MFv(3),MVWp,MSs(3),MNv0(3)

Complex(dp),Intent(in) :: cplcFeFreSsL(3,3),cplcFeFreSsR(3,3),cplcFeFvcVWpL(3,3),cplcFeFvcVWpR(3,3),            & 
& cplFvNv0SsL(3,3,3),cplFvNv0SsR(3,3,3),cplNv0FreVWpL(3),cplNv0FreVWpR(3)
...
coup(2) = Conjg(cplFvNv0SsL(gt3,iIN,i1)) 
coup(1) = Conjg(cplFvNv0SsR(gt3,iIN,i1)) 
coup(4) = Conjg(cplcFeFreSsL(gt2,i1)) 
coup(3) = Conjg(cplcFeFreSsR(gt2,i1))
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Nv0->Fre cFe Fv Propagator: Ss" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplFvNv0SsL(gt3,iIN,i2)) 
coup2(4) = Conjg(cplFvNv0SsR(gt3,iIN,i2))  
coup2(5) = cplcFeFvcVWpL(gt2,gt3) 
coup2(6) = cplcFeFvcVWpR(gt2,gt3) 
coup2(7) = Conjg(cplcFeFreSsL(gt2,i2)) 
coup2(8) = Conjg(cplcFeFreSsR(gt2,i2)) 
coupT = coup2(5) 
coup2(5) = coup2(6) 
coup2(6) = coupT 
...
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Nv0->Fre cFe Fv Propagator: VWp,Ss" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(1,gt2,gt3,Isum)= 0._dp  
...
End If 
Contribution(1,gt2,gt3,Isum)='VWp,Ss'
      End Do 
...
coup2(1) = cplFvNv0SsL(gt3,iIN,i1) 
coup2(2) = cplFvNv0SsR(gt3,iIN,i1) 
coup2(3) = Conjg(cplFvNv0SsL(gt3,iIN,i2)) 
coup2(4) = Conjg(cplFvNv0SsR(gt3,iIN,i2))  
coup2(5) = cplcFeFreSsL(gt2,i1) 
coup2(6) = cplcFeFreSsR(gt2,i1) 
coup2(7) = Conjg(cplcFeFreSsL(gt2,i2)) 
coup2(8) = Conjg(cplcFeFreSsR(gt2,i2)) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Nv0->Fre cFe Fv Propagator: Ss,Ss" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(1,gt2,gt3,Isum)= 0._dp  
...
g=0._dp 
      Do gt2=1,3
        Do gt3=1,3
g(1,gt2,gt3)=Sum(gSum(1,gt2,gt3,1:16))
If (g(1,gt2,gt3).Lt.0._dp) Then
  Write (ErrCan,*)'Error in Subroutine'//NameOfUnit(Iname)
  g(1,gt2,gt3)=0._dp
End If
...
Subroutine Nv0ToNv0FvFv(iIN,MNv0,MFv,MVZ,MSs,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,       & 
& cplFvNv0SsR,cplNv0Nv0VZL,cplNv0Nv0VZR,IntegralSs,IntegralSSss,IntegralSSst,            & 
& IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NSSst,NVs,NVSst,NVVss,gTVZ,             & 
& gTSs,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MNv0(3),MFv(3),MVZ,MSs(3)

Complex(dp),Intent(in) :: cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplFvNv0SsL(3,3,3),cplFvNv0SsR(3,3,3),cplNv0Nv0VZL(3,3),& 
& cplNv0Nv0VZR(3,3)
...
Real(dp),Intent(inout) :: gTVZ,gTSs(3)
...
coup(2) = Conjg(cplFvNv0SsL(gt2,iIN,i1)) 
coup(1) = Conjg(cplFvNv0SsR(gt2,iIN,i1)) 
coup(4) = Conjg(cplFvNv0SsL(gt3,gt1,i1)) 
coup(3) = Conjg(cplFvNv0SsR(gt3,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt3.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplFvNv0SsL(gt3,iIN,i1) 
coup2(2) = cplFvNv0SsR(gt3,iIN,i1) 
coup2(3) = Conjg(cplFvNv0SsL(gt2,iIN,i1)) 
coup2(4) = Conjg(cplFvNv0SsR(gt2,iIN,i1))  
coup2(5) = cplFvNv0SsL(gt2,gt1,i1) 
coup2(6) = cplFvNv0SsR(gt2,gt1,i1) 
coup2(7) = Conjg(cplFvNv0SsL(gt3,gt1,i1)) 
coup2(8) = Conjg(cplFvNv0SsR(gt3,gt1,i1)) 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Nv0->Nv0 Fv Fv Propagator: Ss" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplNv0Nv0VZL(iIN,gt1) 
coup2(2) = cplNv0Nv0VZR(iIN,gt1) 
coup2(3) = Conjg(cplFvNv0SsL(gt2,iIN,i2)) 
coup2(4) = Conjg(cplFvNv0SsR(gt2,iIN,i2))  
coup2(5) = cplFvFvVZL(gt2,gt3) 
coup2(6) = cplFvFvVZR(gt2,gt3) 
coup2(7) = Conjg(cplFvNv0SsL(gt3,gt1,i2)) 
coup2(8) = Conjg(cplFvNv0SsR(gt3,gt1,i2)) 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Nv0->Nv0 Fv Fv Propagator: VZ,Ss" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If 
Contribution(gt1,gt2,gt3,Isum)='VZ,Ss'
      End Do 
...
coup2(1) = cplFvNv0SsL(gt2,iIN,i1) 
coup2(2) = cplFvNv0SsR(gt2,iIN,i1) 
coup2(3) = Conjg(cplFvNv0SsL(gt2,iIN,i2)) 
coup2(4) = Conjg(cplFvNv0SsR(gt2,iIN,i2))  
coup2(5) = cplFvNv0SsL(gt3,gt1,i1) 
coup2(6) = cplFvNv0SsR(gt3,gt1,i1) 
coup2(7) = Conjg(cplFvNv0SsL(gt3,gt1,i2)) 
coup2(8) = Conjg(cplFvNv0SsR(gt3,gt1,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Nv0->Nv0 Fv Fv Propagator: Ss,Ss" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End Module Nv03Decays_radinertT13A 
