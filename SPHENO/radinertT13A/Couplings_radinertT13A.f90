...
Contains 
 ...
 Subroutine AllCouplingsReallyAll(Lam,v,LSH,VSs,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,             & 
& ZEL,ZER,Yu,ZUL,ZUR,YR3,YR4,ZvN,Vv,YR1,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhSsSs,        & 
& cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,cplAhAhSsSs,cplhhhhhhhh,cplhhhhHpcHp,             & 
& cplhhhhSsSs,cplHpHpcHpcHp,cplHpSsSscHp,cplAhhhVZ,cplAhHpcVWp,cplAhcHpVWp,              & 
...
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplNv0Nv0AhL,cplNv0Nv0AhR,             & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,     & 
& cplcFeFehhR,cplcFreFeSsL,cplcFreFeSsR,cplNv0FreHpL,cplNv0FreHpR,cplcFeFreSsL,          & 
& cplcFeFreSsR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFucHpL,cplcFdFucHpR,cplFvNv0SsL,            & 
& cplFvNv0SsR,cplcFeFvcHpL,cplcFeFvcHpR,cplNv0Nv0hhL,cplNv0Nv0hhR,cplcFreNv0cHpL,        & 
& cplcFreNv0cHpR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,           & 
& cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,cplFvFeVWpL,cplFvFeVWpR,cplcFeFeVPL,              & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplNv0FreVWpL,cplNv0FreVWpR,cplcFreFreVPL,         & 
& cplcFreFreVPR,cplcFreFreVZL,cplcFreFreVZR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,         & 
& cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplFvFvVZL,            & 
& cplFvFvVZR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplNv0Nv0VZL,cplNv0Nv0VZR,cplcFreNv0cVWpL,      & 
& cplcFreNv0cVWpR,cplVGVGVGVG1,cplVGVGVGVG2,cplVGVGVGVG3,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,& 
...
Implicit None 
Real(dp), Intent(in) :: v,g1,g2,TW,g3,YR3,YR4,YR1(3,3)

Complex(dp), Intent(in) :: Lam,LSH(3,3),VSs(3,3),Yd(3,3),ZDL(3,3),ZDR(3,3),Ye(3,3),ZEL(3,3),ZER(3,3),            & 
& Yu(3,3),ZUL(3,3),ZUR(3,3),ZvN(3,3),Vv(3,3)

Complex(dp), Intent(out) :: cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhSsSs(3,3),cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,   & 
& cplAhAhSsSs(3,3),cplhhhhhhhh,cplhhhhHpcHp,cplhhhhSsSs(3,3),cplHpHpcHpcHp,              & 
& cplHpSsSscHp(3,3),cplAhhhVZ,cplAhHpcVWp,cplAhcHpVWp,cplhhHpcVWp,cplhhcHpVWp,           & 
...
& cplcFeFeAhR(3,3),cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplNv0Nv0AhL(3,3),cplNv0Nv0AhR(3,3),& 
& cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFuFdHpL(3,3),cplcFuFdHpR(3,3),cplFvFeHpL(3,3),   & 
& cplFvFeHpR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),cplcFreFeSsL(3,3),cplcFreFeSsR(3,3), & 
& cplNv0FreHpL(3),cplNv0FreHpR(3),cplcFeFreSsL(3,3),cplcFeFreSsR(3,3),cplcFuFuhhL(3,3),  & 
& cplcFuFuhhR(3,3),cplcFdFucHpL(3,3),cplcFdFucHpR(3,3),cplFvNv0SsL(3,3,3),               & 
& cplFvNv0SsR(3,3,3),cplcFeFvcHpL(3,3),cplcFeFvcHpR(3,3),cplNv0Nv0hhL(3,3),              & 
& cplNv0Nv0hhR(3,3),cplcFreNv0cHpL(3),cplcFreNv0cHpR(3),cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),& 
& cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplcFdFdVZL(3,3),& 
& cplcFdFdVZR(3,3),cplFvFeVWpL(3,3),cplFvFeVWpR(3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),  & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplNv0FreVWpL(3),cplNv0FreVWpR(3),cplcFreFreVPL,     & 
...
& cplNv0Nv0VZL(3,3),cplNv0Nv0VZR(3,3),cplcFreNv0cVWpL(3),cplcFreNv0cVWpR(3),             & 
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplinghhSsSsT(gt2,gt3,LSH,v,VSs,cplhhSsSs(gt2,gt3))
...
Do gt3 = 1, 3
 Do gt4 = 1, 3
Call CouplingAhAhSsSsT(gt3,gt4,LSH,VSs,cplAhAhSsSs(gt3,gt4))
...
Do gt3 = 1, 3
 Do gt4 = 1, 3
Call CouplinghhhhSsSsT(gt3,gt4,LSH,VSs,cplhhhhSsSs(gt3,gt4))
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplingHpSsSscHpT(gt2,gt3,LSH,VSs,cplHpSsSscHp(gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingNv0Nv0AhT(gt1,gt2,YR3,YR4,ZvN,cplNv0Nv0AhL(gt1,gt2),cplNv0Nv0AhR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingFvFeHpT(gt1,gt2,Ye,ZER,Vv,cplFvFeHpL(gt1,gt2),cplFvFeHpR(gt1,gt2))
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplingcFreFeSsT(gt2,gt3,YR1,ZEL,VSs,cplcFreFeSsL(gt2,gt3),cplcFreFeSsR(gt2,gt3))
...
cplNv0FreHpR = 0._dp 
Do gt1 = 1, 3
Call CouplingNv0FreHpT(gt1,YR3,YR4,ZvN,cplNv0FreHpL(gt1),cplNv0FreHpR(gt1))
...
Do gt1 = 1, 3
 Do gt3 = 1, 3
Call CouplingcFeFreSsT(gt1,gt3,YR1,ZEL,VSs,cplcFeFreSsL(gt1,gt3),cplcFeFreSsR(gt1,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingFvNv0SsT(gt1,gt2,gt3,YR1,ZvN,Vv,VSs,cplFvNv0SsL(gt1,gt2,gt3)             & 
& ,cplFvNv0SsR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFeFvcHpT(gt1,gt2,Ye,ZER,Vv,cplcFeFvcHpL(gt1,gt2),cplcFeFvcHpR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingNv0Nv0hhT(gt1,gt2,YR3,YR4,ZvN,cplNv0Nv0hhL(gt1,gt2),cplNv0Nv0hhR(gt1,gt2))

 End Do 
End Do 


cplcFreNv0cHpL = 0._dp 
cplcFreNv0cHpR = 0._dp 
Do gt2 = 1, 3
Call CouplingcFreNv0cHpT(gt2,YR3,YR4,ZvN,cplcFreNv0cHpL(gt2),cplcFreNv0cHpR(gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingFvFeVWpT(gt1,gt2,g2,ZEL,Vv,cplFvFeVWpL(gt1,gt2),cplFvFeVWpR(gt1,gt2))
...
cplNv0FreVWpR = 0._dp 
Do gt1 = 1, 3
Call CouplingNv0FreVWpT(gt1,g2,ZvN,cplNv0FreVWpL(gt1),cplNv0FreVWpR(gt1))
...
cplcFreFreVPL = 0._dp 
cplcFreFreVPR = 0._dp 
Call CouplingcFreFreVPT(g1,g2,TW,cplcFreFreVPL,cplcFreFreVPR)
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFeFvcVWpT(gt1,gt2,g2,ZEL,Vv,cplcFeFvcVWpL(gt1,gt2),cplcFeFvcVWpR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingNv0Nv0VZT(gt1,gt2,g1,g2,ZvN,TW,cplNv0Nv0VZL(gt1,gt2),cplNv0Nv0VZR(gt1,gt2))

 End Do 
End Do 


cplcFreNv0cVWpL = 0._dp 
cplcFreNv0cVWpR = 0._dp 
Do gt2 = 1, 3
Call CouplingcFreNv0cVWpT(gt2,g2,ZvN,cplcFreNv0cVWpL(gt2),cplcFreNv0cVWpR(gt2))
...
Subroutine AllCouplings(Lam,v,LSH,VSs,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,              & 
& Yu,ZUL,ZUR,YR3,YR4,ZvN,Vv,YR1,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhSsSs,cplAhhhVZ,      & 
& cplAhHpcVWp,cplAhcHpVWp,cplhhHpcVWp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplhhcVWpVWp,    & 
& cplhhVZVZ,cplHpcVWpVP,cplHpcVWpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplVGVGVG,cplcVWpVPVWp,      & 
& cplcVWpVWpVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,              & 
& cplcFuFuAhR,cplNv0Nv0AhL,cplNv0Nv0AhR,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,             & 
& cplcFuFdHpR,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,cplcFeFehhR,cplcFreFeSsL,cplcFreFeSsR,   & 
& cplNv0FreHpL,cplNv0FreHpR,cplcFeFreSsL,cplcFeFreSsR,cplcFuFuhhL,cplcFuFuhhR,           & 
& cplcFdFucHpL,cplcFdFucHpR,cplFvNv0SsL,cplFvNv0SsR,cplcFeFvcHpL,cplcFeFvcHpR,           & 
...
Complex(dp), Intent(out) :: cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhSsSs(3,3),cplAhhhVZ,cplAhHpcVWp,cplAhcHpVWp,      & 
& cplhhHpcVWp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplhhcVWpVWp,cplhhVZVZ,cplHpcVWpVP,      & 
...
& cplcFuFuAhR(3,3),cplNv0Nv0AhL(3,3),cplNv0Nv0AhR(3,3),cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),& 
& cplcFuFdHpL(3,3),cplcFuFdHpR(3,3),cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplcFeFehhL(3,3),    & 
& cplcFeFehhR(3,3),cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplNv0FreHpL(3),cplNv0FreHpR(3),  & 
& cplcFeFreSsL(3,3),cplcFeFreSsR(3,3),cplcFuFuhhL(3,3),cplcFuFuhhR(3,3),cplcFdFucHpL(3,3),& 
& cplcFdFucHpR(3,3),cplFvNv0SsL(3,3,3),cplFvNv0SsR(3,3,3),cplcFeFvcHpL(3,3),             & 
& cplcFeFvcHpR(3,3),cplNv0Nv0hhL(3,3),cplNv0Nv0hhR(3,3),cplcFreNv0cHpL(3),               & 
& cplcFreNv0cHpR(3),cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3), & 
& cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplFvFeVWpL(3,3),& 
& cplFvFeVWpR(3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),  & 
& cplNv0FreVWpL(3),cplNv0FreVWpR(3),cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,           & 
& cplcFreFreVZR,cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),     & 
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFdFucVWpL(3,3),cplcFdFucVWpR(3,3),               & 
& cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplcFeFvcVWpL(3,3),cplcFeFvcVWpR(3,3),cplNv0Nv0VZL(3,3),& 
& cplNv0Nv0VZR(3,3),cplcFreNv0cVWpL(3),cplcFreNv0cVWpR(3)
...
Subroutine CouplinghhSsSsT(gt2,gt3,LSH,v,VSs,res)
...
Complex(dp), Intent(in) :: LSH(3,3),VSs(3,3)
...
Do j2 = 1,3
Do j1 = 1,3
res = res-(v*Conjg(VSs(gt2,j2))*Conjg(VSs(gt3,j1))*LSH(j1,j2))
End Do 
End Do 
Do j2 = 1,3
Do j1 = 1,3
res = res-(v*Conjg(VSs(gt2,j1))*Conjg(VSs(gt3,j2))*LSH(j1,j2))
End Do 
End Do 
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
Subroutine CouplingAhAhSsSsT(gt3,gt4,LSH,VSs,res)
...
Do j2 = 1,3
Do j1 = 1,3
res = res-(Conjg(VSs(gt3,j2))*Conjg(VSs(gt4,j1))*LSH(j1,j2))
End Do 
End Do 
Do j2 = 1,3
Do j1 = 1,3
res = res-(Conjg(VSs(gt3,j1))*Conjg(VSs(gt4,j2))*LSH(j1,j2))
End Do 
End Do 
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
Subroutine CouplinghhhhSsSsT(gt3,gt4,LSH,VSs,res)
...
Subroutine CouplingHpSsSscHpT(gt2,gt3,LSH,VSs,res)
...
Do j2 = 1,3
Do j1 = 1,3
res = res-(Conjg(VSs(gt2,j2))*Conjg(VSs(gt3,j1))*LSH(j1,j2))
End Do 
End Do 
Do j2 = 1,3
Do j1 = 1,3
res = res-(Conjg(VSs(gt2,j1))*Conjg(VSs(gt3,j2))*LSH(j1,j2))
End Do 
End Do 
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
Subroutine CouplingNv0Nv0AhT(gt1,gt2,YR3,YR4,ZvN,resL,resR)

Implicit None 

Integer, Intent(in) :: gt1,gt2
Real(dp), Intent(in) :: YR3,YR4

Complex(dp), Intent(in) :: ZvN(3,3)

Complex(dp), Intent(out) :: resL, resR 
 
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingNv0Nv0Ah' 
...
resL = 0._dp 
resL = resL-((YR3*Conjg(ZvN(gt1,2))*Conjg(ZvN(gt2,1)))/sqrt(2._dp))
resL = resL-((YR4*Conjg(ZvN(gt1,3))*Conjg(ZvN(gt2,1)))/sqrt(2._dp))
resL = resL-((YR3*Conjg(ZvN(gt1,1))*Conjg(ZvN(gt2,2)))/sqrt(2._dp))
resL = resL-((YR4*Conjg(ZvN(gt1,1))*Conjg(ZvN(gt2,3)))/sqrt(2._dp))
resR = 0._dp 
resR = resR+(YR3*ZvN(gt1,2)*ZvN(gt2,1))/sqrt(2._dp)
resR = resR+(YR4*ZvN(gt1,3)*ZvN(gt2,1))/sqrt(2._dp)
resR = resR+(YR3*ZvN(gt1,1)*ZvN(gt2,2))/sqrt(2._dp)
resR = resR+(YR4*ZvN(gt1,1)*ZvN(gt2,3))/sqrt(2._dp)
resL = -(0.,1.)*resL 
...
End Subroutine CouplingNv0Nv0AhT  
...
Subroutine CouplingFvFeHpT(gt1,gt2,Ye,ZER,Vv,resL,resR)

Implicit None 

Integer, Intent(in) :: gt1,gt2
Complex(dp), Intent(in) :: Ye(3,3),ZER(3,3),Vv(3,3)
...
Subroutine CouplingcFreFeSsT(gt2,gt3,YR1,ZEL,VSs,resL,resR)

Implicit None 

Integer, Intent(in) :: gt2,gt3
Real(dp), Intent(in) :: YR1(3,3)

Complex(dp), Intent(in) :: ZEL(3,3),VSs(3,3)
...
Do j2 = 1,3
Do j1 = 1,3
resL = resL+Conjg(ZEL(gt2,j1))*Conjg(VSs(gt3,j2))*YR1(j1,j2)
End Do 
End Do 
resR = 0._dp 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
...
Subroutine CouplingNv0FreHpT(gt1,YR3,YR4,ZvN,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingNv0FreHp' 
...
resL = 0._dp 
resL = resL-(YR3*Conjg(ZvN(gt1,1)))
resR = 0._dp 
resR = resR+YR4*ZvN(gt1,1)
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
End Subroutine CouplingNv0FreHpT  
 
 
Subroutine CouplingcFeFreSsT(gt1,gt3,YR1,ZEL,VSs,resL,resR)
...
Do j2 = 1,3
Do j1 = 1,3
resR = resR+Conjg(VSs(gt3,j2))*ZEL(gt1,j1)*YR1(j1,j2)
End Do 
End Do 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
Subroutine CouplingFvNv0SsT(gt1,gt2,gt3,YR1,ZvN,Vv,VSs,resL,resR)
...
Complex(dp), Intent(in) :: ZvN(3,3),Vv(3,3),VSs(3,3)

Complex(dp), Intent(out) :: resL, resR 
 
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingFvNv0Ss' 
...
Do j2 = 1,3
Do j1 = 1,3
resL = resL+Conjg(VSs(gt3,j2))*Conjg(Vv(gt1,j1))*Conjg(ZvN(gt2,3))*YR1(j1,j2)
End Do 
End Do 
resR = 0._dp 
Do j2 = 1,3
Do j1 = 1,3
resR = resR+Conjg(VSs(gt3,j2))*Vv(gt1,j1)*YR1(j1,j2)*ZvN(gt2,3)
End Do 
End Do 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
End Subroutine CouplingFvNv0SsT  
 
 
Subroutine CouplingcFeFvcHpT(gt1,gt2,Ye,ZER,Vv,resL,resR)
...
Subroutine CouplingNv0Nv0hhT(gt1,gt2,YR3,YR4,ZvN,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingNv0Nv0hh' 
...
End Subroutine CouplingNv0Nv0hhT  
 
 
Subroutine CouplingcFreNv0cHpT(gt2,YR3,YR4,ZvN,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingcFreNv0cHp' 
...
resL = 0._dp 
resL = resL+YR4*Conjg(ZvN(gt2,1))
resR = 0._dp 
resR = resR-(YR3*ZvN(gt2,1))
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
End Subroutine CouplingcFreNv0cHpT  
...
Subroutine CouplingFvFeVWpT(gt1,gt2,g2,ZEL,Vv,resL,resR)
...
Complex(dp), Intent(in) :: ZEL(3,3),Vv(3,3)
...
Subroutine CouplingNv0FreVWpT(gt1,g2,ZvN,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingNv0FreVWp' 
...
resL = 0._dp 
resL = resL-((g2*ZvN(gt1,2))/sqrt(2._dp))
resR = 0._dp 
resR = resR-((g2*Conjg(ZvN(gt1,3)))/sqrt(2._dp))
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
End Subroutine CouplingNv0FreVWpT  
 
 
Subroutine CouplingcFreFreVPT(g1,g2,TW,resL,resR)
...
Subroutine CouplingcFreFreVZT(g1,g2,TW,resL,resR)
...
Subroutine CouplingcFeFvcVWpT(gt1,gt2,g2,ZEL,Vv,resL,resR)
...
Subroutine CouplingNv0Nv0VZT(gt1,gt2,g1,g2,ZvN,TW,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingNv0Nv0VZ' 
...
resL = 0._dp 
resL = resL-(g2*Conjg(ZvN(gt2,2))*Cos(TW)*ZvN(gt1,2))/2._dp
resL = resL-(g1*Conjg(ZvN(gt2,2))*Sin(TW)*ZvN(gt1,2))/2._dp
resL = resL+(g2*Conjg(ZvN(gt2,3))*Cos(TW)*ZvN(gt1,3))/2._dp
resL = resL+(g1*Conjg(ZvN(gt2,3))*Sin(TW)*ZvN(gt1,3))/2._dp
resR = 0._dp 
resR = resR+(g2*Conjg(ZvN(gt1,2))*Cos(TW)*ZvN(gt2,2))/2._dp
resR = resR+(g1*Conjg(ZvN(gt1,2))*Sin(TW)*ZvN(gt2,2))/2._dp
resR = resR-(g2*Conjg(ZvN(gt1,3))*Cos(TW)*ZvN(gt2,3))/2._dp
resR = resR-(g1*Conjg(ZvN(gt1,3))*Sin(TW)*ZvN(gt2,3))/2._dp
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
End Subroutine CouplingNv0Nv0VZT  
 
 
Subroutine CouplingcFreNv0cVWpT(gt2,g2,ZvN,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingcFreNv0cVWp' 
...
resL = 0._dp 
resL = resL-((g2*Conjg(ZvN(gt2,2)))/sqrt(2._dp))
resR = 0._dp 
resR = resR-((g2*ZvN(gt2,3))/sqrt(2._dp))
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
End Subroutine CouplingcFreNv0cVWpT  
...
Subroutine CouplingsForEffPot4(Lam,LSH,VSs,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,      & 
& cplAhAhSsSs,cplhhhhhhhh,cplhhhhHpcHp,cplhhhhSsSs,cplHpHpcHpcHp,cplHpSsSscHp)

Implicit None 
Complex(dp), Intent(in) :: Lam,LSH(3,3),VSs(3,3)

Complex(dp), Intent(out) :: cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,cplAhAhSsSs(3,3),cplhhhhhhhh,cplhhhhHpcHp,       & 
& cplhhhhSsSs(3,3),cplHpHpcHpcHp,cplHpSsSscHp(3,3)
...
Do gt3 = 1, 3
 Do gt4 = 1, 3
Call CouplingAhAhSsSs2L(gt3,gt4,LSH,VSs,cplAhAhSsSs(gt3,gt4))
...
Do gt3 = 1, 3
 Do gt4 = 1, 3
Call CouplinghhhhSsSs2L(gt3,gt4,LSH,VSs,cplhhhhSsSs(gt3,gt4))
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplingHpSsSscHp2L(gt2,gt3,LSH,VSs,cplHpSsSscHp(gt2,gt3))
...
Subroutine CouplingsForEffPot3(Lam,v,LSH,VSs,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,             & 
& ZUL,ZUR,YR3,YR4,ZvN,Vv,YR1,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhSsSs,cplVGVGVG,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,               & 
& cplNv0Nv0AhL,cplNv0Nv0AhR,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,             & 
& cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,cplcFeFehhR,cplcFreFeSsL,cplcFreFeSsR,               & 
& cplNv0FreHpL,cplNv0FreHpR,cplcFeFreSsL,cplcFeFreSsR,cplcFuFuhhL,cplcFuFuhhR,           & 
& cplcFdFucHpL,cplcFdFucHpR,cplFvNv0SsL,cplFvNv0SsR,cplcFeFvcHpL,cplcFeFvcHpR,           & 
& cplNv0Nv0hhL,cplNv0Nv0hhR,cplcFreNv0cHpL,cplcFreNv0cHpR,cplcFdFdVGL,cplcFdFdVGR,       & 
...
Implicit None 
Real(dp), Intent(in) :: v,g3,YR3,YR4,YR1(3,3)

Complex(dp), Intent(in) :: Lam,LSH(3,3),VSs(3,3),Yd(3,3),ZDL(3,3),ZDR(3,3),Ye(3,3),ZEL(3,3),ZER(3,3),            & 
& Yu(3,3),ZUL(3,3),ZUR(3,3),ZvN(3,3),Vv(3,3)

Complex(dp), Intent(out) :: cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhSsSs(3,3),cplVGVGVG,cplcFdFdAhL(3,3),             & 
& cplcFdFdAhR(3,3),cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),  & 
& cplNv0Nv0AhL(3,3),cplNv0Nv0AhR(3,3),cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFuFdHpL(3,3),& 
& cplcFuFdHpR(3,3),cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),    & 
& cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplNv0FreHpL(3),cplNv0FreHpR(3),cplcFeFreSsL(3,3), & 
& cplcFeFreSsR(3,3),cplcFuFuhhL(3,3),cplcFuFuhhR(3,3),cplcFdFucHpL(3,3),cplcFdFucHpR(3,3),& 
& cplFvNv0SsL(3,3,3),cplFvNv0SsR(3,3,3),cplcFeFvcHpL(3,3),cplcFeFvcHpR(3,3),             & 
& cplNv0Nv0hhL(3,3),cplNv0Nv0hhR(3,3),cplcFreNv0cHpL(3),cplcFreNv0cHpR(3),               & 
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplinghhSsSs2L(gt2,gt3,LSH,v,VSs,cplhhSsSs(gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingNv0Nv0Ah2L(gt1,gt2,YR3,YR4,ZvN,cplNv0Nv0AhL(gt1,gt2),cplNv0Nv0AhR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingFvFeHp2L(gt1,gt2,Ye,ZER,Vv,cplFvFeHpL(gt1,gt2),cplFvFeHpR(gt1,gt2))
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplingcFreFeSs2L(gt2,gt3,YR1,ZEL,VSs,cplcFreFeSsL(gt2,gt3),cplcFreFeSsR(gt2,gt3))
...
cplNv0FreHpR = 0._dp 
Do gt1 = 1, 3
Call CouplingNv0FreHp2L(gt1,YR3,YR4,ZvN,cplNv0FreHpL(gt1),cplNv0FreHpR(gt1))
...
Do gt1 = 1, 3
 Do gt3 = 1, 3
Call CouplingcFeFreSs2L(gt1,gt3,YR1,ZEL,VSs,cplcFeFreSsL(gt1,gt3),cplcFeFreSsR(gt1,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingFvNv0Ss2L(gt1,gt2,gt3,YR1,ZvN,Vv,VSs,cplFvNv0SsL(gt1,gt2,gt3)            & 
& ,cplFvNv0SsR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFeFvcHp2L(gt1,gt2,Ye,ZER,Vv,cplcFeFvcHpL(gt1,gt2),cplcFeFvcHpR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingNv0Nv0hh2L(gt1,gt2,YR3,YR4,ZvN,cplNv0Nv0hhL(gt1,gt2),cplNv0Nv0hhR(gt1,gt2))
...
cplcFreNv0cHpR = 0._dp 
Do gt2 = 1, 3
Call CouplingcFreNv0cHp2L(gt2,YR3,YR4,ZvN,cplcFreNv0cHpL(gt2),cplcFreNv0cHpR(gt2))
...
Subroutine CouplingAhAhSsSs2L(gt3,gt4,LSH,VSs,res)
...
Subroutine CouplinghhhhSsSs2L(gt3,gt4,LSH,VSs,res)
...
Subroutine CouplingHpSsSscHp2L(gt2,gt3,LSH,VSs,res)
...
Subroutine CouplinghhSsSs2L(gt2,gt3,LSH,v,VSs,res)
...
Subroutine CouplingNv0Nv0Ah2L(gt1,gt2,YR3,YR4,ZvN,resL,resR)
...
End Subroutine CouplingNv0Nv0Ah2L  
...
Subroutine CouplingFvFeHp2L(gt1,gt2,Ye,ZER,Vv,resL,resR)
...
Subroutine CouplingcFreFeSs2L(gt2,gt3,YR1,ZEL,VSs,resL,resR)
...
Subroutine CouplingNv0FreHp2L(gt1,YR3,YR4,ZvN,resL,resR)
...
End Subroutine CouplingNv0FreHp2L  
 
 
Subroutine CouplingcFeFreSs2L(gt1,gt3,YR1,ZEL,VSs,resL,resR)
...
Subroutine CouplingFvNv0Ss2L(gt1,gt2,gt3,YR1,ZvN,Vv,VSs,resL,resR)
...
End Subroutine CouplingFvNv0Ss2L  
 
 
Subroutine CouplingcFeFvcHp2L(gt1,gt2,Ye,ZER,Vv,resL,resR)
...
Subroutine CouplingNv0Nv0hh2L(gt1,gt2,YR3,YR4,ZvN,resL,resR)
...
End Subroutine CouplingNv0Nv0hh2L  
 
 
Subroutine CouplingcFreNv0cHp2L(gt2,YR3,YR4,ZvN,resL,resR)
...
End Subroutine CouplingcFreNv0cHp2L  
...
& ZEL,ZER,YR1,VSs,Vv,YR3,YR4,ZvN,LSH,v,Lam,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,       & 
...
& cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFreSsL,cplcUFeFreSsR,cplcUFeFvcHpL,      & 
& cplcUFeFvcHpR,cplcUFeFvcVWpL,cplcUFeFvcVWpR,cplUNv0Nv0AhL,cplUNv0Nv0AhR,               & 
& cplUNv0FreHpL,cplUNv0FreHpR,cplUNv0FreVWpL,cplUNv0FreVWpR,cplFvUNv0SsL,cplFvUNv0SsR,   & 
& cplUNv0Nv0hhL,cplUNv0Nv0hhR,cplUNv0Nv0VZL,cplUNv0Nv0VZR,cplUFvFeHpL,cplUFvFeHpR,       & 
& cplUFvFeVWpL,cplUFvFeVWpR,cplUFvFvVZL,cplUFvFvVZR,cplUFvNv0SsL,cplUFvNv0SsR,           & 
& cplcFreFeUSsL,cplcFreFeUSsR,cplFvNv0USsL,cplFvNv0USsR,cplhhUSsSs,cplAhAhUSsUSs,        & 
& cplhhhhUSsUSs,cplHpUSsUSscHp,cplcFreFeSsL,cplcFreFeSsR,cplcFreFreVPL,cplcFreFreVPR,    & 
& cplcFreFreVZL,cplcFreFreVZR,cplcFreNv0cHpL,cplcFreNv0cHpR,cplcFreNv0cVWpL,             & 
& cplcFreNv0cVWpR,cplAhcHpVWp,cplcFdFucHpL,cplcFdFucHpR,cplcFeFvcHpL,cplcFeFvcHpR,       & 
...
& cplHpHpcHpcHp,cplHpSsSscHp,cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,cplAhAhhh,        & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,               & 
& cplcgWpgWpAh,cplcgWCgWCAh,cplAhhhVZ,cplAhHpcVWp,cplNv0Nv0AhL,cplNv0Nv0AhR,             & 
& cplAhAhAhAh,cplAhAhhhhh,cplAhAhSsSs,cplAhAhcVWpVWp,cplAhAhVZVZ,cplcFdFdhhL,            & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,              & 
& cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,cplhhHpcVWp,cplNv0Nv0hhL,cplNv0Nv0hhR,               & 
& cplhhSsSs,cplhhcVWpVWp,cplhhVZVZ,cplhhhhhhhh,cplhhhhSsSs,cplhhhhcVWpVWp,               & 
...
& cplcUFeFreSsL(3,3),cplcUFeFreSsR(3,3),cplcUFeFvcHpL(3,3),cplcUFeFvcHpR(3,3),           & 
& cplcUFeFvcVWpL(3,3),cplcUFeFvcVWpR(3,3),cplUNv0Nv0AhL(3,3),cplUNv0Nv0AhR(3,3),         & 
& cplUNv0FreHpL(3),cplUNv0FreHpR(3),cplUNv0FreVWpL(3),cplUNv0FreVWpR(3),cplFvUNv0SsL(3,3,3),& 
& cplFvUNv0SsR(3,3,3),cplUNv0Nv0hhL(3,3),cplUNv0Nv0hhR(3,3),cplUNv0Nv0VZL(3,3),          & 
& cplUNv0Nv0VZR(3,3),cplUFvFeHpL(3,3),cplUFvFeHpR(3,3),cplUFvFeVWpL(3,3),cplUFvFeVWpR(3,3),& 
& cplUFvFvVZL(3,3),cplUFvFvVZR(3,3),cplUFvNv0SsL(3,3,3),cplUFvNv0SsR(3,3,3),             & 
& cplcFreFeUSsL(3,3),cplcFreFeUSsR(3,3),cplFvNv0USsL(3,3,3),cplFvNv0USsR(3,3,3),         & 
& cplhhUSsSs(3,3),cplAhAhUSsUSs(3,3),cplhhhhUSsUSs(3,3),cplHpUSsUSscHp(3,3),             & 
& cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,         & 
& cplcFreFreVZR,cplcFreNv0cHpL(3),cplcFreNv0cHpR(3),cplcFreNv0cVWpL(3),cplcFreNv0cVWpR(3),& 
& cplAhcHpVWp,cplcFdFucHpL(3,3),cplcFdFucHpR(3,3),cplcFeFvcHpL(3,3),cplcFeFvcHpR(3,3),   & 
& cplcgZgWpcHp,cplcgWpgZHp,cplcgWCgZcHp,cplcgZgWCHp,cplhhHpcHp,cplhhcHpVWp,              & 
& cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplAhAhHpcHp,cplhhhhHpcHp,               & 
& cplHpHpcHpcHp,cplHpSsSscHp(3,3),cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,             & 
...
& cplNv0Nv0AhL(3,3),cplNv0Nv0AhR(3,3),cplAhAhAhAh,cplAhAhhhhh,cplAhAhSsSs(3,3),          & 
...
& cplcgZgZhh,cplhhhhhh,cplhhHpcVWp,cplNv0Nv0hhL(3,3),cplNv0Nv0hhR(3,3),cplhhSsSs(3,3),   & 
& cplhhcVWpVWp,cplhhVZVZ,cplhhhhhhhh,cplhhhhSsSs(3,3),cplhhhhcVWpVWp,cplhhhhVZVZ,        & 
...
& cplHpcVWpVZ,cplNv0Nv0VZL(3,3),cplNv0Nv0VZR(3,3),cplcVWpVWpVZ,cplcVWpVWpVZVZ1,          & 
...
Do gt1 = 1, 3
 Do gt3 = 1, 3
Call CouplingcUFeFreSsL(gt1,gt3,YR1,VSs,cplcUFeFreSsL(gt1,gt3),cplcUFeFreSsR(gt1,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingUNv0Nv0AhL(gt1,gt2,YR3,YR4,ZvN,cplUNv0Nv0AhL(gt1,gt2),cplUNv0Nv0AhR(gt1,gt2))
...
cplUNv0FreHpR = 0._dp 
Do gt1 = 1, 3
Call CouplingUNv0FreHpL(gt1,YR3,YR4,cplUNv0FreHpL(gt1),cplUNv0FreHpR(gt1))

End Do 


cplUNv0FreVWpL = 0._dp 
cplUNv0FreVWpR = 0._dp 
Do gt1 = 1, 3
Call CouplingUNv0FreVWpL(gt1,g2,cplUNv0FreVWpL(gt1),cplUNv0FreVWpR(gt1))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingFvUNv0SsL(gt1,gt2,gt3,YR1,Vv,VSs,cplFvUNv0SsL(gt1,gt2,gt3)               & 
& ,cplFvUNv0SsR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingUNv0Nv0hhL(gt1,gt2,YR3,YR4,ZvN,cplUNv0Nv0hhL(gt1,gt2),cplUNv0Nv0hhR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingUNv0Nv0VZL(gt1,gt2,g1,g2,ZvN,TW,cplUNv0Nv0VZL(gt1,gt2),cplUNv0Nv0VZR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingUFvNv0SsL(gt1,gt2,gt3,YR1,ZvN,VSs,cplUFvNv0SsL(gt1,gt2,gt3)              & 
& ,cplUFvNv0SsR(gt1,gt2,gt3))
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplingcFreFeUSsL(gt2,gt3,YR1,ZEL,cplcFreFeUSsL(gt2,gt3),cplcFreFeUSsR(gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingFvNv0USsL(gt1,gt2,gt3,YR1,ZvN,Vv,cplFvNv0USsL(gt1,gt2,gt3)               & 
& ,cplFvNv0USsR(gt1,gt2,gt3))
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplinghhUSsSsL(gt2,gt3,LSH,v,VSs,cplhhUSsSs(gt2,gt3))
...
Do gt3 = 1, 3
 Do gt4 = 1, 3
Call CouplingAhAhUSsUSsL(gt3,gt4,LSH,cplAhAhUSsUSs(gt3,gt4))
...
Do gt3 = 1, 3
 Do gt4 = 1, 3
Call CouplinghhhhUSsUSsL(gt3,gt4,LSH,cplhhhhUSsUSs(gt3,gt4))

 End Do 
End Do 


cplHpUSsUSscHp = 0._dp 
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplingHpUSsUSscHpL(gt2,gt3,LSH,cplHpUSsUSscHp(gt2,gt3))
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplingcFreFeSsL(gt2,gt3,YR1,ZEL,VSs,cplcFreFeSsL(gt2,gt3),cplcFreFeSsR(gt2,gt3))
...
cplcFreFreVPL = 0._dp 
cplcFreFreVPR = 0._dp 
Call CouplingcFreFreVPL(g1,g2,TW,cplcFreFreVPL,cplcFreFreVPR)



cplcFreFreVZL = 0._dp 
cplcFreFreVZR = 0._dp 
Call CouplingcFreFreVZL(g1,g2,TW,cplcFreFreVZL,cplcFreFreVZR)
...
cplcFreNv0cHpR = 0._dp 
Do gt2 = 1, 3
Call CouplingcFreNv0cHpL(gt2,YR3,YR4,ZvN,cplcFreNv0cHpL(gt2),cplcFreNv0cHpR(gt2))
...
cplcFreNv0cVWpR = 0._dp 
Do gt2 = 1, 3
Call CouplingcFreNv0cVWpL(gt2,g2,ZvN,cplcFreNv0cVWpL(gt2),cplcFreNv0cVWpR(gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFeFvcHpL(gt1,gt2,Ye,ZER,Vv,cplcFeFvcHpL(gt1,gt2),cplcFeFvcHpR(gt1,gt2))
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplingHpSsSscHpL(gt2,gt3,LSH,VSs,cplHpSsSscHp(gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingNv0Nv0AhL(gt1,gt2,YR3,YR4,ZvN,cplNv0Nv0AhL(gt1,gt2),cplNv0Nv0AhR(gt1,gt2))
...
Do gt3 = 1, 3
 Do gt4 = 1, 3
Call CouplingAhAhSsSsL(gt3,gt4,LSH,VSs,cplAhAhSsSs(gt3,gt4))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingNv0Nv0hhL(gt1,gt2,YR3,YR4,ZvN,cplNv0Nv0hhL(gt1,gt2),cplNv0Nv0hhR(gt1,gt2))
...
Do gt2 = 1, 3
 Do gt3 = 1, 3
Call CouplinghhSsSsL(gt2,gt3,LSH,v,VSs,cplhhSsSs(gt2,gt3))
...
Do gt3 = 1, 3
 Do gt4 = 1, 3
Call CouplinghhhhSsSsL(gt3,gt4,LSH,VSs,cplhhhhSsSs(gt3,gt4))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingNv0Nv0VZL(gt1,gt2,g1,g2,ZvN,TW,cplNv0Nv0VZL(gt1,gt2),cplNv0Nv0VZR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFeFvcVWpL(gt1,gt2,g2,ZEL,Vv,cplcFeFvcVWpL(gt1,gt2),cplcFeFvcVWpR(gt1,gt2))
...
Subroutine CouplingcUFeFreSsL(gt1,gt3,YR1,VSs,resL,resR)
...
If ((gt1.le.3).And.(gt1.ge.1)) Then 
Do j2 = 1,3
resR = resR+Conjg(VSs(gt3,j2))*YR1(gt1,j2)
End Do 
End If 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
Subroutine CouplingUNv0Nv0AhL(gt1,gt2,YR3,YR4,ZvN,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingUNv0Nv0Ah' 
...
resL = 0._dp 
If ((1.eq.gt1)) Then 
resL = resL-((YR3*Conjg(ZvN(gt2,2)))/sqrt(2._dp))
End If 
If ((1.eq.gt1)) Then 
resL = resL-((YR4*Conjg(ZvN(gt2,3)))/sqrt(2._dp))
End If 
If ((2.eq.gt1)) Then 
resL = resL-((YR3*Conjg(ZvN(gt2,1)))/sqrt(2._dp))
End If 
If ((3.eq.gt1)) Then 
resL = resL-((YR4*Conjg(ZvN(gt2,1)))/sqrt(2._dp))
End If 
resR = 0._dp 
If ((2.eq.gt1)) Then 
resR = resR+(YR3*ZvN(gt2,1))/sqrt(2._dp)
End If 
If ((3.eq.gt1)) Then 
resR = resR+(YR4*ZvN(gt2,1))/sqrt(2._dp)
End If 
If ((1.eq.gt1)) Then 
resR = resR+(YR3*ZvN(gt2,2))/sqrt(2._dp)
End If 
If ((1.eq.gt1)) Then 
resR = resR+(YR4*ZvN(gt2,3))/sqrt(2._dp)
End If 
resL = -(0.,1.)*resL 
...
End Subroutine CouplingUNv0Nv0AhL  
 
 
Subroutine CouplingUNv0FreHpL(gt1,YR3,YR4,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingUNv0FreHp' 
...
End Subroutine CouplingUNv0FreHpL  
 
 
Subroutine CouplingUNv0FreVWpL(gt1,g2,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingUNv0FreVWp' 
...
End Subroutine CouplingUNv0FreVWpL  
 
 
Subroutine CouplingFvUNv0SsL(gt1,gt2,gt3,YR1,Vv,VSs,resL,resR)
...
Complex(dp), Intent(in) :: Vv(3,3),VSs(3,3)

Complex(dp), Intent(out) :: resL, resR 
 
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingFvUNv0Ss' 
...
Do j2 = 1,3
Do j1 = 1,3
resL = resL+Conjg(VSs(gt3,j2))*Conjg(Vv(gt1,j1))*YR1(j1,j2)
End Do 
End Do 
End If 
resR = 0._dp 
...
Do j2 = 1,3
Do j1 = 1,3
resR = resR+Conjg(VSs(gt3,j2))*Vv(gt1,j1)*YR1(j1,j2)
End Do 
End Do 
End If 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
...
End Subroutine CouplingFvUNv0SsL  
 
 
Subroutine CouplingUNv0Nv0hhL(gt1,gt2,YR3,YR4,ZvN,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingUNv0Nv0hh' 
...
End Subroutine CouplingUNv0Nv0hhL  
 
 
Subroutine CouplingUNv0Nv0VZL(gt1,gt2,g1,g2,ZvN,TW,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingUNv0Nv0VZ' 
...
resL = 0._dp 
If ((2.eq.gt1)) Then 
resL = resL-(g2*Conjg(ZvN(gt2,2))*Cos(TW))/2._dp
End If 
If ((3.eq.gt1)) Then 
resL = resL+(g2*Conjg(ZvN(gt2,3))*Cos(TW))/2._dp
End If 
If ((2.eq.gt1)) Then 
resL = resL-(g1*Conjg(ZvN(gt2,2))*Sin(TW))/2._dp
End If 
If ((3.eq.gt1)) Then 
resL = resL+(g1*Conjg(ZvN(gt2,3))*Sin(TW))/2._dp
End If 
resR = 0._dp 
If ((2.eq.gt1)) Then 
resR = resR+(g2*Cos(TW)*ZvN(gt2,2))/2._dp
End If 
If ((2.eq.gt1)) Then 
resR = resR+(g1*Sin(TW)*ZvN(gt2,2))/2._dp
End If 
If ((3.eq.gt1)) Then 
resR = resR-(g2*Cos(TW)*ZvN(gt2,3))/2._dp
End If 
If ((3.eq.gt1)) Then 
resR = resR-(g1*Sin(TW)*ZvN(gt2,3))/2._dp
End If 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
...
End Subroutine CouplingUNv0Nv0VZL  
...
Subroutine CouplingUFvNv0SsL(gt1,gt2,gt3,YR1,ZvN,VSs,resL,resR)
...
Complex(dp), Intent(in) :: ZvN(3,3),VSs(3,3)

Complex(dp), Intent(out) :: resL, resR 
 
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingUFvNv0Ss' 
...
If ((gt1.le.3).And.(gt1.ge.1)) Then 
Do j2 = 1,3
resL = resL+Conjg(VSs(gt3,j2))*Conjg(ZvN(gt2,3))*YR1(gt1,j2)
End Do 
End If 
resR = 0._dp 
If ((gt1.le.3).And.(gt1.ge.1)) Then 
Do j2 = 1,3
resR = resR+Conjg(VSs(gt3,j2))*YR1(gt1,j2)*ZvN(gt2,3)
End Do 
End If 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
End Subroutine CouplingUFvNv0SsL  
 
 
Subroutine CouplingcFreFeUSsL(gt2,gt3,YR1,ZEL,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingcFreFeUSs' 
...
Do j1 = 1,3
resL = resL+Conjg(ZEL(gt2,j1))*YR1(j1,gt3)
End Do 
End If 
resR = 0._dp 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
...
End Subroutine CouplingcFreFeUSsL  
 
 
Subroutine CouplingFvNv0USsL(gt1,gt2,gt3,YR1,ZvN,Vv,resL,resR)
...
Complex(dp), Intent(in) :: ZvN(3,3),Vv(3,3)

Complex(dp), Intent(out) :: resL, resR 
 
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingFvNv0USs' 
...
If ((gt3.le.3).And.(gt3.ge.1)) Then 
Do j1 = 1,3
resL = resL+Conjg(Vv(gt1,j1))*Conjg(ZvN(gt2,3))*YR1(j1,gt3)
End Do 
End If 
resR = 0._dp 
If ((gt3.le.3).And.(gt3.ge.1)) Then 
Do j1 = 1,3
resR = resR+Vv(gt1,j1)*YR1(j1,gt3)*ZvN(gt2,3)
End Do 
End If 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
End Subroutine CouplingFvNv0USsL  
 
 
Subroutine CouplinghhUSsSsL(gt2,gt3,LSH,v,VSs,res)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplinghhUSsSs' 
...
Do j1 = 1,3
res = res-(v*Conjg(VSs(gt3,j1))*LSH(j1,gt2))
End Do 
End If 
If ((gt2.le.3).And.(gt2.ge.1)) Then 
Do j2 = 1,3
res = res-(v*Conjg(VSs(gt3,j2))*LSH(gt2,j2))
End Do 
End If 
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
End Subroutine CouplinghhUSsSsL  
 
 
Subroutine CouplingAhAhUSsUSsL(gt3,gt4,LSH,res)

Implicit None 

Integer, Intent(in) :: gt3,gt4
Complex(dp), Intent(in) :: LSH(3,3)

Complex(dp), Intent(out) :: res 
 
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingAhAhUSsUSs' 
...
End Subroutine CouplingAhAhUSsUSsL  
 
 
Subroutine CouplinghhhhUSsUSsL(gt3,gt4,LSH,res)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplinghhhhUSsUSs' 
...
End Subroutine CouplinghhhhUSsUSsL  
 
 
Subroutine CouplingHpUSsUSscHpL(gt2,gt3,LSH,res)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CouplingHpUSsUSscHp' 
...
res = 0._dp 
If ((gt2.le.3).And.(gt2.ge.1).And.(gt3.le.3).And.(gt3.ge.1)) Then 
res = res-LSH(gt2,gt3)
End If 
If ((gt2.le.3).And.(gt2.ge.1).And.(gt3.le.3).And.(gt3.ge.1)) Then 
res = res-LSH(gt3,gt2)
...
End Subroutine CouplingHpUSsUSscHpL  
 
 
Subroutine CouplingcFreFeSsL(gt2,gt3,YR1,ZEL,VSs,resL,resR)
...
Subroutine CouplingcFreFreVPL(g1,g2,TW,resL,resR)
...
Subroutine CouplingcFreFreVZL(g1,g2,TW,resL,resR)
...
Subroutine CouplingcFreNv0cHpL(gt2,YR3,YR4,ZvN,resL,resR)
...
End Subroutine CouplingcFreNv0cHpL  
 
 
Subroutine CouplingcFreNv0cVWpL(gt2,g2,ZvN,resL,resR)
...
End Subroutine CouplingcFreNv0cVWpL  
...
Subroutine CouplingcFeFvcHpL(gt1,gt2,Ye,ZER,Vv,resL,resR)
...
Subroutine CouplingHpSsSscHpL(gt2,gt3,LSH,VSs,res)
...
Subroutine CouplingNv0Nv0AhL(gt1,gt2,YR3,YR4,ZvN,resL,resR)
...
End Subroutine CouplingNv0Nv0AhL  
...
Subroutine CouplingAhAhSsSsL(gt3,gt4,LSH,VSs,res)
...
Subroutine CouplingNv0Nv0hhL(gt1,gt2,YR3,YR4,ZvN,resL,resR)
...
End Subroutine CouplingNv0Nv0hhL  
 
 
Subroutine CouplinghhSsSsL(gt2,gt3,LSH,v,VSs,res)
...
Subroutine CouplinghhhhSsSsL(gt3,gt4,LSH,VSs,res)
...
Subroutine CouplingNv0Nv0VZL(gt1,gt2,g1,g2,ZvN,TW,resL,resR)
...
End Subroutine CouplingNv0Nv0VZL  
...
Subroutine CouplingcFeFvcVWpL(gt1,gt2,g2,ZEL,Vv,resL,resR)
...
Subroutine CouplingsForVectorBosons(g1,g2,TW,ZvN,v,ZDL,ZUL,ZEL,Vv,cplcFreFreVZL,      & 
...
Implicit None 
Real(dp), Intent(in) :: g1,g2,TW,v

Complex(dp), Intent(in) :: ZvN(3,3),ZDL(3,3),ZUL(3,3),ZEL(3,3),Vv(3,3)

Complex(dp), Intent(out) :: cplcFreFreVZL,cplcFreFreVZR,cplcFreNv0cVWpL(3),cplcFreNv0cVWpR(3),cplAhcHpVWp,        & 
...
& cplhhVZVZ,cplhhhhcVWpVWp,cplhhhhVZVZ,cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),& 
& cplcFeFeVZR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3),    & 
& cplcgWpgWpVZ,cplcgWCgWCVZ,cplHpcVWpVZ,cplNv0Nv0VZL(3,3),cplNv0Nv0VZR(3,3),             & 
& cplcVWpVWpVZ,cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,cplcFdFucVWpL(3,3),       & 
& cplcFdFucVWpR(3,3),cplcFeFvcVWpL(3,3),cplcFeFvcVWpR(3,3),cplcgWCgAcVWp,cplcgAgWpcVWp,  & 
& cplcgZgWpcVWp,cplcgWCgZcVWp,cplHpcVWpVP,cplcVWpVPVWp,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,  & 
& cplcVWpVPVPVWp3,cplcVWpcVWpVWpVWp1,cplcVWpcVWpVWpVWp2,cplcVWpcVWpVWpVWp3
...
& ZEL,ZER,YR1,VSs,Vv,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,   & 
...
Implicit None 
Real(dp), Intent(in) :: g3,g1,g2,TW,YR1(3,3)
...
Subroutine CouplingsForTadpoles(Yd,ZDL,ZDR,Yu,ZUL,ZUR,Ye,ZEL,ZER,YR3,YR4,             & 
& ZvN,LSH,v,VSs,Lam,g2,g1,TW,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFuFuhhL,cplcUFuFuhhR,        & 
& cplcUFeFehhL,cplcUFeFehhR,cplUNv0Nv0hhL,cplUNv0Nv0hhR,cplhhUSsSs,cplhhhhUSsUSs,        & 
& cplhhHpcHp,cplhhcHpVWp,cplhhhhHpcHp,cplAhAhhh,cplAhhhVZ,cplAhAhhhhh,cplcFdFdhhL,       & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,              & 
& cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,cplhhHpcVWp,cplNv0Nv0hhL,cplNv0Nv0hhR,               & 
& cplhhSsSs,cplhhcVWpVWp,cplhhVZVZ,cplhhhhhhhh,cplhhhhSsSs,cplhhhhcVWpVWp,               & 
& cplhhhhVZVZ)
...
Implicit None 
Real(dp), Intent(in) :: YR3,YR4,v,g2,g1,TW

Complex(dp), Intent(in) :: Yd(3,3),ZDL(3,3),ZDR(3,3),Yu(3,3),ZUL(3,3),ZUR(3,3),Ye(3,3),ZEL(3,3),ZER(3,3),        & 
& ZvN(3,3),LSH(3,3),VSs(3,3),Lam

Complex(dp), Intent(out) :: cplcUFdFdhhL(3,3),cplcUFdFdhhR(3,3),cplcUFuFuhhL(3,3),cplcUFuFuhhR(3,3),              & 
& cplcUFeFehhL(3,3),cplcUFeFehhR(3,3),cplUNv0Nv0hhL(3,3),cplUNv0Nv0hhR(3,3),             & 
& cplhhUSsSs(3,3),cplhhhhUSsUSs(3,3),cplhhHpcHp,cplhhcHpVWp,cplhhhhHpcHp,cplAhAhhh,      & 
& cplAhhhVZ,cplAhAhhhhh,cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFeFehhL(3,3),              & 
& cplcFeFehhR(3,3),cplcFuFuhhL(3,3),cplcFuFuhhR(3,3),cplcgWpgWphh,cplcgWCgWChh,          & 
& cplcgZgZhh,cplhhhhhh,cplhhHpcVWp,cplNv0Nv0hhL(3,3),cplNv0Nv0hhR(3,3),cplhhSsSs(3,3),   & 
& cplhhcVWpVWp,cplhhVZVZ,cplhhhhhhhh,cplhhhhSsSs(3,3),cplhhhhcVWpVWp,cplhhhhVZVZ
...
End Module Couplings_radinertT13A 
