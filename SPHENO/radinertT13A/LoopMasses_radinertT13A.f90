...
! ------------------------------------------------------------------------------  
! File created at 17:01 on 25.5.2016   
! ----------------------------------------------------------------------  
 
 
Module LoopMasses_radinertT13A 
...
Use StandardModel 
Use Tadpoles_radinertT13A 
 Use SusyMasses_radinertT13A 
 
Real(dp), Private :: MNv0_1L(3), MNv02_1L(3)  
Complex(dp), Private :: ZvN_1L(3,3)  
Real(dp), Private :: MFv_1L(3), MFv2_1L(3)  
Complex(dp), Private :: Vv_1L(3,3)  
Real(dp), Private :: MSs_1L(3), MSs2_1L(3)  
Complex(dp), Private :: VSs_1L(3,3)  
...
& ZER,ZUR,ZDL,ZEL,VSs,ZUL,Vv,ZvN,ZW,ZZ,v,g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,              & 
& YR4,Mn,MDF,mu2,MS2,kont)

Implicit None 
Real(dp),Intent(inout) :: g1,g2,g3,YR3,YR1(3,3),YR4,MS2(3,3)

Complex(dp),Intent(inout) :: Lam,LSH(3,3),Yu(3,3),Yd(3,3),Ye(3,3),Mn,MDF,mu2
...
Complex(dp),Intent(inout) :: ZDR(3,3),ZER(3,3),ZUR(3,3),ZDL(3,3),ZEL(3,3),VSs(3,3),ZUL(3,3),Vv(3,3),               & 
& ZvN(3,3),ZW(2,2)

Real(dp),Intent(inout) :: v

Complex(dp) :: cplAhAhAhAh,cplAhAhcVWpVWp,cplAhAhhh,cplAhAhhhhh,cplAhAhHpcHp,cplAhAhSsSs(3,3),       & 
& cplAhAhUSsUSs(3,3),cplAhAhVZVZ,cplAhcHpVWp,cplAhhhVZ,cplAhHpcVWp,cplcFdFdAhL(3,3),     & 
...
& cplcFeFvcVWpR(3,3),cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplcFreFeUSsL(3,3),             & 
& cplcFreFeUSsR(3,3),cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,cplcFreFreVZR,            & 
& cplcFreNv0cHpL(3),cplcFreNv0cHpR(3),cplcFreNv0cVWpL(3),cplcFreNv0cVWpR(3),             & 
...
& cplcUFeFeVZL(3,3),cplcUFeFeVZR(3,3),cplcUFeFreSsL(3,3),cplcUFeFreSsR(3,3),             & 
...
& cplcVWpVWpVZ,cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,cplFvFvVZL(3,3),          & 
& cplFvFvVZR(3,3),cplFvNv0USsL(3,3,3),cplFvNv0USsR(3,3,3),cplFvUNv0SsL(3,3,3),           & 
& cplFvUNv0SsR(3,3,3),cplhhcHpVWp,cplhhcVWpVWp,cplhhhhcVWpVWp,cplhhhhhh,cplhhhhhhhh,     & 
& cplhhhhHpcHp,cplhhhhSsSs(3,3),cplhhhhUSsUSs(3,3),cplhhhhVZVZ,cplhhHpcHp,               & 
& cplhhHpcVWp,cplhhSsSs(3,3),cplhhUSsSs(3,3),cplhhVZVZ,cplHpcHpcVWpVWp,cplHpcHpVP,       & 
& cplHpcHpVPVP,cplHpcHpVZ,cplHpcHpVZVZ,cplHpcVWpVP,cplHpcVWpVZ,cplHpHpcHpcHp,            & 
& cplHpSsSscHp(3,3),cplHpUSsUSscHp(3,3),cplNv0Nv0AhL(3,3),cplNv0Nv0AhR(3,3),             & 
...
& cplUFvFvVZR(3,3),cplUFvNv0SsL(3,3,3),cplUFvNv0SsR(3,3,3),cplUNv0FreHpL(3),             & 
& cplUNv0FreHpR(3),cplUNv0FreVWpL(3),cplUNv0FreVWpR(3),cplUNv0Nv0AhL(3,3),               & 
& cplUNv0Nv0AhR(3,3),cplUNv0Nv0hhL(3,3),cplUNv0Nv0hhR(3,3),cplUNv0Nv0VZL(3,3)

Complex(dp) :: cplUNv0Nv0VZR(3,3)
...
& Mhh,Mhh2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,              & 
& ZDL,ZEL,VSs,ZUL,Vv,ZvN,ZW,ZZ,v,g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,Mn,               & 
& MDF,mu2,MS2,GenerationMixing,kont)
...
& MFv,MFv2,MVZ,MVZ2,MHp,MHp2,MVWp,MVWp2,MNv0,MNv02,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,    & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFreFreVZL,cplcFreFreVZR,cplcFuFuVZL,cplcFuFuVZR,           & 
& cplFvFvVZL,cplFvFvVZR,cplcgWpgWpVZ,cplcgWCgWCVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,      & 
& cplNv0Nv0VZL,cplNv0Nv0VZR,cplcVWpVWpVZ,cplAhAhVZVZ,cplhhhhVZVZ,cplHpcHpVZVZ,           & 
& cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,kont,dmZ2)

vev2=4._dp*Real(mZ2+dmz2,dp)/(g1**2+g2**2) -0 
v= sqrt(vev2)
Call SolveTadpoleEquations(g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,Mn,MDF,              & 
& mu2,MS2,v,(/ ZeroC /))
...
& YR1,VSs,Vv,YR3,YR4,ZvN,LSH,v,Lam,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,               & 
...
& MHp2,MNv0,MNv02,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplcFdFdhhL,cplcFdFdhhR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,cplcgWCgWChh,             & 
& cplcgZgZhh,cplhhhhhh,cplhhHpcHp,cplNv0Nv0hhL,cplNv0Nv0hhR,cplhhSsSs,cplhhcVWpVWp,      & 
& cplhhVZVZ,Tad1Loop(1:1))
...
mu21L = mu2
Call OneLoopNv0(Mn,MDF,YR3,YR4,v,MNv0,MNv02,MAh,MAh2,MHp,MHp2,MFre,MFre2,             & 
& MVWp,MVWp2,MSs,MSs2,MFv,MFv2,Mhh,Mhh2,MVZ,MVZ2,cplUNv0Nv0AhL,cplUNv0Nv0AhR,            & 
& cplUNv0FreHpL,cplUNv0FreHpR,cplUNv0FreVWpL,cplUNv0FreVWpR,cplFvUNv0SsL,cplFvUNv0SsR,   & 
& cplUNv0Nv0hhL,cplUNv0Nv0hhR,cplUNv0Nv0VZL,cplUNv0Nv0VZR,0.1_dp*delta_mass,             & 
& MNv0_1L,MNv02_1L,ZvN_1L,kont)

Call OneLoopFv(MHp,MHp2,MFe,MFe2,MVWp,MVWp2,MVZ,MVZ2,MFv,MFv2,MSs,MSs2,               & 
& MNv0,MNv02,cplUFvFeHpL,cplUFvFeHpR,cplUFvFeVWpL,cplUFvFeVWpR,cplUFvFvVZL,              & 
& cplUFvFvVZR,cplUFvNv0SsL,cplUFvNv0SsR,0.1_dp*delta_mass,MFv_1L,MFv2_1L,Vv_1L,kont)

Call OneLoopSs(MS2,LSH,v,MFre,MFre2,MFe,MFe2,MNv0,MNv02,MFv,MFv2,MSs,MSs2,            & 
& Mhh,Mhh2,MAh,MAh2,MHp,MHp2,cplcFreFeUSsL,cplcFreFeUSsR,cplFvNv0USsL,cplFvNv0USsR,      & 
& cplhhUSsSs,cplAhAhUSsUSs,cplhhhhUSsUSs,cplHpUSsUSscHp,0.1_dp*delta_mass,               & 
& MSs_1L,MSs2_1L,VSs_1L,kont)

Call OneLoopFre(MDF,MSs,MSs2,MFe,MFe2,MFre,MFre2,MVZ,MVZ2,MHp,MHp2,MNv0,              & 
& MNv02,MVWp,MVWp2,cplcFreFeSsL,cplcFreFeSsR,cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,  & 
& cplcFreFreVZR,cplcFreNv0cHpL,cplcFreNv0cHpR,cplcFreNv0cVWpL,cplcFreNv0cVWpR,           & 
& 0.1_dp*delta_mass,MFre_1L,MFre2_1L,kont)

Call OneLoopHp(g2,mu2,Lam,v,MVWp,MVWp2,MAh,MAh2,MFd,MFd2,MFu,MFu2,MFe,MFe2,           & 
& MFv,MFv2,MHp,MHp2,Mhh,Mhh2,MVZ,MVZ2,MFre,MFre2,MNv0,MNv02,MSs,MSs2,cplAhcHpVWp,        & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFeFvcHpL,cplcFeFvcHpR,cplcgZgWpcHp,cplcgWpgZHp,          & 
& cplcgWCgZcHp,cplcgZgWCHp,cplhhHpcHp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcFreNv0cHpL,  & 
& cplcFreNv0cHpR,cplcHpVPVWp,cplcHpVWpVZ,cplAhAhHpcHp,cplhhhhHpcHp,cplHpHpcHpcHp,        & 
& cplHpSsSscHp,cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,0.1_dp*delta_mass,              & 
& MHp_1L,MHp2_1L,kont)

Call OneLoopAh(g1,g2,mu2,Lam,v,TW,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,            & 
& MFu2,MVZ,MVZ2,MVWp,MVWp2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,cplAhAhhh,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWpgWpAh,              & 
& cplcgWCgWCAh,cplAhhhVZ,cplAhHpcVWp,cplNv0Nv0AhL,cplNv0Nv0AhR,cplAhAhAhAh,              & 
& cplAhAhhhhh,cplAhAhHpcHp,cplAhAhSsSs,cplAhAhcVWpVWp,cplAhAhVZVZ,0.1_dp*delta_mass,     & 
& MAh_1L,MAh2_1L,kont)

Call OneLoophh(mu2,Lam,v,MAh,MAh2,MVZ,MVZ2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,            & 
& Mhh2,MHp,MHp2,MVWp,MVWp2,MNv0,MNv02,MSs,MSs2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,          & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,              & 
& cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplNv0Nv0hhL,cplNv0Nv0hhR,    & 
...
& MFv2,Mhh,Mhh2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,             & 
& ZUR,ZDL,ZEL,VSs,ZUL,Vv,ZvN,ZW,ZZ,kont)
...
& Mhh2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,              & 
& cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,cplhhHpcHp,cplNv0Nv0hhL,cplNv0Nv0hhR,cplhhSsSs,      & 
& cplhhcVWpVWp,cplhhVZVZ,tadpoles)

Implicit None 
Real(dp), Intent(in) :: MAh,MAh2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),Mhh,Mhh2,MHp,MHp2,              & 
& MNv0(3),MNv02(3),MSs(3),MSs2(3),MVWp,MVWp2,MVZ,MVZ2
...
& cplhhHpcHp,cplNv0Nv0hhL(3,3),cplNv0Nv0hhR(3,3),cplhhSsSs(3,3),cplhhcVWpVWp,cplhhVZVZ
...
! Nv0 
!------------------------ 
If (Include_in_loopNv0) Then 
Do i1 = 1, 3
 A0m = 2._dp*MNv0(i1)*A0(MNv02(i1)) 
  Do gO1 = 1, 1
   coupL = cplNv0Nv0hhL(i1,i1)
   coupR = cplNv0Nv0hhR(i1,i1)
   sumI(gO1) = (coupL+coupR)*A0m 
  End Do 
...
Implicit None 
Real(dp), Intent(in) :: MFe(3),MFe2(3),MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MSs(3),MSs2(3),MFre,MFre2,MHp,              & 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -0.5_dp*Real(B1(p2,MFre2,MSs2(i1)),dp) 
B0m2 = MFre*Real(B0(p2,MFre2,MSs2(i1)),dp) 
coupL1 = cplcUFeFreSsL(gO1,i1)
coupR1 = cplcUFeFreSsR(gO1,i1)
coupL2 =  Conjg(cplcUFeFreSsL(gO2,i1))
coupR2 =  Conjg(cplcUFeFreSsR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Subroutine OneLoopNv0(Mn,MDF,YR3,YR4,v,MNv0,MNv02,MAh,MAh2,MHp,MHp2,MFre,             & 
& MFre2,MVWp,MVWp2,MSs,MSs2,MFv,MFv2,Mhh,Mhh2,MVZ,MVZ2,cplUNv0Nv0AhL,cplUNv0Nv0AhR,      & 
& cplUNv0FreHpL,cplUNv0FreHpR,cplUNv0FreVWpL,cplUNv0FreVWpR,cplFvUNv0SsL,cplFvUNv0SsR,   & 
& cplUNv0Nv0hhL,cplUNv0Nv0hhR,cplUNv0Nv0VZL,cplUNv0Nv0VZR,delta,MNv0_1L,MNv02_1L,        & 
& ZvN_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: MNv0(3),MNv02(3),MAh,MAh2,MHp,MHp2,MFre,MFre2,MVWp,MVWp2,MSs(3),MSs2(3),              & 
& MFv(3),MFv2(3),Mhh,Mhh2,MVZ,MVZ2

Real(dp), Intent(in) :: YR3,YR4,v

Complex(dp), Intent(in) :: Mn,MDF

Complex(dp), Intent(in) :: cplUNv0Nv0AhL(3,3),cplUNv0Nv0AhR(3,3),cplUNv0FreHpL(3),cplUNv0FreHpR(3),              & 
& cplUNv0FreVWpL(3),cplUNv0FreVWpR(3),cplFvUNv0SsL(3,3,3),cplFvUNv0SsR(3,3,3),           & 
& cplUNv0Nv0hhL(3,3),cplUNv0Nv0hhR(3,3),cplUNv0Nv0VZL(3,3),cplUNv0Nv0VZR(3,3)
...
Real(dp), Intent(in) :: delta 
Real(dp) :: mi2(3), test_m2(3),p2 
Real(dp), Intent(out) :: MNv0_1L(3),MNv02_1L(3) 
Complex(dp), Intent(out) ::  ZvN_1L(3,3) 
Real(dp) :: MNv0_t(3),MNv02_t(3) 
Complex(dp) ::  ZvN_t(3,3) 
Complex(dp) ::  phaseM, E3(3), sigL(3,3), sigR(3,3), sigS(3,3) 
Real(dp) :: ZvNa(3,3), test(2), eig(3) 

Iname = Iname + 1 
NameOfUnit(Iname) = 'OneLoopMNv0'
 
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+Mn
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)-((v*YR3)/sqrt(2._dp))
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(v*YR4)/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)-((v*YR3)/sqrt(2._dp))
mat1a(2,2) = 0._dp 
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)-1._dp*(MDF)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(v*YR4)/sqrt(2._dp)
mat1a(3,2) = 0._dp 
...
sigS=0._dp 
p2 = MNv02(il)
Call Sigma1LoopNv0(p2,MNv0,MNv02,MAh,MAh2,MHp,MHp2,MFre,MFre2,MVWp,MVWp2,             & 
& MSs,MSs2,MFv,MFv2,Mhh,Mhh2,MVZ,MVZ2,cplUNv0Nv0AhL,cplUNv0Nv0AhR,cplUNv0FreHpL,         & 
& cplUNv0FreHpR,cplUNv0FreVWpL,cplUNv0FreVWpR,cplFvUNv0SsL,cplFvUNv0SsR,cplUNv0Nv0hhL,   & 
& cplUNv0Nv0hhR,cplUNv0Nv0VZL,cplUNv0Nv0VZR,sigL,sigR,sigS)
...
Call EigenSystem(Real(mat1,dp),Eig,ZvNa,ierr,test) 
 
   Do i1=1,3
   If (Eig(i1).Lt.0._dp) Then 
    MNv0_t(i1) = - Eig(i1) 
    ZvN_1L(i1,:) = (0._dp,1._dp)*ZvNa(i1,:) 
   Else 
    MNv0_t(i1) = Eig(i1) 
    ZvN_1L(i1,:) = ZvNa(i1,:)
    End If 
...
Do i1=1,2
  Do i2=i1+1,3
    If (Abs(MNv0_t(i1)).Gt.Abs(MNv0_t(i2))) Then 
      Eig(1) = MNv0_t(i1) 
      MNv0_t(i1) = MNv0_t(i2) 
      MNv0_t(i2) = Eig(1) 
      E3 = ZvN_1L(i1,:) 
...
MNv0_1L(iL) = MNv0_t(iL) 
MNv02_1L(iL) = MNv0_t(iL)**2 
Else 
 
mat2 = Matmul( Transpose(Conjg( mat1) ), mat1 ) 
Call Eigensystem(mat2, Eig, ZvN_1L, ierr, test) 
mat2 = Matmul( Conjg(ZvN_1L), Matmul( mat1, Transpose( Conjg(ZvN_1L)))) 
Do i1=1,3
If (Abs(mat2(i1,i1)).gt.0._dp) Then 
  phaseM = Sqrt( mat2(i1,i1) / Abs(mat2(i1,i1))) 
  ZvN_1L(i1,:)= phaseM * ZvN_1L(i1,:) 
End if 
...
If (p2.Ne.0._dp) Then 
  test(1) = Abs(MNv02_1L(il)-p2)/p2
Else 
  test(2) = Abs(MNv02_1L(il))
End If 
If (Abs(MNv02_1L(il)).lt.1.0E-30_dp) Exit p2_loop 
If (test(1).lt.0.1_dp*delta) Exit p2_loop 
If(i_count.gt.30) then 
  Write(ErrCan,*) "Possible numerical problem in "//NameOfUnit(Iname) 
  Exit p2_loop 
...
Iname = Iname -1 
End Subroutine OneLoopNv0
 
 
Subroutine Sigma1LoopNv0(p2,MNv0,MNv02,MAh,MAh2,MHp,MHp2,MFre,MFre2,MVWp,             & 
& MVWp2,MSs,MSs2,MFv,MFv2,Mhh,Mhh2,MVZ,MVZ2,cplUNv0Nv0AhL,cplUNv0Nv0AhR,cplUNv0FreHpL,   & 
& cplUNv0FreHpR,cplUNv0FreVWpL,cplUNv0FreVWpR,cplFvUNv0SsL,cplFvUNv0SsR,cplUNv0Nv0hhL,   & 
& cplUNv0Nv0hhR,cplUNv0Nv0VZL,cplUNv0Nv0VZR,sigL,sigR,sigS)
...
! Nv0, Ah 
!------------------------ 
If ((Include_in_loopNv0).and.(Include_in_loopAh)) Then 
    Do i1 = 1, 3
 SumS = 0._dp 
sumR = 0._dp 
sumL = 0._dp 
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -1._dp*B1(p2,MNv02(i1),MAh2) 
B0m2 = 2._dp*MNv0(i1)*B0(p2,MNv02(i1),MAh2) 
coupL1 = cplUNv0Nv0AhL(gO1,i1)
coupR1 = cplUNv0Nv0AhR(gO1,i1)
coupL2 =  Conjg(cplUNv0Nv0AhL(gO2,i1))
coupR2 =  Conjg(cplUNv0Nv0AhR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
! Hp, Fre 
!------------------------ 
If ((Include_in_loopHp).and.(Include_in_loopFre)) Then 
SumS = 0._dp 
sumR = 0._dp 
sumL = 0._dp 
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -1._dp*B1(p2,MFre2,MHp2) 
B0m2 = 2._dp*MFre*B0(p2,MFre2,MHp2) 
coupL1 = cplUNv0FreHpL(gO1)
coupR1 = cplUNv0FreHpR(gO1)
coupL2 =  Conjg(cplUNv0FreHpL(gO2))
coupR2 =  Conjg(cplUNv0FreHpR(gO2))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
! VWp, Fre 
!------------------------ 
If ((Include_in_loopVWp).and.(Include_in_loopFre)) Then 
SumS = 0._dp 
sumR = 0._dp 
sumL = 0._dp 
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -2._dp*(B1(p2,MFre2,MVWp2) + 0.5_dp*rMS) 
B0m2 = -8._dp*MFre*(B0(p2,MFre2,MVWp2) - 0.5_dp*rMS) 
coupL1 = cplUNv0FreVWpL(gO1)
coupR1 = cplUNv0FreVWpR(gO1)
coupL2 =  Conjg(cplUNv0FreVWpL(gO2))
coupR2 =  Conjg(cplUNv0FreVWpR(gO2))
SumS(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupL1*coupL2*B1m2 
sumL(gO1,gO2) = coupR1*coupR2*B1m2 
   End Do 
...
! Ss, Fv 
!------------------------ 
If ((Include_in_loopSs).and.(Include_in_loopFv)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 3
 SumS = 0._dp 
sumR = 0._dp 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -1._dp*B1(p2,MFv2(i2),MSs2(i1)) 
B0m2 = 2._dp*MFv(i2)*B0(p2,MFv2(i2),MSs2(i1)) 
coupL1 = cplFvUNv0SsL(i2,gO1,i1)
coupR1 = cplFvUNv0SsR(i2,gO1,i1)
coupL2 =  Conjg(cplFvUNv0SsL(i2,gO2,i1))
coupR2 =  Conjg(cplFvUNv0SsR(i2,gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
! Nv0, hh 
!------------------------ 
If ((Include_in_loopNv0).and.(Include_in_loophh)) Then 
    Do i1 = 1, 3
 SumS = 0._dp 
sumR = 0._dp 
sumL = 0._dp 
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -1._dp*B1(p2,MNv02(i1),Mhh2) 
B0m2 = 2._dp*MNv0(i1)*B0(p2,MNv02(i1),Mhh2) 
coupL1 = cplUNv0Nv0hhL(gO1,i1)
coupR1 = cplUNv0Nv0hhR(gO1,i1)
coupL2 =  Conjg(cplUNv0Nv0hhL(gO2,i1))
coupR2 =  Conjg(cplUNv0Nv0hhR(gO2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
! VZ, Nv0 
!------------------------ 
If ((Include_in_loopVZ).and.(Include_in_loopNv0)) Then 
      Do i2 = 1, 3
 SumS = 0._dp 
sumR = 0._dp 
sumL = 0._dp 
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -2._dp*(B1(p2,MNv02(i2),MVZ2) + 0.5_dp*rMS) 
B0m2 = -8._dp*MNv0(i2)*(B0(p2,MNv02(i2),MVZ2) - 0.5_dp*rMS) 
coupL1 = cplUNv0Nv0VZL(gO1,i2)
coupR1 = cplUNv0Nv0VZR(gO1,i2)
coupL2 =  Conjg(cplUNv0Nv0VZL(gO2,i2))
coupR2 =  Conjg(cplUNv0Nv0VZR(gO2,i2))
SumS(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupL1*coupL2*B1m2 
sumL(gO1,gO2) = coupR1*coupR2*B1m2 
   End Do 
...
End Subroutine Sigma1LoopNv0 
 
Subroutine OneLoopFv(MHp,MHp2,MFe,MFe2,MVWp,MVWp2,MVZ,MVZ2,MFv,MFv2,MSs,              & 
& MSs2,MNv0,MNv02,cplUFvFeHpL,cplUFvFeHpR,cplUFvFeVWpL,cplUFvFeVWpR,cplUFvFvVZL,         & 
& cplUFvFvVZR,cplUFvNv0SsL,cplUFvNv0SsR,delta,MFv_1L,MFv2_1L,Vv_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: MHp,MHp2,MFe(3),MFe2(3),MVWp,MVWp2,MVZ,MVZ2,MFv(3),MFv2(3),MSs(3),MSs2(3),            & 
& MNv0(3),MNv02(3)

Complex(dp), Intent(in) :: cplUFvFeHpL(3,3),cplUFvFeHpR(3,3),cplUFvFeVWpL(3,3),cplUFvFeVWpR(3,3),cplUFvFvVZL(3,3),& 
& cplUFvFvVZR(3,3),cplUFvNv0SsL(3,3,3),cplUFvNv0SsR(3,3,3)
...
sigS=0._dp 
p2 = MFv2(il)
Call Sigma1LoopFv(p2,MHp,MHp2,MFe,MFe2,MVWp,MVWp2,MVZ,MVZ2,MFv,MFv2,MSs,              & 
& MSs2,MNv0,MNv02,cplUFvFeHpL,cplUFvFeHpR,cplUFvFeVWpL,cplUFvFeVWpR,cplUFvFvVZL,         & 
& cplUFvFvVZR,cplUFvNv0SsL,cplUFvNv0SsR,sigL,sigR,sigS)
...
& MSs,MSs2,MNv0,MNv02,cplUFvFeHpL,cplUFvFeHpR,cplUFvFeVWpL,cplUFvFeVWpR,cplUFvFvVZL,     & 
& cplUFvFvVZR,cplUFvNv0SsL,cplUFvNv0SsR,sigL,sigR,sigS)
...
! Ss, Nv0 
!------------------------ 
If ((Include_in_loopSs).and.(Include_in_loopNv0)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 3
 SumS = 0._dp 
sumR = 0._dp 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -1._dp*B1(p2,MNv02(i2),MSs2(i1)) 
B0m2 = 2._dp*MNv0(i2)*B0(p2,MNv02(i2),MSs2(i1)) 
coupL1 = cplUFvNv0SsL(gO1,i2,i1)
coupR1 = cplUFvNv0SsR(gO1,i2,i1)
coupL2 =  Conjg(cplUFvNv0SsL(gO2,i2,i1))
coupR2 =  Conjg(cplUFvNv0SsR(gO2,i2,i1))
SumS(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
...
Subroutine OneLoopSs(MS2,LSH,v,MFre,MFre2,MFe,MFe2,MNv0,MNv02,MFv,MFv2,               & 
& MSs,MSs2,Mhh,Mhh2,MAh,MAh2,MHp,MHp2,cplcFreFeUSsL,cplcFreFeUSsR,cplFvNv0USsL,          & 
& cplFvNv0USsR,cplhhUSsSs,cplAhAhUSsUSs,cplhhhhUSsUSs,cplHpUSsUSscHp,delta,              & 
& mass,mass2,RS,kont)

Implicit None 
Real(dp), Intent(in) :: MFre,MFre2,MFe(3),MFe2(3),MNv0(3),MNv02(3),MFv(3),MFv2(3),MSs(3),MSs2(3),             & 
& Mhh,Mhh2,MAh,MAh2,MHp,MHp2

Real(dp), Intent(in) :: MS2(3,3),v

Complex(dp), Intent(in) :: LSH(3,3)

Complex(dp), Intent(in) :: cplcFreFeUSsL(3,3),cplcFreFeUSsR(3,3),cplFvNv0USsL(3,3,3),cplFvNv0USsR(3,3,3),        & 
...
mat2a(1,1) = 0._dp 
mat2a(1,1) = mat2a(1,1)+v**2*LSH(1,1)
mat2a(1,1) = mat2a(1,1)+MS2(1,1)
mat2a(1,2) = 0._dp 
mat2a(1,2) = mat2a(1,2)+(v**2*LSH(1,2))/2._dp
mat2a(1,2) = mat2a(1,2)+(v**2*LSH(2,1))/2._dp
mat2a(1,2) = mat2a(1,2)+MS2(1,2)/2._dp
mat2a(1,2) = mat2a(1,2)+MS2(2,1)/2._dp
mat2a(1,3) = 0._dp 
mat2a(1,3) = mat2a(1,3)+(v**2*LSH(1,3))/2._dp
mat2a(1,3) = mat2a(1,3)+(v**2*LSH(3,1))/2._dp
mat2a(1,3) = mat2a(1,3)+MS2(1,3)/2._dp
mat2a(1,3) = mat2a(1,3)+MS2(3,1)/2._dp
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)+v**2*LSH(2,2)
mat2a(2,2) = mat2a(2,2)+MS2(2,2)
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)+(v**2*LSH(2,3))/2._dp
mat2a(2,3) = mat2a(2,3)+(v**2*LSH(3,2))/2._dp
mat2a(2,3) = mat2a(2,3)+MS2(2,3)/2._dp
mat2a(2,3) = mat2a(2,3)+MS2(3,2)/2._dp
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+v**2*LSH(3,3)
mat2a(3,3) = mat2a(3,3)+MS2(3,3)
...
PiSf(i1,:,:) = ZeroC 
p2 = MSs2(i1)
Call Pi1LoopSs(p2,MFre,MFre2,MFe,MFe2,MNv0,MNv02,MFv,MFv2,MSs,MSs2,Mhh,               & 
& Mhh2,MAh,MAh2,MHp,MHp2,cplcFreFeUSsL,cplcFreFeUSsR,cplFvNv0USsL,cplFvNv0USsR,          & 
& cplhhUSsSs,cplAhAhUSsUSs,cplhhhhUSsUSs,cplHpUSsUSscHp,kont,PiSf(i1,:,:))
...
Subroutine Pi1LoopSs(p2,MFre,MFre2,MFe,MFe2,MNv0,MNv02,MFv,MFv2,MSs,MSs2,             & 
& Mhh,Mhh2,MAh,MAh2,MHp,MHp2,cplcFreFeUSsL,cplcFreFeUSsR,cplFvNv0USsL,cplFvNv0USsR,      & 
& cplhhUSsSs,cplAhAhUSsUSs,cplhhhhUSsUSs,cplHpUSsUSscHp,kont,res)
...
Do gO1 = 1, 3
  Do gO2 = gO1, 3
coupL1 = cplcFreFeUSsL(i2,gO1)
coupR1 = cplcFreFeUSsR(i2,gO1)
coupL2 =  Conjg(cplcFreFeUSsL(i2,gO2))
coupR2 =  Conjg(cplcFreFeUSsR(i2,gO2))
...
If ((Include_in_loopNv0).and.(Include_in_loopFv)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 3
 G0m2 = Gloop(p2,MNv02(i1),MFv2(i2)) 
B0m2 = -2._dp*MNv0(i1)*MFv(i2)*B0(p2,MNv02(i1),MFv2(i2)) 
Do gO1 = 1, 3
  Do gO2 = gO1, 3
coupL1 = cplFvNv0USsL(i2,i1,gO1)
coupR1 = cplFvNv0USsR(i2,i1,gO1)
coupL2 =  Conjg(cplFvNv0USsL(i2,i1,gO2))
coupR2 =  Conjg(cplFvNv0USsR(i2,i1,gO2))
    SumI(gO1,gO2) = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
   End Do 
End Do 
...
If ((Include_in_loopSs).and.(Include_in_loophh)) Then 
    Do i1 = 1, 3
 B0m2 = B0(p2,MSs2(i1),Mhh2) 
Do gO1 = 1, 3
  Do gO2 = gO1, 3
coup1 = cplhhUSsSs(gO1,i1)
coup2 = Conjg(cplhhUSsSs(gO2,i1))
...
Subroutine OneLoopFre(MDF,MSs,MSs2,MFe,MFe2,MFre,MFre2,MVZ,MVZ2,MHp,MHp2,             & 
& MNv0,MNv02,MVWp,MVWp2,cplcFreFeSsL,cplcFreFeSsR,cplcFreFreVPL,cplcFreFreVPR,           & 
& cplcFreFreVZL,cplcFreFreVZR,cplcFreNv0cHpL,cplcFreNv0cHpR,cplcFreNv0cVWpL,             & 
& cplcFreNv0cVWpR,delta,mass,mass2,kont)

Real(dp), Intent(in) :: MSs(3),MSs2(3),MFe(3),MFe2(3),MFre,MFre2,MVZ,MVZ2,MHp,MHp2,MNv0(3),MNv02(3),          & 
& MVWp,MVWp2

Complex(dp), Intent(in) :: MDF

Complex(dp), Intent(in) :: cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,        & 
...
p2 = MFre2
sig = ZeroC 
Call Sigma1LoopFre(p2,MSs,MSs2,MFe,MFe2,MFre,MFre2,MVZ,MVZ2,MHp,MHp2,MNv0,            & 
& MNv02,MVWp,MVWp2,cplcFreFeSsL,cplcFreFeSsR,cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,  & 
& cplcFreFreVZR,cplcFreNv0cHpL,cplcFreNv0cHpR,cplcFreNv0cVWpL,cplcFreNv0cVWpR,sig)
...
Subroutine Sigma1LoopFre(p2,MSs,MSs2,MFe,MFe2,MFre,MFre2,MVZ,MVZ2,MHp,MHp2,           & 
& MNv0,MNv02,MVWp,MVWp2,cplcFreFeSsL,cplcFreFeSsR,cplcFreFreVPL,cplcFreFreVPR,           & 
& cplcFreFreVZL,cplcFreFreVZR,cplcFreNv0cHpL,cplcFreNv0cHpR,cplcFreNv0cVWpL,             & 
& cplcFreNv0cVWpR,sig)
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = -0.5_dp*Real(B1(p2,MFe2(i2),MSs2(i1)),dp) 
B0m2 = MFe(i2)*Real(B0(p2,MFe2(i2),MSs2(i1)),dp) 
coupL1 = cplcFreFeSsL(i2,i1)
coupR1 = cplcFreFeSsR(i2,i1)
coupL2 =  Conjg(cplcFreFeSsL(i2,i1))
coupR2 =  Conjg(cplcFreFeSsR(i2,i1))
...
! conj[Hp], Nv0 
!------------------------ 
If ((Include_in_loopHp).and.(Include_in_loopNv0)) Then 
      Do i2 = 1, 3
 SumS = 0._dp 
sumR = 0._dp 
sumL = 0._dp 
B1m2 = -0.5_dp*Real(B1(p2,MNv02(i2),MHp2),dp) 
B0m2 = MNv0(i2)*Real(B0(p2,MNv02(i2),MHp2),dp) 
coupL1 = cplcFreNv0cHpL(i2)
coupR1 = cplcFreNv0cHpR(i2)
coupL2 =  Conjg(cplcFreNv0cHpL(i2))
coupR2 =  Conjg(cplcFreNv0cHpR(i2))
SumS = coupR1*coupL2*B0m2 
sumR = coupR1*coupR2*B1m2 
sumL = coupL1*coupL2*B1m2 
Sig = Sig +1._dp*(sumS + MFre*(sumL+sumR))
...
! conj[VWp], Nv0 
!------------------------ 
If ((Include_in_loopVWp).and.(Include_in_loopNv0)) Then 
      Do i2 = 1, 3
 SumS = 0._dp 
sumR = 0._dp 
sumL = 0._dp 
B1m2 = - Real(B1(p2,MNv02(i2),MVWp2)+ 0.5_dp*rMS,dp) 
B0m2 = -4._dp*MNv0(i2)*Real(B0(p2,MNv02(i2),MVWp2)-0.5_dp*rMS,dp) 
coupL1 = cplcFreNv0cVWpL(i2)
coupR1 = cplcFreNv0cVWpR(i2)
coupL2 =  Conjg(cplcFreNv0cVWpL(i2))
coupR2 =  Conjg(cplcFreNv0cVWpR(i2))
SumS = coupL1*coupR2*B0m2 
sumR = coupL1*coupL2*B1m2 
sumL = coupR1*coupR2*B1m2 
Sig = Sig +1._dp*(sumS + MFre*(sumL+sumR))
...
& MFe,MFe2,MFv,MFv2,MHp,MHp2,Mhh,Mhh2,MVZ,MVZ2,MFre,MFre2,MNv0,MNv02,MSs,MSs2,           & 
...
& cplcFreNv0cHpL,cplcFreNv0cHpR,cplcHpVPVWp,cplcHpVWpVZ,cplAhAhHpcHp,cplhhhhHpcHp,       & 
& cplHpHpcHpcHp,cplHpSsSscHp,cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,delta,            & 
& mass,mass2,kont)

Real(dp), Intent(in) :: MVWp,MVWp2,MAh,MAh2,MFd(3),MFd2(3),MFu(3),MFu2(3),MFe(3),MFe2(3),MFv(3),              & 
& MFv2(3),MHp,MHp2,Mhh,Mhh2,MVZ,MVZ2,MFre,MFre2,MNv0(3),MNv02(3),MSs(3),MSs2(3)
...
& cplcgZgWpcHp,cplcgWpgZHp,cplcgWCgZcHp,cplcgZgWCHp,cplhhHpcHp,cplhhcHpVWp,              & 
& cplHpcHpVP,cplHpcHpVZ,cplcFreNv0cHpL(3),cplcFreNv0cHpR(3),cplcHpVPVWp,cplcHpVWpVZ,     & 
& cplAhAhHpcHp,cplhhhhHpcHp,cplHpHpcHpcHp,cplHpSsSscHp(3,3),cplHpcHpVPVP,cplHpcHpcVWpVWp,& 
& cplHpcHpVZVZ
...
& MHp,MHp2,Mhh,Mhh2,MVZ,MVZ2,MFre,MFre2,MNv0,MNv02,MSs,MSs2,cplAhcHpVWp,cplcFdFucHpL,    & 
& cplcFdFucHpR,cplcFeFvcHpL,cplcFeFvcHpR,cplcgZgWpcHp,cplcgWpgZHp,cplcgWCgZcHp,          & 
& cplcgZgWCHp,cplhhHpcHp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcFreNv0cHpL,               & 
& cplcFreNv0cHpR,cplcHpVPVWp,cplcHpVWpVZ,cplAhAhHpcHp,cplhhhhHpcHp,cplHpHpcHpcHp,        & 
& cplHpSsSscHp,cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,kont,PiSf)
...
& cplcgWCgZcHp,cplcgZgWCHp,cplhhHpcHp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcFreNv0cHpL,  & 
& cplcFreNv0cHpR,cplcHpVPVWp,cplcHpVWpVZ,cplAhAhHpcHp,cplhhhhHpcHp,cplHpHpcHpcHp,        & 
& cplHpSsSscHp,cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,kont,res)
...
If ((Include_in_loopFre).and.(Include_in_loopNv0)) Then 
      Do i2 = 1, 3
 G0m2 = Gloop(p2,MFre2,MNv02(i2)) 
B0m2 = -2._dp*MFre*MNv0(i2)*B0(p2,MFre2,MNv02(i2)) 
coupL1 = cplcFreNv0cHpL(i2)
coupR1 = cplcFreNv0cHpR(i2)
coupL2 =  Conjg(cplcFreNv0cHpL(i2))
coupR2 =  Conjg(cplcFreNv0cHpR(i2))
...
& MFe2,MFu,MFu2,MVZ,MVZ2,MVWp,MVWp2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,cplAhAhhh,              & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,               & 
& cplcgWpgWpAh,cplcgWCgWCAh,cplAhhhVZ,cplAhHpcVWp,cplNv0Nv0AhL,cplNv0Nv0AhR,             & 
...
& MVWp,MVWp2,MHp,MHp2,MNv0(3),MNv02(3),MSs(3),MSs2(3)
...
& cplNv0Nv0AhL(3,3),cplNv0Nv0AhR(3,3),cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,              & 
& cplAhAhSsSs(3,3),cplAhAhcVWpVWp,cplAhAhVZVZ
...
& MVWp,MVWp2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,             & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWpgWpAh,cplcgWCgWCAh,             & 
& cplAhhhVZ,cplAhHpcVWp,cplNv0Nv0AhL,cplNv0Nv0AhR,cplAhAhAhAh,cplAhAhhhhh,               & 
& cplAhAhHpcHp,cplAhAhSsSs,cplAhAhcVWpVWp,cplAhAhVZVZ,kont,PiSf)
...
& MVZ2,MVWp,MVWp2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,        & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWpgWpAh,cplcgWCgWCAh,             & 
& cplAhhhVZ,cplAhHpcVWp,cplNv0Nv0AhL,cplNv0Nv0AhR,cplAhAhAhAh,cplAhAhhhhh,               & 
& cplAhAhHpcHp,cplAhAhSsSs,cplAhAhcVWpVWp,cplAhAhVZVZ,kont,res)
...
If ((Include_in_loopNv0).and.(Include_in_loopNv0)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 3
 G0m2 = Gloop(p2,MNv02(i1),MNv02(i2)) 
B0m2 = -2._dp*MNv0(i1)*MNv0(i2)*B0(p2,MNv02(i1),MNv02(i2)) 
coupL1 = cplNv0Nv0AhL(i1,i2)
coupR1 = cplNv0Nv0AhR(i1,i2)
coupL2 =  Conjg(cplNv0Nv0AhL(i1,i2))
coupR2 =  Conjg(cplNv0Nv0AhR(i1,i2))
    SumI = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
res = res +1._dp/2._dp* SumI  
      End Do 
...
& MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MNv0,MNv02,MSs,MSs2,cplAhAhhh,cplAhhhVZ,             & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcgWpgWphh,cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplNv0Nv0hhL,    & 
& cplNv0Nv0hhR,cplhhSsSs,cplhhcVWpVWp,cplhhVZVZ,cplAhAhhhhh,cplhhhhhhhh,cplhhhhHpcHp,    & 
& cplhhhhSsSs,cplhhhhcVWpVWp,cplhhhhVZVZ,delta,mass,mass2,kont)

Real(dp), Intent(in) :: MAh,MAh2,MVZ,MVZ2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),Mhh,Mhh2,              & 
& MHp,MHp2,MVWp,MVWp2,MNv0(3),MNv02(3),MSs(3),MSs2(3)
...
& cplcgZgZhh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplNv0Nv0hhL(3,3),cplNv0Nv0hhR(3,3),       & 
& cplhhSsSs(3,3),cplhhcVWpVWp,cplhhVZVZ,cplAhAhhhhh,cplhhhhhhhh,cplhhhhHpcHp,            & 
& cplhhhhSsSs(3,3),cplhhhhcVWpVWp,cplhhhhVZVZ
...
& MHp,MHp2,MVWp,MVWp2,MNv0,MNv02,MSs,MSs2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,               & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,              & 
& cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplNv0Nv0hhL,cplNv0Nv0hhR,    & 
& cplhhSsSs,cplhhcVWpVWp,cplhhVZVZ,cplAhAhhhhh,cplhhhhhhhh,cplhhhhHpcHp,cplhhhhSsSs,     & 
& cplhhhhcVWpVWp,cplhhhhVZVZ,kont,PiSf)
...
If ((Include_in_loopNv0).and.(Include_in_loopNv0)) Then 
 ...
 G0m2 = Gloop(p2,MNv02(i1),MNv02(i2)) 
B0m2 = -2._dp*MNv0(i1)*MNv0(i2)*B0(p2,MNv02(i1),MNv02(i2)) 
coupL1 = cplNv0Nv0hhL(i1,i2)
coupR1 = cplNv0Nv0hhR(i1,i2)
coupL2 =  Conjg(cplNv0Nv0hhL(i1,i2))
coupR2 =  Conjg(cplNv0Nv0hhR(i1,i2))
    SumI = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
res = res +1._dp/2._dp* SumI  
      End Do 
...
If ((Include_in_loopSs).and.(Include_in_loopSs)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 3
 B0m2 = B0(p2,MSs2(i1),MSs2(i2)) 
coup1 = cplhhSsSs(i1,i2)
coup2 = Conjg(cplhhSsSs(i1,i2))
    SumI = coup1*coup2*B0m2 
res = res +1._dp/2._dp* SumI  
      End Do 
     End Do 
...
& MFre2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MHp,MHp2,MVWp,MVWp2,MNv0,MNv02,cplAhhhVZ,             & 
...
& cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplNv0Nv0VZL,cplNv0Nv0VZR,cplcVWpVWpVZ,               & 
...
& MFv(3),MFv2(3),MVZ,MVZ2,MHp,MHp2,MVWp,MVWp2,MNv0(3),MNv02(3)

Real(dp), Intent(in) :: g1,g2,v,TW

Complex(dp), Intent(in) :: cplAhhhVZ,cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),        & 
& cplcFreFreVZL,cplcFreFreVZR,cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplFvFvVZL(3,3),         & 
& cplFvFvVZR(3,3),cplcgWpgWpVZ,cplcgWCgWCVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,            & 
& cplNv0Nv0VZL(3,3),cplNv0Nv0VZR(3,3),cplcVWpVWpVZ,cplAhAhVZVZ,cplhhhhVZVZ,              & 
...
& MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MHp,MHp2,MVWp,MVWp2,MNv0,MNv02,cplAhhhVZ,cplcFdFdVZL,       & 
...
& cplHpcVWpVZ,cplNv0Nv0VZL,cplNv0Nv0VZR,cplcVWpVWpVZ,cplAhAhVZVZ,cplhhhhVZVZ,            & 
...
sumI = 0._dp 
    ...
    Do i1 = 1, 3
       Do i2 = 1, 3
 H0m2 = Hloop(p2,MNv02(i1),MNv02(i2)) 
B0m2 = 4._dp*MNv0(i1)*MNv0(i2)*B0(p2,MNv02(i1),MNv02(i2)) 
coupL1 = cplNv0Nv0VZL(i1,i2)
coupR1 = cplNv0Nv0VZR(i1,i2)
    SumI = (Abs(coupL1)**2+Abs(coupR1)**2)*H0m2 & 
                & + (Real(Conjg(coupL1)*coupR1,dp))*B0m2 
res = res +0.5_dp* SumI  
      End Do 
...
& MFv,MFv2,Mhh,Mhh2,MVWp,MVWp2,MVZ,MVZ2,MFre,MFre2,MNv0,MNv02,cplAhHpcVWp,               & 
& cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcgWCgAcVWp,cplcgAgWpcVWp,   & 
& cplcgZgWpcVWp,cplcgWCgZcVWp,cplhhHpcVWp,cplhhcVWpVWp,cplHpcVWpVP,cplHpcVWpVZ,          & 
& cplcFreNv0cVWpL,cplcFreNv0cVWpR,cplcVWpVPVWp,cplcVWpVWpVZ,cplAhAhcVWpVWp,              & 
...
& Mhh,Mhh2,MVWp,MVWp2,MVZ,MVZ2,MFre,MFre2,MNv0(3),MNv02(3)
...
& cplHpcVWpVP,cplHpcVWpVZ,cplcFreNv0cVWpL(3),cplcFreNv0cVWpR(3),cplcVWpVPVWp,            & 
...
& Mhh,Mhh2,MVWp,MVWp2,MVZ,MVZ2,MFre,MFre2,MNv0,MNv02,cplAhHpcVWp,cplcFdFucVWpL,          & 
...
& MFv2,Mhh,Mhh2,MVWp,MVWp2,MVZ,MVZ2,MFre,MFre2,MNv0,MNv02,cplAhHpcVWp,cplcFdFucVWpL,     & 
& cplcFdFucVWpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcgWCgAcVWp,cplcgAgWpcVWp,cplcgZgWpcVWp,   & 
& cplcgWCgZcVWp,cplhhHpcVWp,cplhhcVWpVWp,cplHpcVWpVP,cplHpcVWpVZ,cplcFreNv0cVWpL,        & 
& cplcFreNv0cVWpR,cplcVWpVPVWp,cplcVWpVWpVZ,cplAhAhcVWpVWp,cplhhhhcVWpVWp,               & 
& cplHpcHpcVWpVWp,cplcVWpVPVPVWp3,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,cplcVWpcVWpVWpVWp2,    & 
...
sumI = 0._dp 
      ...
      Do i2 = 1, 3
 H0m2 = Hloop(p2,MFre2,MNv02(i2)) 
B0m2 = 4._dp*MFre*MNv0(i2)*B0(p2,MFre2,MNv02(i2)) 
coupL1 = cplcFreNv0cVWpL(i2)
coupR1 = cplcFreNv0cVWpR(i2)
    SumI = (Abs(coupL1)**2+Abs(coupR1)**2)*H0m2 & 
                & + (Real(Conjg(coupL1)*coupR1,dp))*B0m2 
...
End Module LoopMasses_radinertT13A 
