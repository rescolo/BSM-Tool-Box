...
Module CouplingsForDecays_radinertT13A
...
& MFv2input,Mhhinput,Mhh2input,MHpinput,MHp2input,MNv0input,MNv02input,MSsinput,         & 
& MSs2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,VSsinput,ZULinput,Vvinput,ZvNinput,ZWinput,ZZinput,         & 
& g1input,g2input,g3input,Laminput,LSHinput,Yuinput,Ydinput,Yeinput,YR3input,            & 
& YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,vinput,cplcFuFdVWpL,              & 
...
Real(dp),Intent(in) :: g1input,g2input,g3input,YR3input,YR1input(3,3),YR4input,MS2input(3,3),vinput

Complex(dp),Intent(in) :: Laminput,LSHinput(3,3),Yuinput(3,3),Ydinput(3,3),Yeinput(3,3),Mninput,MDFinput,mu2input
...
& MHpinput,MHp2input,MNv0input(3),MNv02input(3),MSsinput(3),MSs2input(3),MVWpinput,      & 
& MVWp2input,MVZinput,MVZ2input,TWinput,ZZinput(2,2)

Complex(dp),Intent(in) :: ZDRinput(3,3),ZERinput(3,3),ZURinput(3,3),ZDLinput(3,3),ZELinput(3,3),VSsinput(3,3),  & 
& ZULinput(3,3),Vvinput(3,3),ZvNinput(3,3),ZWinput(2,2)
...
& ZURinput,ZDLinput,ZELinput,VSsinput,ZULinput,Vvinput,ZvNinput,ZWinput,ZZinput,         & 
& g1input,g2input,g3input,Laminput,LSHinput,Yuinput,Ydinput,Yeinput,YR3input,            & 
& YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,vinput,cplHiggsPP,cplHiggsGG,     & 
& cplHiggsZZvirt,cplHiggsWWvirt,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,         & 
& cplcFuFuhhL,cplcFuFuhhR,cplhhhhhh,cplNv0Nv0hhL,cplNv0Nv0hhR,cplhhSsSs,cplhhcVWpVWp,    & 
& cplhhVZVZ,deltaM)
...
& ZURinput,ZDLinput,ZELinput,VSsinput,ZULinput,Vvinput,ZvNinput,ZWinput,ZZinput,         & 
& g1input,g2input,g3input,Laminput,LSHinput,Yuinput,Ydinput,Yeinput,YR3input,            & 
& YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,vinput,cplcFreFeSsL,              & 
& cplcFreFeSsR,cplFvNv0SsL,cplFvNv0SsR,cplhhSsSs,deltaM)
...
Complex(dp),Intent(out) :: cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplFvNv0SsL(3,3,3),cplFvNv0SsR(3,3,3),            & 
& cplhhSsSs(3,3)
...
Subroutine CouplingsFor_Nv0_decays_2B(m_in,i1,MAhinput,MAh2input,MFdinput,            & 
& MFd2input,MFeinput,MFe2input,MFreinput,MFre2input,MFuinput,MFu2input,MFvinput,         & 
& MFv2input,Mhhinput,Mhh2input,MHpinput,MHp2input,MNv0input,MNv02input,MSsinput,         & 
& MSs2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,VSsinput,ZULinput,Vvinput,ZvNinput,ZWinput,ZZinput,         & 
& g1input,g2input,g3input,Laminput,LSHinput,Yuinput,Ydinput,Yeinput,YR3input,            & 
& YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,vinput,cplNv0FreVWpL,             & 
& cplNv0FreVWpR,cplFvNv0SsL,cplFvNv0SsR,cplNv0Nv0hhL,cplNv0Nv0hhR,cplNv0Nv0VZL,          & 
& cplNv0Nv0VZR,deltaM)
...
Complex(dp),Intent(out) :: cplNv0FreVWpL(3),cplNv0FreVWpR(3),cplFvNv0SsL(3,3,3),cplFvNv0SsR(3,3,3),              & 
...
Real(dp) :: gSM(11), sinW2, dt, tz, Qin 
Iname = Iname + 1 
NameOfUnit(Iname) = 'Couplings_Nv0_2B'
...
End subroutine CouplingsFor_Nv0_decays_2B
...
& g1input,g2input,g3input,Laminput,LSHinput,Yuinput,Ydinput,Yeinput,YR3input,            & 
& YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,vinput,cplcFreFeSsL,              & 
& cplcFreFeSsR,cplcFreFreVZL,cplcFreFreVZR,cplcFreNv0cVWpL,cplcFreNv0cVWpR,deltaM)
...
Complex(dp),Intent(out) :: cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplcFreFreVZL,cplcFreFreVZR,cplcFreNv0cVWpL(3),   & 
& cplcFreNv0cVWpR(3)
...
& ZURinput,ZDLinput,ZELinput,VSsinput,ZULinput,Vvinput,ZvNinput,ZWinput,ZZinput,         & 
& g1input,g2input,g3input,Laminput,LSHinput,Yuinput,Ydinput,Yeinput,YR3input,            & 
& YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,vinput,cplcFdFdhhL,               & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFehhL,           & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFreFreVZL,         & 
& cplcFreFreVZR,cplcFreNv0cVWpL,cplcFreNv0cVWpR,cplcFuFdVWpL,cplcFuFdVWpR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplNv0Nv0hhL,    & 
& cplNv0Nv0hhR,cplNv0Nv0VZL,cplNv0Nv0VZR,deltaM)
...
& cplcFreNv0cVWpR(3),cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplcFuFuhhL(3,3),               & 
& cplcFuFuhhR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3),    & 
& cplNv0Nv0hhL(3,3),cplNv0Nv0hhR(3,3),cplNv0Nv0VZL(3,3),cplNv0Nv0VZR(3,3)
...
Subroutine CouplingsFor_Ss_decays_3B(m_in,i1,MAhinput,MAh2input,MFdinput,             & 
& MFd2input,MFeinput,MFe2input,MFreinput,MFre2input,MFuinput,MFu2input,MFvinput,         & 
& MFv2input,Mhhinput,Mhh2input,MHpinput,MHp2input,MNv0input,MNv02input,MSsinput,         & 
& MSs2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,VSsinput,ZULinput,Vvinput,ZvNinput,ZWinput,ZZinput,         & 
& g1input,g2input,g3input,Laminput,LSHinput,Yuinput,Ydinput,Yeinput,YR3input,            & 
& YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,vinput,cplcFdFdhhL,               & 
& cplcFdFdhhR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFreSsL,              & 
& cplcFeFreSsR,cplcFreFeSsL,cplcFreFeSsR,cplcFuFuhhL,cplcFuFuhhR,cplFvFeHpL,             & 
& cplFvFeHpR,cplFvNv0SsL,cplFvNv0SsR,cplhhSsSs,cplNv0FreHpL,cplNv0FreHpR,cplNv0Nv0AhL,   & 
& cplNv0Nv0AhR,cplNv0Nv0hhL,cplNv0Nv0hhR,deltaM)
...
Complex(dp),Intent(out) :: cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplcFeFehhL(3,3), & 
...
Real(dp) :: gSM(11), sinW2, dt, tz, Qin 
Iname = Iname + 1 
NameOfUnit(Iname) = 'Couplings_Ss_3B'
...
End subroutine CouplingsFor_Ss_decays_3B
 
Subroutine CouplingsFor_Nv0_decays_3B(m_in,i1,MAhinput,MAh2input,MFdinput,            & 
& MFd2input,MFeinput,MFe2input,MFreinput,MFre2input,MFuinput,MFu2input,MFvinput,         & 
& MFv2input,Mhhinput,Mhh2input,MHpinput,MHp2input,MNv0input,MNv02input,MSsinput,         & 
& MSs2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,VSsinput,ZULinput,Vvinput,ZvNinput,ZWinput,ZZinput,         & 
...
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,     & 
& cplFvNv0SsR,cplNv0FreVWpL,cplNv0FreVWpR,cplNv0Nv0hhL,cplNv0Nv0hhR,cplNv0Nv0VZL,        & 
& cplNv0Nv0VZR,deltaM)
...
Complex(dp),Intent(out) :: cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFucVWpL(3,3),& 
& cplcFdFucVWpR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),& 
& cplcFeFreSsL(3,3),cplcFeFreSsR(3,3),cplcFeFvcVWpL(3,3),cplcFeFvcVWpR(3,3),             & 
& cplcFreFreVZL,cplcFreFreVZR,cplcFreNv0cVWpL(3),cplcFreNv0cVWpR(3),cplcFuFuhhL(3,3),    & 
& cplcFuFuhhR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3),    & 
& cplFvNv0SsL(3,3,3),cplFvNv0SsR(3,3,3),cplNv0FreVWpL(3),cplNv0FreVWpR(3),               & 
& cplNv0Nv0hhL(3,3),cplNv0Nv0hhR(3,3),cplNv0Nv0VZL(3,3),cplNv0Nv0VZR(3,3)
...
Real(dp) :: gSM(11), sinW2, dt, tz, Qin 
Iname = Iname + 1 
NameOfUnit(Iname) = 'Couplings_Nv0_3B'
...
End subroutine CouplingsFor_Nv0_decays_3B
...
& g1input,g2input,g3input,Laminput,LSHinput,Yuinput,Ydinput,Yeinput,YR3input,            & 
& YR1input,YR4input,Mninput,MDFinput,mu2input,MS2input,vinput,cplcFreFeSsL,              & 
& cplcFreFeSsR,cplcFreNv0cVWpL,cplcFreNv0cVWpR,cplcFuFdVWpL,cplcFuFdVWpR,cplFvFeVWpL,    & 
& cplFvFeVWpR,cplFvNv0SsL,cplFvNv0SsR,deltaM)
...
Complex(dp),Intent(out) :: cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplcFreNv0cVWpL(3),cplcFreNv0cVWpR(3),            & 
...
End Module CouplingsForDecays_radinertT13A
