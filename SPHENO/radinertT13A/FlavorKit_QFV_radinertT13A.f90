...
Module FlavorKit_QFV_radinertT13A 
Use Control 
Use Couplings_radinertT13A 
Use LoopCouplings_radinertT13A 
Use LoopFunctions 
Use LoopMasses_radinertT13A 
Use StandardModel 
...
& MVZ,MVZ2,cplAhAhhh,cplAhcHpVWp,cplAhhhVZ,cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,          & 
...
& cplcFreFeSsL,cplcFreFeSsR,cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,cplcFreFreVZR,     & 
...
& cplHpcVWpVZ,BOddllSLL,BOddllSRR,BOddllSRL,BOddllSLR,BOddllVRR,BOddllVLL,               & 
& BOddllVRL,BOddllVLR,BOddllTLL,BOddllTLR,BOddllTRL,BOddllTRR)
...
& MFv2(3),Mhh,Mhh2,MHp,MHp2,MSs(3),MSs2(3),MVWp,MVWp2,MVZ,MVZ2
...
& cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFreSsL(3,3), & 
& cplcFeFreSsR(3,3),cplcFeFvcHpL(3,3),cplcFeFvcHpR(3,3),cplcFeFvcVWpL(3,3),              & 
& cplcFeFvcVWpR(3,3),cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplcFreFreVPL,cplcFreFreVPR,    & 
...
& cplcHpVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplFvFeVWpL(3,3),& 
& cplFvFeVWpR(3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplhhcHpVWp,cplhhcVWpVWp,             & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhSsSs(3,3),cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,       & 
...
& MFe,MFe2,MFre,MFre2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MSs,MSs2,MVWp,MVWp2,           & 
& MVZ,MVZ2,cplAhAhhh,cplAhcHpVWp,cplAhhhVZ,cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,          & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
...
& cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,      & 
& cplhhHpcHp,cplhhHpcVWp,cplhhSsSs,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,          & 
& cplHpcVWpVZ,PSOddllSLL,PSOddllSRR,PSOddllSRL,PSOddllSLR,PSOddllVRR,PSOddllVLL,         & 
...
Do i1=1,3
    Do i3=1,3
If ((MSs2(i1).gt.mf_l2(3)).Or.(MFre2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplcFreFeSsL(gt3,i1)
coup1R = cplcFreFeSsR(gt3,i1)
coup2L = cplcFeFreSsL(i3,i1)
coup2R = cplcFeFreSsR(i3,i1)
coup3L = cplcFeFeAhL(gt4,i3)
coup3R = cplcFeFeAhR(gt4,i3)
coup4L = cplcFdFdAhL(gt2,gt1)
coup4R = cplcFdFdAhR(gt2,gt1)
...
If ((Include_in_loopFre).and.(Include_in_loopSs).and.(Include_in_loopFe).and.IncludeWave) Then 
  Do i2=1,3
    Do i3=1,3
If ((MFre2.gt.mf_l2(3)).Or.(MSs2(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup3L = cplcFeFeAhL(i3,gt3)
coup3R = cplcFeFeAhR(i3,gt3)
coup2L = cplcFreFeSsL(i3,i2)
coup2R = cplcFreFeSsR(i3,i2)
coup1L = cplcFeFreSsL(gt4,i2)
coup1R = cplcFeFreSsR(gt4,i2)
coup4L = cplcFdFdAhL(gt2,gt1)
coup4R = cplcFdFdAhR(gt2,gt1)
! Masses in loop
mF1 = MFre
...
If ((Include_in_loopFre).and.(Include_in_loopSs).and.(Include_in_loopSs).and.IncludePenguins) Then 
  Do i2=1,3
    Do i3=1,3
If ((MFre2.gt.mf_l2(3)).Or.(MSs2(i2).gt.mf_l2(3)).Or.(MSs2(i3).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplcFreFeSsL(gt3,i2)
coup1R = cplcFreFeSsR(gt3,i2)
coup2L = cplcFeFreSsL(gt4,i3)
coup2R = cplcFeFreSsR(gt4,i3)
coup3 = cplhhSsSs(i3,i2)
coup4L = cplcFdFdhhL(gt2,gt1)
coup4R = cplcFdFdhhR(gt2,gt1)
! Masses in loop
mF1 = MFre
...
& cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,      & 
& cplhhHpcHp,cplhhHpcVWp,cplhhSsSs,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,          & 
& cplHpcVWpVZ,PVOddllSLL,PVOddllSRR,PVOddllSRL,PVOddllSLR,PVOddllVRR,PVOddllVLL,         & 
...
Do i1=1,3
If ((MSs2(i1).gt.mf_l2(3)).Or.(MFre2.gt.mf_l2(3)).Or.(MFre2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplcFreFeSsL(gt3,i1)
coup1R = cplcFreFeSsR(gt3,i1)
coup2L = cplcFeFreSsL(gt4,i1)
coup2R = cplcFeFreSsR(gt4,i1)
...
& cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,      & 
& cplhhHpcHp,cplhhHpcVWp,cplhhSsSs,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,          & 
& cplHpcVWpVZ,TSOddllSLL,TSOddllSRR,TSOddllSRL,TSOddllSLR,TSOddllVRR,TSOddllVLL,         & 
...
& cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,      & 
& cplhhHpcHp,cplhhHpcVWp,cplhhSsSs,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,          & 
& cplHpcVWpVZ,TVOddllSLL,TVOddllSRR,TVOddllSRL,TVOddllSLR,TVOddllVRR,TVOddllVLL,         & 
...
& MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,MVWp,MVWp2,               & 
...
& cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,      & 
& cplFvNv0SsL,cplFvNv0SsR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplNv0Nv0VZL,cplNv0Nv0VZR,    & 
...
& Mhh2,MHp,MHp2,MNv0(3),MNv02(3),MSs(3),MSs2(3),MVWp,MVWp2,MVZ,MVZ2
...
& cplcVWpVWpVZ,cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplFvFeVWpL(3,3),cplFvFeVWpR(3,3),        & 
& cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplFvNv0SsL(3,3,3),cplFvNv0SsR(3,3,3),cplhhVZVZ,       & 
& cplHpcHpVZ,cplHpcVWpVZ,cplNv0Nv0VZL(3,3),cplNv0Nv0VZR(3,3)
...
coup4L = cplcFeFvcHpL(i3,gt4)
coup4R = cplcFeFvcHpR(i3,gt4)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHp
mS12 = MHp2
...
mS22 = MHp2
  ...
  BOddvvVRL=BOddvvVRL - 1.*chargefactor*coup1R*coup2L*coup3L*coup4R*int1
  BOddvvVLR=BOddvvVLR - 1.*chargefactor*coup1L*coup2R*coup3R*coup4L*int1
  End if 
End if 
    End Do 
  End Do 
...
coup2L = cplcFdFucVWpL(gt2,i1)
coup2R = cplcFdFucVWpR(gt2,i1)
coup3L = Conjg(-cplFvFeVWpR(gt3,i3))
coup3R = Conjg(-cplFvFeVWpL(gt3,i3))
coup4L = cplcFeFvcHpL(i3,gt4)
coup4R = cplcFeFvcHpR(i3,gt4)
mF1 = MFu(i1)
mF12 = MFu2(i1)
...
mV22 = MVWp2
  ...
  BOddvvVRR=BOddvvVRR+chargefactor*coup1R*coup2R*coup3R*coup4L*int1
  BOddvvVLL=BOddvvVLL+chargefactor*coup1L*coup2L*coup3L*coup4R*int1
  BOddvvVRL=BOddvvVRL+chargefactor*coup1R*coup2R*coup3L*coup4R*int1
  BOddvvVLR=BOddvvVLR+chargefactor*coup1L*coup2L*coup3R*coup4L*int1
  End if 
End if 
    End Do 
  End Do 
...
coup3L = cplFvFeHpL(gt3,i3)
coup3R = cplFvFeHpR(gt3,i3)
coup4L = Conjg(-cplcFeFvcVWpR(i3,gt4))
coup4R = Conjg(-cplcFeFvcVWpL(i3,gt4))
mF1 = MFu(i1)
mF12 = MFu2(i1)
mV1 = MVWp
mV12 = MVWp2
...
coup2L = cplcFdFucHpL(gt2,i1)
coup2R = cplcFdFucHpR(gt2,i1)
coup3L = cplFvFeHpL(gt4,i3)
coup3R = cplFvFeHpR(gt4,i3)
coup4L = cplcFeFvcHpL(i3,gt3)
coup4R = cplcFeFvcHpR(i3,gt3)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHp
mS12 = MHp2
...
coup2L = cplcFdFucVWpL(gt2,i1)
coup2R = cplcFdFucVWpR(gt2,i1)
coup3L = cplFvFeVWpL(gt4,i3)
coup3R = cplFvFeVWpR(gt4,i3)
coup4L = cplcFeFvcHpL(i3,gt3)
coup4R = cplcFeFvcHpR(i3,gt3)
mF1 = MFu(i1)
mF12 = MFu2(i1)
...
coup3L = cplFvFeHpL(gt4,i3)
coup3R = cplFvFeHpR(gt4,i3)
coup4L = cplcFeFvcVWpL(i3,gt3)
coup4R = cplcFeFvcVWpR(i3,gt3)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mV1 = MVWp
mV12 = MVWp2
...
& MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,MVWp,MVWp2,           & 
& MVZ,MVZ2,cplAhhhVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,        & 
& cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFeVZL,         & 
& cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFuFdHpL,         & 
& cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVZL,cplcFuFuVZR,cplcHpVWpVZ,             & 
...
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
If ((Include_in_loopFe).and.(Include_in_loopHp).and.(Include_in_loopFv).and.IncludeWave) Then 
Do i1=1,3
    Do i3=1,3
...
! Generic diagram: FVF,  InsertionOrder: 7
chargefactor = 1 
If ((Include_in_loopFe).and.(Include_in_loopVWp).and.(Include_in_loopFv).and.IncludeWave) Then 
Do i1=1,3
    Do i3=1,3
...
! Generic diagram: FVF,  InsertionOrder: 7
chargefactor = 1 
If ((Include_in_loopFv).and.(Include_in_loopVZ).and.(Include_in_loopFv).and.IncludeWave) Then 
Do i1=1,3
    Do i3=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Nv0,Ss, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
If ((Include_in_loopNv0).and.(Include_in_loopSs).and.(Include_in_loopFv).and.IncludeWave) Then 
Do i1=1,3
  Do i2=1,3
    Do i3=1,3
If ((MNv02(i1).gt.mf_l2(3)).Or.(MSs2(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplFvNv0SsL(gt3,i1,i2)
coup1R = cplFvNv0SsR(gt3,i1,i2)
coup2L = cplFvNv0SsL(i3,i1,i2)
coup2R = cplFvNv0SsR(i3,i1,i2)
coup3L = cplFvFvVZL(gt4,i3)
coup3R = cplFvFvVZR(gt4,i3)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
...
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
If ((Include_in_loopHp).and.(Include_in_loopFe).and.(Include_in_loopFv).and.IncludeWave) Then 
  Do i2=1,3
    Do i3=1,3
...
! Generic diagram: VFF,  InsertionOrder: 8
chargefactor = 1 
If ((Include_in_loopVWp).and.(Include_in_loopFe).and.(Include_in_loopFv).and.IncludeWave) Then 
  Do i2=1,3
    Do i3=1,3
...
! Generic diagram: VFF,  InsertionOrder: 8
chargefactor = 1 
If ((Include_in_loopVZ).and.(Include_in_loopFv).and.(Include_in_loopFv).and.IncludeWave) Then 
  Do i2=1,3
    Do i3=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Ss,Nv0, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
If ((Include_in_loopSs).and.(Include_in_loopNv0).and.(Include_in_loopFv).and.IncludeWave) Then 
Do i1=1,3
  Do i2=1,3
    Do i3=1,3
If ((MSs2(i1).gt.mf_l2(3)).Or.(MNv02(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup3L = cplFvFvVZL(gt3,i3)
coup3R = cplFvFvVZR(gt3,i3)
coup2L = cplFvNv0SsL(i3,i2,i1)
coup2R = cplFvNv0SsR(i3,i2,i1)
coup1L = cplFvNv0SsL(gt4,i2,i1)
coup1R = cplFvNv0SsR(gt4,i2,i1)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
! Masses in loop
mS1 = MSs(i1)
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Ss,Nv0,Nv0
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
If ((Include_in_loopSs).and.(Include_in_loopNv0).and.(Include_in_loopNv0).and.IncludePenguins) Then 
Do i1=1,3
  Do i2=1,3
    Do i3=1,3
If ((MSs2(i1).gt.mf_l2(3)).Or.(MNv02(i2).gt.mf_l2(3)).Or.(MNv02(i3).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplFvNv0SsL(gt3,i2,i1)
coup1R = cplFvNv0SsR(gt3,i2,i1)
coup2L = cplFvNv0SsL(gt4,i3,i1)
coup2R = cplFvNv0SsR(gt4,i3,i1)
coup3L = cplNv0Nv0VZL(i3,i2)
coup3R = cplNv0Nv0VZR(i3,i2)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
! Masses in loop
mS1 = MSs(i1)
...
! Generic diagram: VFF,  InsertionOrder: 4
chargefactor = 1 
If ((Include_in_loopVZ).and.(Include_in_loopFv).and.(Include_in_loopFv).and.IncludePenguins) Then 
  Do i2=1,3
    Do i3=1,3
...
coup4L = cplcFdFdAhL(gt4,i4)
coup4R = cplcFdFdAhR(gt4,i4)
mV1 = 0.
mV12 = 0._dp
mF1 = MFd(i4)
mF12 = MFd2(i4)
...
coup4L = cplcFdFdhhL(gt4,i4)
coup4R = cplcFdFdhhR(gt4,i4)
mV1 = 0.
mV12 = 0._dp
mF1 = MFd(i4)
mF12 = MFd2(i4)
...
coup1L = cplcFdFdVGL(i4,gt1)
coup1R = cplcFdFdVGR(i4,gt1)
coup2L = cplcFdFdAhL(gt4,i4)
coup2R = cplcFdFdAhR(gt4,i4)
coup3L = cplcFdFdVGL(i2,gt3)
coup3R = cplcFdFdVGR(i2,gt3)
coup4L = cplcFdFdAhL(gt2,i2)
coup4R = cplcFdFdAhR(gt2,i2)
mV1 = 0.
mV12 = 0._dp
mF1 = MFd(i4)
mF12 = MFd2(i4)
...
coup1L = cplcFdFdVGL(i4,gt1)
coup1R = cplcFdFdVGR(i4,gt1)
coup2L = cplcFdFdhhL(gt4,i4)
coup2R = cplcFdFdhhR(gt4,i4)
coup3L = cplcFdFdVGL(i2,gt3)
coup3R = cplcFdFdVGR(i2,gt3)
coup4L = cplcFdFdhhL(gt2,i2)
coup4R = cplcFdFdhhR(gt2,i2)
mV1 = 0.
mV12 = 0._dp
mF1 = MFd(i4)
mF12 = MFd2(i4)
...
& MFe,MFe2,MFre,MFre2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MNv0,MNv02,MSs,MSs2,           & 
& MVWp,MVWp2,MVZ,MVZ2,cplAhcHpVWp,cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,       & 
...
& cplcFreFeSsR,cplcFreNv0cHpL,cplcFreNv0cHpR,cplcFreNv0cVWpL,cplcFreNv0cVWpR,            & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,    & 
& cplFvFvVZL,cplFvFvVZR,cplFvNv0SsL,cplFvNv0SsR,cplhhcHpVWp,cplhhcVWpVWp,cplhhHpcHp,     & 
...
Implicit None 
Real(dp),Intent(in) :: MAh,MAh2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFre,MFre2,MFu(3),MFu2(3),MFv(3),              & 
& MFv2(3),Mhh,Mhh2,MHp,MHp2,MNv0(3),MNv02(3),MSs(3),MSs2(3),MVWp,MVWp2,MVZ,MVZ2
...
& cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFreSsL(3,3),cplcFeFreSsR(3,3),& 
& cplcFeFvcHpL(3,3),cplcFeFvcHpR(3,3),cplcFeFvcVWpL(3,3),cplcFeFvcVWpR(3,3),             & 
& cplcFreFeSsL(3,3),cplcFreFeSsR(3,3),cplcFreNv0cHpL(3),cplcFreNv0cHpR(3),               & 
& cplcFreNv0cVWpL(3),cplcFreNv0cVWpR(3),cplcFuFdHpL(3,3),cplcFuFdHpR(3,3),               & 
& cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplcFuFuhhL(3,3),& 
& cplcFuFuhhR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),  & 
& cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplFvFeVWpL(3,3), & 
& cplFvFeVWpR(3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplFvNv0SsL(3,3,3),cplFvNv0SsR(3,3,3),& 
...
End Function C1C2 
End Module FlavorKit_QFV_radinertT13A 
