...
! ------------------------------------------------------------------------------  
! File created at 17:03 on 25.5.2016   
! ----------------------------------------------------------------------  
 
 
Module InputOutput_radinertT13A 
...
Do 
 ...
 End If 
   ...
   Else If (read_line(7:11).Eq."LSHIN") Then 
InputValueforLSH= .True. 
    Call ReadMatrixC(99,3,3,LSHIN,0, "LSHIN",kont)

 
   Else If (read_line(7:13).Eq."IMLSHIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMLSH") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,LSHIN,1, "LSHIN",kont)
...
InputValueforYe= .True. 
   ...
   Else If (read_line(7:11).Eq."YR1IN") Then 
InputValueforYR1= .True. 
    Call ReadMatrixR(99,3,3,YR1IN, "YR1IN",kont)

 
   Else If (read_line(7:13).Eq."MSOFTIN") Then 
InputValueforMS2= .True. 
    Call ReadMatrixR(99,3,3,MS2IN, "MS2IN",kont)
   ...
   Else If (read_line(7:11).Eq."YR3IN") Then 
    Call Read_YR3IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMYR3IN") Then 
    Call Read_YR3IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:11).Eq."YR4IN") Then 
    Call Read_YR4IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMYR4IN") Then 
    Call Read_YR4IN(99,1,i_model,set_mod_par,kont) 
   ...
   Else If (read_line(7:10).Eq."LSIN") Then 
InputValueforLS= .True. 
    Call ReadMatrixR(99,3,3,MS2IN, "MS2IN",kont)

 
   Else If (read_line(7:12).Eq."IMLSIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMLS") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,YeIN,1, "YeIN",kont)
...
Complex(dp) :: PDGhh,PDGSs(3),PDGAh,PDGHp,PDGVP,PDGVZ,PDGVG,PDGVWp,PDGgP,PDGgWp,PDGgWpC,             & 
& PDGgZ,PDGgG,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3),PDGFre,PDGNv0(3)

Character(len=30) :: NameParticlehh
Character(len=30),Dimension(3):: NameParticleSs
...
Character(len=30),Dimension(3):: NameParticleNv0
...
NameParticlehh="hh"
PDGSs(1)=6666637
NameParticleSs(1)="Ss_1"
PDGSs(2)=6666638
NameParticleSs(2)="Ss_2"
PDGSs(3)=6666639
NameParticleSs(3)="Ss_3"
PDGAh=0
NameParticleAh="Ah"
PDGHp=0
NameParticleHp="Hp"
...
NameParticleFre="Fre"
PDGNv0(1)=210000001
NameParticleNv0(1)="Nv0_1"
PDGNv0(2)=210000002
NameParticleNv0(2)="Nv0_2"
PDGNv0(3)=210000003
NameParticleNv0(3)="Nv0_3"
...
End Do 
Do i1=1,3
  If (MaxVal(Abs(AImag(ZvN(i1,:)))).gt.MaxVal(Abs(Real(ZvN(i1,:),dp)))) Then 
MNv0(i1) = - MNv0(i1) 
ZvN(i1,:) = -(0._dp,1._dp)*ZvN(i1,:) 
  End If 
End Do 
End If 
 
Write(io_L,100) "# SUSY Les Houches Accord 2 - radinert/T13A Spectrum + Decays + Flavor Observables"
...
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block YR3 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(YR3,dp), "# YR3" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMYR3 Q=",Q,"# (Renormalization Scale)" 
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block YR4 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(YR4,dp), "# YR4" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMYR4 Q=",Q,"# (Renormalization Scale)" 
End if 
WriteNextBlock = .false. 
...
End if 
End if 
Write(io_L,106) "Block LSH Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(LSH(1,1),dp), "# Real(LSH(1,1),dp)" 
Write(io_L,107)1,2,Real(LSH(1,2),dp), "# Real(LSH(1,2),dp)" 
Write(io_L,107)1,3,Real(LSH(1,3),dp), "# Real(LSH(1,3),dp)" 
Write(io_L,107)2,1,Real(LSH(2,1),dp), "# Real(LSH(2,1),dp)" 
Write(io_L,107)2,2,Real(LSH(2,2),dp), "# Real(LSH(2,2),dp)" 
Write(io_L,107)2,3,Real(LSH(2,3),dp), "# Real(LSH(2,3),dp)" 
Write(io_L,107)3,1,Real(LSH(3,1),dp), "# Real(LSH(3,1),dp)" 
Write(io_L,107)3,2,Real(LSH(3,2),dp), "# Real(LSH(3,2),dp)" 
Write(io_L,107)3,3,Real(LSH(3,3),dp), "# Real(LSH(3,3),dp)" 
If (MaxVal(Abs(AImag(LSH))).gt.0._dp) Then 
Write(io_L,106) "Block IMLSH Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(LSH(1,1)), "# Aimag(LSH(1,1))" 
Write(io_L,107)1,2,Aimag(LSH(1,2)), "# Aimag(LSH(1,2))" 
Write(io_L,107)1,3,Aimag(LSH(1,3)), "# Aimag(LSH(1,3))" 
Write(io_L,107)2,1,Aimag(LSH(2,1)), "# Aimag(LSH(2,1))" 
Write(io_L,107)2,2,Aimag(LSH(2,2)), "# Aimag(LSH(2,2))" 
Write(io_L,107)2,3,Aimag(LSH(2,3)), "# Aimag(LSH(2,3))" 
Write(io_L,107)3,1,Aimag(LSH(3,1)), "# Aimag(LSH(3,1))" 
Write(io_L,107)3,2,Aimag(LSH(3,2)), "# Aimag(LSH(3,2))" 
Write(io_L,107)3,3,Aimag(LSH(3,3)), "# Aimag(LSH(3,3))" 
End If 
...
Write(io_L,106) "Block YR1 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,YR1(1,1), "# YR1(1,1)" 
Write(io_L,107)1,2,YR1(1,2), "# YR1(1,2)" 
Write(io_L,107)1,3,YR1(1,3), "# YR1(1,3)" 
Write(io_L,107)2,1,YR1(2,1), "# YR1(2,1)" 
Write(io_L,107)2,2,YR1(2,2), "# YR1(2,2)" 
Write(io_L,107)2,3,YR1(2,3), "# YR1(2,3)" 
Write(io_L,107)3,1,YR1(3,1), "# YR1(3,1)" 
Write(io_L,107)3,2,YR1(3,2), "# YR1(3,2)" 
Write(io_L,107)3,3,YR1(3,3), "# YR1(3,3)" 
Write(io_L,106) "Block {MSOFT, 22} Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,MS2(1,1), "# MS2(1,1)" 
Write(io_L,107)1,2,MS2(1,2), "# MS2(1,2)" 
Write(io_L,107)1,3,MS2(1,3), "# MS2(1,3)" 
Write(io_L,107)2,1,MS2(2,1), "# MS2(2,1)" 
Write(io_L,107)2,2,MS2(2,2), "# MS2(2,2)" 
Write(io_L,107)2,3,MS2(2,3), "# MS2(2,3)" 
Write(io_L,107)3,1,MS2(3,1), "# MS2(3,1)" 
Write(io_L,107)3,2,MS2(3,2), "# MS2(3,2)" 
Write(io_L,107)3,3,MS2(3,3), "# MS2(3,3)" 
Write(io_L,106) "Block LS Q=",Q,"# (Renormalization Scale)" 
If (MaxVal(Abs(AImag(LS))).gt.0._dp) Then 
Write(io_L,106) "Block IMLS Q=",Q,"# (Renormalization Scale)" 
End If 
...
Write(io_L,106) "Block YR3GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(YR3GUT,dp), "# YR3" 
Write(io_L,106) "Block YR4GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(YR4GUT,dp), "# YR4" 
...
Write(io_L,106) "Block LSHGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(LSHGUT(1,1),dp), "# Real(LSHGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(LSHGUT(1,2),dp), "# Real(LSHGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(LSHGUT(1,3),dp), "# Real(LSHGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(LSHGUT(2,1),dp), "# Real(LSHGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(LSHGUT(2,2),dp), "# Real(LSHGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(LSHGUT(2,3),dp), "# Real(LSHGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(LSHGUT(3,1),dp), "# Real(LSHGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(LSHGUT(3,2),dp), "# Real(LSHGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(LSHGUT(3,3),dp), "# Real(LSHGUT(3,3),dp)" 
If (MaxVal(Abs(AImag(LSHGUT))).gt.0._dp) Then 
Write(io_L,106) "Block IMLSHGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(LSHGUT(1,1)), "# Aimag(LSHGUT(1,1))" 
Write(io_L,107)1,2,Aimag(LSHGUT(1,2)), "# Aimag(LSHGUT(1,2))" 
Write(io_L,107)1,3,Aimag(LSHGUT(1,3)), "# Aimag(LSHGUT(1,3))" 
Write(io_L,107)2,1,Aimag(LSHGUT(2,1)), "# Aimag(LSHGUT(2,1))" 
Write(io_L,107)2,2,Aimag(LSHGUT(2,2)), "# Aimag(LSHGUT(2,2))" 
Write(io_L,107)2,3,Aimag(LSHGUT(2,3)), "# Aimag(LSHGUT(2,3))" 
Write(io_L,107)3,1,Aimag(LSHGUT(3,1)), "# Aimag(LSHGUT(3,1))" 
Write(io_L,107)3,2,Aimag(LSHGUT(3,2)), "# Aimag(LSHGUT(3,2))" 
Write(io_L,107)3,3,Aimag(LSHGUT(3,3)), "# Aimag(LSHGUT(3,3))" 
End If 
...
Write(io_L,106) "Block YR1GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,YR1GUT(1,1), "# YR1GUT(1,1)" 
Write(io_L,107)1,2,YR1GUT(1,2), "# YR1GUT(1,2)" 
Write(io_L,107)1,3,YR1GUT(1,3), "# YR1GUT(1,3)" 
Write(io_L,107)2,1,YR1GUT(2,1), "# YR1GUT(2,1)" 
Write(io_L,107)2,2,YR1GUT(2,2), "# YR1GUT(2,2)" 
Write(io_L,107)2,3,YR1GUT(2,3), "# YR1GUT(2,3)" 
Write(io_L,107)3,1,YR1GUT(3,1), "# YR1GUT(3,1)" 
Write(io_L,107)3,2,YR1GUT(3,2), "# YR1GUT(3,2)" 
Write(io_L,107)3,3,YR1GUT(3,3), "# YR1GUT(3,3)" 
Write(io_L,106) "Block MS2GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,MS2GUT(1,1), "# MS2GUT(1,1)" 
Write(io_L,107)1,2,MS2GUT(1,2), "# MS2GUT(1,2)" 
Write(io_L,107)1,3,MS2GUT(1,3), "# MS2GUT(1,3)" 
Write(io_L,107)2,1,MS2GUT(2,1), "# MS2GUT(2,1)" 
Write(io_L,107)2,2,MS2GUT(2,2), "# MS2GUT(2,2)" 
Write(io_L,107)2,3,MS2GUT(2,3), "# MS2GUT(2,3)" 
Write(io_L,107)3,1,MS2GUT(3,1), "# MS2GUT(3,1)" 
Write(io_L,107)3,2,MS2GUT(3,2), "# MS2GUT(3,2)" 
Write(io_L,107)3,3,MS2GUT(3,3), "# MS2GUT(3,3)" 
End if 
...
Write(io_L,100) "#   PDG code      mass          particle" 
 ...
 Write(io_L,102) INT(Abs(PDGSs(1))),MSs(1),"# "//Trim(NameParticleSs(1))// "" 
If (MassLSP(1).gt.Abs(MSs(1))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6666637 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MSs(1))
Else 
If (MassLSP(2).gt.Abs(MSs(1))) Then 
PDGLSP(2) = 6666637 
MassLSP(2) = Abs(MSs(1))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGSs(2))),MSs(2),"# "//Trim(NameParticleSs(2))// "" 
If (MassLSP(1).gt.Abs(MSs(2))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6666638 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MSs(2))
Else 
If (MassLSP(2).gt.Abs(MSs(2))) Then 
PDGLSP(2) = 6666638 
MassLSP(2) = Abs(MSs(2))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGSs(3))),MSs(3),"# "//Trim(NameParticleSs(3))// "" 
If (MassLSP(1).gt.Abs(MSs(3))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 6666639 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MSs(3))
Else 
If (MassLSP(2).gt.Abs(MSs(3))) Then 
PDGLSP(2) = 6666639 
MassLSP(2) = Abs(MSs(3))
End if 
End if 
...
End if 
End if 
 Write(io_L,102) INT(Abs(PDGNv0(1))),MNv0(1),"# "//Trim(NameParticleNv0(1))// "" 
If (MassLSP(1).gt.Abs(MNv0(1))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 210000001 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MNv0(1))
Else 
If (MassLSP(2).gt.Abs(MNv0(1))) Then 
PDGLSP(2) = 210000001 
MassLSP(2) = Abs(MNv0(1))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGNv0(2))),MNv0(2),"# "//Trim(NameParticleNv0(2))// "" 
If (MassLSP(1).gt.Abs(MNv0(2))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 210000002 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MNv0(2))
Else 
If (MassLSP(2).gt.Abs(MNv0(2))) Then 
PDGLSP(2) = 210000002 
MassLSP(2) = Abs(MNv0(2))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGNv0(3))),MNv0(3),"# "//Trim(NameParticleNv0(3))// "" 
If (MassLSP(1).gt.Abs(MNv0(3))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 210000003 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MNv0(3))
Else 
If (MassLSP(2).gt.Abs(MNv0(3))) Then 
PDGLSP(2) = 210000003 
MassLSP(2) = Abs(MNv0(3))
End if 
End if 
...
Write(io_L,106) "Block ZvN Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(ZvN(1,1),dp), "# Real(ZvN(1,1),dp)" 
Write(io_L,107)1,2,Real(ZvN(1,2),dp), "# Real(ZvN(1,2),dp)" 
Write(io_L,107)1,3,Real(ZvN(1,3),dp), "# Real(ZvN(1,3),dp)" 
Write(io_L,107)2,1,Real(ZvN(2,1),dp), "# Real(ZvN(2,1),dp)" 
Write(io_L,107)2,2,Real(ZvN(2,2),dp), "# Real(ZvN(2,2),dp)" 
Write(io_L,107)2,3,Real(ZvN(2,3),dp), "# Real(ZvN(2,3),dp)" 
Write(io_L,107)3,1,Real(ZvN(3,1),dp), "# Real(ZvN(3,1),dp)" 
Write(io_L,107)3,2,Real(ZvN(3,2),dp), "# Real(ZvN(3,2),dp)" 
Write(io_L,107)3,3,Real(ZvN(3,3),dp), "# Real(ZvN(3,3),dp)" 
If (MaxVal(Abs(AImag(ZvN))).gt.0._dp) Then 
Write(io_L,106) "Block IMZvN Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(ZvN(1,1)), "# Aimag(ZvN(1,1))" 
Write(io_L,107)1,2,Aimag(ZvN(1,2)), "# Aimag(ZvN(1,2))" 
Write(io_L,107)1,3,Aimag(ZvN(1,3)), "# Aimag(ZvN(1,3))" 
Write(io_L,107)2,1,Aimag(ZvN(2,1)), "# Aimag(ZvN(2,1))" 
Write(io_L,107)2,2,Aimag(ZvN(2,2)), "# Aimag(ZvN(2,2))" 
Write(io_L,107)2,3,Aimag(ZvN(2,3)), "# Aimag(ZvN(2,3))" 
Write(io_L,107)3,1,Aimag(ZvN(3,1)), "# Aimag(ZvN(3,1))" 
Write(io_L,107)3,2,Aimag(ZvN(3,2)), "# Aimag(ZvN(3,2))" 
Write(io_L,107)3,3,Aimag(ZvN(3,3)), "# Aimag(ZvN(3,3))" 
End If 

Write(io_L,106) "Block VVMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block IMVVMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block VSs Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(VSs(1,1),dp), "# Real(VSs(1,1),dp)" 
Write(io_L,107)1,2,Real(VSs(1,2),dp), "# Real(VSs(1,2),dp)" 
Write(io_L,107)1,3,Real(VSs(1,3),dp), "# Real(VSs(1,3),dp)" 
Write(io_L,107)2,1,Real(VSs(2,1),dp), "# Real(VSs(2,1),dp)" 
Write(io_L,107)2,2,Real(VSs(2,2),dp), "# Real(VSs(2,2),dp)" 
Write(io_L,107)2,3,Real(VSs(2,3),dp), "# Real(VSs(2,3),dp)" 
Write(io_L,107)3,1,Real(VSs(3,1),dp), "# Real(VSs(3,1),dp)" 
Write(io_L,107)3,2,Real(VSs(3,2),dp), "# Real(VSs(3,2),dp)" 
Write(io_L,107)3,3,Real(VSs(3,3),dp), "# Real(VSs(3,3),dp)" 
If (MaxVal(Abs(AImag(VSs))).gt.0._dp) Then 
Write(io_L,106) "Block IMVSs Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(VSs(1,1)), "# Aimag(VSs(1,1))" 
Write(io_L,107)1,2,Aimag(VSs(1,2)), "# Aimag(VSs(1,2))" 
Write(io_L,107)1,3,Aimag(VSs(1,3)), "# Aimag(VSs(1,3))" 
Write(io_L,107)2,1,Aimag(VSs(2,1)), "# Aimag(VSs(2,1))" 
Write(io_L,107)2,2,Aimag(VSs(2,2)), "# Aimag(VSs(2,2))" 
Write(io_L,107)2,3,Aimag(VSs(2,3)), "# Aimag(VSs(2,3))" 
Write(io_L,107)3,1,Aimag(VSs(3,1)), "# Aimag(VSs(3,1))" 
Write(io_L,107)3,2,Aimag(VSs(3,2)), "# Aimag(VSs(3,2))" 
Write(io_L,107)3,3,Aimag(VSs(3,3)), "# Aimag(VSs(3,3))" 
End If 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,10:183)).Gt.BRmin) Then 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFre)//"^* "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If (BRFu(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFu(gt1) 
CurrentPDG3(2) = PDGNv0(gt2) 
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,10:183)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFre)//"^* "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,10:183)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFre)//"^* "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Do gt1= 1, 3
  Do gt2= gt1, 3
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGNv0(gt1) 
CurrentPDG2(2) = PDGNv0(gt2) 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Do gt1= 1, 3
  Do gt2= gt1, 3
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSs(gt1) 
CurrentPDG2(2) = PDGSs(gt2) 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleSs(gt2))//" "//")"
If (((gTSs(gt1).le.WidthToBeInvisible).and.(gTSs(gt2).le.WidthToBeInvisible)).OR. & 
...
If(gTSs(1).gt.MinWidth) Then 
Write(io_L,200) INT(PDGSs(1)),gTSs(1),Trim(NameParticleSs(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
  Do gt2=1, 3
...
Write(io_L,201) BRSs(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt2))//" "//")"
Write(io_L,201) BRSs(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
...
Write(io_L,201) BRSs(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRSs(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSs(1,16:189)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
    Do gt3=1,3
...
CurrentPDG3(2) = PDGHp 
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleHp)//" "//Trim(NameParticleNv0(gt3))//" "//")"
Write(io_L,202) BRSs(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleHp)//"^* "//Trim(NameParticleNv0(gt3))//"^* "//")"
End if 
icount = icount +1 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
If (BRSs(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGSs(gt1) 
CurrentPDG3(2) = PDGFe(gt2) 
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSs(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSs(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleAh)//" "//Trim(NameParticleFe(gt3))//"^* "//")"
Write(io_L,202) BRSs(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleAh)//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGHp 
Write(io_L,202) BRSs(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleHp)//" "//")"
Write(io_L,202) BRSs(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleHp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSs(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt3))//"^* "//")"
Write(io_L,202) BRSs(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticlehh)//"^* "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
...
If (BRSs(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFre 
CurrentPDG3(2) = PDGSs(gt2) 
CurrentPDG3(3) = -PDGFre 
Write(io_L,202) BRSs(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleSs(gt2))//" "//Trim(NameParticleFre)//"^* "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleAh)//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(1) = PDGFv(gt1) 
CurrentPDG3(2) = PDGFv(gt2) 
CurrentPDG3(3) = PDGSs(gt3) 
Write(io_L,202) BRSs(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleSs(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSs(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSs(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(1))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
If(gTSs(2).gt.MinWidth) Then 
Write(io_L,200) INT(PDGSs(2)),gTSs(2),Trim(NameParticleSs(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
  Do gt2=1, 3
If (BRSs(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFre 
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRSs(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt2))//" "//")"
Write(io_L,201) BRSs(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(1) = PDGNv0(gt1) 
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRSs(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRSs(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSs(2,16:189)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
    Do gt3=1,3
...
CurrentPDG3(2) = PDGHp 
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleHp)//" "//Trim(NameParticleNv0(gt3))//" "//")"
Write(io_L,202) BRSs(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleHp)//"^* "//Trim(NameParticleNv0(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(2) = PDGFe(gt2) 
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSs(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSs(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleAh)//" "//Trim(NameParticleFe(gt3))//"^* "//")"
Write(io_L,202) BRSs(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleAh)//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGHp 
Write(io_L,202) BRSs(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleHp)//" "//")"
Write(io_L,202) BRSs(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleHp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSs(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt3))//"^* "//")"
Write(io_L,202) BRSs(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticlehh)//"^* "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = -PDGFre 
Write(io_L,202) BRSs(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleSs(gt2))//" "//Trim(NameParticleFre)//"^* "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleAh)//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGSs(gt3) 
Write(io_L,202) BRSs(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleSs(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSs(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSs(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(2))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
If(gTSs(3).gt.MinWidth) Then 
Write(io_L,200) INT(PDGSs(3)),gTSs(3),Trim(NameParticleSs(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
  Do gt2=1, 3
If (BRSs(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFre 
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRSs(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt2))//" "//")"
Write(io_L,201) BRSs(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(1) = PDGNv0(gt1) 
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRSs(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRSs(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSs(3,16:189)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
    Do gt3=1,3
...
CurrentPDG3(2) = PDGHp 
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleHp)//" "//Trim(NameParticleNv0(gt3))//" "//")"
Write(io_L,202) BRSs(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleHp)//"^* "//Trim(NameParticleNv0(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(2) = PDGFe(gt2) 
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSs(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSs(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleAh)//" "//Trim(NameParticleFe(gt3))//"^* "//")"
Write(io_L,202) BRSs(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleAh)//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGHp 
Write(io_L,202) BRSs(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleHp)//" "//")"
Write(io_L,202) BRSs(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleHp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSs(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt3))//"^* "//")"
Write(io_L,202) BRSs(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticlehh)//"^* "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = -PDGFre 
Write(io_L,202) BRSs(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleSs(gt2))//" "//Trim(NameParticleFre)//"^* "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleAh)//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGSs(gt3) 
Write(io_L,202) BRSs(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleSs(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRSs(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSs(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSs(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSs(3))//" -> "//Trim(NameParticleSs(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If(gTNv0(1).gt.MinWidth) Then 
Write(io_L,200) INT(PDGNv0(1)),gTNv0(1),Trim(NameParticleNv0(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BRNv0(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFre 
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRNv0(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRNv0(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
...
Write(io_L,201) BRNv0(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSs(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRNv0(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRNv0(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRNv0(1,17:172)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
  Do gt2=1,3
    Do gt3=1,3
...
CurrentPDG3(2) = -PDGFd(gt2) 
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRNv0(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
Write(io_L,202) BRNv0(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRNv0(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFv(gt3))//" "//")"
Write(io_L,202) BRNv0(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
...
Do gt1=1,3
If (BRNv0(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGNv0(gt1) 
CurrentPDG3(2) = -PDGFre 
CurrentPDG3(3) = PDGFre 
Write(io_L,202) BRNv0(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFre)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRNv0(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRNv0(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRNv0(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRNv0(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRNv0(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(1))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
If(gTNv0(2).gt.MinWidth) Then 
Write(io_L,200) INT(PDGNv0(2)),gTNv0(2),Trim(NameParticleNv0(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BRNv0(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFre 
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRNv0(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRNv0(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGSs(gt2) 
Write(io_L,201) BRNv0(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSs(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRNv0(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRNv0(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRNv0(2,17:172)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
  Do gt2=1,3
    Do gt3=1,3
...
CurrentPDG3(2) = -PDGFd(gt2) 
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRNv0(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
Write(io_L,202) BRNv0(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRNv0(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFv(gt3))//" "//")"
Write(io_L,202) BRNv0(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(2) = -PDGFre 
CurrentPDG3(3) = PDGFre 
Write(io_L,202) BRNv0(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFre)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRNv0(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRNv0(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRNv0(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRNv0(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRNv0(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(2))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
If(gTNv0(3).gt.MinWidth) Then 
Write(io_L,200) INT(PDGNv0(3)),gTNv0(3),Trim(NameParticleNv0(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BRNv0(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFre 
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRNv0(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BRNv0(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGSs(gt2) 
Write(io_L,201) BRNv0(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSs(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRNv0(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRNv0(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRNv0(3,17:172)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
  Do gt2=1,3
    Do gt3=1,3
...
CurrentPDG3(2) = -PDGFd(gt2) 
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRNv0(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
Write(io_L,202) BRNv0(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRNv0(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFv(gt3))//" "//")"
Write(io_L,202) BRNv0(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(2) = -PDGFre 
CurrentPDG3(3) = PDGFre 
Write(io_L,202) BRNv0(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFre)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRNv0(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRNv0(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRNv0(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRNv0(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGNv0(gt3) 
Write(io_L,202) BRNv0(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleNv0(3))//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleNv0(gt2))//" "//Trim(NameParticleNv0(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRFre(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFre)//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleSs(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRFre(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFre)//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFre(1,14:67)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,202) BRFre(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFre)//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRFre(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFre)//" -> "//Trim(NameParticleNv0(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.radinertT13A",status="unknown")
Write(123,*) "# Couplings and VEVs" 
 
Write(123,*) "" 
Write(123,*) "LSH11_r= ",Real(LSH(1,1),dp)
Write(123,*) "LSH12_r= ",Real(LSH(1,2),dp)
Write(123,*) "LSH13_r= ",Real(LSH(1,3),dp)
Write(123,*) "LSH21_r= ",Real(LSH(2,1),dp)
Write(123,*) "LSH22_r= ",Real(LSH(2,2),dp)
Write(123,*) "LSH23_r= ",Real(LSH(2,3),dp)
Write(123,*) "LSH31_r= ",Real(LSH(3,1),dp)
Write(123,*) "LSH32_r= ",Real(LSH(3,2),dp)
Write(123,*) "LSH33_r= ",Real(LSH(3,3),dp)
Write(123,*) "LSH11_i= ",AImag(LSH(1,1))
Write(123,*) "LSH12_i= ",AImag(LSH(1,2))
Write(123,*) "LSH13_i= ",AImag(LSH(1,3))
Write(123,*) "LSH21_i= ",AImag(LSH(2,1))
Write(123,*) "LSH22_i= ",AImag(LSH(2,2))
Write(123,*) "LSH23_i= ",AImag(LSH(2,3))
Write(123,*) "LSH31_i= ",AImag(LSH(3,1))
Write(123,*) "LSH32_i= ",AImag(LSH(3,2))
Write(123,*) "LSH33_i= ",AImag(LSH(3,3))
Write(123,*) "YR3= ",YR3
Write(123,*) "YR111= ",YR1(1,1)
Write(123,*) "YR112= ",YR1(1,2)
Write(123,*) "YR113= ",YR1(1,3)
Write(123,*) "YR121= ",YR1(2,1)
Write(123,*) "YR122= ",YR1(2,2)
Write(123,*) "YR123= ",YR1(2,3)
Write(123,*) "YR131= ",YR1(3,1)
Write(123,*) "YR132= ",YR1(3,2)
Write(123,*) "YR133= ",YR1(3,3)
Write(123,*) "YR4= ",YR4
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "MSs1= ", Abs(MSs(1)) 
Write(123,*) "MSs2= ", Abs(MSs(2)) 
Write(123,*) "MSs3= ", Abs(MSs(3)) 
...
Write(123,*) "MNv01= ", Abs(MNv0(1)) 
Write(123,*) "MNv02= ", Abs(MNv0(2)) 
Write(123,*) "MNv03= ", Abs(MNv0(3)) 
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "Wh = ",gThh
Write(123,*) "WSs1 = ",gTSs(1)
Write(123,*) "WSs2 = ",gTSs(2)
Write(123,*) "WSs3 = ",gTSs(3)
Write(123,*) "WNv01 = ",gTNv0(1)
Write(123,*) "WNv02 = ",gTNv0(2)
Write(123,*) "WNv03 = ",gTNv0(3)
Write(123,*) "WRe = ",gTFre
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "" 
If (MNv0(1).Gt.0._dp) Then 
Write(123,*) "ZvN11_r = ", Real(ZvN(1,1),dp)
Write(123,*) "ZvN11_i = ", AImag(ZvN(1,1))
Write(123,*) "ZvN12_r = ", Real(ZvN(1,2),dp)
Write(123,*) "ZvN12_i = ", AImag(ZvN(1,2))
Write(123,*) "ZvN13_r = ", Real(ZvN(1,3),dp)
Write(123,*) "ZvN13_i = ", AImag(ZvN(1,3))
Else 
Write(123,*) "ZvN11_i = ", Real(ZvN(1,1),dp)
Write(123,*) "ZvN11_r = ", -AImag(ZvN(1,1))
Write(123,*) "ZvN12_i = ", Real(ZvN(1,2),dp)
Write(123,*) "ZvN12_r = ", -AImag(ZvN(1,2))
Write(123,*) "ZvN13_i = ", Real(ZvN(1,3),dp)
Write(123,*) "ZvN13_r = ", -AImag(ZvN(1,3))
End if 
If (MNv0(2).Gt.0._dp) Then 
Write(123,*) "ZvN21_r = ", Real(ZvN(2,1),dp)
Write(123,*) "ZvN21_i = ", AImag(ZvN(2,1))
Write(123,*) "ZvN22_r = ", Real(ZvN(2,2),dp)
Write(123,*) "ZvN22_i = ", AImag(ZvN(2,2))
Write(123,*) "ZvN23_r = ", Real(ZvN(2,3),dp)
Write(123,*) "ZvN23_i = ", AImag(ZvN(2,3))
Else 
Write(123,*) "ZvN21_i = ", Real(ZvN(2,1),dp)
Write(123,*) "ZvN21_r = ", -AImag(ZvN(2,1))
Write(123,*) "ZvN22_i = ", Real(ZvN(2,2),dp)
Write(123,*) "ZvN22_r = ", -AImag(ZvN(2,2))
Write(123,*) "ZvN23_i = ", Real(ZvN(2,3),dp)
Write(123,*) "ZvN23_r = ", -AImag(ZvN(2,3))
End if 
If (MNv0(3).Gt.0._dp) Then 
Write(123,*) "ZvN31_r = ", Real(ZvN(3,1),dp)
Write(123,*) "ZvN31_i = ", AImag(ZvN(3,1))
Write(123,*) "ZvN32_r = ", Real(ZvN(3,2),dp)
Write(123,*) "ZvN32_i = ", AImag(ZvN(3,2))
Write(123,*) "ZvN33_r = ", Real(ZvN(3,3),dp)
Write(123,*) "ZvN33_i = ", AImag(ZvN(3,3))
Else 
Write(123,*) "ZvN31_i = ", Real(ZvN(3,1),dp)
Write(123,*) "ZvN31_r = ", -AImag(ZvN(3,1))
Write(123,*) "ZvN32_i = ", Real(ZvN(3,2),dp)
Write(123,*) "ZvN32_r = ", -AImag(ZvN(3,2))
Write(123,*) "ZvN33_i = ", Real(ZvN(3,3),dp)
Write(123,*) "ZvN33_r = ", -AImag(ZvN(3,3))
End if 
...
End if 
If (MSs(1).Gt.0._dp) Then 
Write(123,*) "VSs11_r = ", Real(VSs(1,1),dp)
Write(123,*) "VSs11_i = ", AImag(VSs(1,1))
Write(123,*) "VSs12_r = ", Real(VSs(1,2),dp)
Write(123,*) "VSs12_i = ", AImag(VSs(1,2))
Write(123,*) "VSs13_r = ", Real(VSs(1,3),dp)
Write(123,*) "VSs13_i = ", AImag(VSs(1,3))
Else 
Write(123,*) "VSs11_i = ", Real(VSs(1,1),dp)
Write(123,*) "VSs11_r = ", -AImag(VSs(1,1))
Write(123,*) "VSs12_i = ", Real(VSs(1,2),dp)
Write(123,*) "VSs12_r = ", -AImag(VSs(1,2))
Write(123,*) "VSs13_i = ", Real(VSs(1,3),dp)
Write(123,*) "VSs13_r = ", -AImag(VSs(1,3))
End if 
If (MSs(2).Gt.0._dp) Then 
Write(123,*) "VSs21_r = ", Real(VSs(2,1),dp)
Write(123,*) "VSs21_i = ", AImag(VSs(2,1))
Write(123,*) "VSs22_r = ", Real(VSs(2,2),dp)
Write(123,*) "VSs22_i = ", AImag(VSs(2,2))
Write(123,*) "VSs23_r = ", Real(VSs(2,3),dp)
Write(123,*) "VSs23_i = ", AImag(VSs(2,3))
Else 
Write(123,*) "VSs21_i = ", Real(VSs(2,1),dp)
Write(123,*) "VSs21_r = ", -AImag(VSs(2,1))
Write(123,*) "VSs22_i = ", Real(VSs(2,2),dp)
Write(123,*) "VSs22_r = ", -AImag(VSs(2,2))
Write(123,*) "VSs23_i = ", Real(VSs(2,3),dp)
Write(123,*) "VSs23_r = ", -AImag(VSs(2,3))
End if 
If (MSs(3).Gt.0._dp) Then 
Write(123,*) "VSs31_r = ", Real(VSs(3,1),dp)
Write(123,*) "VSs31_i = ", AImag(VSs(3,1))
Write(123,*) "VSs32_r = ", Real(VSs(3,2),dp)
Write(123,*) "VSs32_i = ", AImag(VSs(3,2))
Write(123,*) "VSs33_r = ", Real(VSs(3,3),dp)
Write(123,*) "VSs33_i = ", AImag(VSs(3,3))
Else 
Write(123,*) "VSs31_i = ", Real(VSs(3,1),dp)
Write(123,*) "VSs31_r = ", -AImag(VSs(3,1))
Write(123,*) "VSs32_i = ", Real(VSs(3,2),dp)
Write(123,*) "VSs32_r = ", -AImag(VSs(3,2))
Write(123,*) "VSs33_i = ", Real(VSs(3,3),dp)
Write(123,*) "VSs33_r = ", -AImag(VSs(3,3))
End if 
...
Subroutine Read_YR3IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
YR3IN= wert 
InputValueforYR3= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YR3IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYR3IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YR3IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYR3IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YR3IN 
 
 
Subroutine Read_YR4IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
YR4IN= wert 
InputValueforYR4= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YR4IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYR4IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YR4IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYR4IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YR4IN 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) MnIN= Cmplx(wert,Aimag(MnIN),dp) 
If (i_c.Eq.1) MnIN= Cmplx(Real(MnIN,dp),wert,dp) 
InputValueforMn= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MNIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMNIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MNIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMNIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
...
End Module InputOutput_radinertT13A 
