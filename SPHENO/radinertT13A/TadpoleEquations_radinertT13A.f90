...
Subroutine SolveTadpoleEquations(g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,               & 
& Mn,MDF,mu2,MS2,v,Tad1Loop)

Implicit None
Real(dp),Intent(inout) :: g1,g2,g3,YR3,YR1(3,3),YR4,MS2(3,3),v
...
Subroutine CalculateTadpoles(g1,g2,g3,Lam,LSH,Yu,Yd,Ye,YR3,YR1,YR4,Mn,MDF,            & 
& mu2,MS2,v,Tad1Loop,TadpoleValues)
...
End Module Tadpoles_radinertT13A 
