...
& LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12)

Implicit None 
Real(dp), Intent(in) :: g(107) 
Real(dp),Intent(out) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,M1,mu32,MU22,MU12
...
& LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,g)
...
& betaLAM32,DLAM3,M1,betaM11,betaM12,DM1,mu32,betamu321,betamu322,Dmu32,MU22,            & 
& betaMU221,betaMU222,DMU22,MU12,betaMU121,betaMU122,DMU12
...
& LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12)
...
& DLAM4,DLAM2,DLAM3,DYDR,DYL1,DYQ1,DYL2,DYQ2,DM1,Dmu32,DMU22,DMU12,f)
...
& LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR)

Implicit None 
Real(dp), Intent(in) :: g(110) 
Real(dp),Intent(out) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,M1,mu32,MU22,               & 
& MU12,vd,vu,vR
...
& LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,g)
...
& betaLAM41,betaLAM42,DLAM4,LAM2,betaLAM21,betaLAM22,DLAM2,LAM3,betaLAM31,               & 
& betaLAM32,DLAM3,M1,betaM11,betaM12,DM1,mu32,betamu321,betamu322,Dmu32,MU22,            & 
& betaMU221,betaMU222,DMU22,MU12,betaMU121,betaMU122,DMU12,vd,betavd1,betavd2,           & 
& Dvd,vu,betavu1,betavu2,Dvu,vR,betavR1,betavR2,DvR
Complex(dp) :: YDR(3,3),betaYDR1(3,3),betaYDR2(3,3),DYDR(3,3),adjYDR(3,3)             & 
& ,YL1(3,3),betaYL11(3,3),betaYL12(3,3),DYL1(3,3),adjYL1(3,3),YQ1(3,3),betaYQ11(3,3)     & 
& ,betaYQ12(3,3),DYQ1(3,3),adjYQ1(3,3),YL2(3,3),betaYL21(3,3),betaYL22(3,3)              & 
& ,DYL2(3,3),adjYL2(3,3),YQ2(3,3),betaYQ21(3,3),betaYQ22(3,3),DYQ2(3,3),adjYQ2(3,3)
...
& LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR)
...
& DLAM4,DLAM2,DLAM3,DYDR,DYL1,DYQ1,DYL2,DYQ2,DM1,Dmu32,DMU22,DMU12,Dvd,Dvu,DvR,f)

Iname = Iname - 1 
 
End Subroutine rge110  

End Module RGEs_LRmodelsTRDM 
