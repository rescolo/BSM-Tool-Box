...
Program SPhenoLRmodelsTRDM 
 
Use Control
Use InputOutput_LRmodelsTRDM
Use LoopFunctions
Use RunSM_LRmodelsTRDM
Use LowEnergy_LRmodelsTRDM
Use FlavorKit_LFV_LRmodelsTRDM
Use FlavorKit_QFV_LRmodelsTRDM
Use FlavorKit_Observables_LRmodelsTRDM
Use Mathematics
Use Model_Data_LRmodelsTRDM
Use Tadpoles_LRmodelsTRDM 
 Use HiggsCS_LRmodelsTRDM
Use TreeLevelMasses_LRmodelsTRDM
Use LoopMasses_LRmodelsTRDM
 
Use BranchingRatios_LRmodelsTRDM
...
Call OneLoopMasses(MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFc,MFc2,MFcp,MFcp2,MFd,             & 
...
& YQ1,YL2,YQ2,M1,mu32,MU22,MU12,kont)
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,vd,vu,vR,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,              & 
& LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,gPFu,gTFu,BRFu,gPFe,              & 
& gTFe,BRFe,gPFd,gTFd,BRFd,gPhh,gThh,BRhh,gPFv,gTFv,BRFv,gPVZ,gTVZ,BRVZ,gPVZR,           & 
& gTVZR,BRVZR,gPdeltaRpp,gTdeltaRpp,BRdeltaRpp,gPHpm,gTHpm,BRHpm,gPAh,gTAh,              & 
& BRAh,gPVWLm,gTVWLm,BRVWLm,gPVWRm,gTVWRm,BRVWRm)
...
& ALP2,LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,ae,amu,             & 
& atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,BrDmunu,ratioDmunu,BrDsmunu,        & 
...
& g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,           & 
& MU22,MU12,kont)
...
& LAM3input,YDRinput,YL1input,YQ1input,YL2input,YQ2input,M1input,mu32input,              & 
& MU22input,MU12input,vdinput,vuinput,vRinput,ae,amu,atau,EDMe,EDMmu,EDMtau,             & 
...
& cplcdeltaRppcVWLmcVWLm,cplcdeltaRppcVWLmcVWRm,cplcdeltaRppcVWRmcVWRm,cplcFcpFccVWLmL,  & 
& cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFcpFcpVPL,cplcFcpFcpVPR,           & 
& cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdAhL(3,3,3),          & 
...
& cpldeltaRppVWLmVWLm,cpldeltaRppVWLmVWRm,cpldeltaRppVWRmVWRm,cplFcFcpVWLmL,             & 
& cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,cplFeFecdeltaRppL(3,3),cplFeFecdeltaRppR(3,3),& 
...
Complex(dp) :: cplFvFvhhL(6,6,3),cplFvFvhhR(6,6,3),cplFvFvVPL(6,6),cplFvFvVPR(6,6),cplFvFvVZL(6,6),   & 
& cplFvFvVZR(6,6),cplFvFvVZRL(6,6),cplFvFvVZRR(6,6),cplhhcHpmVWLm(3,3),cplhhcHpmVWRm(3,3),& 
& cplhhcVWLmVWLm(3),cplhhcVWLmVWRm(3),cplhhcVWRmVWLm(3),cplhhcVWRmVWRm(3),               & 
& cplhhhhcVWLmVWLm(3,3),cplhhhhhh(3,3,3),cplhhhhVZVZ(3,3),cplhhHpmcHpm(3,3,3),           & 
& cplhhHpmcVWLm(3,3),cplhhHpmcVWRm(3,3),cplhhVPVZ(3),cplhhVPVZR(3),cplhhVZRVZR(3),       & 
& cplhhVZVZ(3),cplhhVZVZR(3),cplHpmcHpmcVWLmVWLm(3,3),cplHpmcHpmVP(3,3),cplHpmcHpmVZ(3,3),& 
& cplHpmcHpmVZR(3,3),cplHpmcHpmVZVZ(3,3),cplHpmcVWLmVP(3),cplHpmcVWLmVZ(3),              & 
& cplHpmcVWLmVZR(3),cplHpmcVWRmVP(3),cplHpmcVWRmVZ(3),cplHpmcVWRmVZR(3),cplVGVGVG
...
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,M1input,mu32input,MU22input,              & 
& MU12input,vdinput,vuinput,vRinput,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,               & 
& ALP2,LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,CKM_160,            & 
...
& cplFvFvhhL,cplFvFvhhR,cplcFeFvcHpmL,cplcFeFvcHpmR,cplFcFcpVWLmL,cplFcFcpVWLmR,         & 
...
& cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,         & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,       & 
& cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplFvFeVWLmL,cplFvFeVWLmR,cplFvFeVWRmL,cplFvFeVWRmR,     & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,             & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWLmL,cplcFdFuVWLmR,           & 
& cplcFdFuVWRmL,cplcFdFuVWRmR,cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,         & 
& cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZRL,cplFvFvVZRR,cplcFeFvcVWLmL,    & 
& cplcFeFvcVWLmR,cplcFeFvcVWRmL,cplcFeFvcVWRmR)
...
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,M1input,mu32input,MU22input,              & 
& MU12input,vdinput,vuinput,vRinput,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,               & 
& ALP2,LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,CKM_MZ,             & 
& sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
Call DeltaRho(MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFc,MFc2,MFcp,MFcp2,MFd,MFd2,             & 
& MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,              & 
& MVZ,MVZ2,MVZR,MVZR2,cplAhAhcVWLmVWLm,cplAhAhVZVZ,cplAhcVWLmVWRm,cplAhhhVZ,             & 
& cplAhHpmcVWLm,cplcdeltaRppcHpmcVWLm,cplcdeltaRppcVWLmcVWLm,cplcdeltaRppcVWLmcVWRm,     & 
& cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFdFdVZL,               & 
...
End Program SPhenoLRmodelsTRDM 
