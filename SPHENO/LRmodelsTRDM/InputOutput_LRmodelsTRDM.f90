...
Module InputOutput_LRmodelsTRDM 
...
& PDGFu(3),PDGFe(3),PDGFv(6),PDGFcp,PDGFc
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - LRmodels/TRDM Spectrum + Decays + Flavor Observables"
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,28:276)).Gt.BRmin) Then 
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,28:276)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,28:276)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,40:291)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,40:291)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,40:291)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFc 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFcp)//" "//Trim(NameParticleFc)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,28:276)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,28:276)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,28:276)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(1,46:459)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(2,46:459)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(3,46:459)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(4,46:459)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(5,46:459)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(6,46:459)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.LRmodelsTRDM",status="unknown")
...
End Module InputOutput_LRmodelsTRDM 
