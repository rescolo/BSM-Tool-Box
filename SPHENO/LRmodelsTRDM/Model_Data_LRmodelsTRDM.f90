...
Module Model_Data_LRmodelsTRDM 
...
Complex(dp) :: CG1(2, 3, 2) 
 Real(dp) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,M1,mu32,MU22,MU12
...
& LAM3IN,M1IN,mu32IN,MU22IN,MU12IN
...
& LAM3MZ,M1MZ,mu32MZ,MU22MZ,MU12MZ
...
& LAM4GUT,LAM2GUT,LAM3GUT,M1GUT,mu32GUT,MU22GUT,MU12GUT
...
Real(dp) :: gPFu(3,276),gTFu(3),BRFu(3,276),gPFe(3,291),gTFe(3),BRFe(3,291),gPFd(3,276),          & 
...
End Module Model_Data_LRmodelsTRDM