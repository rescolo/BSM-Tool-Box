...
! ------------------------------------------------------------------------------  
! File created at 20:18 on 26.10.2016   
! ----------------------------------------------------------------------  
 
 
Module CouplingsForDecays_LRmodelsTRDM
 
Use Control 
Use Model_Data_LRmodelsTRDM 
Use Couplings_LRmodelsTRDM 
Use LoopCouplings_LRmodelsTRDM 
...
& MdeltaRpp2input,MFcinput,MFc2input,MFcpinput,MFcp2input,MFdinput,MFd2input,            & 
& MFeinput,MFe2input,MFuinput,MFu2input,MFvinput,MFv2input,Mhhinput,Mhh2input,           & 
& MHpminput,MHpm2input,MVWLminput,MVWLm2input,MVWRminput,MVWRm2input,MVZinput,           & 
& MVZ2input,MVZRinput,MVZR2input,PhiWinput,UVinput,TWinput,UCinput,ZDRinput,             & 
& ZERinput,UPinput,ZURinput,ZDLinput,ZELinput,ZULinput,ZHinput,ZWinput,ZZinput,          & 
& gBLinput,g2input,gRinput,g3input,RHO2input,RHO1input,ALP1input,LAM1input,              & 
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,M1input,mu32input,MU22input,         & 
...
& MFcpinput,MFcp2input,MFdinput(3),MFd2input(3),MFeinput(3),MFe2input(3),MFuinput(3),    & 
& MFu2input(3),MFvinput(6),MFv2input(6),Mhhinput(3),Mhh2input(3),MHpminput(3),           & 
& MHpm2input(3),MVWLminput,MVWLm2input,MVWRminput,MVWRm2input,MVZinput,MVZ2input,        & 
& MVZRinput,MVZR2input,PhiWinput,TWinput,UCinput(3,3),UPinput(3,3),ZHinput(3,3)
...
Real(dp) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,M1,mu32,MU22,               & 
& MU12,vd,vu,vR
...
Real(dp) :: MAh(3),MAh2(3),MdeltaRpp,MdeltaRpp2,MFc,MFc2,MFcp,MFcp2,MFd(3),MFd2(3),               & 
...
& YQ1,YL2,YQ2,M1,mu32,MU22,MU12,.True.,kont)
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
& vRinput,cplcFeFeAhL,cplcFeFeAhR,cplcFecFedeltaRppL,cplcFecFedeltaRppR,cplcFeFehhL,     & 
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
& vRinput,cplFvFvAhL,cplFvFvAhR,cplFvFeHpmL,cplFvFeHpmR,cplFvFeVWLmL,cplFvFeVWLmR,       & 
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
& vRinput,cplAhhhVZ,cpldeltaRppcdeltaRppVZ,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFdFdVZL,      & 
...
Complex(dp),Intent(out) :: cplAhhhVZ(3,3),cpldeltaRppcdeltaRppVZ,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFdFdVZL(3,3),   & 
& cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),  & 
& cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplhhVZVZ(3),cplhhVZVZR(3),cplHpmcHpmVZ(3,3),          & 
...
cplcFcpFcpVZL = 0._dp 
cplcFcpFcpVZR = 0._dp 
Call CouplingcFcpFcpVZT(gR,ZZ,cplcFcpFcpVZL,cplcFcpFcpVZR)
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
& vRinput,cplAhhhVZR,cpldeltaRppcdeltaRppVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,              & 
...
Complex(dp),Intent(out) :: cplAhhhVZR(3,3),cpldeltaRppcdeltaRppVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdVZRL(3,3),& 
...
Call CouplingcFcpFcpVZRT(gR,ZZ,cplcFcpFcpVZRL,cplcFcpFcpVZRR)
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
& vRinput,cpldeltaRpphhcdeltaRpp,cpldeltaRppcdeltaRppVZ,cpldeltaRppcdeltaRppVZR,         & 
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
& vRinput,cplAhHpmcVWLm,cplAhcVWLmVWRm,cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFuFdcVWLmL,   & 
...
Complex(dp),Intent(out) :: cplAhHpmcVWLm(3,3),cplAhcVWLmVWRm(3),cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFuFdcVWLmL(3,3),& 
& cplcFuFdcVWLmR(3,3),cplcFeFvcVWLmL(3,6),cplcFeFvcVWLmR(3,6),cplhhHpmcVWLm(3,3),        & 
& cplhhcVWLmVWLm(3),cplhhcVWLmVWRm(3),cplHpmcVWLmVZ(3),cplHpmcVWLmVZR(3),cplcVWLmVWLmVZ, & 
& cplcVWLmVWLmVZR,cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,cplcdeltaRppcHpmcVWLm(3),               & 
& cplcdeltaRppcVWLmcVWLm,cplcdeltaRppcVWLmcVWRm
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
& vRinput,cplAhHpmcVWRm,cplAhcVWRmVWLm,cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFuFdcVWRmL,   & 
...
Complex(dp),Intent(out) :: cplAhHpmcVWRm(3,3),cplAhcVWRmVWLm(3),cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFuFdcVWRmL(3,3),& 
& cplcFuFdcVWRmR(3,3),cplcFeFvcVWRmL(3,6),cplcFeFvcVWRmR(3,6),cplhhHpmcVWRm(3,3),        & 
& cplhhcVWRmVWLm(3),cplhhcVWRmVWRm(3),cplHpmcVWRmVZ(3),cplHpmcVWRmVZR(3),cplcVWRmVWLmVZ, & 
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
& vRinput,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdAhL,         & 
...
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplFcFcpVWLmL,           & 
& cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,cplFvFeHpmL,cplFvFeHpmR,cplFvFeVWLmL,        & 
...
Complex(dp),Intent(out) :: cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdAhL(3,3,3),         & 
...
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplcFuFuVZRL(3,3),cplcFuFuVZRR(3,3),cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,         & 
& cplFcFcpVWRmR,cplFvFeHpmL(6,3,3),cplFvFeHpmR(6,3,3),cplFvFeVWLmL(6,3),cplFvFeVWLmR(6,3),& 
& cplFvFeVWRmL(6,3),cplFvFeVWRmR(6,3),cplFvFvAhL(6,6,3),cplFvFvAhR(6,6,3),               & 
& cplFvFvhhL(6,6,3),cplFvFvhhR(6,6,3),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplFvFvVZRL(6,6),  & 
& cplFvFvVZRR(6,6)
...
cplFcFcpVWLmL = 0._dp 
cplFcFcpVWLmR = 0._dp 
Call CouplingFcFcpVWLmT(gR,PhiW,cplFcFcpVWLmL,cplFcFcpVWLmR)



cplFcFcpVWRmL = 0._dp 
cplFcFcpVWRmR = 0._dp 
Call CouplingFcFcpVWRmT(gR,PhiW,cplFcFcpVWRmL,cplFcFcpVWRmR)
...
& cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,       & 
& cplFcFcpVWRmR,cplFeFecdeltaRppL,cplFeFecdeltaRppR,cplFvFeHpmL,cplFvFeHpmR,             & 
...
& ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,          & 
& YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,vdinput,vuinput,               & 
& vRinput,cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,               & 
& cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdAhL,cplcFdFdAhR,     & 
...
Complex(dp),Intent(out) :: cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFcpFcpVZL,        & 
& cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),     & 
...
& cplcFuFuVZR(3,3),cplcFuFuVZRL(3,3),cplcFuFuVZRR(3,3),cplFvFvAhL(6,6,3),cplFvFvAhR(6,6,3),& 
& cplFvFvhhL(6,6,3),cplFvFvhhR(6,6,3),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplFvFvVZRL(6,6),  & 
& cplFvFvVZRR(6,6)
...
& cplcFeFvcVWRmL,cplcFeFvcVWRmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWLmL,              & 
& cplcFuFdcVWLmR,cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,      & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplFvFeHpmL,             & 
& cplFvFeHpmR,cplFvFeVWLmL,cplFvFeVWLmR,cplFvFeVWRmL,cplFvFeVWRmR,cplFvFvAhL,            & 
& cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZRL,cplFvFvVZRR,deltaM)
...
End Module CouplingsForDecays_LRmodelsTRDM
