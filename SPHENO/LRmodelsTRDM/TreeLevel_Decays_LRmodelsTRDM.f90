...
Module TreeLevelDecays_LRmodelsTRDM
 
Use Control 
Use DecayFunctions 
Use LoopCouplings_LRmodelsTRDM 
Use CouplingsForDecays_LRmodelsTRDM 
...
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,gPartial,gT,BR)

Implicit None 
 
Real(dp),Intent(in) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,M1,mu32,MU22,               & 
& MU12,vd,vu,vR,MAh(3),MAh2(3),MdeltaRpp,MdeltaRpp2,MFc,MFc2,MFcp,MFcp2,MFd(3),          & 
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplcFuFuAhL,cplcFuFuAhR,           & 
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplcFeFeAhL,cplcFeFeAhR,           & 
& cplcFecFedeltaRppL,cplcFecFedeltaRppR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,             & 
& cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,cplcFeFvcHpmL,cplcFeFvcHpmR,cplcFeFvcVWLmL,      & 
& cplcFeFvcVWLmR,cplcFeFvcVWRmL,cplcFeFvcVWRmR,deltaM)
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplcFdFdAhL,cplcFdFdAhR,           & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,             & 
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWLmL,cplcFdFuVWLmR,cplcFdFuVWRmL,cplcFdFuVWRmR,deltaM)
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplHiggsPP,cplHiggsGG,             & 
& cplHiggsZZvirt,cplHiggsWWvirt,cplAhAhhh,cplAhhhVZ,cplAhhhVZR,cpldeltaRpphhcdeltaRpp,   & 
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplFvFvAhL,cplFvFvAhR,             & 
...
Complex(dp) :: cplAhhhVZ(3,3),cpldeltaRppcdeltaRppVZ,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFdFdVZL(3,3),   & 
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplAhhhVZ,cpldeltaRppcdeltaRppVZ,  & 
...
Complex(dp) :: cplAhhhVZR(3,3),cpldeltaRppcdeltaRppVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdVZRL(3,3),& 
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplAhhhVZR,cpldeltaRppcdeltaRppVZR,& 
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cpldeltaRpphhcdeltaRpp,            & 
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplAhHpmcHpm,cplAhcHpmVWLm,        & 
& cplAhcHpmVWRm,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFeFvcHpmL,cplcFeFvcHpmR,cplhhHpmcHpm,    & 
& cplhhcHpmVWLm,cplhhcHpmVWRm,cplHpmcHpmVZ,cplHpmcHpmVZR,cplcHpmVWLmVZ,cplcHpmVWLmVZR,   & 
& cplcHpmVWRmVZ,cplcHpmVWRmVZR,cplcdeltaRppcHpmcHpm,cplcdeltaRppcHpmcVWLm,               & 
& cplcdeltaRppcHpmcVWRm,deltaM)
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplPseudoHiggsPP,cplPseudoHiggsGG, & 
...
Complex(dp) :: cplAhHpmcVWLm(3,3),cplAhcVWLmVWRm(3),cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFuFdcVWLmL(3,3),& 
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplAhHpmcVWLm,cplAhcVWLmVWRm,      & 
& cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplcFeFvcVWLmL,          & 
...
m1out = MFcp
m2out = MFc
coupL = cplcFcpFccVWLmL
coupR = cplcFcpFccVWLmR
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
Complex(dp) :: cplAhHpmcVWRm(3,3),cplAhcVWRmVWLm(3),cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFuFdcVWRmL(3,3),& 
...
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,            & 
& ZDL,ZEL,ZUL,ZH,ZW,ZZ,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,             & 
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplAhHpmcVWRm,cplAhcVWRmVWLm,      & 
& cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFeFvcVWRmL,          & 
...
m1out = MFcp
m2out = MFc
coupL = cplcFcpFccVWRmL
coupR = cplcFcpFccVWRmR
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
End Module TreeLevelDecays_LRmodelsTRDM 
