...
Module RunSM_LRmodelsTRDM 
 
Use Control 
Use LoopFunctions 
Use Mathematics 
Use StandardModel 
Use RGEs_LRmodelsTRDM 
...
& ALP2,LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,CKMout,             & 
...
& YL1input,YQ1input,YL2input,YQ2input,M1input,mu32input,MU22input,MU12input,             & 
