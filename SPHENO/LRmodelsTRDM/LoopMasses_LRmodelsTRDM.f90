...
! ------------------------------------------------------------------------------  
! File created at 20:10 on 26.10.2016   
! ----------------------------------------------------------------------  
 
 
Module LoopMasses_LRmodelsTRDM 
 
Use Control 
Use Couplings_LRmodelsTRDM 
Use LoopFunctions 
Use AddLoopFunctions 
Use Mathematics 
Use MathematicsQP 
Use Model_Data_LRmodelsTRDM 
Use StandardModel 
Use Tadpoles_LRmodelsTRDM 
 Use TreeLevelMasses_LRmodelsTRDM 
...
& YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,kont)

Implicit None 
Real(dp),Intent(inout) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,M1,mu32,MU22,MU12

Complex(dp),Intent(inout) :: YDR(3,3),YL1(3,3),YQ1(3,3),YL2(3,3),YQ2(3,3)

Real(dp),Intent(inout) :: MAh(3),MAh2(3),MdeltaRpp,MdeltaRpp2,MFc,MFc2,MFcp,MFcp2,MFd(3),MFd2(3),               & 
& MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(6),MFv2(6),Mhh(3),Mhh2(3),MHpm(3),MHpm2(3),          & 
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,TW,UC(3,3),UP(3,3),ZH(3,3)
...
& cplcdeltaRppcVWLmcVWRm,cplcdeltaRppcVWRmcVWRm,cplcFcpFccVWLmL,cplcFcpFccVWLmR,         & 
& cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFcpFcpVPL,cplcFcpFcpVPR,cplcFcpFcpVZL,             & 
& cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdUAhL(3,3,3),cplcFdFdUAhR(3,3,3),   & 
...
Complex(dp) :: cplcUFdFdVPL(3,3),cplcUFdFdVPR(3,3),cplcUFdFdVZL(3,3),cplcUFdFdVZR(3,3),               & 
...
& cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,cplFeFecdeltaRppL(3,3),        & 
...
Complex(dp) :: cplHpmcVWLmVZ(3),cplHpmcVWLmVZR(3),cplHpmcVWRmVP(3),cplHpmcVWRmVZ(3),cplHpmcVWRmVZR(3),& 
...
Call TreeMasses(MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFc,MFc2,MFcp,MFcp2,MFd,MFd2,           & 
& MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,              & 
& MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,vd,              & 
& vu,vR,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,YDR,YL1,               & 
& YQ1,YL2,YQ2,M1,mu32,MU22,MU12,GenerationMixing,kont)
...
Call CouplingsForVectorBosons(gR,PhiW,ZZ,gBL,UC,vR,g2,ZH,UP,UV,vd,vu,ZDL,             & 
& ZDR,ZUL,ZUR,ZEL,ZER,cplFcFcpVWLmL,cplFcFcpVWLmR,cplcFcpFccVWLmL,cplcFcpFccVWLmR,       & 
& cplcFcpFcpVZL,cplcFcpFcpVZR,cpldeltaRppcdeltaRppVZ,cplcdeltaRppcHpmcVWLm,              & 
& cplcdeltaRppcVWLmcVWLm,cplcdeltaRppcVWLmcVWRm,cpldeltaRppcdeltaRppcVWLmVWLm,           & 
& cpldeltaRppcdeltaRppVZVZ,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,    & 
...
& cplcFuFdcVWLmR,cplcFeFvcVWLmL,cplcFeFvcVWLmR,cplcgWLpgPcVWLm,cplcgWRpgPcVWLm,          & 
...
& cplhhHpmcVWLm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,cplHpmcVWLmVP,cplcVWLmVPVWLm,              & 
& cplcVWLmVPVWRm,cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,cplAhAhcVWLmVWLm,cplhhhhcVWLmVWLm,       & 
& cplHpmcHpmcVWLmVWLm,cplcVWLmVPVPVWLm1,cplcVWLmVPVPVWLm2,cplcVWLmVPVPVWLm3,             & 
& cplcVWLmcVWLmVWLmVWLm1,cplcVWLmcVWLmVWLmVWLm2,cplcVWLmcVWLmVWLmVWLm3,cplcVWLmcVWRmVWLmVWRm1,& 
& cplcVWLmcVWRmVWLmVWRm2,cplcVWLmcVWRmVWLmVWRm3,cplAhcVWRmVWLm,cplhhcVWRmVWLm,           & 
& cplcVWRmVPVWLm)

Call SolveTadpoleEquations(gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,           & 
& LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,(/ ZeroC, ZeroC, ZeroC /))
...
& cplUFvFvVZL,cplUFvFvVZR,cplUFvFvVZRL,cplUFvFvVZRR,cplFcFcpVWLmL,cplFcFcpVWLmR,         & 
& cplFcFcpVWRmL,cplFcFcpVWRmR,cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,           & 
& cplcFcpFccVWRmR,cplcFcpFcpVPL,cplcFcpFcpVPR,cplcFcpFcpVZL,cplcFcpFcpVZR,               & 
& cplcFcpFcpVZRL,cplcFcpFcpVZRR,cpldeltaRpphhcdeltaRpp,cpldeltaRppcdeltaRppVP,           & 
& cpldeltaRppcdeltaRppVZ,cpldeltaRppcdeltaRppVZR,cplFeFecdeltaRppL,cplFeFecdeltaRppR,    & 
...
mu32Tree  = mu32
Call SolveTadpoleEquations(gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,           & 
& LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,Tad1Loop)
...
Call OneLoopFc(M1,MVWLm,MVWLm2,MFcp,MFcp2,MVWRm,MVWRm2,cplFcFcpVWLmL,cplFcFcpVWLmR,   & 
& cplFcFcpVWRmL,cplFcFcpVWRmR,0.1_dp*delta_mass,MFc_1L,MFc2_1L,kont)

Call OneLoopFcp(M1,MVWLm,MVWLm2,MFc,MFc2,MVWRm,MVWRm2,MFcp,MFcp2,MVZ,MVZ2,            & 
& MVZR,MVZR2,cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,            & 
& cplcFcpFcpVPL,cplcFcpFcpVPR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR, & 
& 0.1_dp*delta_mass,MFcp_1L,MFcp2_1L,kont)
...
Call SortGoldstones(MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFc,MFc2,MFcp,MFcp2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,         & 
& MVZ,MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,kont)
...
Subroutine OneLoopFc(M1,MVWLm,MVWLm2,MFcp,MFcp2,MVWRm,MVWRm2,cplFcFcpVWLmL,           & 
& cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,delta,mass,mass2,kont)

Real(dp), Intent(in) :: MVWLm,MVWLm2,MFcp,MFcp2,MVWRm,MVWRm2

Real(dp), Intent(in) :: M1

Complex(dp), Intent(in) :: cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR
...
sigR = ZeroC 
sigS = ZeroC 
Call Sigma1LoopFc(p2,MVWLm,MVWLm2,MFcp,MFcp2,MVWRm,MVWRm2,cplFcFcpVWLmL,              & 
& cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,sigL,sigR,sigS)

mass = mi - sigS-MFc*(SigR+SigL) 
mass2= mass**2 
i_count = 0 
Do  
i_count = i_count + 1 
...
Subroutine Sigma1LoopFc(p2,MVWLm,MVWLm2,MFcp,MFcp2,MVWRm,MVWRm2,cplFcFcpVWLmL,        & 
& cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,SigL,SigR,SigS)
...
coupL1 = cplFcFcpVWLmL
coupR1 = cplFcFcpVWLmR
coupL2 =  Conjg(cplFcFcpVWLmL)
coupR2 =  Conjg(cplFcFcpVWLmR)
...
coupL1 = cplFcFcpVWRmL
coupR1 = cplFcFcpVWRmR
coupL2 =  Conjg(cplFcFcpVWRmL)
coupR2 =  Conjg(cplFcFcpVWRmR)
SumS = coupL1*coupR2*B0m2 
sumR = coupL1*coupL2*B1m2 
sumL = coupR1*coupR2*B1m2 
SigL = SigL +1._dp*sumL
...
Subroutine OneLoopFcp(M1,MVWLm,MVWLm2,MFc,MFc2,MVWRm,MVWRm2,MFcp,MFcp2,               & 
& MVZ,MVZ2,MVZR,MVZR2,cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,   & 
& cplcFcpFcpVPL,cplcFcpFcpVPR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR, & 
& delta,mass,mass2,kont)

Real(dp), Intent(in) :: MVWLm,MVWLm2,MFc,MFc2,MVWRm,MVWRm2,MFcp,MFcp2,MVZ,MVZ2,MVZR,MVZR2
...
sigR = ZeroC 
sigS = ZeroC 
Call Sigma1LoopFcp(p2,MVWLm,MVWLm2,MFc,MFc2,MVWRm,MVWRm2,MFcp,MFcp2,MVZ,              & 
& MVZ2,MVZR,MVZR2,cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,       & 
& cplcFcpFcpVPL,cplcFcpFcpVPR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR, & 
& sigL,sigR,sigS)

mass = mi - sigS-MFcp*(SigR+SigL) 
mass2= mass**2 
i_count = 0 
Do  
i_count = i_count + 1 
...
Subroutine Sigma1LoopFcp(p2,MVWLm,MVWLm2,MFc,MFc2,MVWRm,MVWRm2,MFcp,MFcp2,            & 
& MVZ,MVZ2,MVZR,MVZR2,cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,   & 
& cplcFcpFcpVPL,cplcFcpFcpVPR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR, & 
& sigL,sigR,sigS)
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = - Real(B1(p2,MFcp2,0._dp)+ 0.5_dp*rMS,dp) 
B0m2 = -4._dp*MFcp*Real(B0(p2,MFcp2,0._dp)-0.5_dp*rMS,dp) 
coupL1 = cplcFcpFcpVPL
coupR1 = cplcFcpFcpVPR
coupL2 =  Conjg(cplcFcpFcpVPL)
coupR2 =  Conjg(cplcFcpFcpVPR)
SumS = coupL1*coupR2*B0m2 
sumR = coupL1*coupL2*B1m2 
sumL = coupR1*coupR2*B1m2 
SigL = SigL +1._dp*sumL 
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = - Real(B1(p2,MFcp2,MVZ2)+ 0.5_dp*rMS,dp) 
B0m2 = -4._dp*MFcp*Real(B0(p2,MFcp2,MVZ2)-0.5_dp*rMS,dp) 
coupL1 = cplcFcpFcpVZL
coupR1 = cplcFcpFcpVZR
coupL2 =  Conjg(cplcFcpFcpVZL)
coupR2 =  Conjg(cplcFcpFcpVZR)
SumS = coupL1*coupR2*B0m2 
sumR = coupL1*coupL2*B1m2 
sumL = coupR1*coupR2*B1m2 
SigL = SigL +1._dp*sumL 
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = - Real(B1(p2,MFcp2,MVZR2)+ 0.5_dp*rMS,dp) 
B0m2 = -4._dp*MFcp*Real(B0(p2,MFcp2,MVZR2)-0.5_dp*rMS,dp) 
coupL1 = cplcFcpFcpVZRL
coupR1 = cplcFcpFcpVZRR
coupL2 =  Conjg(cplcFcpFcpVZRL)
coupR2 =  Conjg(cplcFcpFcpVZRR)
SumS = coupL1*coupR2*B0m2 
sumR = coupL1*coupL2*B1m2 
sumL = coupR1*coupR2*B1m2 
SigL = SigL +1._dp*sumL 
...
& MdeltaRpp2,MFcp,MFcp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,               & 
& MVZR2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplAhhhVZ,cpldeltaRppcdeltaRppVZ,           & 
& cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,           & 
& cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplcgWLmgWLmVZ,cplcgWRmgWLmVZ,           & 
& cplcgWLpgWLpVZ,cplcgWRpgWLpVZ,cplcgWRmgWRmVZ,cplcgWRpgWRpVZ,cplhhVPVZ,cplhhVZVZ,       & 
& cplhhVZVZR,cplHpmcHpmVZ,cplHpmcVWLmVZ,cplHpmcVWRmVZ,cplcVWLmVWLmVZ,cplcVWRmVWLmVZ,     & 
...
Real(dp), Intent(in) :: Mhh(3),Mhh2(3),MAh(3),MAh2(3),MdeltaRpp,MdeltaRpp2,MFcp,MFcp2,MFd(3),MFd2(3),         & 
& MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(6),MFv2(6),MVZ,MVZ2,MVZR,MVZR2,MHpm(3),              & 
& MHpm2(3),MVWLm,MVWLm2,MVWRm,MVWRm2

Real(dp), Intent(in) :: gBL,g2,gR,vd,vu,vR

Complex(dp), Intent(in) :: ZZ(3,3)

Complex(dp), Intent(in) :: cplAhhhVZ(3,3),cpldeltaRppcdeltaRppVZ,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFdFdVZL(3,3),   & 
& cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),  & 
& cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplcgWLmgWLmVZ,cplcgWRmgWLmVZ,cplcgWLpgWLpVZ,          & 
& cplcgWRpgWLpVZ,cplcgWRmgWRmVZ,cplcgWRpgWRpVZ,cplhhVPVZ(3),cplhhVZVZ(3),cplhhVZVZR(3),  & 
& cplHpmcHpmVZ(3,3),cplHpmcVWLmVZ(3),cplHpmcVWRmVZ(3),cplcVWLmVWLmVZ,cplcVWRmVWLmVZ,     & 
& cplcVWRmVWRmVZ,cplAhAhVZVZ(3,3),cpldeltaRppcdeltaRppVZVZ,cplhhhhVZVZ(3,3),             & 
& cplHpmcHpmVZVZ(3,3),cplcVWLmVWLmVZVZ1,cplcVWLmVWLmVZVZ2,cplcVWLmVWLmVZVZ3,             & 
...
p2 = MVZ2
PiSf = ZeroC 
Call Pi1LoopVZ(p2,Mhh,Mhh2,MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFcp,MFcp2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,MVWLm2,           & 
& MVWRm,MVWRm2,cplAhhhVZ,cpldeltaRppcdeltaRppVZ,cplcFcpFcpVZL,cplcFcpFcpVZR,             & 
...
Subroutine Pi1LoopVZ(p2,Mhh,Mhh2,MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFcp,MFcp2,            & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,              & 
& MVWLm2,MVWRm,MVWRm2,cplAhhhVZ,cpldeltaRppcdeltaRppVZ,cplcFcpFcpVZL,cplcFcpFcpVZR,      & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplFvFvVZL,cplFvFvVZR,cplcgWLmgWLmVZ,cplcgWRmgWLmVZ,cplcgWLpgWLpVZ,cplcgWRpgWLpVZ,     & 
& cplcgWRmgWRmVZ,cplcgWRpgWRpVZ,cplhhVPVZ,cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVZ,             & 
& cplHpmcVWLmVZ,cplHpmcVWRmVZ,cplcVWLmVWLmVZ,cplcVWRmVWLmVZ,cplcVWRmVWRmVZ,              & 
...
H0m2 = Hloop(p2,MFcp2,MFcp2) 
B0m2 = 4._dp*MFcp*MFcp*B0(p2,MFcp2,MFcp2) 
coupL1 = cplcFcpFcpVZL
coupR1 = cplcFcpFcpVZR
...
& cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFeFeVZRL,cplcFeFeVZRR,     & 
& cplcFuFuVZRL,cplcFuFuVZRR,cplFvFvVZRL,cplFvFvVZRR,cplcgWLmgWLmVZR,cplcgWRmgWLmVZR,     & 
& cplcgWLpgWLpVZR,cplcgWRpgWLpVZR,cplcgWRmgWRmVZR,cplcgWRpgWRpVZR,cplhhVPVZR,            & 
& cplhhVZVZR,cplhhVZRVZR,cplHpmcHpmVZR,cplHpmcVWLmVZR,cplHpmcVWRmVZR,cplcVWLmVWLmVZR,    & 
& cplcVWRmVWLmVZR,cplcVWRmVWRmVZR,cplAhAhVZRVZR,cpldeltaRppcdeltaRppVZRVZR,              & 
...
Complex(dp), Intent(in) :: cplAhhhVZR(3,3),cpldeltaRppcdeltaRppVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdVZRL(3,3),& 
...
p2 = MVZR2
PiSf = ZeroC 
Call Pi1LoopVZR(p2,Mhh,Mhh2,MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFcp,MFcp2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,MVWLm2,           & 
& MVWRm,MVWRm2,cplAhhhVZR,cpldeltaRppcdeltaRppVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,         & 
...
Subroutine Pi1LoopVZR(p2,Mhh,Mhh2,MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFcp,MFcp2,           & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,              & 
& MVWLm2,MVWRm,MVWRm2,cplAhhhVZR,cpldeltaRppcdeltaRppVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,  & 
& cplcFdFdVZRL,cplcFdFdVZRR,cplcFeFeVZRL,cplcFeFeVZRR,cplcFuFuVZRL,cplcFuFuVZRR,         & 
& cplFvFvVZRL,cplFvFvVZRR,cplcgWLmgWLmVZR,cplcgWRmgWLmVZR,cplcgWLpgWLpVZR,               & 
& cplcgWRpgWLpVZR,cplcgWRmgWRmVZR,cplcgWRpgWRpVZR,cplhhVPVZR,cplhhVZVZR,cplhhVZRVZR,     & 
& cplHpmcHpmVZR,cplHpmcVWLmVZR,cplHpmcVWRmVZR,cplcVWLmVWLmVZR,cplcVWRmVWLmVZR,           & 
...
& MFcp,MFcp2,MFc,MFc2,MFu,MFu2,MFd,MFd2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MVWLm,MVWLm2,         & 
& MVZ,MVZ2,MVZR,MVZR2,MdeltaRpp,MdeltaRpp2,cplAhHpmcVWLm,cplAhcVWLmVWRm,cplcFcpFccVWLmL, & 
& cplcFcpFccVWLmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplcFeFvcVWLmL,cplcFeFvcVWLmR,           & 
& cplcgWLpgPcVWLm,cplcgWRpgPcVWLm,cplcgPgWLmcVWLm,cplcgZgWLmcVWLm,cplcgZpgWLmcVWLm,      & 
& cplcgPgWRmcVWLm,cplcgZgWRmcVWLm,cplcgZpgWRmcVWLm,cplcgWLpgZcVWLm,cplcgWRpgZcVWLm,      & 
& cplcgWLpgZpcVWLm,cplcgWRpgZpcVWLm,cplhhHpmcVWLm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,         & 
& cplHpmcVWLmVP,cplHpmcVWLmVZ,cplHpmcVWLmVZR,cplcVWLmVPVWLm,cplcVWLmVPVWRm,              & 
& cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,cplcdeltaRppcHpmcVWLm,   & 
& cplcdeltaRppcVWLmcVWLm,cplcdeltaRppcVWLmcVWRm,cplAhAhcVWLmVWLm,cpldeltaRppcdeltaRppcVWLmVWLm,& 
...
Real(dp), Intent(in) :: MHpm(3),MHpm2(3),MAh(3),MAh2(3),MVWRm,MVWRm2,MFcp,MFcp2,MFc,MFc2,MFu(3),              & 
& MFu2(3),MFd(3),MFd2(3),MFe(3),MFe2(3),MFv(6),MFv2(6),Mhh(3),Mhh2(3),MVWLm,             & 
& MVWLm2,MVZ,MVZ2,MVZR,MVZR2,MdeltaRpp,MdeltaRpp2

Real(dp), Intent(in) :: g2,gR,vd,vu,vR,PhiW

Complex(dp), Intent(in) :: cplAhHpmcVWLm(3,3),cplAhcVWLmVWRm(3),cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFuFdcVWLmL(3,3),& 
& cplcFuFdcVWLmR(3,3),cplcFeFvcVWLmL(3,6),cplcFeFvcVWLmR(3,6),cplcgWLpgPcVWLm,           & 
...
& cplcgWRpgZpcVWLm,cplhhHpmcVWLm(3,3),cplhhcVWLmVWLm(3),cplhhcVWLmVWRm(3),               & 
& cplHpmcVWLmVP(3),cplHpmcVWLmVZ(3),cplHpmcVWLmVZR(3),cplcVWLmVPVWLm,cplcVWLmVPVWRm,     & 
& cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,cplcdeltaRppcHpmcVWLm(3),& 
...
& MVZR2,MdeltaRpp,MdeltaRpp2,cplAhHpmcVWLm,cplAhcVWLmVWRm,cplcFcpFccVWLmL,               & 
& cplcFcpFccVWLmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplcFeFvcVWLmL,cplcFeFvcVWLmR,           & 
& cplcgWLpgPcVWLm,cplcgWRpgPcVWLm,cplcgPgWLmcVWLm,cplcgZgWLmcVWLm,cplcgZpgWLmcVWLm,      & 
& cplcgPgWRmcVWLm,cplcgZgWRmcVWLm,cplcgZpgWRmcVWLm,cplcgWLpgZcVWLm,cplcgWRpgZcVWLm,      & 
& cplcgWLpgZpcVWLm,cplcgWRpgZpcVWLm,cplhhHpmcVWLm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,         & 
...
& MFc2,MFu,MFu2,MFd,MFd2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MVWLm,MVWLm2,MVZ,MVZ2,               & 
& MVZR,MVZR2,MdeltaRpp,MdeltaRpp2,cplAhHpmcVWLm,cplAhcVWLmVWRm,cplcFcpFccVWLmL,          & 
& cplcFcpFccVWLmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplcFeFvcVWLmL,cplcFeFvcVWLmR,           & 
& cplcgWLpgPcVWLm,cplcgWRpgPcVWLm,cplcgPgWLmcVWLm,cplcgZgWLmcVWLm,cplcgZpgWLmcVWLm,      & 
& cplcgPgWRmcVWLm,cplcgZgWRmcVWLm,cplcgZpgWRmcVWLm,cplcgWLpgZcVWLm,cplcgWRpgZcVWLm,      & 
& cplcgWLpgZpcVWLm,cplcgWRpgZpcVWLm,cplhhHpmcVWLm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,         & 
...
& MFcp,MFcp2,MFc,MFc2,MFu,MFu2,MFd,MFd2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MVWRm,MVWRm2,         & 
& MVZ,MVZ2,MVZR,MVZR2,MdeltaRpp,MdeltaRpp2,cplAhHpmcVWRm,cplAhcVWRmVWLm,cplcFcpFccVWRmL, & 
& cplcFcpFccVWRmR,cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFeFvcVWRmL,cplcFeFvcVWRmR,           & 
...
& cplHpmcVWRmVP,cplHpmcVWRmVZ,cplHpmcVWRmVZR,cplcVWRmVPVWLm,cplcVWRmVPVWRm,              & 
& cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,cplcVWRmVWRmVZ,cplcVWRmVWRmVZR,cplcdeltaRppcHpmcVWRm,   & 
& cplcdeltaRppcVWLmcVWRm,cplcdeltaRppcVWRmcVWRm,cplAhAhcVWRmVWRm,cpldeltaRppcdeltaRppcVWRmVWRm,& 
...
Real(dp), Intent(in) :: MHpm(3),MHpm2(3),MAh(3),MAh2(3),MVWLm,MVWLm2,MFcp,MFcp2,MFc,MFc2,MFu(3),              & 
& MFu2(3),MFd(3),MFd2(3),MFe(3),MFe2(3),MFv(6),MFv2(6),Mhh(3),Mhh2(3),MVWRm,             & 
& MVWRm2,MVZ,MVZ2,MVZR,MVZR2,MdeltaRpp,MdeltaRpp2

Real(dp), Intent(in) :: g2,gR,vd,vu,vR,PhiW

Complex(dp), Intent(in) :: cplAhHpmcVWRm(3,3),cplAhcVWRmVWLm(3),cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFuFdcVWRmL(3,3),& 
& cplcFuFdcVWRmR(3,3),cplcFeFvcVWRmL(3,6),cplcFeFvcVWRmR(3,6),cplcgWLpgPcVWRm,           & 
...
& cplcgWRpgZpcVWRm,cplhhHpmcVWRm(3,3),cplhhcVWRmVWLm(3),cplhhcVWRmVWRm(3),               & 
& cplHpmcVWRmVP(3),cplHpmcVWRmVZ(3),cplHpmcVWRmVZR(3),cplcVWRmVPVWLm,cplcVWRmVPVWRm,     & 
& cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,cplcVWRmVWRmVZ,cplcVWRmVWRmVZR,cplcdeltaRppcHpmcVWRm(3),& 
...
& MVZR2,MdeltaRpp,MdeltaRpp2,cplAhHpmcVWRm,cplAhcVWRmVWLm,cplcFcpFccVWRmL,               & 
& cplcFcpFccVWRmR,cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFeFvcVWRmL,cplcFeFvcVWRmR,           & 
& cplcgWLpgPcVWRm,cplcgWRpgPcVWRm,cplcgPgWLmcVWRm,cplcgZgWLmcVWRm,cplcgZpgWLmcVWRm,      & 
& cplcgPgWRmcVWRm,cplcgZgWRmcVWRm,cplcgZpgWRmcVWRm,cplcgWLpgZcVWRm,cplcgWRpgZcVWRm,      & 
& cplcgWLpgZpcVWRm,cplcgWRpgZpcVWRm,cplhhHpmcVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,         & 
...
& MFc2,MFu,MFu2,MFd,MFd2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MVWRm,MVWRm2,MVZ,MVZ2,               & 
& MVZR,MVZR2,MdeltaRpp,MdeltaRpp2,cplAhHpmcVWRm,cplAhcVWRmVWLm,cplcFcpFccVWRmL,          & 
& cplcFcpFccVWRmR,cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFeFvcVWRmL,cplcFeFvcVWRmR,           & 
& cplcgWLpgPcVWRm,cplcgWRpgPcVWRm,cplcgPgWLmcVWRm,cplcgZgWLmcVWRm,cplcgZpgWLmcVWRm,      & 
& cplcgPgWRmcVWRm,cplcgZgWRmcVWRm,cplcgZpgWRmcVWRm,cplcgWLpgZcVWRm,cplcgWRpgZcVWRm,      & 
& cplcgWLpgZpcVWRm,cplcgWRpgZpcVWRm,cplhhHpmcVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,         & 
...
End Module LoopMasses_LRmodelsTRDM 
