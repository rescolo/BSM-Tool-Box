...
& gTVZ,gTVZR,gFvFvcFdFd,gFvFvcFeFe,gFvFvcFuFu,gFvFvFvFv,gFvFecFuFd,gFvFecFcpFc,          & 
& gFvFvcFcpFcp,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Complex(dp) :: cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFcpFcpVZL,        & 
...
& gFvFecFuFd(6,3,3,3),gFvFecFcpFc(6,3,1,1),gFvFvcFcpFcp(6,6,1,1)
...
& gFvFecFuFdi(3,3,3),gFvFecFcpFci(3,1,1),gFvFvcFcpFcpi(6,1,1)
...
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplcFcpFccVWLmL,cplcFcpFccVWLmR,   & 
& cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,            & 
& cplcFcpFcpVZRR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,            & 
...
Real(dp),Intent(in) :: MFe(3),MFcp,MFc,MVWLm,MVWRm,MFv(6)

Complex(dp),Intent(in) :: cplcFcpFccVWLmL,cplcFcpFccVWLmR,cplcFcpFccVWRmL,cplcFcpFccVWRmR,cplFvFeVWLmL(6,3),    & 
& cplFvFeVWLmR(6,3),cplFvFeVWRmL(6,3),cplFvFeVWRmR(6,3)
...
If(Abs(MFv(iIN)).gt.(Abs(MFc)+Abs(MFcp)+Abs(MFe(gt1)))) Then 
!-------------- 
!  VWLm 
!-------------- 
Isum = Isum + 1 
...
End Module Fv3Decays_LRmodelsTRDM 
