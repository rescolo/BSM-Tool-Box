...
& YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,gTAh,gTdeltaRpp,gThh,gTHpm,             & 
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,gFeFeFvFv,gFeFecFcpFcp,      & 
& gFeFvcFdFu,gFeFvFcpFc,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Complex(dp) :: cplcFcpFcpVZL,cplcFcpFcpVZR,cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdAhL(3,3,3),         & 
...
& gFeFecFcpFcp(3,3,1,1),gFeFvcFdFu(3,6,3,3),gFeFvFcpFc(3,6,1,1)
...
& gFeFecFcpFcpi(3,1,1),gFeFvcFdFui(6,3,3),gFeFvFcpFci(6,1,1)
...
& LAM3,YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,cplcFcpFcpVZL,cplcFcpFcpVZR,       & 
& cplcFcpFcpVZRL,cplcFcpFcpVZRR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,         & 
...
& cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR,cplFeFecdeltaRppL,cplFeFecdeltaRppR,         & 
...
gFeFvFcpFci = 0._dp 
Call FeToFvFcpFc(i_run,MFv,MFcp,MFc,MVWLm,MVWRm,MFe,cplcFeFvcVWLmL,cplcFeFvcVWLmR,    & 
& cplcFeFvcVWRmL,cplcFeFvcVWRmR,cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,               & 
& cplFcFcpVWRmR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWLmtemp,gTVWRmtemp,deltaM,          & 
& epsI,check,gFeFvFcpFci)
...
Subroutine FeToFvFcpFc(iIN,MFv,MFcp,MFc,MVWLm,MVWRm,MFe,cplcFeFvcVWLmL,               & 
& cplcFeFvcVWLmR,cplcFeFvcVWRmL,cplcFeFvcVWRmR,cplFcFcpVWLmL,cplFcFcpVWLmR,              & 
& cplFcFcpVWRmL,cplFcFcpVWRmR,IntegralVs,IntegralVVss,NVs,NVVss,gTVWLm,gTVWRm,           & 
& deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFv(6),MFcp,MFc,MVWLm,MVWRm,MFe(3)

Complex(dp),Intent(in) :: cplcFeFvcVWLmL(3,6),cplcFeFvcVWLmR(3,6),cplcFeFvcVWRmL(3,6),cplcFeFvcVWRmR(3,6),      & 
& cplFcFcpVWLmL,cplFcFcpVWLmR,cplFcFcpVWRmL,cplFcFcpVWRmR
...
If(Abs(MFe(iIN)).gt.(Abs(MFc)+Abs(MFcp)+Abs(MFv(gt1)))) Then 
!-------------- 
!  conj[VWLm] 
!-------------- 
Isum = Isum + 1 
...
coup(2) = Conjg(cplcFeFvcVWLmL(iIN,gt1)) 
coup(1) = Conjg(cplcFeFvcVWLmR(iIN,gt1)) 
coup(4) = Conjg(cplFcFcpVWLmL) 
coup(3) = Conjg(cplFcFcpVWLmR)
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
coup(2) = Conjg(cplcFeFvcVWRmL(iIN,gt1)) 
coup(1) = Conjg(cplcFeFvcVWRmR(iIN,gt1)) 
coup(4) = Conjg(cplFcFcpVWRmL) 
coup(3) = Conjg(cplFcFcpVWRmR)
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
coup2(4) = Conjg(cplcFeFvcVWRmL(iIN,gt1)) 
coup2(3) = Conjg(cplcFeFvcVWRmR(iIN,gt1))  
coup2(5) = cplFcFcpVWLmL 
coup2(6) = cplFcFcpVWLmR 
coup2(8) = Conjg(cplFcFcpVWRmL) 
coup2(7) = Conjg(cplFcFcpVWRmR) 
Call IntegrateGaugeSS(Boson4, mass, coup2, deltaM, epsI,IntegralVVss,NVVss, resR, check) 
If (resR.ne.resR) resR = 0._dp
resC = 2._dp*resR 
resS = resS + resC 
...
End Module Fe3Decays_LRmodelsTRDM 
