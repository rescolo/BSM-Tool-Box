...
& YDR,YL1,YQ1,YL2,YQ2,M1,mu32,MU22,MU12,vd,vu,vR,gTAh,gThh,gTHpm,gTVWLm,gTVWRm,          & 
& gTVZ,gTVZR,gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,gFuFuFvFv,gFuFdFvFe,gFuFdFcpFc,            & 
& gFuFucFcpFcp,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
& gFuFdFvFe(3,3,6,3),gFuFdFcpFc(3,3,1,1),gFuFucFcpFcp(3,3,1,1)
...
& gFuFdFvFei(3,6,3),gFuFdFcpFci(3,1,1),gFuFucFcpFcpi(3,1,1)
...
& cplFcFcpVWRmR,cplFvFeHpmL,cplFvFeHpmR,cplFvFeVWLmL,cplFvFeVWLmR,cplFvFeVWRmL,          & 
...
Real(dp),Intent(in) :: MFd(3),MFcp,MFc,MVWLm,MVWRm,MFu(3)
...
If(Abs(MFu(iIN)).gt.(Abs(MFc)+Abs(MFcp)+Abs(MFd(gt1)))) Then 
!-------------- 
!  conj[VWLm] 
!-------------- 
Isum = Isum + 1 
...
End Module Fu3Decays_LRmodelsTRDM 
